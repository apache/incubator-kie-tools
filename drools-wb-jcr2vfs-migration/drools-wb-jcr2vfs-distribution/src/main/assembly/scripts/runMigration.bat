...
rem echo "Usage: runMigration.bat <path-to-jcr-repository> <vfs-repository>"
...
%JAVA_BIN% -Xms256m -Xmx1024m -cp ..\jcr-exporter-libs\*; %exporterMainClass% %1 .\temp

%JAVA_BIN% -Xms256m -Xmx1024m -cp ..\vfs-importer-libs\*; %importerMainClass% .\temp %2
...
public class UberFireSecurityFilter implements Filter {
    ...
    private void logout(final SecurityContext context, final HttpServletRequest httpRequest, final HttpServletResponse httpResponse) {
    ...
    private <T> T loadConfigClazz(final String clazzName, Class<T> typeOf) {

...
public class FileDownloadServletTest {
    ...
    private void doDownloadByPath( String sourceFolder, String sourceFileName, String fileContent ) throws Exception {
        ...
        MockServletOutputStream servletOutputStream = new MockServletOutputStream( outputStream );
        ...
        assertArrayEquals( fileContent.getBytes(), outputStream.toByteArray() );
    }
    ...
    private class MockServletOutputStream extends ServletOutputStream {
        ...
        public MockServletOutputStream( OutputStream output ) {
            this.output = output;
        }

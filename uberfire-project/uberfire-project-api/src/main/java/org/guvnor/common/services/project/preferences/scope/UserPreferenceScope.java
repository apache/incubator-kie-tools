...
public class UserPreferenceScope implements PreferenceScopeBean {

    private PreferenceScopeFactory scopeFactory;

    @Inject
    public UserPreferenceScope(final PreferenceScopeFactory scopeFactory) {
        this.scopeFactory = scopeFactory;
    }

    @Override
    public PreferenceScope resolve() {
        return scopeFactory.createScope(GuvnorPreferenceScopes.USER);
    }
}

...
public class ProviderTypeListRefreshEvent {
    ...
    public ProviderTypeListRefreshEvent(final ProviderTypeKey providerTypeKey) {
    ...
    public boolean equals(Object o) {
        ...
        ProviderTypeListRefreshEvent that = (ProviderTypeListRefreshEvent) o;

        return providerTypeKey != null ? providerTypeKey.equals(that.providerTypeKey) : that.providerTypeKey == null;
    }

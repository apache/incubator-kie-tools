...
@Property
@FieldDefinition
public class ProcessInstanceDescription implements BPMNProperty {

    @Caption
    public static final transient String caption = "Process Instance Description";

    @Description
    public static final transient String description = "This attribute is used to annotate Process Instances";

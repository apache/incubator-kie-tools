...
public class Independent implements BPMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "Independent";

    @Description
    public static final transient String description = "Subprocess is executed as an Independent Process";
    ...
    public Independent(final Boolean value) {
        this.value = value;
    }

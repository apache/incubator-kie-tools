...
public class FontBorderColor implements BPMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "Font Border Color";

    @Description
    public static final transient String description = "The font border color";
    ...
    public FontBorderColor() {
    }

    public FontBorderColor(final String value) {
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof FontBorderColor) {
            FontBorderColor other = (FontBorderColor) o;

...
public class ErrorRef implements BPMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "ErrorRef";

    @Description
    public static final transient String description = "Error Reference";
    ...
    public ErrorRef(final String value) {
        this.value = value;
    }

...
public class AdHoc implements BPMNProperty {
    ...
    @Caption
    public static final transient String caption = "Ad-Hoc";

    @Description
    public static final transient String description = "Is an Ad-Hoc process";
    ...
    public AdHoc(final Boolean value) {
        this.value = value;
    }

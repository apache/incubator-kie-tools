...
public class WaitForCompletion implements BPMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "Wait for Completion";

    @Description
    public static final transient String description = "Wait for the Subprocess to terminate (completed or aborted)";
    ...
    public WaitForCompletion(final Boolean value) {
        this.value = value;
    }

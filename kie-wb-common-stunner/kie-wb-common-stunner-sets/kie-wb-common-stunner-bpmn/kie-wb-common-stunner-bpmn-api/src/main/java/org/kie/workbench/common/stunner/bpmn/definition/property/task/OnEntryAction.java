...
public class OnEntryAction implements BPMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "On Entry Action";

    @Description
    public static final transient String description = "On Entry Action";
    ...
    public OnEntryAction(final String value) {
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof OnEntryAction) {
            OnEntryAction other = (OnEntryAction) o;

...
public class EndMessageEvent extends BaseEndEvent {
    ...
    @Title
    public static final transient String title = "End Message Event";

    @Description
    public static final transient String description = "At the end of the process, a message is sent.";

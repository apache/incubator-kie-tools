...
public class SignalScope implements BPMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "Signal Scope";

    @Description
    public static final transient String description = "Defines the Signal Propagation Scope";

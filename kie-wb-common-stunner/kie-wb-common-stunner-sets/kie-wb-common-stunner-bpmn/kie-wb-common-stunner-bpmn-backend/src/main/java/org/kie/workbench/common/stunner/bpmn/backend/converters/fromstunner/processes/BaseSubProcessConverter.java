...
public abstract class BaseSubProcessConverter<A extends BaseAdHocSubprocess>
        extends ProcessConverterDelegate<A>  {

    private final DefinitionsBuildingContext context;
    private final PropertyWriterFactory propertyWriterFactory;

    public BaseSubProcessConverter(DefinitionsBuildingContext context,
                                   PropertyWriterFactory propertyWriterFactory,
                                   BaseConverterFactory<?, A, ?> converterFactory) {
    ...
    private SubProcessPropertyWriter convertAdHocSubprocessNode(Node<View<A>, ?> n) {
        ...
        A definition = n.getContent().getDefinition();

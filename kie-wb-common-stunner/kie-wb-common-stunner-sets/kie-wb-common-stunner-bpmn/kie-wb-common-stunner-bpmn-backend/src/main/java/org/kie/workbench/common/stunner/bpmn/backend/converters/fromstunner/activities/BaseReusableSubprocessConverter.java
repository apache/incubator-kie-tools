...
public abstract class BaseReusableSubprocessConverter<T extends BaseReusableSubprocess> {

    private final PropertyWriterFactory propertyWriterFactory;

    public BaseReusableSubprocessConverter(PropertyWriterFactory propertyWriterFactory) {
        this.propertyWriterFactory = propertyWriterFactory;
    }

    public PropertyWriter toFlowElement(Node<View<T>, ?> n) {
        ...
        T definition = n.getContent().getDefinition();

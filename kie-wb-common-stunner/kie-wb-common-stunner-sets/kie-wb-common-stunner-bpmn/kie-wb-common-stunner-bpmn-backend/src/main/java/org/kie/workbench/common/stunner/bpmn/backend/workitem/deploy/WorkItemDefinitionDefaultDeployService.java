...
public class WorkItemDefinitionDefaultDeployService implements WorkItemDefinitionDeployService {
    ...
    static final String REST_ICON = "defaultresticon.png";
    static final String EMAIL_ICON = "defaultemailicon.png";
    static final String WEB_SERVICE_ICON = "defaultwebserviceicon.png";
    static final String BR_ICON = "defaultbusinessruletaskicon.png";
    static final String DECISION_ICON = "defaultdecisiontaskicon.png";
    static final String LOG_ICON = "defaultlogicon.png";

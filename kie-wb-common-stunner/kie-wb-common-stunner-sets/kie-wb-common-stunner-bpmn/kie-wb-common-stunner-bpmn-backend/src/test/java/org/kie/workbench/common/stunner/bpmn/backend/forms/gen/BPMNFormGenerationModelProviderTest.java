...
public class BPMNFormGenerationModelProviderTest {
    ...
    public void init() {
        ...
        tested = new BPMNFormGenerationModelProvider(bpmnDiagramMarshaller,
                                                     definitionUtils);
        tested.init();
        verify(definitionUtils, times(1)).getDefinitionSetId(eq(BPMNDefinitionSet.class));
    }
    ...
    public void testGenerate() throws Exception {
        ...
        verify(bpmnDiagramMarshaller, times(1)).marshallToBpmn2Resource(eq(diagram));
    }
}

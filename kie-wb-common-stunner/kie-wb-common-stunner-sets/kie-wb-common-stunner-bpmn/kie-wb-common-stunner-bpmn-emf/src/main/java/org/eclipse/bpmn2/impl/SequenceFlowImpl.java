...
public class SequenceFlowImpl extends FlowElementImpl implements SequenceFlow {
	...
	public NotificationChain basicSetConditionExpression(Expression newConditionExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Bpmn2Package.SEQUENCE_FLOW__CONDITION_EXPRESSION, oldConditionExpression, newConditionExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newConditionExpression != conditionExpression) {
			...
			if (conditionExpression != null)
				msgs = ((InternalEObject) conditionExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmn2Package.SEQUENCE_FLOW__CONDITION_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__CONDITION_EXPRESSION,
	...
	public void setIsImmediate(boolean newIsImmediate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__IS_IMMEDIATE,
	...
	public void setSourceRef(FlowNode newSourceRef) {
		if (newSourceRef != sourceRef) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__SOURCE_REF, newSourceRef,
					newSourceRef));
	}
	...
	public void setTargetRef(FlowNode newTargetRef) {
		if (newTargetRef != targetRef) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__TARGET_REF, newTargetRef,
					newTargetRef));
	}

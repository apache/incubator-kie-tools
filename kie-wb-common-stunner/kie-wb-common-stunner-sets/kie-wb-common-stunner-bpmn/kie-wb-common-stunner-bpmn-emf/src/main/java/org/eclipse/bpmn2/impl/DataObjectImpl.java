...
public class DataObjectImpl extends FlowElementImpl implements DataObject {
		...
		if (newDataState != dataState) {
			...
			if (dataState != null)
				msgs = ((InternalEObject) dataState).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmn2Package.DATA_OBJECT__DATA_STATE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.DATA_OBJECT__DATA_STATE, newDataState,
					newDataState));
	}
	...
	public void setItemSubjectRef(ItemDefinition newItemSubjectRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.DATA_OBJECT__ITEM_SUBJECT_REF,
	...
	public void setIsCollection(boolean newIsCollection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.DATA_OBJECT__IS_COLLECTION,

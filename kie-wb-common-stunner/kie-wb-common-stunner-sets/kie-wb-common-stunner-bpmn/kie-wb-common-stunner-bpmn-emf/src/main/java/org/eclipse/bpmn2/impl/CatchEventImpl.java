...
public abstract class CatchEventImpl extends EventImpl implements CatchEvent {
	...
	public EList<DataOutputAssociation> getDataOutputAssociation() {
		if (dataOutputAssociation == null) {
			dataOutputAssociation = new EObjectContainmentEList<DataOutputAssociation>(DataOutputAssociation.class,
					this, Bpmn2Package.CATCH_EVENT__DATA_OUTPUT_ASSOCIATION);
		}
		...
		if (newOutputSet != outputSet) {
			...
			if (outputSet != null)
				msgs = ((InternalEObject) outputSet).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmn2Package.CATCH_EVENT__OUTPUT_SET, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.CATCH_EVENT__OUTPUT_SET, newOutputSet,
					newOutputSet));
	}
	...
	public void setParallelMultiple(boolean newParallelMultiple) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.CATCH_EVENT__PARALLEL_MULTIPLE,

...
public class ReceiveTaskImpl extends TaskImpl implements ReceiveTask {
	...
	public void setImplementation(String newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.RECEIVE_TASK__IMPLEMENTATION,
	...
	public Message getMessageRef() {
		if (messageRef != null && messageRef.eIsProxy()) {
			...
			if (messageRef != oldMessageRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.RECEIVE_TASK__MESSAGE_REF,
	...
	public void setMessageRef(Message newMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.RECEIVE_TASK__MESSAGE_REF, oldMessageRef,
					messageRef));
	}
	...
	public Operation getOperationRef() {
		if (operationRef != null && operationRef.eIsProxy()) {
			...
			if (operationRef != oldOperationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.RECEIVE_TASK__OPERATION_REF,
	...
	public void setOperationRef(Operation newOperationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.RECEIVE_TASK__OPERATION_REF,
					oldOperationRef, operationRef));
	}

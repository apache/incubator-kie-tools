...
import static org.kie.workbench.common.stunner.bpmn.client.marshall.converters.tostunner.GraphBuilderTest.mockBpmnNode;
import static org.kie.workbench.common.stunner.bpmn.client.marshall.converters.tostunner.GraphBuilderTest.mockNode;
...
public class ProcessPostConverterTest {
    ...
    public void testPostConvert() {
        ...
        EList<Point> wayPoints = ECollections.newBasicEList();

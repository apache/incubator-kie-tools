...
public class BPMNProjectSessionDiagramSavedHandlerTest extends BPMNProjectBaseSessionDiagramHandlerTest<BPMNProjectSessionDiagramSavedHandler> {
    ...
    @Override
    protected BPMNProjectSessionDiagramSavedHandler createHandler() {
        return new BPMNProjectSessionDiagramSavedHandler(bpmnDiagramResourceType,
                                                         diagramService,
                                                         canvasExport,
                                                         notificationEvent,
                                                         translationService);
    ...
    public void testOnSessionDiagramSavedSuccessful() {
        handler.onSessionDiagramSaved(editorSession);
    ...
    public void testOnSessionDiagramOpenedSessionForReadonlySession() {
        handler.onSessionDiagramSaved(mock(ViewerSession.class));
        verifyDoNothing();
    }
}

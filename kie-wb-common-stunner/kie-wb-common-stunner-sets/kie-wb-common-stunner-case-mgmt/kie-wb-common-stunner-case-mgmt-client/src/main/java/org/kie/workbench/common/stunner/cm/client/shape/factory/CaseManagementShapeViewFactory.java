...
public class CaseManagementShapeViewFactory {
    ...
    public StageView newStageView(final double width,
                                  final double height,
                                  final double voffset) {
        return new StageView(width,
                             height,
                             voffset);
    }

    public ActivityView newActivityView(final double width,
                                        final double height) {
        return new ActivityView(width,
                                height);
    }

    public DiagramView newDiagramView(final double width,
                                      final double height) {
        return new DiagramView(width,
                               height);
    }
}

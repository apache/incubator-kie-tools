...
public final class CaseManagementSubprocessShapeDef
        ...
        implements
        StageShapeDef<CaseManagementBaseSubprocess>,
        HasChildShapeDefs<CaseManagementBaseSubprocess> {
    ...
    @Override
    public String getNamePropertyValue(final CaseManagementBaseSubprocess element) {
    ...
    @Override
    public Map<ShapeDef<CaseManagementBaseSubprocess>, HasChildren.Layout> getChildShapeDefs() {
        return new HashMap<ShapeDef<CaseManagementBaseSubprocess>, HasChildren.Layout>() {{
    ...
    public final class ProcessIconProxy
            extends AbstractShapeDef<CaseManagementBaseSubprocess>
            implements DynamicIconShapeDef<CaseManagementBaseSubprocess> {
        ...
        @Override
        public Icons getIcon(final CaseManagementBaseSubprocess definition) {
            return Icons.PLUS;
        }
    }
}

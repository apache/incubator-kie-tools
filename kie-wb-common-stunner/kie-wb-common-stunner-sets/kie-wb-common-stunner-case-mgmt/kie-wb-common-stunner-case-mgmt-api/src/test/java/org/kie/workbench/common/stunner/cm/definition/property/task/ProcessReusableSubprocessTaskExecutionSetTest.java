...
public class ProcessReusableSubprocessTaskExecutionSetTest {
    ...
    public void setUp() throws Exception {
        ...
        tested = new ProcessReusableSubprocessTaskExecutionSet();
        tested.setIsCase(new IsCase(CASE_VALID));
    }

    @Test
    public void testAllValid() {
        Set<ConstraintViolation<ProcessReusableSubprocessTaskExecutionSet>> violations = this.validator.validate(tested);

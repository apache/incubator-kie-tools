...
public class ProcessReusableSubprocessTest {
    ...
    private ProcessReusableSubprocess tested;
    ...
    public void testAllValid() {
        Set<ConstraintViolation<ProcessReusableSubprocess>> violations = this.validator.validate(tested);

...
package org.kie.workbench.common.stunner.basicset.client.shape.view.handler;
...
public class BasicSetViewHandlers {

    public static final TitleHandler<ShapeView> TITLE_HANDLER = new TitleHandler<>();

    public static class FontHandlerBuilder<W extends BasicSetDefinition, V extends ShapeView>
    ...
    public static class ViewAttributesHandlerBuilder<W extends BasicSetDefinition, V extends ShapeView>

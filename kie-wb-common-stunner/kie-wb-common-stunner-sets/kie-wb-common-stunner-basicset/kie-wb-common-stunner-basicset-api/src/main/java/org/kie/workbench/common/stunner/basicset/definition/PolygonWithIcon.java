...
import static org.kie.workbench.common.stunner.basicset.util.FieldDefLabelConstants.FIELDDEF_ICON_TYPE;
...
public class PolygonWithIcon {
    ...
    @Property
    @FieldDef(label = FIELDDEF_ICON_TYPE, property = "value")
    @Valid

...
public class BPMNStandaloneDiagramServiceImplTest {
    ...
    public void testNameAndIdAsXML() throws IOException {
        ...
        assertEquals(BPMNStandaloneDiagramServiceImpl.DEFAULT_PROCESS_ID, diagramSet.getName().getValue());
        assertEquals(BPMNStandaloneDiagramServiceImpl.DEFAULT_PROCESS_ID, diagramSet.getId().getValue());
    }
}

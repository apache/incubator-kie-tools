...
public final class SetCanvasConnectionTargetNodeCommand extends AbstractCanvasConnectionCommand {
    ...
    protected Command<GraphCommandExecutionContext, RuleViolation> buildGraphCommand( final AbstractCanvasHandler context ) {
        return new SetConnectionTargetNodeCommand( getNode(), getEdge(), getMagnetIndex() );
    }

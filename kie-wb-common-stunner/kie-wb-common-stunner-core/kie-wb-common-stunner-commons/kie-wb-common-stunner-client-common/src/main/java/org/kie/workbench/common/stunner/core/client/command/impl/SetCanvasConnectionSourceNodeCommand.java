...
public final class SetCanvasConnectionSourceNodeCommand extends AbstractCanvasConnectionCommand {

    public SetCanvasConnectionSourceNodeCommand( final Node<? extends View<?>, Edge> node,
                                                 final Edge<? extends View<?>, Node> edge,
                                                 final int magnetIndex ) {
        super( node, edge, magnetIndex );
    }

    @Override
    protected Command<GraphCommandExecutionContext, RuleViolation> buildGraphCommand( final AbstractCanvasHandler context ) {
        return new SetConnectionSourceNodeCommand( getNode(), getEdge(), getMagnetIndex() );
    }

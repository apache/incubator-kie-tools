...
public class DeleteEdgeCommandTest extends AbstractGraphCommandTest {
    ...
    private Node target;
    private Edge edge;
    private DeleteEdgeCommand tested;
    ...
    public void setup() throws Exception {
        ...
        this.tested = new DeleteEdgeCommand( UUID );
    }
    ...
    public void testAllow() {
        ...
        verify( edgeCardinalityRuleManager, times( 1 ) ).evaluate( any( Edge.class ), eq( target ), eq( source ),
                any( List.class ), any( List.class ), eq( RuleManager.Operation.DELETE ) );
    ...
    public void testNotAllowed() {
        ...
        when( edgeCardinalityRuleManager.evaluate( any( Edge.class ), any( Node.class ), any( Node.class ),
                any( List.class ), any( List.class ), any( RuleManager.Operation.class ) ) ).thenReturn( FAILED_VIOLATIONS );
        CommandResult<RuleViolation> result = tested.allow( graphCommandExecutionContext );

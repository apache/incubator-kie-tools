...
public class DeleteParentEdgeCommandTest extends AbstractGraphCommandTest {
    ...
    public void setup() throws Exception {
        ...
        this.tested = new DeleteParentEdgeCommand( PARENT_UUID, CANDIDATE_UUID );
    }

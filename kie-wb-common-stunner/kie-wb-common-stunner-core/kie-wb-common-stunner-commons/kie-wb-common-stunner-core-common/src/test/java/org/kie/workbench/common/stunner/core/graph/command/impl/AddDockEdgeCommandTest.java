...
public class AddDockEdgeCommandTest extends AbstractGraphCommandTest {
    ...
    private AddDockEdgeCommand tested;
    ...
    public void setup() throws Exception {
        ...
        this.tested = new AddDockEdgeCommand( PARENT_UUID, CANDIDATE_UUID );
    }
    ...
    public void testNotAllowed() {
        ...
        when( dockingRuleManager.evaluate( any( Element.class ), any( Element.class ) ) ).thenReturn( FAILED_VIOLATIONS );
        CommandResult<RuleViolation> result = tested.allow( graphCommandExecutionContext );

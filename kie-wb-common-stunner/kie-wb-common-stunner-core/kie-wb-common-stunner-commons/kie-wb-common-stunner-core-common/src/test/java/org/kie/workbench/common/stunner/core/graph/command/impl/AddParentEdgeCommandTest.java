...
public class AddParentEdgeCommandTest extends AbstractGraphCommandTest {
    ...
    private AddParentEdgeCommand tested;
    ...
    public void setup() throws Exception {
        ...
        this.tested = new AddParentEdgeCommand( PARENT_UUID, CANDIDATE_UUID );
    }

...
public class DeleteChildEdgeCommandTest extends AbstractGraphCommandTest {
    ...
    public void setup() throws Exception {
        ...
        this.tested = new DeleteChildEdgeCommand( PARENT_UUID, CANDIDATE_UUID );
    }

...
public class DeleteDockEdgeCommandTest extends AbstractGraphCommandTest {
    ...
    private DeleteDockEdgeCommand tested;
    ...
    public void setup() throws Exception {
        ...
        this.tested = new DeleteDockEdgeCommand( PARENT_UUID, CANDIDATE_UUID );
    }

...
public class AddChildEdgeCommandTest extends AbstractGraphCommandTest {
    ...
    private AddChildEdgeCommand tested;
    ...
    public void setup() throws Exception {
        ...
        this.tested = new AddChildEdgeCommand( PARENT_UUID, CANDIDATE_UUID );
    }

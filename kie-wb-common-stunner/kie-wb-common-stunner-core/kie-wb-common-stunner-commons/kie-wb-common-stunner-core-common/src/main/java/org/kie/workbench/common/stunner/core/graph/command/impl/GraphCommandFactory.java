...
public class GraphCommandFactory {
    ...
    @SuppressWarnings( "unchecked" )
    public AddConnectorCommand addConnector( final Node target, final Edge edge, final int magnetIdx ) {
    ...
    @SuppressWarnings( "unchecked" )
    public SetParentNodeCommand setParentNode( final Node parent, final Node candidate ) {
        return new SetParentNodeCommand( parent, candidate );
    }

    @SuppressWarnings( "unchecked" )
    public DockNodeCommand dockNode( final Node parent, final Node candidate ) {
    ...
    @SuppressWarnings( "unchecked" )
    public RemoveParentCommand removeFromParent( final Node parent, final Node candidate ) {
        return new RemoveParentCommand( parent, candidate );
    }

    @SuppressWarnings( "unchecked" )
    public UnDockNodeCommand unDockNode( final Node parent, final Node candidate ) {

...
public final class StaticIconsBuilder {
    ...
    private static Group businessRule() {
        ...
        final Rectangle r1 = new Rectangle( 22,
                                            4 )
                .setX( 0 )
                .setY( 0 )
                .setFillColor( "#B3B1B3" )
                ...
                .setStrokeAlpha( 1 );
        group.add( r1 );
        final Rectangle r2 = new Rectangle( 22,
                                            12 )
                .setX( 0 )
                .setY( 4 )
                .setFillAlpha( 1 )
                ...
                .setStrokeAlpha( 1 );
        group.add( r2 );
        final SVGPath path3 = createSVGPath( "M 0 10 L 22 10",
                                             null,
                                             1,
                                             BLACK );
        group.add( path3 );
        final SVGPath path4 = createSVGPath( "M 7 4 L 7 16",
                                             null,
                                             1,
                                             BLACK );
        group.add( path4 );
    ...
    private static Group script() {
        ...
        final SVGPath path1 = createSVGPath( "M6.402,0.5h14.5c0,0-5.833,2.833-5.833,5.583s4.417,6,4.417,9.167s-4.167,5." +
                                                     "083-4.167,5.083H0.235c0,0,5-2.667,5-5s-4.583-6.75-4.583-9.25S6.402,0.5,6.402,0.5z",
                                             null,
                                             1,
                                             BLACK );
        group.add( path1 );
        final SVGPath path2 = createSVGPath( "M 3.5 4.5 L 13.5 4.5",
                                             null,
                                             1,
                                             BLACK )
                .setStrokeWidth( 1.5 );
        group.add( path2 );
        final SVGPath path3 = createSVGPath( "M 3.8 8.5 L 13.8 8.5",
                                             null,
                                             1,
                                             BLACK )
                .setStrokeWidth( 1.5 );
        group.add( path3 );
        final SVGPath path4 = createSVGPath( "M 6.3 12.5 L 16.3 12.5",
                                             null,
                                             1,
                                             BLACK )
                .setStrokeWidth( 1.5 );
        group.add( path4 );
        final SVGPath path5 = createSVGPath( "M 6.5 16.5 L 16.5 16.5",
                                             null,
                                             1,
                                             BLACK )
                .setStrokeWidth( 1.5 );
    ...
    private static Group user() {
        ...
        final SVGPath path1 = createSVGPath( "M0.585,24.167h24.083v-7.833c0,0-2.333-3.917-7.083-5.167h-9.25\n" +
                                             ...
                                             BLACK );
        group.add( path1 );
        final SVGPath path2 = createSVGPath( "M 6 20 L 6 24",
                                             null,
                                             1,
                                             BLACK );
        group.add( path2 );
        final SVGPath path3 = createSVGPath( "M 20 20 L 20 24",
                                             null,
                                             1,
                                             BLACK );
        group.add( path3 );
    ...
    private static SVGPath createSVGPath( final String path ) {
        return new SVGPath( path ).setDraggable( false );
    }
}

...
public class WiresControlFactoryImpl extends com.ait.lienzo.client.core.shape.wires.handlers.impl.WiresControlFactoryImpl {

    @Override
    public WiresDockingAndContainmentControl newDockingAndContainmentControl(final WiresShape shape,
                                                                             final WiresManager wiresManager) {
        return new WiresDockingAndContainmentControlImpl(shape,
                                                         wiresManager);
    }
}

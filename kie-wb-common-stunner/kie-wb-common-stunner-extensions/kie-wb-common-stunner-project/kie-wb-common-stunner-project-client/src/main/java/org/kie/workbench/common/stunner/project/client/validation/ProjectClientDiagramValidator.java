...
@ApplicationScoped
@Specializes
public class ProjectClientDiagramValidator extends ClientDiagramValidator {

    private final Caller<ProjectValidationService> validationService;
    ...
    @Inject
    public ProjectClientDiagramValidator(final DefinitionManager definitionManager,

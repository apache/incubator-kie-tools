...
public class GenerateProcessFormsSessionCommandTest
        extends AbstractFormsSessionCommandTest {

    private GenerateProcessFormsSessionCommand tested;

    @Before
    @SuppressWarnings("unchecked")
    public void init() {
        super.init();
        tested = new GenerateProcessFormsSessionCommand(formGenerationManager);
        tested.bind(session);
    }

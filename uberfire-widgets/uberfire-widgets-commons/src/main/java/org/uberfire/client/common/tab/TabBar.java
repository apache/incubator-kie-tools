...
public class TabBar extends Composite implements SourcesTabEvents,
     ...
     * your own risk.
     */
    public interface Tab extends HasAllKeyHandlers,
                                 HasClickHandlers,
                                 HasWordWrap {
    ...
    private class ClickDelegatePanel extends Composite implements Tab {
        ...
        ClickDelegatePanel( Widget child ) {
            ...
            focusablePanel = new SimplePanel( new FocusPanel() );
    ...
    private static final String          STYLENAME_DEFAULT = CommonResources.INSTANCE.CSS().tabBarItem();
    ...
    public TabBar() {
        ...
        setStyleName( CommonResources.INSTANCE.CSS().tabBar() );
        ...
        first.setStyleName( CommonResources.INSTANCE.CSS().tabBarFirst() );
        rest.setStyleName( CommonResources.INSTANCE.CSS().tabBarRest() );
        first.setHeight( "100%" );
        rest.setHeight( "100%" );
        ...
        setStyleName( first.getElement().getParentElement(),
                      "uf-TabBarFirst-wrapper" );
        setStyleName( rest.getElement().getParentElement(), "uf-TabBarRest-wrapper" );
    }
    ...
    public void setTabEnabled( int index,
        ...
        setStyleName( delPanel.getElement(), CommonResources.INSTANCE.CSS().tabBarItemDisabled(), !enabled );
        setStyleName( delPanel.getElement().getParentElement(),
                      "uf-TabBarItem-wrapper-disabled", !enabled );
    }
    ...
    private void setSelectionStyle( Widget item,
                                    boolean selected ) {
        if ( item != null ) {
            if ( selected ) {
                item.addStyleName( CommonResources.INSTANCE.CSS().tabBarItemSelected() );
                setStyleName( DOM.getParent( item.getElement() ),
                              "uf-TabBarItem-wrapper-selected", true );
            } else {
                item.removeStyleName( CommonResources.INSTANCE.CSS().tabBarItemSelected() );
                setStyleName( DOM.getParent( item.getElement() ),
                              "uf-TabBarItem-wrapper-selected", false );
            }
        }
    }
}

...
public class ObjectStorageTest {
    ...
    public void testWriteFileAndCheckThatExists() {
        objectStorage.write( "/forks/uberfire.txt", "content" );
    ...
    public void testWriteAndRead() {
        ...
        objectStorage.write( "/forks/uberfire", fileContent );
    ...
    public void testWriteAndReadList() {
        ...
        assertEquals( fileContent.size(), content.size() );
        assertEquals( fileContent.get( 0 ), content.get( 0 ) );
    }
    ...
    public void testWriteTwoTimes() {
        ...
        objectStorage.write( "/forks/uberfire", "content a" );

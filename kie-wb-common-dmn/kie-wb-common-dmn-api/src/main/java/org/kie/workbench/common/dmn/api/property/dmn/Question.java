...
public class Question implements DMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "Question";

    @Description
    public static final transient String description = "The question";
    ...
    @DefaultValue
    public static final transient String defaultValue = "My question";

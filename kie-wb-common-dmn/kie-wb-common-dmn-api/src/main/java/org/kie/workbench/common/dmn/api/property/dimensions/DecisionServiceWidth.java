...
public class DecisionServiceWidth implements Width {
    ...
    public DecisionServiceWidth() {
        this(DEFAULT);
    }

    public DecisionServiceWidth(final Double value) {
        this.value = value;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof DecisionServiceWidth)) {
            return false;
        }

        final DecisionServiceWidth width = (DecisionServiceWidth) o;

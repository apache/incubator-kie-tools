...
public class ExpressionLanguage implements DMNProperty {
    ...
    @Caption
    @FieldLabel
    public static final transient String caption = "ExpressionLanguage";

    @Description
    public static final transient String description = "The expression language";
    ...
    @DefaultValue
    public static final transient String defaultValue = "My expression language";

...
public class AllowedAnswers implements DMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "AllowedAnswers";

    @Description
    public static final transient String description = "The allowed answers";
    ...
    @DefaultValue
    public static final transient String defaultValue = "My allowed answers";

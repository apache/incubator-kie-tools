...
public class Label implements DMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "Label";

    @Description
    public static final transient String description = "The label";
    ...
    @DefaultValue
    public static final transient String defaultValue = "My label";
    ...
    public Label(final String value) {
        this.value = value;
    }

...
public class ImportType implements DMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "ImportType";

    @Description
    public static final transient String description = "The import type";
    ...
    @DefaultValue
    public static final transient String defaultValue = "My import type";
    ...
    public ImportType(final String value) {
        this.value = value;
    }

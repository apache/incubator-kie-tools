...
public class ImportedElement implements DMNProperty {
    ...
    @Caption
    @FieldLabel
    public static final transient String caption = "ImportedElement";

    @Description
    public static final transient String description = "The imported element";
    ...
    @DefaultValue
    public static final transient String defaultValue = "My imported element";

    @Value
    @FieldValue
    private String value = defaultValue;

    public ImportedElement() {
    }

    public ImportedElement(final String value) {
        this.value = value;
    }

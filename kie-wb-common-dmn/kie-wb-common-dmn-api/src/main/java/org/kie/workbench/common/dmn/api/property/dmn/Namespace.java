...
public class Namespace implements DMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "Namespace";

    @Description
    public static final transient String description = "The namespace";
    ...
    @DefaultValue
    public static final transient String defaultValue = "My namespace";

...
public class Text implements DMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "Text";

    @Description
    public static final transient String description = "The text";
    ...
    @DefaultValue
    public static final transient String defaultValue = "My text";

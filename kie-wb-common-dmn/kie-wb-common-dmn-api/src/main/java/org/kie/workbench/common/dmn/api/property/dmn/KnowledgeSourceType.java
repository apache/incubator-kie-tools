...
public class KnowledgeSourceType implements DMNProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "KnowledgeSourceType";

    @Description
    public static final transient String description = "The KnowledgeSourceType";
    ...
    @DefaultValue
    public static final transient String defaultValue = "My KnowledgeSourceType";

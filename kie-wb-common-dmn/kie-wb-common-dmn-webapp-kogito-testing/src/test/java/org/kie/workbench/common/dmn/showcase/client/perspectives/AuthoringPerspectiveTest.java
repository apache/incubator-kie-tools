...
public class AuthoringPerspectiveTest {
    ...
    public void testStructure() {
        ...
        assertThat(perspectiveDefinition.getRoot().getPanelType()).isEqualTo(MultiListWorkbenchPanelPresenter.class.getName());
        ...
        assertThat(part.getPlace().getIdentifier()).isEqualTo(DMNDiagramsNavigatorScreen.SCREEN_ID);
    }
}

// .ui.xml template last modified: 1607096091692
...
public class UberfirePagedTable_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.uberfire.ext.widgets.table.client.UberfirePagedTable>, org.uberfire.ext.widgets.table.client.UberfirePagedTable.Binder {


  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.uberfire.ext.widgets.table.client.UberfirePagedTable owner) {
   ...
   */
  class Widgets {
    private final org.uberfire.ext.widgets.table.client.UberfirePagedTable owner;


    public Widgets(final org.uberfire.ext.widgets.table.client.UberfirePagedTable owner) {
      this.owner = owner;
     ...
     */
    private org.uberfire.ext.widgets.table.client.UberfirePagedTable_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.uberfire.ext.widgets.table.client.UberfirePagedTable_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.uberfire.ext.widgets.table.client.UberfirePagedTable_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.uberfire.ext.widgets.table.client.UberfirePagedTable_BinderImpl_GenBundle) GWT.create(org.uberfire.ext.widgets.table.client.UberfirePagedTable_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private org.uberfire.ext.widgets.table.client.UberfirePagedTable_BinderImpl_GenCss_style style;
    private org.uberfire.ext.widgets.table.client.UberfirePagedTable_BinderImpl_GenCss_style get_style() {
      return style;
    }
    private org.uberfire.ext.widgets.table.client.UberfirePagedTable_BinderImpl_GenCss_style build_style() {
      // Creation section.
    ...
    private com.google.gwt.user.client.ui.HorizontalPanel build_f_HorizontalPanel3() {
      ...
      f_HorizontalPanel3.setCellHorizontalAlignment(get_pageSizesSelector(), com.google.gwt.user.client.ui.HasHorizontalAlignment.ALIGN_LEFT);
      f_HorizontalPanel3.setCellVerticalAlignment(get_pageSizesSelector(), com.google.gwt.user.client.ui.HasVerticalAlignment.ALIGN_MIDDLE);
      f_HorizontalPanel3.setCellWidth(get_pageSizesSelector(), "50%");
      f_HorizontalPanel3.add(get_pager());
      f_HorizontalPanel3.setCellHorizontalAlignment(get_pager(), com.google.gwt.user.client.ui.HasHorizontalAlignment.ALIGN_RIGHT);
      f_HorizontalPanel3.setCellVerticalAlignment(get_pager(), com.google.gwt.user.client.ui.HasVerticalAlignment.ALIGN_TOP);
    ...
    private org.gwtbootstrap3.client.ui.ListBox build_pageSizesSelector() {
      // Creation section.
      pageSizesSelector = (org.gwtbootstrap3.client.ui.ListBox) GWT.create(org.gwtbootstrap3.client.ui.ListBox.class);
      // Setup section.
     ...
     */
    private org.uberfire.ext.widgets.table.client.UberfireSimplePager pager;
    ...
    private org.uberfire.ext.widgets.table.client.UberfireSimplePager build_pager() {
      // Creation section.
      pager = (org.uberfire.ext.widgets.table.client.UberfireSimplePager) GWT.create(org.uberfire.ext.widgets.table.client.UberfireSimplePager.class);
      // Setup section.

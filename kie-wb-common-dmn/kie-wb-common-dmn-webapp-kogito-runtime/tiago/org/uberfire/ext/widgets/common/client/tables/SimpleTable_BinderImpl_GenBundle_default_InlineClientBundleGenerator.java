  ...
  private void styleInitializer() {
    style = new org.uberfire.ext.widgets.common.client.tables.SimpleTable_BinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GFVDQLFDMS{padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.GFVDQLFDNS{height:" + ("32px")  + ";}.GFVDQLFDOS{float:" + ("left")  + ";text-align:" + ("left")  + ";}.GFVDQLFDLS{text-align:" + ("center")  + ";}")) : ((".GFVDQLFDMS{padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.GFVDQLFDNS{height:" + ("32px")  + ";}.GFVDQLFDOS{float:" + ("right")  + ";text-align:" + ("right")  + ";}.GFVDQLFDLS{text-align:" + ("center")  + ";}"));
      }

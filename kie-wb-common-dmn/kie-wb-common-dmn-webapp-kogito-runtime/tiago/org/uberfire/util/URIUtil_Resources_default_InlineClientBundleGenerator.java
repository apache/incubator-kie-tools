...
public class URIUtil_Resources_default_InlineClientBundleGenerator implements org.uberfire.util.URIUtil.Resources {
  private static URIUtil_Resources_default_InlineClientBundleGenerator _instance0 = new URIUtil_Resources_default_InlineClientBundleGenerator();
  private void uriDotJsInitializer() {
    uriDotJs = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/Users/tiagobento/.m2/repository/org/uberfire/uberfire-api/7.47.0-SNAPSHOT/uberfire-api-7.47.0-SNAPSHOT.jar!/org/uberfire/jre/org/uberfire/util/uri.min.js
  ...
  private static class uriDotJsInitializer {
    static {
      _instance0.uriDotJsInitializer();
    }
    static com.google.gwt.resources.client.TextResource get() {
      return uriDotJs;
    }
  }
  public com.google.gwt.resources.client.TextResource uriDotJs() {
    return uriDotJsInitializer.get();
  }
  private static java.util.HashMap<java.lang.String, com.google.gwt.resources.client.ResourcePrototype> resourceMap;
  private static com.google.gwt.resources.client.TextResource uriDotJs;
  ...
  public ResourcePrototype getResource(String name) {
    if (GWT.isScript()) {
      ...
      if (resourceMap == null) {
        ...
        resourceMap.put("uriDotJs", uriDotJs());
      }
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'uriDotJs': return this.@org.uberfire.util.URIUtil.Resources::uriDotJs()();
    }
    return null;
  }-*/;
}

...
public class _AssociationValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.dmn.api.definition.model.Association> implements _AssociationValidator {
  private static final java.util.List<String> ALL_PROPERTY_NAMES = 
      java.util.Collections.<String>unmodifiableList(
          java.util.Arrays.<String>asList("additionalAttributes","class","defaultNamespace","description","extensionElements","id","nsContext","parent","stunnerCategory","stunnerLabels"));
  ...
  private final com.google.gwt.validation.client.impl.GwtBeanDescriptor<org.kie.workbench.common.dmn.api.definition.model.Association> beanDescriptor = 
  ...
  public <T> void validateClassGroups(
      ...
      org.kie.workbench.common.dmn.api.definition.model.Association object,
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.dmn.api.definition.model.Association> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public GwtBeanDescriptor<org.kie.workbench.common.dmn.api.definition.model.Association> getConstraints(ValidationGroupsMetadata validationGroupsMetadata) {

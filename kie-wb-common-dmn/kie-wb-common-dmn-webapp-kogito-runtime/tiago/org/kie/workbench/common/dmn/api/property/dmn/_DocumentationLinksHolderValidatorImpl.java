...
public class _DocumentationLinksHolderValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.dmn.api.property.dmn.DocumentationLinksHolder> implements _DocumentationLinksHolderValidator {
  ...
  private final com.google.gwt.validation.client.impl.GwtBeanDescriptor<org.kie.workbench.common.dmn.api.property.dmn.DocumentationLinksHolder> beanDescriptor = 
      com.google.gwt.validation.client.impl.GwtBeanDescriptorImpl.builder(org.kie.workbench.common.dmn.api.property.dmn.DocumentationLinksHolder.class)
  ...
  public <T> void validateClassGroups(
      ...
      org.kie.workbench.common.dmn.api.property.dmn.DocumentationLinksHolder object,
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.dmn.api.property.dmn.DocumentationLinksHolder> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public <T> void validatePropertyGroups(
     ...
     if (!ALL_PROPERTY_NAMES.contains(propertyName)) {
      throw new java.lang.IllegalArgumentException( propertyName +" is not a valid property of org.kie.workbench.common.dmn.api.property.dmn.DocumentationLinksHolder");
    }
  }
  ...
  public GwtBeanDescriptor<org.kie.workbench.common.dmn.api.property.dmn.DocumentationLinksHolder> getConstraints(ValidationGroupsMetadata validationGroupsMetadata) {

...
public class _BorderColourValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.dmn.api.property.background.BorderColour> implements _BorderColourValidator {
  private static final java.util.List<String> ALL_PROPERTY_NAMES = 
      java.util.Collections.<String>unmodifiableList(
          java.util.Arrays.<String>asList("class","type","value"));
  private final BeanMetadata beanMetadata =
      new BeanMetadata(
          org.kie.workbench.common.dmn.api.property.background.BorderColour.class,
          javax.validation.groups.Default.class);
  
  private final com.google.gwt.validation.client.impl.GwtBeanDescriptor<org.kie.workbench.common.dmn.api.property.background.BorderColour> beanDescriptor = 
      com.google.gwt.validation.client.impl.GwtBeanDescriptorImpl.builder(org.kie.workbench.common.dmn.api.property.background.BorderColour.class)
  ...
  public <T> void validateClassGroups(
      ...
      org.kie.workbench.common.dmn.api.property.background.BorderColour object,
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.dmn.api.property.background.BorderColour> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public <T> void validatePropertyGroups(
     ...
     if (!ALL_PROPERTY_NAMES.contains(propertyName)) {
      throw new java.lang.IllegalArgumentException( propertyName +" is not a valid property of org.kie.workbench.common.dmn.api.property.background.BorderColour");
    }
  }
  ...
  public GwtBeanDescriptor<org.kie.workbench.common.dmn.api.property.background.BorderColour> getConstraints(ValidationGroupsMetadata validationGroupsMetadata) {

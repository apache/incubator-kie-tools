...
public class _FontFamilyValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.dmn.api.property.font.FontFamily> implements _FontFamilyValidator {
  ...
  private final com.google.gwt.validation.client.impl.GwtBeanDescriptor<org.kie.workbench.common.dmn.api.property.font.FontFamily> beanDescriptor = 
      com.google.gwt.validation.client.impl.GwtBeanDescriptorImpl.builder(org.kie.workbench.common.dmn.api.property.font.FontFamily.class)
  ...
  public <T> void validateClassGroups(
      ...
      org.kie.workbench.common.dmn.api.property.font.FontFamily object,
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.dmn.api.property.font.FontFamily> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public <T> void validatePropertyGroups(
     ...
     if (!ALL_PROPERTY_NAMES.contains(propertyName)) {
      throw new java.lang.IllegalArgumentException( propertyName +" is not a valid property of org.kie.workbench.common.dmn.api.property.font.FontFamily");
    }
  }
  ...
  public GwtBeanDescriptor<org.kie.workbench.common.dmn.api.property.font.FontFamily> getConstraints(ValidationGroupsMetadata validationGroupsMetadata) {

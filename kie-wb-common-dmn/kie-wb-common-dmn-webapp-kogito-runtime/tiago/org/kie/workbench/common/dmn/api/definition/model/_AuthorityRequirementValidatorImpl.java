...
public class _AuthorityRequirementValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.dmn.api.definition.model.AuthorityRequirement> implements _AuthorityRequirementValidator {
  ...
  private final BeanMetadata beanMetadata =
      new BeanMetadata(
          org.kie.workbench.common.dmn.api.definition.model.AuthorityRequirement.class,
  ...
  private final com.google.gwt.validation.client.impl.GwtBeanDescriptor<org.kie.workbench.common.dmn.api.definition.model.AuthorityRequirement> beanDescriptor = 
      com.google.gwt.validation.client.impl.GwtBeanDescriptorImpl.builder(org.kie.workbench.common.dmn.api.definition.model.AuthorityRequirement.class)
          .setConstrained(true)
          .add(this_c0)
  ...
  public <T> void validateClassGroups(
      ...
      org.kie.workbench.common.dmn.api.definition.model.AuthorityRequirement object,
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.dmn.api.definition.model.AuthorityRequirement> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public <T> void validatePropertyGroups(
     ...
     if (!ALL_PROPERTY_NAMES.contains(propertyName)) {
      throw new java.lang.IllegalArgumentException( propertyName +" is not a valid property of org.kie.workbench.common.dmn.api.definition.model.AuthorityRequirement");
    }
  }
  ...
  public GwtBeanDescriptor<org.kie.workbench.common.dmn.api.definition.model.AuthorityRequirement> getConstraints(ValidationGroupsMetadata validationGroupsMetadata) {

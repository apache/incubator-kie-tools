...
public class _InformationItemPrimaryValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.dmn.api.definition.model.InformationItemPrimary> implements _InformationItemPrimaryValidator {
  private static final java.util.List<String> ALL_PROPERTY_NAMES = 
      java.util.Collections.<String>unmodifiableList(
          java.util.Arrays.<String>asList("additionalAttributes","class","defaultNamespace","domainObjectNameTranslationKey","domainObjectUUID","hasTypeRefs","id","name","nsContext","parent","stunnerCategory","stunnerLabels","typeRef","typeRefHolder"));
  ...
  private final com.google.gwt.validation.client.impl.PropertyDescriptorImpl typeRefHolder_pd =
      new com.google.gwt.validation.client.impl.PropertyDescriptorImpl(
          ...
          true,beanMetadata);
  private final com.google.gwt.validation.client.impl.GwtBeanDescriptor<org.kie.workbench.common.dmn.api.definition.model.InformationItemPrimary> beanDescriptor = 
      com.google.gwt.validation.client.impl.GwtBeanDescriptorImpl.builder(org.kie.workbench.common.dmn.api.definition.model.InformationItemPrimary.class)
  ...
  public <T> void validateClassGroups(
      ...
      org.kie.workbench.common.dmn.api.definition.model.InformationItemPrimary object,
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.dmn.api.definition.model.InformationItemPrimary> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public <T> void validatePropertyGroups(
    ...
    if (propertyName.equals("typeRefHolder")) {
      ...
      throw new java.lang.IllegalArgumentException( propertyName +" is not a valid property of org.kie.workbench.common.dmn.api.definition.model.InformationItemPrimary");
    }
  }
  ...
  public GwtBeanDescriptor<org.kie.workbench.common.dmn.api.definition.model.InformationItemPrimary> getConstraints(ValidationGroupsMetadata validationGroupsMetadata) {
  ...
  private native org.kie.workbench.common.dmn.api.property.dmn.QNameHolder _typeRefHolder(org.kie.workbench.common.dmn.api.definition.model.InformationItemPrimary object) /*-{
    return object.@org.kie.workbench.common.dmn.api.definition.model.InformationItemPrimary::typeRefHolder;
  }-*/;

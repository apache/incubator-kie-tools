...
public class _KnowledgeSourceValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.dmn.api.definition.model.KnowledgeSource> implements _KnowledgeSourceValidator {
  private static final java.util.List<String> ALL_PROPERTY_NAMES = 
      java.util.Collections.<String>unmodifiableList(
          java.util.Arrays.<String>asList("additionalAttributes","allowOnlyVisualChange","backgroundSet","class","contentDefinitionId","defaultNamespace","description","diagramId","dimensionsSet","extensionElements","fontSet","id","linksHolder","locationURI","name","nameHolder","nsContext","parent","stunnerCategory","stunnerLabels","type"));
  ...
  public <T> void validateClassGroups(
      ...
      org.kie.workbench.common.dmn.api.definition.model.KnowledgeSource object,
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.dmn.api.definition.model.KnowledgeSource> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public GwtBeanDescriptor<org.kie.workbench.common.dmn.api.definition.model.KnowledgeSource> getConstraints(ValidationGroupsMetadata validationGroupsMetadata) {

...
public class _CharacterSelectorOptionValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption> implements _CharacterSelectorOptionValidator {
  ...
  private final BeanMetadata beanMetadata =
      new BeanMetadata(
          org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption.class,
  ...
  private final com.google.gwt.validation.client.impl.PropertyDescriptorImpl value_pd =
      new com.google.gwt.validation.client.impl.PropertyDescriptorImpl(
          ...
          false,beanMetadata,
          value_c0);
  private final com.google.gwt.validation.client.impl.GwtBeanDescriptor<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption> beanDescriptor = 
      com.google.gwt.validation.client.impl.GwtBeanDescriptorImpl.builder(org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption.class)
          .setConstrained(true)
          .put("text", text_pd)
          .put("value", value_pd)
  ...
  public <T> void validateClassGroups(
      ...
      org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption object,
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public <T> void validatePropertyGroups(
    ...
    if (propertyName.equals("text")) {
      ...
      throw new java.lang.IllegalArgumentException( propertyName +" is not a valid property of org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption");
    }
  }
  ...
  public <T> void validateValueGroups(
    ...
    if (propertyName.equals("text")) {
      ...
      if ( value == null || value instanceof java.lang.Character) {
        valueTypeMatches = true;
        validateProperty_getvalue(context, violations, null, (java.lang.Character) value, false, groups);
      }
      if ( value == null || value instanceof java.lang.Character) {
        valueTypeMatches = true;
        validateProperty_value(context, violations, null, (java.lang.Character) value, false, groups);
      }
      if(!valueTypeMatches)  {
        throw new ValidationException(value.getClass() +" is not a valid type for "+ propertyName);
      }
  ...
  public GwtBeanDescriptor<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption> getConstraints(ValidationGroupsMetadata validationGroupsMetadata) {
  ...
  private final <T> void validateProperty_value(
      ...
      final Set<ConstraintViolation<T>> violations,
      org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption object,
      final java.lang.Character value,
      boolean honorValid,
      Class<?>... groups) {
  ...
  private native java.lang.Character _value(org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption object) /*-{
    return object.@org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption::value;
  }-*/;
  
  private native java.lang.String _text(org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption object) /*-{
    return object.@org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.CharacterSelectorOption::text;
  }-*/;

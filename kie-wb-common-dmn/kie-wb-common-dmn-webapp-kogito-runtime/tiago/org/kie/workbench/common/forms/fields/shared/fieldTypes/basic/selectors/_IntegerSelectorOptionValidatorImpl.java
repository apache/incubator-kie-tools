...
public class _IntegerSelectorOptionValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption> implements _IntegerSelectorOptionValidator {
  ...
  private final com.google.gwt.validation.client.impl.PropertyDescriptorImpl text_pd =
      new com.google.gwt.validation.client.impl.PropertyDescriptorImpl(
          ...
          text_c0,
          text_c1);
  private final com.google.gwt.validation.client.impl.GwtBeanDescriptor<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption> beanDescriptor = 
      com.google.gwt.validation.client.impl.GwtBeanDescriptorImpl.builder(org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption.class)
          .setConstrained(true)
          .put("value", value_pd)
          .put("text", text_pd)
  ...
  public <T> void validateClassGroups(
      ...
      org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption object,
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public <T> void validatePropertyGroups(
    ...
    if (propertyName.equals("value")) {
      ...
      throw new java.lang.IllegalArgumentException( propertyName +" is not a valid property of org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption");
    }
  }
  ...
  public <T> void validateValueGroups(
    ...
    if (propertyName.equals("value")) {
      ...
      if ( value == null || value instanceof java.lang.Long) {
        valueTypeMatches = true;
        validateProperty_getvalue(context, violations, null, (java.lang.Long) value, false, groups);
      }
      if ( value == null || value instanceof java.lang.Long) {
        valueTypeMatches = true;
        validateProperty_value(context, violations, null, (java.lang.Long) value, false, groups);
      }
      if(!valueTypeMatches)  {
  ...
  public GwtBeanDescriptor<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption> getConstraints(ValidationGroupsMetadata validationGroupsMetadata) {
  ...
  private native java.lang.Long _value(org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption object) /*-{
    return object.@org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption::value;
  }-*/;
  
  private native java.lang.String _text(org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption object) /*-{
    return object.@org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.IntegerSelectorOption::text;
  }-*/;

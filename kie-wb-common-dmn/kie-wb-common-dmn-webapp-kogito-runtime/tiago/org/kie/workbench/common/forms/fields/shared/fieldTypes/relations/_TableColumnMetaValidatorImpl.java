...
public class _TableColumnMetaValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.forms.fields.shared.fieldTypes.relations.TableColumnMeta> implements _TableColumnMetaValidator {
  ...
  private final com.google.gwt.validation.client.impl.ConstraintDescriptorImpl<javax.validation.constraints.Size> property_c0_0  = 
  ...
  private final com.google.gwt.validation.client.impl.ConstraintDescriptorImpl<javax.validation.constraints.NotNull> property_c0_1  = 
  ...
  private final com.google.gwt.validation.client.impl.ConstraintDescriptorImpl<javax.validation.constraints.NotNull> label_c1_0  = 
      com.google.gwt.validation.client.impl.ConstraintDescriptorImpl.<javax.validation.constraints.NotNull> builder()
          .setAnnotation( 
              new javax.validation.constraints.NotNull(){
                  public Class<? extends Annotation> annotationType() {  return javax.validation.constraints.NotNull.class; }
  ...
  private final com.google.gwt.validation.client.impl.ConstraintDescriptorImpl<javax.validation.constraints.Size> label_c1_1  = 
      com.google.gwt.validation.client.impl.ConstraintDescriptorImpl.<javax.validation.constraints.Size> builder()
          .setAnnotation( 
              new javax.validation.constraints.Size(){
                  public Class<? extends Annotation> annotationType() {  return javax.validation.constraints.Size.class; }
  ...
  private final <T> void validateProperty_property(
    ...
    if (isReachable) {
      ...
      if (validate(myContext, property_c0_violations, object, value, new org.hibernate.validator.constraints.impl.SizeValidatorForString(), property_c0_0, groups) ||
          validate(myContext, property_c0_violations, object, value, new org.hibernate.validator.constraints.impl.NotNullValidator(), property_c0_1, groups) ||
          false ) {
  ...
  private final <T> void validateProperty_label(
    ...
    if (isReachable) {
      ...
      Set<ConstraintViolation<T>> label_c1_violations = 
          new HashSet<ConstraintViolation<T>>();
      if (validate(myContext, label_c1_violations, object, value, new org.hibernate.validator.constraints.impl.NotNullValidator(), label_c1_0, groups) ||
          validate(myContext, label_c1_violations, object, value, new org.hibernate.validator.constraints.impl.SizeValidatorForString(), label_c1_1, groups) ||
          false ) {

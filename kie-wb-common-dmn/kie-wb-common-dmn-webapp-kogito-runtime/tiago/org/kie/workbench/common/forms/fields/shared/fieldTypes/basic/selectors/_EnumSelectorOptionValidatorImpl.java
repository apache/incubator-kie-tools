...
public class _EnumSelectorOptionValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.EnumSelectorOption> implements _EnumSelectorOptionValidator {
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.selectors.EnumSelectorOption> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public <T> void validateValueGroups(
    ...
    if (propertyName.equals("value")) {
      ...
      if ( value == null || value instanceof java.lang.Enum) {
        ...
        validateProperty_getvalue(context, violations, null, (java.lang.Enum) value, false, groups);
      }
      if ( value == null || value instanceof java.lang.Enum) {
        valueTypeMatches = true;

...
public class _CharacterBoxFieldDefinitionValidatorImpl extends com.google.gwt.validation.client.impl.AbstractGwtSpecificValidator<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.textBox.definition.CharacterBoxFieldDefinition> implements _CharacterBoxFieldDefinitionValidator {
      ...
      com.google.gwt.validation.client.impl.ConstraintDescriptorImpl.<javax.validation.constraints.Max> builder()
          .setAnnotation( 
              new javax.validation.constraints.Max(){
                  ...
                  public java.lang.Class[] groups() { return new java.lang.Class[] {};}
                  public long value() { return 1L;}
                  public java.lang.String message() { return "{javax.validation.constraints.Max.message}";}
              }
              )
          .setAttributes(attributeBuilder()
            .put("groups", new java.lang.Class[] {javax.validation.groups.Default.class})
            .put("message", "{javax.validation.constraints.Max.message}")
            .put("payload", new java.lang.Class[] {})
            .put("value", 1L)
            .build())
  ...
  private final com.google.gwt.validation.client.impl.PropertyDescriptorImpl maxLength_pd =
      new com.google.gwt.validation.client.impl.PropertyDescriptorImpl(
          ...
          maxLength_c0,
          maxLength_c1);
  private final com.google.gwt.validation.client.impl.GwtBeanDescriptor<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.textBox.definition.CharacterBoxFieldDefinition> beanDescriptor = 
      com.google.gwt.validation.client.impl.GwtBeanDescriptorImpl.builder(org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.textBox.definition.CharacterBoxFieldDefinition.class)
          .setConstrained(true)
  ...
  public <T> void validateClassGroups(
      ...
      org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.textBox.definition.CharacterBoxFieldDefinition object,
  ...
  public <T> void expandDefaultAndValidateValueGroups(
      GwtValidationContext<T> context,
      Class<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.textBox.definition.CharacterBoxFieldDefinition> beanType,
      String propertyName,
      Object value,
      Set<ConstraintViolation<T>> violations,
      Group... groups) {
  ...
  public <T> void validatePropertyGroups(
    ...
    if (propertyName.equals("maxLength")) {
      ...
      throw new java.lang.IllegalArgumentException( propertyName +" is not a valid property of org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.textBox.definition.CharacterBoxFieldDefinition");
    }
  }
  ...
  public GwtBeanDescriptor<org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.textBox.definition.CharacterBoxFieldDefinition> getConstraints(ValidationGroupsMetadata validationGroupsMetadata) {
  ...
  private native java.lang.Integer _maxLength(org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.textBox.definition.CharacterBoxFieldDefinition object) /*-{
    return object.@org.kie.workbench.common.forms.fields.shared.fieldTypes.basic.textBox.definition.CharacterBoxFieldDefinition::maxLength;
  }-*/;

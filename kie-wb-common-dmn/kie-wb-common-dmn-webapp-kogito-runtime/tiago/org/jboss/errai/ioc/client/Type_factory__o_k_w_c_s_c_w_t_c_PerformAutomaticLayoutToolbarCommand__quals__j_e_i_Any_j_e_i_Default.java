...
public class Type_factory__o_k_w_c_s_c_w_t_c_PerformAutomaticLayoutToolbarCommand__quals__j_e_i_Any_j_e_i_Default extends Factory<PerformAutomaticLayoutToolbarCommand> { public Type_factory__o_k_w_c_s_c_w_t_c_PerformAutomaticLayoutToolbarCommand__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(PerformAutomaticLayoutToolbarCommand.class, "Type_factory__o_k_w_c_s_c_w_t_c_PerformAutomaticLayoutToolbarCommand__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { PerformAutomaticLayoutToolbarCommand.class, AbstractToolbarCommand.class, Object.class, ToolbarCommand.class });
  }

  public PerformAutomaticLayoutToolbarCommand createInstance(final ContextManager contextManager) {
    ...
    final PerformAutomaticLayoutToolbarCommand instance = new PerformAutomaticLayoutToolbarCommand(_definitionUtils_0, _commands_1, _translationService_2);

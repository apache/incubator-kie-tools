...
public class Type_factory__o_k_w_c_d_c_e_e_t_u_UndefinedExpressionEditorDefinition__quals__j_e_i_Any_j_e_i_Default extends Factory<UndefinedExpressionEditorDefinition> { private class Type_factory__o_k_w_c_d_c_e_e_t_u_UndefinedExpressionEditorDefinition__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends UndefinedExpressionEditorDefinition implements Proxy<UndefinedExpressionEditorDefinition> {
    private final ProxyHelper<UndefinedExpressionEditorDefinition> proxyHelper = new ProxyHelperImpl<UndefinedExpressionEditorDefinition>("Type_factory__o_k_w_c_d_c_e_e_t_u_UndefinedExpressionEditorDefinition__quals__j_e_i_Any_j_e_i_Default");
    public void initProxyProperties(final UndefinedExpressionEditorDefinition instance) {

    }

    public UndefinedExpressionEditorDefinition asBeanType() {
      return this;
    }

    public void setInstance(final UndefinedExpressionEditorDefinition instance) {
    ...
    @Override public ExpressionType getType() {
      if (proxyHelper != null) {
        final UndefinedExpressionEditorDefinition proxiedInstance = proxyHelper.getInstance(this);
    ...
    @Override protected DMNGridData makeGridData(Supplier expression) {
      if (proxyHelper != null) {
        final UndefinedExpressionEditorDefinition proxiedInstance = proxyHelper.getInstance(this);
        final DMNGridData retVal = UndefinedExpressionEditorDefinition_makeGridData_Supplier(proxiedInstance, expression);
        return retVal;
      } else {
  ...
  public Type_factory__o_k_w_c_d_c_e_e_t_u_UndefinedExpressionEditorDefinition__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(UndefinedExpressionEditorDefinition.class, "Type_factory__o_k_w_c_d_c_e_e_t_u_UndefinedExpressionEditorDefinition__quals__j_e_i_Any_j_e_i_Default", ApplicationScoped.class, false, null, true));
    handle.setAssignableTypes(new Class[] { UndefinedExpressionEditorDefinition.class, BaseEditorDefinition.class, Object.class, ExpressionEditorDefinition.class, ExpressionEditorModelEnricher.class });
  }

  public UndefinedExpressionEditorDefinition createInstance(final ContextManager contextManager) {
    ...
    final Supplier<ExpressionEditorDefinitions> _expressionEditorDefinitionsSupplier_10 = (ExpressionEditorDefinitionsProducer) contextManager.getInstance("Type_factory__o_k_w_c_d_c_e_e_t_ExpressionEditorDefinitionsProducer__quals__j_e_i_Any_o_k_w_c_d_a_q_DMNEditor");
    final org.kie.workbench.common.dmn.client.editors.expressions.types.undefined.selector.UndefinedExpressionSelectorPopoverView.Presenter _undefinedExpressionSelector_9 = (UndefinedExpressionSelectorPopoverImpl) contextManager.getInstance("Type_factory__o_k_w_c_d_c_e_e_t_u_s_UndefinedExpressionSelectorPopoverImpl__quals__j_e_i_Any_j_e_i_Default");
    ...
    final UndefinedExpressionEditorDefinition instance = new UndefinedExpressionEditorDefinition(_definitionUtils_0, _sessionManager_1, _sessionCommandManager_2, _canvasCommandFactory_3, _editorSelectedEvent_4, _refreshFormPropertiesEvent_5, _domainObjectSelectionEvent_6, _listSelector_7, _translationService_8, _undefinedExpressionSelector_9, _expressionEditorDefinitionsSupplier_10, _readOnlyProvider_11);
  ...
  public Proxy createProxy(final Context context) {
    final Proxy<UndefinedExpressionEditorDefinition> proxyImpl = new Type_factory__o_k_w_c_d_c_e_e_t_u_UndefinedExpressionEditorDefinition__quals__j_e_i_Any_j_e_i_DefaultProxyImpl();
  ...
  public native static DMNGridData UndefinedExpressionEditorDefinition_makeGridData_Supplier(UndefinedExpressionEditorDefinition instance, Supplier<Optional<Expression>> a0) /*-{
    return instance.@org.kie.workbench.common.dmn.client.editors.expressions.types.undefined.UndefinedExpressionEditorDefinition::makeGridData(Ljava/util/function/Supplier;)(a0);
  }-*/;

...
public class Type_factory__o_k_w_c_f_d_c_r_r_s_r_DecimalRadioGroupFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<DecimalRadioGroupFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_s_r_DecimalRadioGroupFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(DecimalRadioGroupFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_s_r_DecimalRadioGroupFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { DecimalRadioGroupFieldRenderer.class, RadioGroupFieldRendererBase.class, SelectorFieldRenderer.class, FieldRenderer.class, Object.class, RequiresValueConverter.class });
  }

  public DecimalRadioGroupFieldRenderer createInstance(final ContextManager contextManager) {
    final DecimalRadioGroupFieldRenderer instance = new DecimalRadioGroupFieldRenderer();
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((DecimalRadioGroupFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final DecimalRadioGroupFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

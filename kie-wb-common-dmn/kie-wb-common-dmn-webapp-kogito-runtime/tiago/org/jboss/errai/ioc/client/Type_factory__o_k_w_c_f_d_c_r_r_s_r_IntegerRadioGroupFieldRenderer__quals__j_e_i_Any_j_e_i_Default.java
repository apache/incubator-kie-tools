...
public class Type_factory__o_k_w_c_f_d_c_r_r_s_r_IntegerRadioGroupFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<IntegerRadioGroupFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_s_r_IntegerRadioGroupFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(IntegerRadioGroupFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_s_r_IntegerRadioGroupFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { IntegerRadioGroupFieldRenderer.class, RadioGroupFieldRendererBase.class, SelectorFieldRenderer.class, FieldRenderer.class, Object.class, RequiresValueConverter.class });
  }

  public IntegerRadioGroupFieldRenderer createInstance(final ContextManager contextManager) {
    final IntegerRadioGroupFieldRenderer instance = new IntegerRadioGroupFieldRenderer();
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((IntegerRadioGroupFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final IntegerRadioGroupFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

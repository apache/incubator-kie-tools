...
public class Type_factory__o_k_w_c_f_d_c_r_r_r_s_w_SubFormWidget__quals__j_e_i_Any_j_e_i_Default_o_k_w_c_f_d_c_r_r_r_s_w_SubFormWidgetTemplateResource_default_InlineClientBundleGenerator implements org.jboss.errai.ioc.client.Type_factory__o_k_w_c_f_d_c_r_r_r_s_w_SubFormWidget__quals__j_e_i_Any_j_e_i_Default.o_k_w_c_f_d_c_r_r_r_s_w_SubFormWidgetTemplateResource {
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'getContents': return this.@org.jboss.errai.ioc.client.Type_factory__o_k_w_c_f_d_c_r_r_r_s_w_SubFormWidget__quals__j_e_i_Any_j_e_i_Default.o_k_w_c_f_d_c_r_r_r_s_w_SubFormWidgetTemplateResource::getContents()();
    }
    return null;
  }-*/;
}

...
public class Type_factory__o_k_w_c_p_a_p_ProfilePreferencesBeanGeneratedImpl__quals__j_e_i_Any_j_e_i_Default extends Factory<ProfilePreferencesBeanGeneratedImpl> { public Type_factory__o_k_w_c_p_a_p_ProfilePreferencesBeanGeneratedImpl__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(ProfilePreferencesBeanGeneratedImpl.class, "Type_factory__o_k_w_c_p_a_p_ProfilePreferencesBeanGeneratedImpl__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { ProfilePreferencesBeanGeneratedImpl.class, ProfilePreferences.class, Object.class, BasePreference.class, Preference.class, BasePreferenceBean.class });
  }

  public ProfilePreferencesBeanGeneratedImpl createInstance(final ContextManager contextManager) {
    ...
    final ProfilePreferencesBeanGeneratedImpl instance = new ProfilePreferencesBeanGeneratedImpl(_store_0, _resolutionStrategy_1);

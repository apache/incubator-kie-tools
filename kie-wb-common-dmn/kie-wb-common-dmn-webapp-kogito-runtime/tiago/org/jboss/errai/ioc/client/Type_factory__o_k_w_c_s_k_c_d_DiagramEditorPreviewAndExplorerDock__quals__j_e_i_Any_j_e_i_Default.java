...
public class Type_factory__o_k_w_c_s_k_c_d_DiagramEditorPreviewAndExplorerDock__quals__j_e_i_Any_j_e_i_Default extends Factory<DiagramEditorPreviewAndExplorerDock> { private class Type_factory__o_k_w_c_s_k_c_d_DiagramEditorPreviewAndExplorerDock__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends DiagramEditorPreviewAndExplorerDock implements Proxy<DiagramEditorPreviewAndExplorerDock> {
    private final ProxyHelper<DiagramEditorPreviewAndExplorerDock> proxyHelper = new ProxyHelperImpl<DiagramEditorPreviewAndExplorerDock>("Type_factory__o_k_w_c_s_k_c_d_DiagramEditorPreviewAndExplorerDock__quals__j_e_i_Any_j_e_i_Default");
    public void initProxyProperties(final DiagramEditorPreviewAndExplorerDock instance) {

    }

    public DiagramEditorPreviewAndExplorerDock asBeanType() {
      return this;
    }

    public void setInstance(final DiagramEditorPreviewAndExplorerDock instance) {
    ...
    @Override public void init(String owningPerspectiveId) {
      if (proxyHelper != null) {
        final DiagramEditorPreviewAndExplorerDock proxiedInstance = proxyHelper.getInstance(this);
  ...
  public Type_factory__o_k_w_c_s_k_c_d_DiagramEditorPreviewAndExplorerDock__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(DiagramEditorPreviewAndExplorerDock.class, "Type_factory__o_k_w_c_s_k_c_d_DiagramEditorPreviewAndExplorerDock__quals__j_e_i_Any_j_e_i_Default", ApplicationScoped.class, false, null, true));
    handle.setAssignableTypes(new Class[] { DiagramEditorPreviewAndExplorerDock.class, BaseDiagramEditorDock.class, Object.class, DiagramEditorDock.class });
  }

  public DiagramEditorPreviewAndExplorerDock createInstance(final ContextManager contextManager) {
    ...
    final DiagramEditorPreviewAndExplorerDock instance = new DiagramEditorPreviewAndExplorerDock(_uberfireDocks_0, _translationService_1);
  ...
  public Proxy createProxy(final Context context) {
    final Proxy<DiagramEditorPreviewAndExplorerDock> proxyImpl = new Type_factory__o_k_w_c_s_k_c_d_DiagramEditorPreviewAndExplorerDock__quals__j_e_i_Any_j_e_i_DefaultProxyImpl();

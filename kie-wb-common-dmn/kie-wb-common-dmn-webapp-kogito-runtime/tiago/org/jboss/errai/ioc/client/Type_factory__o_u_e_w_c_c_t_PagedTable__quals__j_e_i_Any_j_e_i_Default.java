...
public class Type_factory__o_u_e_w_c_c_t_PagedTable__quals__j_e_i_Any_j_e_i_Default extends Factory<PagedTable> { public Type_factory__o_u_e_w_c_c_t_PagedTable__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(PagedTable.class, "Type_factory__o_u_e_w_c_c_t_PagedTable__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { PagedTable.class, SimpleTable.class, UberfireSimpleTable.class, Composite.class, Widget.class, UIObject.class, Object.class, HasVisibility.class, EventListener.class, HasAttachHandlers.class, HasHandlers.class, IsWidget.class, IsRenderable.class, HasData.class, HasRows.class, HasCellPreviewHandlers.class });
  }

  public PagedTable createInstance(final ContextManager contextManager) {
    final PagedTable instance = new PagedTable();

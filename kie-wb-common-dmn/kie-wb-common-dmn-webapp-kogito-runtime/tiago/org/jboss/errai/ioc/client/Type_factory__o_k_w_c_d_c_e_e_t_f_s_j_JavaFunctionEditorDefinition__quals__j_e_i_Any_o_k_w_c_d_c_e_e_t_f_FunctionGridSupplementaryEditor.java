...
public class Type_factory__o_k_w_c_d_c_e_e_t_f_s_j_JavaFunctionEditorDefinition__quals__j_e_i_Any_o_k_w_c_d_c_e_e_t_f_FunctionGridSupplementaryEditor extends Factory<JavaFunctionEditorDefinition> { public Type_factory__o_k_w_c_d_c_e_e_t_f_s_j_JavaFunctionEditorDefinition__quals__j_e_i_Any_o_k_w_c_d_c_e_e_t_f_FunctionGridSupplementaryEditor() {
    super(new FactoryHandleImpl(JavaFunctionEditorDefinition.class, "Type_factory__o_k_w_c_d_c_e_e_t_f_s_j_JavaFunctionEditorDefinition__quals__j_e_i_Any_o_k_w_c_d_c_e_e_t_f_FunctionGridSupplementaryEditor", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { JavaFunctionEditorDefinition.class, BaseSupplementaryFunctionEditorDefinition.class, BaseEditorDefinition.class, Object.class, ExpressionEditorDefinition.class, ExpressionEditorModelEnricher.class });
  ...
  public JavaFunctionEditorDefinition createInstance(final ContextManager contextManager) {
    ...
    final JavaFunctionEditorDefinition instance = new JavaFunctionEditorDefinition(_definitionUtils_0, _sessionManager_1, _sessionCommandManager_2, _canvasCommandFactory_3, _editorSelectedEvent_4, _refreshFormPropertiesEvent_5, _domainObjectSelectionEvent_6, _listSelector_7, _translationService_8, _expressionEditorDefinitionsSupplier_9, _readOnlyProvider_10);

...
public class Type_factory__o_k_w_c_s_c_c_s_c_i_CopySelectionSessionCommand__quals__j_e_i_Any_j_e_i_Default extends Factory<CopySelectionSessionCommand> { public Type_factory__o_k_w_c_s_c_c_s_c_i_CopySelectionSessionCommand__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(CopySelectionSessionCommand.class, "Type_factory__o_k_w_c_s_c_c_s_c_i_CopySelectionSessionCommand__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { CopySelectionSessionCommand.class, AbstractSelectionAwareSessionCommand.class, AbstractClientSessionCommand.class, Object.class, ClientSessionCommand.class, SessionAware.class });
  }
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CopySelectionSessionCommand) instance, contextManager);
  }

  public void destroyInstanceHelper(final CopySelectionSessionCommand instance, final ContextManager contextManager) {

...
public class Type_factory__o_k_w_c_f_d_c_r_r_s_r_StringRadioGroupFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<StringRadioGroupFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_s_r_StringRadioGroupFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(StringRadioGroupFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_s_r_StringRadioGroupFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { StringRadioGroupFieldRenderer.class, RadioGroupFieldRendererBase.class, SelectorFieldRenderer.class, FieldRenderer.class, Object.class, RequiresValueConverter.class });
  }

  public StringRadioGroupFieldRenderer createInstance(final ContextManager contextManager) {
    final StringRadioGroupFieldRenderer instance = new StringRadioGroupFieldRenderer();
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((StringRadioGroupFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final StringRadioGroupFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

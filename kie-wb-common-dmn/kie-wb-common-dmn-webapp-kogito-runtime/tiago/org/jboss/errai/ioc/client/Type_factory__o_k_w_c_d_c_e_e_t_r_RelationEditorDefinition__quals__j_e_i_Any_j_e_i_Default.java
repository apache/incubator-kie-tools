...
public class Type_factory__o_k_w_c_d_c_e_e_t_r_RelationEditorDefinition__quals__j_e_i_Any_j_e_i_Default extends Factory<RelationEditorDefinition> { private class Type_factory__o_k_w_c_d_c_e_e_t_r_RelationEditorDefinition__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends RelationEditorDefinition implements Proxy<RelationEditorDefinition> {
    private final ProxyHelper<RelationEditorDefinition> proxyHelper = new ProxyHelperImpl<RelationEditorDefinition>("Type_factory__o_k_w_c_d_c_e_e_t_r_RelationEditorDefinition__quals__j_e_i_Any_j_e_i_Default");
    public void initProxyProperties(final RelationEditorDefinition instance) {

    }

    public RelationEditorDefinition asBeanType() {
      return this;
    }

    public void setInstance(final RelationEditorDefinition instance) {
    ...
    @Override public ExpressionType getType() {
      if (proxyHelper != null) {
        final RelationEditorDefinition proxiedInstance = proxyHelper.getInstance(this);
    ...
    @Override protected RelationGridData makeGridData(Supplier expression) {
      if (proxyHelper != null) {
        final RelationEditorDefinition proxiedInstance = proxyHelper.getInstance(this);
        final RelationGridData retVal = RelationEditorDefinition_makeGridData_Supplier(proxiedInstance, expression);
        return retVal;
      } else {
  ...
  public Type_factory__o_k_w_c_d_c_e_e_t_r_RelationEditorDefinition__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(RelationEditorDefinition.class, "Type_factory__o_k_w_c_d_c_e_e_t_r_RelationEditorDefinition__quals__j_e_i_Any_j_e_i_Default", ApplicationScoped.class, false, null, true));
    handle.setAssignableTypes(new Class[] { RelationEditorDefinition.class, BaseEditorDefinition.class, Object.class, ExpressionEditorDefinition.class, ExpressionEditorModelEnricher.class });
  }

  public RelationEditorDefinition createInstance(final ContextManager contextManager) {
    ...
    final ManagedInstance<org.kie.workbench.common.dmn.client.editors.types.ValueAndDataTypePopoverView.Presenter> _headerEditors_9 = (ManagedInstance) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_i_c_a_ManagedInstance__quals__Universal", new Class[] { org.kie.workbench.common.dmn.client.editors.types.ValueAndDataTypePopoverView.Presenter.class }, new Annotation[] { });
    ...
    final RelationEditorDefinition instance = new RelationEditorDefinition(_definitionUtils_0, _sessionManager_1, _sessionCommandManager_2, _canvasCommandFactory_3, _editorSelectedEvent_4, _refreshFormPropertiesEvent_5, _domainObjectSelectionEvent_6, _listSelector_7, _translationService_8, _headerEditors_9, _readOnlyProvider_10);
    registerDependentScopedReference(instance, _translationService_8);
    registerDependentScopedReference(instance, _headerEditors_9);
  ...
  public Proxy createProxy(final Context context) {
    final Proxy<RelationEditorDefinition> proxyImpl = new Type_factory__o_k_w_c_d_c_e_e_t_r_RelationEditorDefinition__quals__j_e_i_Any_j_e_i_DefaultProxyImpl();
  ...
  public native static RelationGridData RelationEditorDefinition_makeGridData_Supplier(RelationEditorDefinition instance, Supplier<Optional<Relation>> a0) /*-{
    return instance.@org.kie.workbench.common.dmn.client.editors.expressions.types.relation.RelationEditorDefinition::makeGridData(Ljava/util/function/Supplier;)(a0);
  }-*/;
}
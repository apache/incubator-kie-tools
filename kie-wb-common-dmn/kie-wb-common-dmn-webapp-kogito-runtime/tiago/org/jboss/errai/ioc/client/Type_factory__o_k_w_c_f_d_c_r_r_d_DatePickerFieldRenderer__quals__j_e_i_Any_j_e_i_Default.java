...
public class Type_factory__o_k_w_c_f_d_c_r_r_d_DatePickerFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<DatePickerFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_d_DatePickerFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(DatePickerFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_d_DatePickerFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { DatePickerFieldRenderer.class, FieldRenderer.class, Object.class });
  }

  public DatePickerFieldRenderer createInstance(final ContextManager contextManager) {
    final DatePickerWrapper _datePickerWrapper_0 = (DatePickerWrapper) contextManager.getInstance("Type_factory__o_k_w_c_f_d_c_r_r_d_i_DatePickerWrapper__quals__j_e_i_Any_j_e_i_Default");
    final DatePickerFieldRenderer instance = new DatePickerFieldRenderer(_datePickerWrapper_0);
    registerDependentScopedReference(instance, _datePickerWrapper_0);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((DatePickerFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final DatePickerFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

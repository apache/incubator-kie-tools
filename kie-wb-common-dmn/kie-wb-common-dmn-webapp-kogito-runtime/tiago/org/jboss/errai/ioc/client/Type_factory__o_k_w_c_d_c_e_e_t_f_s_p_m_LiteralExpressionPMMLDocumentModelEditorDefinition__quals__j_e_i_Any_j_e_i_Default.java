...
public class Type_factory__o_k_w_c_d_c_e_e_t_f_s_p_m_LiteralExpressionPMMLDocumentModelEditorDefinition__quals__j_e_i_Any_j_e_i_Default extends Factory<LiteralExpressionPMMLDocumentModelEditorDefinition> { private class Type_factory__o_k_w_c_d_c_e_e_t_f_s_p_m_LiteralExpressionPMMLDocumentModelEditorDefinition__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends LiteralExpressionPMMLDocumentModelEditorDefinition implements Proxy<LiteralExpressionPMMLDocumentModelEditorDefinition> {
    private final ProxyHelper<LiteralExpressionPMMLDocumentModelEditorDefinition> proxyHelper = new ProxyHelperImpl<LiteralExpressionPMMLDocumentModelEditorDefinition>("Type_factory__o_k_w_c_d_c_e_e_t_f_s_p_m_LiteralExpressionPMMLDocumentModelEditorDefinition__quals__j_e_i_Any_j_e_i_Default");
    public void initProxyProperties(final LiteralExpressionPMMLDocumentModelEditorDefinition instance) {

    }

    public LiteralExpressionPMMLDocumentModelEditorDefinition asBeanType() {
      return this;
    }

    public void setInstance(final LiteralExpressionPMMLDocumentModelEditorDefinition instance) {
    ...
    @Override public boolean isUserSelectable() {
      if (proxyHelper != null) {
        final LiteralExpressionPMMLDocumentModelEditorDefinition proxiedInstance = proxyHelper.getInstance(this);
    ...
    @Override protected DMNGridData makeGridData(Supplier expression) {
      if (proxyHelper != null) {
        final LiteralExpressionPMMLDocumentModelEditorDefinition proxiedInstance = proxyHelper.getInstance(this);
        final DMNGridData retVal = LiteralExpressionPMMLDocumentModelEditorDefinition_makeGridData_Supplier(proxiedInstance, expression);
        return retVal;
      } else {
  ...
  public Type_factory__o_k_w_c_d_c_e_e_t_f_s_p_m_LiteralExpressionPMMLDocumentModelEditorDefinition__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(LiteralExpressionPMMLDocumentModelEditorDefinition.class, "Type_factory__o_k_w_c_d_c_e_e_t_f_s_p_m_LiteralExpressionPMMLDocumentModelEditorDefinition__quals__j_e_i_Any_j_e_i_Default", ApplicationScoped.class, false, null, true));
    handle.setAssignableTypes(new Class[] { LiteralExpressionPMMLDocumentModelEditorDefinition.class, BaseEditorDefinition.class, Object.class, ExpressionEditorDefinition.class, ExpressionEditorModelEnricher.class });
  }

  public LiteralExpressionPMMLDocumentModelEditorDefinition createInstance(final ContextManager contextManager) {
  ...
  public Proxy createProxy(final Context context) {
    final Proxy<LiteralExpressionPMMLDocumentModelEditorDefinition> proxyImpl = new Type_factory__o_k_w_c_d_c_e_e_t_f_s_p_m_LiteralExpressionPMMLDocumentModelEditorDefinition__quals__j_e_i_Any_j_e_i_DefaultProxyImpl();
  ...
  public native static DMNGridData LiteralExpressionPMMLDocumentModelEditorDefinition_makeGridData_Supplier(LiteralExpressionPMMLDocumentModelEditorDefinition instance, Supplier<Optional<LiteralExpressionPMMLDocumentModel>> a0) /*-{
    return instance.@org.kie.workbench.common.dmn.client.editors.expressions.types.function.supplementary.pmml.model.LiteralExpressionPMMLDocumentModelEditorDefinition::makeGridData(Ljava/util/function/Supplier;)(a0);
  }-*/;

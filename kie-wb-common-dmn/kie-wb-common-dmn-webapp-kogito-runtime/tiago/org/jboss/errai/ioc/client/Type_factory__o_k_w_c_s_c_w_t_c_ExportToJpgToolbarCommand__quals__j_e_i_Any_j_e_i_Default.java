...
public class Type_factory__o_k_w_c_s_c_w_t_c_ExportToJpgToolbarCommand__quals__j_e_i_Any_j_e_i_Default extends Factory<ExportToJpgToolbarCommand> { public Type_factory__o_k_w_c_s_c_w_t_c_ExportToJpgToolbarCommand__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(ExportToJpgToolbarCommand.class, "Type_factory__o_k_w_c_s_c_w_t_c_ExportToJpgToolbarCommand__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { ExportToJpgToolbarCommand.class, AbstractToolbarCommand.class, Object.class, ToolbarCommand.class });
  }

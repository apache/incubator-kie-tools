...
public class Type_factory__o_k_w_c_d_c_e_e_t_c_ContextEditorDefinition__quals__j_e_i_Any_j_e_i_Default extends Factory<ContextEditorDefinition> { private class Type_factory__o_k_w_c_d_c_e_e_t_c_ContextEditorDefinition__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends ContextEditorDefinition implements Proxy<ContextEditorDefinition> {
    private final ProxyHelper<ContextEditorDefinition> proxyHelper = new ProxyHelperImpl<ContextEditorDefinition>("Type_factory__o_k_w_c_d_c_e_e_t_c_ContextEditorDefinition__quals__j_e_i_Any_j_e_i_Default");
    public void initProxyProperties(final ContextEditorDefinition instance) {

    }

    public ContextEditorDefinition asBeanType() {
      return this;
    }

    public void setInstance(final ContextEditorDefinition instance) {
    ...
    @Override public ExpressionType getType() {
      if (proxyHelper != null) {
        final ContextEditorDefinition proxiedInstance = proxyHelper.getInstance(this);
    ...
    @Override protected ContextGridData makeGridData(Supplier expression) {
      if (proxyHelper != null) {
        final ContextEditorDefinition proxiedInstance = proxyHelper.getInstance(this);
        final ContextGridData retVal = ContextEditorDefinition_makeGridData_Supplier(proxiedInstance, expression);
        return retVal;
      } else {
  ...
  public Type_factory__o_k_w_c_d_c_e_e_t_c_ContextEditorDefinition__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(ContextEditorDefinition.class, "Type_factory__o_k_w_c_d_c_e_e_t_c_ContextEditorDefinition__quals__j_e_i_Any_j_e_i_Default", ApplicationScoped.class, false, null, true));
    handle.setAssignableTypes(new Class[] { ContextEditorDefinition.class, BaseEditorDefinition.class, Object.class, ExpressionEditorDefinition.class, ExpressionEditorModelEnricher.class });
  }

  public ContextEditorDefinition createInstance(final ContextManager contextManager) {
    ...
    final ContextEditorDefinition instance = new ContextEditorDefinition(_definitionUtils_0, _sessionManager_1, _sessionCommandManager_2, _canvasCommandFactory_3, _editorSelectedEvent_4, _refreshFormPropertiesEvent_5, _domainObjectSelectionEvent_6, _listSelector_7, _translationService_8, _expressionEditorDefinitionsSupplier_9, _headerEditor_10, _readOnlyProvider_11);
  ...
  public Proxy createProxy(final Context context) {
    final Proxy<ContextEditorDefinition> proxyImpl = new Type_factory__o_k_w_c_d_c_e_e_t_c_ContextEditorDefinition__quals__j_e_i_Any_j_e_i_DefaultProxyImpl();
  ...
  public native static ContextGridData ContextEditorDefinition_makeGridData_Supplier(ContextEditorDefinition instance, Supplier<Optional<org.kie.workbench.common.dmn.api.definition.model.Context>> a0) /*-{
    return instance.@org.kie.workbench.common.dmn.client.editors.expressions.types.context.ContextEditorDefinition::makeGridData(Ljava/util/function/Supplier;)(a0);
  }-*/;
}
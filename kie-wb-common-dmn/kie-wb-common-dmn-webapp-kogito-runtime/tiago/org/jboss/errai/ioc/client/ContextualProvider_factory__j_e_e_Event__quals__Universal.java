...
public class ContextualProvider_factory__j_e_e_Event__quals__Universal extends Factory<Event> { public ContextualProvider_factory__j_e_e_Event__quals__Universal() {
    super(new FactoryHandleImpl(Event.class, "ContextualProvider_factory__j_e_e_Event__quals__Universal", Dependent.class, false, null, false));
    handle.setAssignableTypes(new Class[] { Event.class });

...
public class Type_factory__o_k_w_c_d_c_p_d_DocumentationLinksFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<DocumentationLinksFieldRenderer> { public Type_factory__o_k_w_c_d_c_p_d_DocumentationLinksFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(DocumentationLinksFieldRenderer.class, "Type_factory__o_k_w_c_d_c_p_d_DocumentationLinksFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { DocumentationLinksFieldRenderer.class, FieldRenderer.class, Object.class });
  }

  public DocumentationLinksFieldRenderer createInstance(final ContextManager contextManager) {
    final DocumentationLinksWidget _widget_0 = (DocumentationLinksWidget) contextManager.getInstance("Type_factory__o_k_w_c_d_c_e_d_DocumentationLinksWidget__quals__j_e_i_Any_j_e_i_Default");
    final DocumentationLinksFieldRenderer instance = new DocumentationLinksFieldRenderer(_widget_0);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((DocumentationLinksFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final DocumentationLinksFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

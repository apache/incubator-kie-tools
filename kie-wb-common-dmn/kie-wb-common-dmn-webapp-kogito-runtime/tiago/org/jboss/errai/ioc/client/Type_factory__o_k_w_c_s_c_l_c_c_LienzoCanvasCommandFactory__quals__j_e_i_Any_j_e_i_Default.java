...
public class Type_factory__o_k_w_c_s_c_l_c_c_LienzoCanvasCommandFactory__quals__j_e_i_Any_j_e_i_Default extends Factory<LienzoCanvasCommandFactory> { private class Type_factory__o_k_w_c_s_c_l_c_c_LienzoCanvasCommandFactory__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends LienzoCanvasCommandFactory implements Proxy<LienzoCanvasCommandFactory> {
    private final ProxyHelper<LienzoCanvasCommandFactory> proxyHelper = new ProxyHelperImpl<LienzoCanvasCommandFactory>("Type_factory__o_k_w_c_s_c_l_c_c_LienzoCanvasCommandFactory__quals__j_e_i_Any_j_e_i_Default");
    public void initProxyProperties(final LienzoCanvasCommandFactory instance) {

    }

    public LienzoCanvasCommandFactory asBeanType() {
      return this;
    }

    public void setInstance(final LienzoCanvasCommandFactory instance) {
    ...
    @Override public CanvasCommand resize(Element element, BoundingBox boundingBox) {
      if (proxyHelper != null) {
        final LienzoCanvasCommandFactory proxiedInstance = proxyHelper.getInstance(this);
  ...
  public Type_factory__o_k_w_c_s_c_l_c_c_LienzoCanvasCommandFactory__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(LienzoCanvasCommandFactory.class, "Type_factory__o_k_w_c_s_c_l_c_c_LienzoCanvasCommandFactory__quals__j_e_i_Any_j_e_i_Default", ApplicationScoped.class, false, null, true));
    handle.setAssignableTypes(new Class[] { LienzoCanvasCommandFactory.class, DefaultCanvasCommandFactory.class, Object.class, CanvasCommandFactory.class });
  }
  ...
  public Proxy createProxy(final Context context) {
    final Proxy<LienzoCanvasCommandFactory> proxyImpl = new Type_factory__o_k_w_c_s_c_l_c_c_LienzoCanvasCommandFactory__quals__j_e_i_Any_j_e_i_DefaultProxyImpl();
    proxyImpl.setProxyContext(context);
    return proxyImpl;
  }

  public native static ChildrenTraverseProcessor DefaultCanvasCommandFactory_newChildrenTraverseProcessor(DefaultCanvasCommandFactory instance) /*-{
  ...
  public native static ViewTraverseProcessor DefaultCanvasCommandFactory_newViewTraverseProcessor(DefaultCanvasCommandFactory instance) /*-{
  ...
  public native static ManagedInstance DefaultCanvasCommandFactory_getChildrenTraverseProcessors(DefaultCanvasCommandFactory instance) /*-{

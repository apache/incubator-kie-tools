...
public class Type_factory__o_k_w_c_d_c_e_e_t_f_FunctionEditorDefinition__quals__j_e_i_Any_j_e_i_Default extends Factory<FunctionEditorDefinition> { private class Type_factory__o_k_w_c_d_c_e_e_t_f_FunctionEditorDefinition__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends FunctionEditorDefinition implements Proxy<FunctionEditorDefinition> {
    private final ProxyHelper<FunctionEditorDefinition> proxyHelper = new ProxyHelperImpl<FunctionEditorDefinition>("Type_factory__o_k_w_c_d_c_e_e_t_f_FunctionEditorDefinition__quals__j_e_i_Any_j_e_i_Default");
    public void initProxyProperties(final FunctionEditorDefinition instance) {

    }

    public FunctionEditorDefinition asBeanType() {
      return this;
    }

    public void setInstance(final FunctionEditorDefinition instance) {
    ...
    @Override public ExpressionType getType() {
      if (proxyHelper != null) {
        final FunctionEditorDefinition proxiedInstance = proxyHelper.getInstance(this);
    ...
    @Override protected DMNGridData makeGridData(Supplier expression) {
      if (proxyHelper != null) {
        final FunctionEditorDefinition proxiedInstance = proxyHelper.getInstance(this);
        final DMNGridData retVal = FunctionEditorDefinition_makeGridData_Supplier(proxiedInstance, expression);
        return retVal;
      } else {
  ...
  public Type_factory__o_k_w_c_d_c_e_e_t_f_FunctionEditorDefinition__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(FunctionEditorDefinition.class, "Type_factory__o_k_w_c_d_c_e_e_t_f_FunctionEditorDefinition__quals__j_e_i_Any_j_e_i_Default", ApplicationScoped.class, false, null, true));
    handle.setAssignableTypes(new Class[] { FunctionEditorDefinition.class, BaseEditorDefinition.class, Object.class, ExpressionEditorDefinition.class, ExpressionEditorModelEnricher.class });
  }

  public FunctionEditorDefinition createInstance(final ContextManager contextManager) {
    ...
    final ReadOnlyProvider _readOnlyProvider_14 = (ReadOnlyProviderImpl) contextManager.getInstance("Type_factory__o_k_w_c_d_c_a_ReadOnlyProviderImpl__quals__j_e_i_Any_o_k_w_c_d_a_q_DMNEditor");
    ...
    final org.kie.workbench.common.dmn.client.editors.types.ValueAndDataTypePopoverView.Presenter _headerEditor_11 = (ValueAndDataTypePopoverImpl) contextManager.getInstance("Type_factory__o_k_w_c_d_c_e_t_ValueAndDataTypePopoverImpl__quals__j_e_i_Any_j_e_i_Default");
    ...
    final org.kie.workbench.common.dmn.client.editors.expressions.types.function.kindselector.KindPopoverView.Presenter _kindEditor_13 = (KindPopoverImpl) contextManager.getInstance("Type_factory__o_k_w_c_d_c_e_e_t_f_k_KindPopoverImpl__quals__j_e_i_Any_j_e_i_Default");
    final org.kie.workbench.common.dmn.client.editors.expressions.types.function.parameters.ParametersPopoverView.Presenter _parametersEditor_12 = (ParametersPopoverImpl) contextManager.getInstance("Type_factory__o_k_w_c_d_c_e_e_t_f_p_ParametersPopoverImpl__quals__j_e_i_Any_j_e_i_Default");
    final Supplier<ExpressionEditorDefinitions> _supplementaryEditorDefinitionsSupplier_10 = (FunctionSupplementaryGridEditorDefinitionsProducer) contextManager.getInstance("Type_factory__o_k_w_c_d_c_e_e_t_f_s_FunctionSupplementaryGridEditorDefinitionsProducer__quals__j_e_i_Any_o_k_w_c_d_c_e_e_t_f_FunctionGridSupplementaryEditor");
    final FunctionEditorDefinition instance = new FunctionEditorDefinition(_definitionUtils_0, _sessionManager_1, _sessionCommandManager_2, _canvasCommandFactory_3, _editorSelectedEvent_4, _refreshFormPropertiesEvent_5, _domainObjectSelectionEvent_6, _listSelector_7, _translationService_8, _expressionEditorDefinitionsSupplier_9, _supplementaryEditorDefinitionsSupplier_10, _headerEditor_11, _parametersEditor_12, _kindEditor_13, _readOnlyProvider_14);
    ...
    registerDependentScopedReference(instance, _headerEditor_11);
  ...
  public Proxy createProxy(final Context context) {
    final Proxy<FunctionEditorDefinition> proxyImpl = new Type_factory__o_k_w_c_d_c_e_e_t_f_FunctionEditorDefinition__quals__j_e_i_Any_j_e_i_DefaultProxyImpl();
  ...
  public native static DMNGridData FunctionEditorDefinition_makeGridData_Supplier(FunctionEditorDefinition instance, Supplier<Optional<FunctionDefinition>> a0) /*-{
    return instance.@org.kie.workbench.common.dmn.client.editors.expressions.types.function.FunctionEditorDefinition::makeGridData(Ljava/util/function/Supplier;)(a0);
  }-*/;

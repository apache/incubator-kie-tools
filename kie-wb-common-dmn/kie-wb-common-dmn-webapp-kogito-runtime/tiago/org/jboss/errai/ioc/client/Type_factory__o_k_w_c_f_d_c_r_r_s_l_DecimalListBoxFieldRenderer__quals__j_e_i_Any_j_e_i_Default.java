...
public class Type_factory__o_k_w_c_f_d_c_r_r_s_l_DecimalListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<DecimalListBoxFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_s_l_DecimalListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(DecimalListBoxFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_s_l_DecimalListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { DecimalListBoxFieldRenderer.class, AbstractListBoxFieldRenderer.class, SelectorFieldRenderer.class, FieldRenderer.class, Object.class, RequiresValueConverter.class });
  }

  public DecimalListBoxFieldRenderer createInstance(final ContextManager contextManager) {
    ...
    final DecimalListBoxFieldRenderer instance = new DecimalListBoxFieldRenderer(_translationService_0);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((DecimalListBoxFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final DecimalListBoxFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

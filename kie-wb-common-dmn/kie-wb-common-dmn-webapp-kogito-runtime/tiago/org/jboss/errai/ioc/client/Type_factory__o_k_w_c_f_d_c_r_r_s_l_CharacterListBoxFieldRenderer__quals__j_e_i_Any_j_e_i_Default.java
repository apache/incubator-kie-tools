...
public class Type_factory__o_k_w_c_f_d_c_r_r_s_l_CharacterListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<CharacterListBoxFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_s_l_CharacterListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(CharacterListBoxFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_s_l_CharacterListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { CharacterListBoxFieldRenderer.class, AbstractListBoxFieldRenderer.class, SelectorFieldRenderer.class, FieldRenderer.class, Object.class, RequiresValueConverter.class });
  }

  public CharacterListBoxFieldRenderer createInstance(final ContextManager contextManager) {
    ...
    final CharacterListBoxFieldRenderer instance = new CharacterListBoxFieldRenderer(_translationService_0);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CharacterListBoxFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final CharacterListBoxFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

...
public class Type_factory__o_u_c_v_p_m_WorkbenchMenuCompactNavBarView__quals__j_e_i_Any_j_e_i_Default extends Factory<WorkbenchMenuCompactNavBarView> { private class Type_factory__o_u_c_v_p_m_WorkbenchMenuCompactNavBarView__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends WorkbenchMenuCompactNavBarView implements Proxy<WorkbenchMenuCompactNavBarView> {
    private final ProxyHelper<WorkbenchMenuCompactNavBarView> proxyHelper = new ProxyHelperImpl<WorkbenchMenuCompactNavBarView>("Type_factory__o_u_c_v_p_m_WorkbenchMenuCompactNavBarView__quals__j_e_i_Any_j_e_i_Default");
    public void initProxyProperties(final WorkbenchMenuCompactNavBarView instance) {

    }

    public WorkbenchMenuCompactNavBarView asBeanType() {
      return this;
    }

    public void setInstance(final WorkbenchMenuCompactNavBarView instance) {
    ...
    @Override protected void setup() {
      if (proxyHelper != null) {
        final WorkbenchMenuCompactNavBarView proxiedInstance = proxyHelper.getInstance(this);
        WorkbenchMenuCompactNavBarView_setup(proxiedInstance);
      } else {
        super.setup();
      }
    }
    ...
    @Override protected void selectElement(ComplexPanel item) {
      if (proxyHelper != null) {
        final WorkbenchMenuCompactNavBarView proxiedInstance = proxyHelper.getInstance(this);
        WorkbenchMenuCompactNavBarView_selectElement_ComplexPanel(proxiedInstance, item);
      } else {
        super.selectElement(item);
      }
    }

    @Override protected Multimap getMenuItemContextMenus() {
      if (proxyHelper != null) {
        final WorkbenchMenuCompactNavBarView proxiedInstance = proxyHelper.getInstance(this);
        final Multimap retVal = WorkbenchMenuCompactNavBarView_getMenuItemContextMenus(proxiedInstance);
        return retVal;
      } else {
        return super.getMenuItemContextMenus();
      }
    }
  ...
  public Type_factory__o_u_c_v_p_m_WorkbenchMenuCompactNavBarView__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(WorkbenchMenuCompactNavBarView.class, "Type_factory__o_u_c_v_p_m_WorkbenchMenuCompactNavBarView__quals__j_e_i_Any_j_e_i_Default", ApplicationScoped.class, false, null, true));
    handle.setAssignableTypes(new Class[] { WorkbenchMenuCompactNavBarView.class, WorkbenchMenuNavBarView.class, Composite.class, Widget.class, UIObject.class, Object.class, HasVisibility.class, EventListener.class, HasAttachHandlers.class, HasHandlers.class, IsWidget.class, IsRenderable.class, org.uberfire.client.views.pfly.menu.WorkbenchMenuBarView.WorkbenchMenuNavBarView.class });
  }

  public WorkbenchMenuCompactNavBarView createInstance(final ContextManager contextManager) {
    final WorkbenchMenuCompactNavBarView instance = new WorkbenchMenuCompactNavBarView();
    setIncompleteInstance(instance);
    setIncompleteInstance(null);
    return instance;
  }

  public void invokePostConstructs(final WorkbenchMenuCompactNavBarView instance) {
    WorkbenchMenuCompactNavBarView_setup(instance);
  }

  public Proxy createProxy(final Context context) {
    final Proxy<WorkbenchMenuCompactNavBarView> proxyImpl = new Type_factory__o_u_c_v_p_m_WorkbenchMenuCompactNavBarView__quals__j_e_i_Any_j_e_i_DefaultProxyImpl();
  ...
  public native static void WorkbenchMenuCompactNavBarView_selectElement_ComplexPanel(WorkbenchMenuCompactNavBarView instance, ComplexPanel a0) /*-{
    instance.@org.uberfire.client.views.pfly.menu.WorkbenchMenuCompactNavBarView::selectElement(Lcom/google/gwt/user/client/ui/ComplexPanel;)(a0);
  }-*/;
  ...
  public native static void WorkbenchMenuCompactNavBarView_setup(WorkbenchMenuCompactNavBarView instance) /*-{
  ...
  public native static Multimap WorkbenchMenuCompactNavBarView_getMenuItemContextMenus(WorkbenchMenuCompactNavBarView instance) /*-{
    return instance.@org.uberfire.client.views.pfly.menu.WorkbenchMenuCompactNavBarView::getMenuItemContextMenus()();
  }-*/;

...
public class Type_factory__o_k_w_c_s_f_c_f_c_ModuleFieldRendererTypesProvider__quals__j_e_i_Any_j_e_i_Default extends Factory<ModuleFieldRendererTypesProvider> { private class Type_factory__o_k_w_c_s_f_c_f_c_ModuleFieldRendererTypesProvider__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends ModuleFieldRendererTypesProvider implements Proxy<ModuleFieldRendererTypesProvider> {
    private final ProxyHelper<ModuleFieldRendererTypesProvider> proxyHelper = new ProxyHelperImpl<ModuleFieldRendererTypesProvider>("Type_factory__o_k_w_c_s_f_c_f_c_ModuleFieldRendererTypesProvider__quals__j_e_i_Any_j_e_i_Default");
  ...
  public Type_factory__o_k_w_c_s_f_c_f_c_ModuleFieldRendererTypesProvider__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(ModuleFieldRendererTypesProvider.class, "Type_factory__o_k_w_c_s_f_c_f_c_ModuleFieldRendererTypesProvider__quals__j_e_i_Any_j_e_i_Default", ApplicationScoped.class, false, null, true));
  ...
  public Proxy createProxy(final Context context) {
    final Proxy<ModuleFieldRendererTypesProvider> proxyImpl = new Type_factory__o_k_w_c_s_f_c_f_c_ModuleFieldRendererTypesProvider__quals__j_e_i_Any_j_e_i_DefaultProxyImpl();

...
public class Type_factory__o_k_w_c_f_d_c_r_r_TextBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<TextBoxFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_TextBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(TextBoxFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_TextBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { TextBoxFieldRenderer.class, FieldRenderer.class, Object.class, RequiresValueConverter.class });
  }

  public TextBoxFieldRenderer createInstance(final ContextManager contextManager) {
    final TextBoxFieldRenderer instance = new TextBoxFieldRenderer();
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((TextBoxFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final TextBoxFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

  native static TextBox TextBoxFieldRenderer_TextBox_textBox(TextBoxFieldRenderer instance) /*-{
    return instance.@org.kie.workbench.common.forms.dynamic.client.rendering.renderers.TextBoxFieldRenderer::textBox;
  }-*/;

  native static void TextBoxFieldRenderer_TextBox_textBox(TextBoxFieldRenderer instance, TextBox value) /*-{
    instance.@org.kie.workbench.common.forms.dynamic.client.rendering.renderers.TextBoxFieldRenderer::textBox = value;
  }-*/;

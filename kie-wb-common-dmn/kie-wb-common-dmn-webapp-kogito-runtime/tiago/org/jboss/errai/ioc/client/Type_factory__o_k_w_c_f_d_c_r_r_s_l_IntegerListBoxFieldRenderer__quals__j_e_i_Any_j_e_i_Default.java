...
public class Type_factory__o_k_w_c_f_d_c_r_r_s_l_IntegerListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<IntegerListBoxFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_s_l_IntegerListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(IntegerListBoxFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_s_l_IntegerListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { IntegerListBoxFieldRenderer.class, AbstractListBoxFieldRenderer.class, SelectorFieldRenderer.class, FieldRenderer.class, Object.class, RequiresValueConverter.class });
  }

  public IntegerListBoxFieldRenderer createInstance(final ContextManager contextManager) {
    ...
    final IntegerListBoxFieldRenderer instance = new IntegerListBoxFieldRenderer(_translationService_0);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((IntegerListBoxFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final IntegerListBoxFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

...
public class Type_factory__o_k_w_c_d_c_e_t_l_c_c_t_n_NumberSelector__quals__j_e_i_Any_j_e_i_Default extends Factory<NumberSelector> { public Type_factory__o_k_w_c_d_c_e_t_l_c_c_t_n_NumberSelector__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(NumberSelector.class, "Type_factory__o_k_w_c_d_c_e_t_l_c_c_t_n_NumberSelector__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { NumberSelector.class, BaseSelector.class, Object.class, TypedValueSelector.class });
  }

  public NumberSelector createInstance(final ContextManager contextManager) {
    ...
    final NumberSelector instance = new NumberSelector(_view_0);
  ...
  public void invokePostConstructs(final NumberSelector instance) {

...
public class Type_factory__o_k_w_c_d_c_p_d_QNameFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<QNameFieldRenderer> { public Type_factory__o_k_w_c_d_c_p_d_QNameFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(QNameFieldRenderer.class, "Type_factory__o_k_w_c_d_c_p_d_QNameFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { QNameFieldRenderer.class, FieldRenderer.class, Object.class });
  }

  public QNameFieldRenderer createInstance(final ContextManager contextManager) {
    final DataTypePickerWidget _typePicker_0 = (DataTypePickerWidget) contextManager.getInstance("Type_factory__o_k_w_c_d_c_e_t_DataTypePickerWidget__quals__j_e_i_Any_j_e_i_Default");
    final QNameFieldRenderer instance = new QNameFieldRenderer(_typePicker_0);
    registerDependentScopedReference(instance, _typePicker_0);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((QNameFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final QNameFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

...
public class Type_factory__o_k_w_c_s_c_c_c_p_ExpandedPaletteDefinitionBuilder__quals__j_e_i_Any_j_e_i_Default extends Factory<ExpandedPaletteDefinitionBuilder> { public Type_factory__o_k_w_c_s_c_c_c_p_ExpandedPaletteDefinitionBuilder__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(ExpandedPaletteDefinitionBuilder.class, "Type_factory__o_k_w_c_s_c_c_c_p_ExpandedPaletteDefinitionBuilder__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { ExpandedPaletteDefinitionBuilder.class, AbstractPaletteDefinitionBuilder.class, Object.class, PaletteDefinitionBuilder.class });
  }

...
public class Type_factory__o_k_w_c_s_c_w_t_c_ValidateToolbarCommand__quals__j_e_i_Any_j_e_i_Default extends Factory<ValidateToolbarCommand> { public Type_factory__o_k_w_c_s_c_w_t_c_ValidateToolbarCommand__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(ValidateToolbarCommand.class, "Type_factory__o_k_w_c_s_c_w_t_c_ValidateToolbarCommand__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { ValidateToolbarCommand.class, AbstractToolbarCommand.class, Object.class, ToolbarCommand.class });
  }

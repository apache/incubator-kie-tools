...
public class Type_factory__o_k_w_c_f_d_c_r_r_p_PictureFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<PictureFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_p_PictureFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(PictureFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_p_PictureFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { PictureFieldRenderer.class, FieldRenderer.class, Object.class });
  }

  public PictureFieldRenderer createInstance(final ContextManager contextManager) {
    final PictureInput _pictureInput_0 = (PictureInput) contextManager.getInstance("Type_factory__o_k_w_c_f_c_r_c_w_p_PictureInput__quals__j_e_i_Any_j_e_i_Default");
    final PictureFieldRenderer instance = new PictureFieldRenderer(_pictureInput_0);
    registerDependentScopedReference(instance, _pictureInput_0);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((PictureFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final PictureFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

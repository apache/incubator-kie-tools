...
public class Type_factory__o_k_w_c_s_c_c_c_c_b_i_ObserverBuilderControl__quals__j_e_i_Any_j_e_i_Default_o_k_w_c_s_c_c_c_c_b_i_Observer extends Factory<ObserverBuilderControl> { public Type_factory__o_k_w_c_s_c_c_c_c_b_i_ObserverBuilderControl__quals__j_e_i_Any_j_e_i_Default_o_k_w_c_s_c_c_c_c_b_i_Observer() {
    super(new FactoryHandleImpl(ObserverBuilderControl.class, "Type_factory__o_k_w_c_s_c_c_c_c_b_i_ObserverBuilderControl__quals__j_e_i_Any_j_e_i_Default_o_k_w_c_s_c_c_c_c_b_i_Observer", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { ObserverBuilderControl.class, AbstractElementBuilderControl.class, AbstractCanvasHandlerControl.class, Object.class, CanvasControl.class, ElementBuilderControl.class, BuilderControl.class, RequiresCommandManager.class });
    handle.setQualifiers(new Annotation[] { QualifierUtil.ANY_ANNOTATION, QualifierUtil.DEFAULT_ANNOTATION, new Observer() {
  ...
  public native static void ObserverBuilderControl_onBuildCanvasShape_BuildCanvasShapeEvent(ObserverBuilderControl instance, BuildCanvasShapeEvent a0) /*-{

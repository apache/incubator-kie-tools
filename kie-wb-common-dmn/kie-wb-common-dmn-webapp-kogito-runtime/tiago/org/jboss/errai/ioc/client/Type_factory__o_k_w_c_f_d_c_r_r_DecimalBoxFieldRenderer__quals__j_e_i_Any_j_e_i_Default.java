...
public class Type_factory__o_k_w_c_f_d_c_r_r_DecimalBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<DecimalBoxFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_DecimalBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(DecimalBoxFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_DecimalBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { DecimalBoxFieldRenderer.class, FieldRenderer.class, Object.class, RequiresValueConverter.class });
  }

  public DecimalBoxFieldRenderer createInstance(final ContextManager contextManager) {
    final DecimalBox _decimalBox_0 = (DecimalBox) contextManager.getInstance("Type_factory__o_k_w_c_f_c_r_c_w_d_DecimalBox__quals__j_e_i_Any_j_e_i_Default");
    final DecimalBoxFieldRenderer instance = new DecimalBoxFieldRenderer(_decimalBox_0);
    registerDependentScopedReference(instance, _decimalBox_0);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((DecimalBoxFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final DecimalBoxFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

...
public class Type_factory__o_k_w_c_f_d_c_r_r_s_l_StringListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default extends Factory<StringListBoxFieldRenderer> { public Type_factory__o_k_w_c_f_d_c_r_r_s_l_StringListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(StringListBoxFieldRenderer.class, "Type_factory__o_k_w_c_f_d_c_r_r_s_l_StringListBoxFieldRenderer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { StringListBoxFieldRenderer.class, AbstractListBoxFieldRenderer.class, SelectorFieldRenderer.class, FieldRenderer.class, Object.class, RequiresValueConverter.class });
  }

  public StringListBoxFieldRenderer createInstance(final ContextManager contextManager) {
    ...
    final StringListBoxFieldRenderer instance = new StringListBoxFieldRenderer(_translationService_0);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((StringListBoxFieldRenderer) instance, contextManager);
  }

  public void destroyInstanceHelper(final StringListBoxFieldRenderer instance, final ContextManager contextManager) {
    instance.preDestroy();
  }

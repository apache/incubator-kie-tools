...
public class TranslationServiceImpl_org_uberfire_experimental_client_resources_i18n_UberfireExperimentalConstants_default_properties_default_InlineClientBundleGenerator implements org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_uberfire_experimental_client_resources_i18n_UberfireExperimentalConstants_default_properties {
  private static TranslationServiceImpl_org_uberfire_experimental_client_resources_i18n_UberfireExperimentalConstants_default_properties_default_InlineClientBundleGenerator _instance0 = new TranslationServiceImpl_org_uberfire_experimental_client_resources_i18n_UberfireExperimentalConstants_default_properties_default_InlineClientBundleGenerator();
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'getContents': return this.@org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_uberfire_experimental_client_resources_i18n_UberfireExperimentalConstants_default_properties::getContents()();
    }
    return null;
  }-*/;
}

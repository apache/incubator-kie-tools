...
public class TranslationServiceImpl_org_kie_workbench_common_forms_dynamic_client_resources_i18n_FormRenderingConstants_default_properties_default_InlineClientBundleGenerator implements org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_kie_workbench_common_forms_dynamic_client_resources_i18n_FormRenderingConstants_default_properties {
  private static TranslationServiceImpl_org_kie_workbench_common_forms_dynamic_client_resources_i18n_FormRenderingConstants_default_properties_default_InlineClientBundleGenerator _instance0 = new TranslationServiceImpl_org_kie_workbench_common_forms_dynamic_client_resources_i18n_FormRenderingConstants_default_properties_default_InlineClientBundleGenerator();
  private void getContentsInitializer() {
    getContents = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/Users/tiagobento/redhat/kiegroup-all/kie-wb-common/kie-wb-common-forms/kie-wb-common-dynamic-forms/kie-wb-common-dynamic-forms-client/target/kie-wb-common-dynamic-forms-client-7.47.0-SNAPSHOT.jar!/org/kie/workbench/common/forms/dynamic/client/resources/i18n/FormRenderingConstants_default.properties
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'getContents': return this.@org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_kie_workbench_common_forms_dynamic_client_resources_i18n_FormRenderingConstants_default_properties::getContents()();
    }
    return null;
  }-*/;
}

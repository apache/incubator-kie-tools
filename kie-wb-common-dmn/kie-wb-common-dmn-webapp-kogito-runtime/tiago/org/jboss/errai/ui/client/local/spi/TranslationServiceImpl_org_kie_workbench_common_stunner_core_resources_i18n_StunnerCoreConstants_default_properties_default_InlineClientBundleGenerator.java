...
public class TranslationServiceImpl_org_kie_workbench_common_stunner_core_resources_i18n_StunnerCoreConstants_default_properties_default_InlineClientBundleGenerator implements org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_kie_workbench_common_stunner_core_resources_i18n_StunnerCoreConstants_default_properties {
  private static TranslationServiceImpl_org_kie_workbench_common_stunner_core_resources_i18n_StunnerCoreConstants_default_properties_default_InlineClientBundleGenerator _instance0 = new TranslationServiceImpl_org_kie_workbench_common_stunner_core_resources_i18n_StunnerCoreConstants_default_properties_default_InlineClientBundleGenerator();
  private void getContentsInitializer() {
    getContents = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/Users/tiagobento/redhat/kiegroup-all/kie-wb-common/kie-wb-common-stunner/kie-wb-common-stunner-core/kie-wb-common-stunner-commons/kie-wb-common-stunner-core-common/target/kie-wb-common-stunner-core-common-7.47.0-SNAPSHOT.jar!/org/kie/workbench/common/stunner/core/resources/i18n/StunnerCoreConstants_default.properties
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'getContents': return this.@org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_kie_workbench_common_stunner_core_resources_i18n_StunnerCoreConstants_default_properties::getContents()();
    }
    return null;
  }-*/;
}

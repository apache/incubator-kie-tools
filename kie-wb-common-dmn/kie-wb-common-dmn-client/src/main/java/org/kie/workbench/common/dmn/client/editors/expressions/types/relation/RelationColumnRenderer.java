...
public class RelationColumnRenderer extends BaseGridColumnSingletonDOMElementRenderer<String, TextArea, TextAreaDOMElement> {

    public RelationColumnRenderer(final TextAreaSingletonDOMElementFactory factory) {
        super(factory);
    }

...
public class InvocationParameterColumnRenderer extends NameAndDataTypeColumnRenderer<TextBox, TextBoxDOMElement> {

    public InvocationParameterColumnRenderer(final TextBoxSingletonDOMElementFactory factory) {
        super(factory);
    }

...
public class NameColumnRenderer extends BaseGridColumnSingletonDOMElementRenderer<String, TextBox, TextBoxDOMElement> {

    public NameColumnRenderer(final TextBoxSingletonDOMElementFactory factory) {
        super(factory);
    }

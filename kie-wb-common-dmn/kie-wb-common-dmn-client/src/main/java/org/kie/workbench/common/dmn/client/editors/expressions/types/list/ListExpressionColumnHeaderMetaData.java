...
public class ListExpressionColumnHeaderMetaData extends NameAndDataTypeHeaderMetaData implements HasCellEditorControls,
                                                                                                 HasListSelectorControl {

    static final String NAME_DATA_TYPE_COLUMN_GROUP = "ListExpressionColumnHeaderMetaData$NameAndDataTypeColumn";

    public ListExpressionColumnHeaderMetaData(final HasExpression hasExpression,
    ...
    public String getPopoverTitle() {
        return translationService.getTranslation(DMNEditorConstants.ListEditor_EditExpression);
    }
}

...
import static org.kie.workbench.common.dmn.client.editors.types.treegrid.common.JQuerySelectPicker.$;
...
public class DataTypeSelectView implements DataTypeSelect.View {
    ...
    public void onTypeTextClicked(final ClickEvent event) {
        hide(typeText);
        showSelectPicker();
        openSelectPicker();

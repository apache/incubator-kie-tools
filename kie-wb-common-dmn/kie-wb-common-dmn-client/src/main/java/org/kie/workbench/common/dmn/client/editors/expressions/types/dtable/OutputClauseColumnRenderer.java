...
public class OutputClauseColumnRenderer extends BaseGridColumnSingletonDOMElementRenderer<String, TextArea, TextAreaDOMElement> {

    public OutputClauseColumnRenderer(final TextAreaSingletonDOMElementFactory factory) {
        super(factory);
    }

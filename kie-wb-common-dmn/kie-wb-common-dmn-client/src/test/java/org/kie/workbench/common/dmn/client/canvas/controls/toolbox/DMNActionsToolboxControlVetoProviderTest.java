...
public class DMNActionsToolboxControlVetoProviderTest extends BaseDMNToolboxControlProviderTest {

    @Override
    protected AbstractToolboxControlProvider getProvider() {
        return new DMNActionsToolboxControlVetoProvider(toolboxFactory,

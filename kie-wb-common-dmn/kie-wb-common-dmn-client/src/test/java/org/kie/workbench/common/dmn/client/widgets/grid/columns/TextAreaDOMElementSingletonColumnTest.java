...
public class TextAreaDOMElementSingletonColumnTest extends BaseDOMElementSingletonColumnTest<TextAreaSingletonDOMElementFactory, TextAreaDOMElement, TextArea, TextAreaDOMElementSingletonColumn> {
    ...
    @Override
    protected TextAreaDOMElementSingletonColumn getColumn() {
        return new TextAreaDOMElementSingletonColumn(headerMetaData,
                                                     factory,
                                                     100.0);
    }
}

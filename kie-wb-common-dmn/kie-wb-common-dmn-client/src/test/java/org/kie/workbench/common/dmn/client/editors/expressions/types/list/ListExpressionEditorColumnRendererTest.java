...
public class ListExpressionEditorColumnRendererTest extends BaseNameAndDataTypeColumnRendererTest<ListExpressionEditorColumnRenderer, ContextGridCell> {

    @Mock
    private GridWidgetRegistry registry;

    @Override
    protected ListExpressionEditorColumnRenderer getColumnRenderer() {
        return new ListExpressionEditorColumnRenderer(registry);
    }
}

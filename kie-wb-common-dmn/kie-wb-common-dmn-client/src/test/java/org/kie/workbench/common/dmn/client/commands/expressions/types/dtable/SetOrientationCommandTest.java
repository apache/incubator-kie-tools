...
public class SetOrientationCommandTest {
    ...
    private void makeCommand(final DecisionTableOrientation orientation) {
        ...
        this.command = new SetOrientationCommand(dtable,
                                                 NEW_ORIENTATION,
                                                 canvasOperation);
    }
    ...
    public void testGraphCommandExecute() {
        ...
        assertEquals(NEW_ORIENTATION,
                     dtable.getPreferredOrientation());
    }
    ...
    public void testGraphCommandUndoWhenOriginallyNull() {
        ...
        assertEquals(DecisionTableOrientation.RULE_AS_ROW,
                     dtable.getPreferredOrientation());
    }

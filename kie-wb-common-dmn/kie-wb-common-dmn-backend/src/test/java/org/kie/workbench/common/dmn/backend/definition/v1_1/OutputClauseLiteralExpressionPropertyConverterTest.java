...
public class OutputClauseLiteralExpressionPropertyConverterTest extends BaseLiteralExpressionPropertyConverterTest<OutputClauseLiteralExpression> {
    ...
    @Override
    protected OutputClauseLiteralExpression convertWBFromDMN(final LiteralExpression dmn) {
        return OutputClauseLiteralExpressionPropertyConverter.wbFromDMN(dmn);
    }
}

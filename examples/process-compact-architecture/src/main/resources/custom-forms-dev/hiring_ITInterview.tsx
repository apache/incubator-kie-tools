    ...
    <div className={"pf-c-form"}>
      ...
      <Card>
        <CardBody className="pf-c-form">
          ...
          <FormGroup fieldId={"uniforms-0004-0004"} label={"Email"} isRequired={false}>
            <TextInput
          ...
          <FormGroup fieldId={"uniforms-0004-0006"} label={"Experience"} isRequired={false}>
            <TextInput
              type={"number"}
          ...
          <FormGroup fieldId={"uniforms-0004-0007"} label={"Last name"} isRequired={false}>
            <TextInput
          ...
          <FormGroup fieldId={"uniforms-0004-0008"} label={"Name"} isRequired={false}>
            <TextInput
              name={"candidate.name"}
              ...
              {candidate__offers?.map((_, itemIndex) => (
                ...
                >
                  <div style={{ width: "100%", marginRight: "10px" }}>
                    <Card>
                      <CardBody className="pf-c-form">
                        <FormGroup fieldId={"uniforms-0004-000d"} label={"Category"} isRequired={false}>
                          <TextInput
                            ...
                            {candidate__offers?.map((_, nested__itemIndex) => (
                              ...
                              >
                                ...
                                >
                                  <Card>
                                    <CardBody className="pf-c-form">
                                      <FormGroup fieldId={"uniforms-0004-000i"} label={"Currency"} isRequired={false}>
                                        <TextInput
                                      ...
                                      <FormGroup fieldId={"uniforms-0004-000j"} label={"Value"} isRequired={false}>
                                        <TextInput
                                          name={`candidate__offers.${nested__itemIndex}.value`}
                                          id={"uniforms-0004-000j"}
                                          isDisabled={true}
                                          placeholder={""}
                                          type={"text"}
          ...
          <div>
            ...
            <div>
              {candidate__skills?.map((_, itemIndex) => (
                ...
                >
                  <div style={{ width: "100%", marginRight: "10px" }}>
                    <FormGroup fieldId={"uniforms-0004-000m"} label={""} isRequired={false}>
                      <TextInput
                        name={`candidate__skills.${itemIndex}`}
                        id={"uniforms-0004-000m"}
                        isDisabled={true}
                        placeholder={""}
                        type={"text"}
      ...
      <Card>
        <CardBody className="pf-c-form">
          ...
          <FormGroup fieldId={"uniforms-0004-000p"} label={"Category"} isRequired={false}>
            <TextInput
              name={"offer.category"}
              id={"uniforms-0004-000p"}
              isDisabled={true}
              placeholder={""}
              type={"text"}
            ...
            <Split hasGutter>
              ...
              <SplitItem>
                <Button
                  ...
                  disabled={true}
                  onClick={() => {
                    !true && set__offer__salary((offer__salary ?? []).concat([{}]));
                  }}
                >
                  <PlusCircleIcon color="#0088ce" />
                </Button>
              ...
              {offer__salary?.map((_, itemIndex) => (
                ...
                >
                  <div style={{ width: "100%", marginRight: "10px" }}>
                    <Card>
                      <CardBody className="pf-c-form">
                        <FormGroup fieldId={"uniforms-0004-000u"} label={"Currency"} isRequired={false}>
                          <TextInput
                            name={`offer__salary.${itemIndex}.currency`}
                            id={"uniforms-0004-000u"}
                            isDisabled={true}
                            placeholder={""}
                            type={"text"}
                        ...
                        <FormGroup fieldId={"uniforms-0004-000v"} label={"Value"} isRequired={false}>
                          <TextInput
                            name={`offer__salary.${itemIndex}.value`}
                            id={"uniforms-0004-000v"}
                            isDisabled={true}
                            placeholder={""}
                            type={"text"}

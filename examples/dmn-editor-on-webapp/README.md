...
This package contains a web application that features the DMN Editor wrapped inside a Micro-frontend [**_Multiplying Architecture_**](../../repo/MULTIPLYING_ARCHITECTURE.md) Envelope.

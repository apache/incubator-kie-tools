...
export function DmnEditorClassicPage() {
   ...
   * On this example, we're using a local envelope. To do this, it's necessary to copy the files from @kie-tools/stunner-editors on webpack.config
   */
  const editorEnvelopeLocator: EditorEnvelopeLocator = useMemo(() => {
    return new EditorEnvelopeLocator(window.location.origin, [
      new EnvelopeMapping({
        type: "dmn",
        filePathGlob: "**/*.dmn",
        resourcesPathPrefix: "../dmn-editor-classic",
        envelopeContent: { type: EnvelopeContentType.PATH, path: "dmn-editor-classic-envelope.html" },
      }),
    ]);
  }, []);

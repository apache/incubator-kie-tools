...
export function BpmnEditorPage() {
   ...
   * On this example, we're using a local envelope. To do this, it's necessary to copy the files from @kie-tools/bpmn-editor on webpack.config
   */
  const editorEnvelopeLocator: EditorEnvelopeLocator = useMemo(() => {
    return new EditorEnvelopeLocator(window.location.origin, [
      new EnvelopeMapping({
        type: "bpmn",
        filePathGlob: "**/*.bpmn",
        resourcesPathPrefix: "../bpmn-editor",
        envelopeContent: { type: EnvelopeContentType.PATH, path: "bpmn-editor-envelope.html" },
      }),
    ]);
  }, []);

...
public class ConfiguredRepositories {
    ...
    void reloadRepositories() {
        ...
        if (!(repoConfigs == null || repoConfigs.isEmpty())) {
            for (final ConfigGroup configGroup : repoConfigs) {
                ...
                ConfiguredRepositoriesBySpace configuredRepositoriesBySpace = getConfiguredRepositoriesBySpace(repository.getSpace());
     ...
     */
    List<Repository> getAllConfiguredRepositories(final Space space) {
        ConfiguredRepositoriesBySpace configuredRepositoriesBySpace = getConfiguredRepositoriesBySpace(space);

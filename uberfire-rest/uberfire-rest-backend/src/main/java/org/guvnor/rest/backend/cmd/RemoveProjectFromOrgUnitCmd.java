...
public class RemoveProjectFromOrgUnitCmd extends AbstractJobCommand {

    public RemoveProjectFromOrgUnitCmd(final JobRequestHelper jobRequestHelper,
    ...
    public JobResult internalExecute(JobRequest request) throws Exception {
        ...
        RemoveProjectFromOrganizationalUnitRequest jobRequest = (RemoveProjectFromOrganizationalUnitRequest) request;
        ...
        try {
            ...
            logger.debug("-----removeProjectFromOrganizationalUnit--- , OrganizationalUnit name: {}, project name: {} [{}]",
                         jobRequest.getOrganizationalUnitName(),
                         jobRequest.getProjectName(),
                         status);
        }

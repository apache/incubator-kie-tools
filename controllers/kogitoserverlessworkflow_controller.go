...
//+kubebuilder:rbac:groups=serverless.kiegroup.org,resources=kogitoserverlessworkflows,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=serverless.kiegroup.org,resources=kogitoserverlessworkflows/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=serverless.kiegroup.org,resources=kogitoserverlessworkflows/finalizers,verbs=update

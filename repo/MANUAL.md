...
- Mostly used by our automations
  ...
  - [update-kogito-version](../scripts/update-kogito-version/README.md): Updates the version of Kogito Maven dependencies. (E.g., `999-20250706-SNAPSHOT`, `111-SNAPSHOT` or `10.0.0`)
...
Used for centralized `<dependencyManagement>` and other necessary standard configurations.
...
This ensures the release scripts know what other Maven packages need to be published alongside yours.

...
public class Modal extends DivWidget implements HasVisibility,
    ...
    private native void setHandlerFunctions( Element e ) /*-{
        ...
        $wnd.jQuery(e).on('hide', function (e) {
            that.@org.kie.uberfire.client.common.Modal::onHide(Lcom/google/gwt/user/client/Event;)(e);
        });
        $wnd.jQuery(e).on('hidden', function (e) {
            that.@org.kie.uberfire.client.common.Modal::onHidden(Lcom/google/gwt/user/client/Event;)(e);
        });
        $wnd.jQuery(e).on('show', function (e) {
            that.@org.kie.uberfire.client.common.Modal::onShow(Lcom/google/gwt/user/client/Event;)(e);
        });
        $wnd.jQuery(e).on('shown', function (e) {
            that.@org.kie.uberfire.client.common.Modal::onShown(Lcom/google/gwt/user/client/Event;)(e);
        });
    }-*/;

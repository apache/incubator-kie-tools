...
public class ElasticFullTextSearchIndexTest extends BaseIndexTest {
    ...
    protected String[] getRepositoryNames() {
        return new String[]{"elastic_" + this.getClass().getSimpleName()};
    }

    @Test
    public void testFullTextIndexedFile() throws IOException, InterruptedException {
        setupCountDown(2);
        final Path path1 = getBasePath("elastic_" + this.getClass().getSimpleName()).resolve("mydrlfile1.drl");
        ...
        final Path path2 = getBasePath("elastic_" + this.getClass().getSimpleName()).resolve("a.drl");

...
public class SocialUserTimelinePagedRepositoryTest {
    ...
    public void get10EventsFromFreshEvents() {
        ...
        queryAndAssertNumberOfEvents(10,
                                     new SocialPaged(10));
    }
    ...
    public void thereIsntEnoughtEventsOnFreshSoIHaveToReadLastFile() {
        ...
        queryAndAssertNumberOfEvents(5,
                                     socialPaged);
    }
    ...
    public void nextPageOnFileShouldContinueReading() {
        ...
        PagedSocialQuery query = repository.getUserTimeline(socialUser,
                                                            socialPaged);
        ...
        query = repository.getUserTimeline(socialUser,
                                           socialPaged);
        assertStoredEvent("5",
                          "2",
                          0,
    ...
    private void createFreshCacheEventsEvents(int numberOfEvents) {
        for (int i = 0; i < numberOfEvents; i++) {
            socialTimelinePersistenceFake.persist(socialUser,
                                                  new SocialActivitiesEvent(new SocialUser("fresh"),

...
public class SocialEntryPointTest {
    ...
    public void setup() {
        ...
        socialUserRepositoryAPICaller = new CallerMock<>(socialUserRepositoryAPI);
        socialEntryPoint = new SocialEntryPoint(sessionInfo,
                                                socialUserRepositoryAPICaller);
    }

    @Test
    public void setupTest() {
        socialEntryPoint.setup();

        verify(socialUserRepositoryAPI).findSocialUser("admin");
    }
}

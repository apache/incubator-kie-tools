...
public class GroupsManagementPerspective {
    ...
    public PerspectiveDefinition buildPerspective() {
        ...
        perspective.setName(UsersManagementWorkbenchConstants.INSTANCE.groupsManagement());
        perspective.getRoot().addPart(new PartDefinitionImpl(new DefaultPlaceRequest(GroupsManagementHomeScreen.SCREEN_ID)));
        final PanelDefinition west = new PanelDefinitionImpl(MultiListWorkbenchPanelPresenter.class.getName());
        west.setWidth(600);
        west.setMinWidth(400);
        west.addPart(new PartDefinitionImpl(new DefaultPlaceRequest(GroupsExplorerScreen.SCREEN_ID)));

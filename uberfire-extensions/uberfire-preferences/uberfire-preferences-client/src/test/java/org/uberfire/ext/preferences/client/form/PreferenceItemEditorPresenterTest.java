...
public class PreferenceItemEditorPresenterTest {

    private PreferenceItemEditorPresenter.View view;

    private PreferenceItemEditorPresenter presenter;

    @Before
    public void setup() {
        view = mock( PreferenceItemEditorPresenter.View.class );
        presenter = new PreferenceItemEditorPresenter( view );
    }

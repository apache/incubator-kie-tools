...
public class PreferencesActivityGenerator extends AbstractGenerator {
    ...
    public StringBuffer generate( final String packageName,
        ...
        if ( !isWidget && getWidgetMethodName == null ) {
            throw new GenerationException( "The WorkbenchPreferences must either extend IsWidget or provide a @WorkbenchPartView annotated method to return a com.google.gwt.user.client.ui.IsWidget or preferably org.jboss.errai.common.client.api.IsElement.", packageName + "." + className );
        }
        if ( isWidget && getWidgetMethodName != null ) {
            final String msg = "The WorkbenchPreferences both extends com.google.gwt.user.client.ui.IsWidget and provides a @WorkbenchPartView annotated method. The annotated method will take precedence.";
        ...
        if ( getTitleMethodName == null ) {
            throw new GenerationException( "The WorkbenchPreferences must provide a @WorkbenchPartTitle annotated method to return a java.lang.String.", packageName + "." + className );
        }

...
@ApplicationScoped
public class DefaultPreferenceScopeResolutionStrategyProducer {
    ...
    @Produces
    @Customizable
    public PreferenceScopeResolutionStrategy preferenceScopeResolutionStrategyProducer() {
        if ( this.preferenceScopeResolutionStrategy.isUnsatisfied() ) {
            if ( defaultPreferenceScopeResolutionStrategy == null ) {
                defaultPreferenceScopeResolutionStrategy = new DefaultPreferenceScopeResolutionStrategy( scopeBuilder );
            }

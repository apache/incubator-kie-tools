...
public class DocksBars {
    ...
    @Inject
    public DocksBars( PlaceManager placeManager, MenuBuilder menuBuilder,
    ...
    public void addDock( UberfireDock dock ) {
        ...
        docksBar.addDock( dock, createDockSelectCommand( dock, docksBar ),
                          createDockDeselectCommand( dock, docksBar ) );
    }

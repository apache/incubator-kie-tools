...
public class GlobalPreferencesScreen {
    ...
    @Inject
    public GlobalPreferencesScreen( final PreferencesEditorFormPresenter preferencesForm,
    ...
    @PostConstruct
    public void init() {
        preferencesForm.init( preferenceStore, managedKeys(), getTitle(), ViewMode.GLOBAL );
    }

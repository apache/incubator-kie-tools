...
@Dependent
@WorkbenchPreferences(identifier = WiresTreesPreferencesScreen.IDENTIFIER)
public class WiresTreesPreferencesScreen {

    public static final String IDENTIFIER = "WiresTreesPreferencesScreen";
    ...
    @Inject
    public WiresTreesPreferencesScreen( final PreferencesEditorFormPresenter preferencesForm,
    ...
    @PostConstruct
    public void init() {
        preferencesForm.init( preferenceStore, managedKeys(), getTitle(), ViewMode.COMPONENT );
    }
    ...
    public String getTitle() {
        return "Wires Trees Preferences";
    }

    protected List<String> managedKeys() {
        List<String> keys = new ArrayList<>();
        keys.add( "date.format" );

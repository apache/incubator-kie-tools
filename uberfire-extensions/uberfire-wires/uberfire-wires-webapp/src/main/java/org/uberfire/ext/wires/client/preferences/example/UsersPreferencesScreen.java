...
@Dependent
@WorkbenchPreferences(identifier = UsersPreferencesScreen.IDENTIFIER)
public class UsersPreferencesScreen {

    public static final String IDENTIFIER = "UsersPreferencesScreen";
    ...
    @Inject
    public UsersPreferencesScreen( final PreferencesEditorFormPresenter preferencesForm,
    ...
    @PostConstruct
    public void init() {
        preferencesForm.init( preferenceStore, managedKeys(), getTitle(), ViewMode.USER );
    }

...
public class MultiActivityManager implements PlaceChangeEvent.Handler {
    ...
    //    private MultiContentPanel multiContentPanel;
...
//    public void setMultiContentPanel(MultiContentPanel multiContentPanel) {
//        if (this.multiContentPanel == null) {
//            this.multiContentPanel = multiContentPanel;
//        }
//    }

    public void onPlaceChange(PlaceChangeEvent event) {

//        if (multiContentPanel == null) {
//            return;
//        }
...
//        activity.start(multiContentPanel.addTab(newPlace), resettableEventBus);
    }
...
//            multiContentPanel.close(closePlaceEvent.getPlace());
        }
    }
}

...
public class PlaceHistoryHandler {
   ...
   * 
   * @param mapper a {@link PlaceRequestHistoryMapper} instance
   */
   ...
   */
  public PlaceHistoryHandler(PlaceRequestHistoryMapper mapper, Historian historian) {
    this.mapper = mapper;
   ...
   */
  public HandlerRegistration register(PlaceManager placeManager, EventBus eventBus,

...
Feature: logic--swf-builder-rhel8 feature.
  ...
  Scenario: verify if all labels are correctly set on logic-swf-builder-rhel8 image
    Given image is built
      ...
      And the image should contain label io.k8s.description with value Red Hat build of Runtime image for Kogito Serverless Workflow base builder with Quarkus extensions libraries preinstalled

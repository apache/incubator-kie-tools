...
Feature: kogito-s2i-builder image JVM build tests
  ...
  Scenario: Verify if the s2i build is finished as expected with non native build and no runtime image
    Given s2i build https://github.com/kiegroup/kogito-examples.git from kogito-quarkus-examples/rules-quarkus-helloworld using 2.0.0-snapshot
      | variable     | value   |
      | NATIVE       | false   |
  ...
  Scenario: Verify if the s2i build is finished as expected performing a non native build with runtime image
    Given s2i build https://github.com/kiegroup/kogito-examples.git from kogito-quarkus-examples/rules-quarkus-helloworld using 2.0.0-snapshot and runtime-image quay.io/kiegroup/kogito-runtime-jvm:latest
      | variable     | value                     |
      | NATIVE       | false                     |
      | RUNTIME_TYPE | quarkus                   |
  ...
  Scenario: Verify if the s2i build is finished as expected performing a non native build and if it is listening on the expected port , test uses custom properties file to test the port configuration.
    Given s2i build /tmp/kogito-examples from kogito-quarkus-examples/rules-quarkus-helloworld using 2.0.0-snapshot and runtime-image quay.io/kiegroup/kogito-runtime-jvm:latest
      | variable     | value   |
      | RUNTIME_TYPE | quarkus |
      | NATIVE       | false   |
    Then check that page is served
  ...
  Scenario: Verify if the multi-module s2i build is finished as expected performing a non native build
    Given s2i build https://github.com/kiegroup/kogito-examples.git from . using 2.0.0-snapshot and runtime-image quay.io/kiegroup/kogito-runtime-jvm:latest
      | variable          | value                                                    |
      | RUNTIME_TYPE      | quarkus                                                  |
      | NATIVE            | false                                                    |
  ...
  Scenario: Perform a incremental s2i build using quarkus runtime type
    Given s2i build https://github.com/kiegroup/kogito-examples.git from kogito-quarkus-examples/rules-quarkus-helloworld with env and incremental using 2.0.0-snapshot
      | variable     | value   |
      | RUNTIME_TYPE | quarkus |
      | NATIVE       | false   |
...
#### SpringBoot Scenarios
  ...
  Scenario: Verify if the s2i build is finished as expected with debug enabled
      Given s2i build https://github.com/kiegroup/kogito-examples.git from kogito-springboot-examples/process-springboot-example using 2.0.0-snapshot and runtime-image quay.io/kiegroup/kogito-runtime-jvm:latest
        | variable     | value        |
  ...
  Scenario: Verify if the s2i build is finished as expected with no runtime image and debug enabled
    Given s2i build https://github.com/kiegroup/kogito-examples.git from kogito-springboot-examples/process-springboot-example using 2.0.0-snapshot
      | variable            | value        |
      | JAVA_OPTIONS        | -Ddebug=true |
      | RUNTIME_TYPE        | springboot   |
    Then check that page is served
  ...
  Scenario: Verify if the s2i build is finished as expected and if it is listening on the expected port, test uses custom properties file to test the port configuration.
    Given s2i build /tmp/kogito-examples from kogito-springboot-examples/process-springboot-example using 2.0.0-snapshot and runtime-image quay.io/kiegroup/kogito-runtime-jvm:latest
  ...
  Scenario: Perform a incremental s2i build using springboot runtime type
    Given s2i build https://github.com/kiegroup/kogito-examples.git from kogito-springboot-examples/process-springboot-example with env and incremental using 2.0.0-snapshot
      # Leave those here as placeholder for scripts adding variable to the test. No impact on tests if empty.
      | variable     | value      |
      | RUNTIME_TYPE | springboot |
    Then check that page is served
  ...
  Scenario: Verify if the s2i build is finished as expected with uber-jar package type built
    Given s2i build https://github.com/kiegroup/kogito-examples.git from kogito-quarkus-examples/process-quarkus-example using 2.0.0-snapshot and runtime-image quay.io/kiegroup/kogito-runtime-jvm:latest
      | variable          | value                           |

...
Feature: Kogito-quarkus-ubi8 feature.
  ...
  Scenario: verify if all labels are correctly set.
    ...
    And the image should contain label io.openshift.expose-services with value 8180:http
  ...
  Scenario: verify if the binary index is available on /home/kogito
    ...
    Then run sh -c 'ls /home/kogito/bin/data-index-service-*-runner.jar' in container and immediately check its output for /home/kogito/bin/data-index-service-0.3.0-runner.jar

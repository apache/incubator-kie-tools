...
public class MultipleSubformFieldAdapter extends AbstractFieldAdapter {
    ...
    protected FieldDefinition getFieldDefinition(Field originalField) {
        MultipleSubFormFieldDefinition fieldDefinition = new MultipleSubFormFieldDefinition();
        fieldDefinition.setCreationForm(originalField.getDefaultSubform());
        fieldDefinition.setEditionForm(originalField.getDefaultSubform());

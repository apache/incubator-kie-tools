...
public class SubformFieldAdapter extends AbstractFieldAdapter {

    @Override
    protected FieldDefinition getFieldDefinition(Field originalField) {
        SubFormFieldDefinition fieldDefinition = new SubFormFieldDefinition();
        fieldDefinition.setNestedForm(originalField.getDefaultSubform());
        return fieldDefinition;
    }

    @Override
    public String[] getLegacyFieldTypeCodes() {
        return new String[]{FieldTypeBuilder.SUBFORM};
    }
}

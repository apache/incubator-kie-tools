...
public class AdminPlace extends ContentPlace {

    private final String helloName;
    private final String tabName;

    public AdminPlace() {
        this.helloName = "Admin";
        this.tabName = "admin1Tab";
    }

    public AdminPlace(final String token) {

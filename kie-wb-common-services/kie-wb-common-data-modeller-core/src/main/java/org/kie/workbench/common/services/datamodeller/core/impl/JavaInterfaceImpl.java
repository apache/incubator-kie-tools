...
public class JavaInterfaceImpl extends AbstractJavaType implements JavaInterface {
    ...
    public JavaInterfaceImpl( String packageName, String name, JavaType enclosingType ) {
        super( packageName, name, JavaTypeKind.INTERFACE );
        this.enclosingType = enclosingType;
    }

    public JavaInterfaceImpl( String packageName, String name, JavaType enclosingType, Visibility visibility ) {
        super( packageName, name, JavaTypeKind.INTERFACE, visibility );
        this.enclosingType = enclosingType;
    }

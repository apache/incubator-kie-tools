...
public class FindFieldTypesQueryValidIndexTermsTest extends BaseIndexingTest<TestDrlFileTypeDefinition> {
    ...
    @Test
    public void testFindFieldTypesQueryValidIndexTerms() throws IOException, InterruptedException {
...

        {
            final RefactoringPageRequest request = new RefactoringPageRequest( "FindTypeFieldsQuery",
                                                                               new HashSet<ValueIndexTerm>() {{
                                                                                   ...
                                                                                   add( new ValueFieldIndexTerm( "age" ) );
                                                                               }},
                                                                               0,
                                                                               10 );

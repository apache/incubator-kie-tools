...
@ApplicationScoped
public class FindResourcePartReferencesQuery extends AbstractFindQuery implements NamedQuery {

    public static String NAME = FindResourcePartReferencesQuery.class.getSimpleName();
    ...
    public void validateTerms(Set<ValueIndexTerm> queryTerms) throws IllegalArgumentException {
        ...
        checkInvalidAndRequiredTerms(queryTerms, NAME,
                new String [0], // no required terms
                (t) -> (t instanceof ValueSharedPartIndexTerm),
                (t) -> (t instanceof ValuePartReferenceIndexTerm)
                );

...
/**
 * Simple query builder for use when there is only 1 term (added using the constructor)
 */
public class SingleTermQueryBuilder extends AbstractQueryBuilder implements QueryBuilder<SingleTermQueryBuilder> {
    ...
    public SingleTermQueryBuilder( final ValueIndexTerm term ) {
        this.term = term;
    }

    @Override
    public SingleTermQueryBuilder addTerm( final ValueIndexTerm term ) {

...
@ApplicationScoped
public class FindResourcesQuery extends AbstractFindQuery implements NamedQuery {

    public static String NAME = FindResourcesQuery.class.getSimpleName();
    ...
    public void validateTerms(Set<ValueIndexTerm> queryTerms) throws IllegalArgumentException {
        ...
        checkInvalidAndRequiredTerms(queryTerms, NAME,
                ...
                (t) -> (t instanceof ValueResourceIndexTerm));

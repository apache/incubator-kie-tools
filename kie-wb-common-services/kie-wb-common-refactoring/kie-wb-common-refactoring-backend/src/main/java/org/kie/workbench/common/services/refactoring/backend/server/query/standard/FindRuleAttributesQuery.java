...
public class FindRuleAttributesQuery
    ...
    public static String FIND_RULE_ATTRIBUTES_QUERY = "FindRuleAttributesQuery";
    ...
    public String getName() {
        return FIND_RULE_ATTRIBUTES_QUERY;
    }
    ...
    public Query toQuery( final Set<ValueIndexTerm> terms,
        ...
        final NormalizedTerms normalizedTerms = new NormalizedTerms( terms,
                                                                     RuleAttributeIndexTerm.TERM,
                                                                     RuleAttributeValueIndexTerm.TERM );

        final BasicQueryBuilder builder = new BasicQueryBuilder(useWildcards);
        builder.addTerm( normalizedTerms.get( RuleAttributeIndexTerm.TERM ) )
                .addTerm( normalizedTerms.get( RuleAttributeValueIndexTerm.TERM ) );

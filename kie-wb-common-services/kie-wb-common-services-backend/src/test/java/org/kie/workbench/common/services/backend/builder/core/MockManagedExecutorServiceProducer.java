...
import org.uberfire.backend.server.cdi.workspace.WorkspaceManagedExecutorServiceProducer;
import org.uberfire.backend.server.cdi.workspace.WorkspaceNameResolver;
import org.uberfire.commons.async.DescriptiveThreadFactory;

public class MockManagedExecutorServiceProducer extends WorkspaceManagedExecutorServiceProducer {

    @Inject
    public MockManagedExecutorServiceProducer(WorkspaceNameResolver workspaceNameResolver) {
        super(workspaceNameResolver);
    }
    ...
    public ManagedExecutorService produceExecutorService(InjectionPoint injectionPoint) {
        ...
        return new ManagedExecutorService() {
            ...
            @Override
            public <T> T invokeAny(Collection<? extends Callable<T>> collection) throws

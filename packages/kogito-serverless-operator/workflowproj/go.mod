module github.com/apache/incubator-kie-tools/packages/kogito-serverless-operator/workflowproj
...
replace github.com/apache/incubator-kie-tools/packages/kogito-serverless-operator/api v0.0.0 => ../api

module github.com/apache/incubator-kie-tools/packages/kogito-serverless-operator

go 1.21

// Internal dependencies
replace (
	github.com/apache/incubator-kie-tools/packages/kogito-serverless-operator/api v0.0.0 => ./api
	github.com/apache/incubator-kie-tools/packages/kogito-serverless-operator/container-builder v0.0.0 => ./container-builder
	github.com/apache/incubator-kie-tools/packages/kogito-serverless-operator/workflowproj v0.0.0 => ./workflowproj
)
...
require (
	...
	github.com/apache/incubator-kie-tools/packages/kogito-serverless-operator/container-builder v0.0.0

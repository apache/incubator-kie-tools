module github.com/apache/incubator-kie-tools/packages/kogito-serverless-operator/bddframework
...
replace github.com/apache/incubator-kie-tools/packages/kogito-serverless-operator v0.0.0 => ../

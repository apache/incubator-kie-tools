...
const testFocus = (
  ...
  expect(document.activeElement).toBe(elementToBeFocused);
...
describe("FocusUtils tests", () => {
  ...
  beforeEach(() => {
    mockTable = createMockTable(2, 3, 6);
    mockThead = mockTable.tHead || document.createElement("thead");
    mockTbody = mockTable.tBodies[0];
    // document.body.innerHTML += mockTable.outerHTML;

    // mockTableColRowspan = createMockTable(2, 3, 6);
    ...
    // document.body.innerHTML += mockTableColRowspan.outerHTML;
  ...
  //
  //         parentCell.innerHTML += innerTable.outerHTML;
  //         parentCell.appendChild(innerTable);
  //         document.body.innerHTML += parentCell.outerHTML;
  //
  ...
  // });
  //
  // describe.skip("focusLowerCell tests", () => {

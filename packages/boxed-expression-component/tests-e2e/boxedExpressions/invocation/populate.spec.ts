...
test.describe("Populate Boxed Invocation", () => {
  test("should correctly create pre-bureau-affordability boxed invocation", async ({
    ...
    await bee.selectExpressionMenu.selectLiteral(page.getByRole("row", { name: "p-1" }));
    ...
    await bee.selectExpressionMenu.selectLiteral(page.getByRole("row", { name: "p-5" }));
    ...
    await bee.selectExpressionMenu.selectLiteral(page.getByRole("row", { name: "p-4" }));
    ...
    await bee.selectExpressionMenu.selectLiteral(page.getByRole("row", { name: "p-3" }));
    ...
    await bee.selectExpressionMenu.selectLiteral(page.getByRole("row", { name: "p-2" }));

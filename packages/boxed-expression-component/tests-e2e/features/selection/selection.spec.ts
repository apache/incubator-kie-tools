...
test.describe("Selection", () => {
  ...
  test.describe("Filter Expression", () => {
    test("should correctly copy and paste a filter expression from context menu", async ({
      ...
      await bee.copyFilter(page.getByTestId("logic-type-selected-header"));
      await bee.resetFilter();
      await bee.selectExpressionMenu.selectContext(page.getByText("Select expression").first());

...
<div style={{ display: "flex", flexDirection: "row" }}>
  ...
  <small>
    <br />
    <br />
    This example brings a Boxed Literal expression with a 500px width.
  </small>
</div>
...
<div style={{ display: "flex", flexDirection: "column" }}>
  ...
  <small>This example brings a Boxed Context expression with nested expressions of different sizes.</small>
</div>

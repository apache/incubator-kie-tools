...
To perform a selection, you can use the mouse, by right clicking on one cell and dragomg to a target
cell, the first, the target and cells in between will be selected. Additionaly, it's possible to

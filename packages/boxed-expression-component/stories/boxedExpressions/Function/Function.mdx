...
All Business Knowledge Model (BKM) nodes are defined as Boxed Functions, and it's
not possible to create Boxed Function on the root of a decision [1].
...
This Boxed Function expression can be invoked with the textual syntax as follow by
a Boxed Literal as follow:
...
This expression can be changed for any other boxed epxression.
Also, it's possible to have any number o parameters.

### JAVA (J)

This Kind of Boxed Function is used to call externelly defined functions, and its body is
a Boxed Context. It's possible to have any number o parameters.
...
The first will represents the BKM name and type, and the second is the function parameters.
...
> #### Function parameters
>
> This row has a cell for the function parameters, and by right clicking on it
> its possible to add, edit or delete parameters name and types.

## Body

The function Body depends of the function Kind, but the Body is responsible to return

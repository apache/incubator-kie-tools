...
A boxed expression in DMN is how is defined a graphical notation for all decision logic. This notation is
used to decompose the decision logic into small pieces that can be associated with the DRG artifacts.
The combination of the DRG with the boxed expressions form a complete and mostly graphical langauge [1].

The boxed expressions are defined recursively, meaning that the some boxed expressions can contain another

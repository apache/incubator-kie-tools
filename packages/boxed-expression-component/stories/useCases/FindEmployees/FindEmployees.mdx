...
It was created some data types for this DMN model. The "tEmployee" data type which contains
...
the values "Git", "Java", "Scrum", "TypeScript".
The "Dept" is from the type "tDept", which is a enumeration with the "Sales", "Engineering"
...
to create a column for each Employee property. The Employee contains Id, Name, Dept
(Department) and the employee Knowledges. The Knowledges is a List of Knowledge.

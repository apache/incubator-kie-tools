...
import * as BureauCallType from "./BureauCallType.stories.tsx";

<Meta title="Use cases/Loan Originations/Bureau Strategy Decision Service/Bureau Call Type" of={BureauCallType} />
...
<Story of={BureauCallType.Expression} />

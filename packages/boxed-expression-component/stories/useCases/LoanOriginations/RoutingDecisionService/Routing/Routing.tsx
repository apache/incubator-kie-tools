    ...
    <BoxedExpressionEditorBase
      expressionDefinition={{
        ...
        contextEntries: [
          ...
          {
            entryInfo: {
              id: "_65BC0F72-D019-4FA3-9395-B9A89A651E6B",
              name: "Post-Bureau Affordability",
              dataType: DmnBuiltInDataType.Boolean,
            },
            entryExpression: {
              id: "_4B3C0A41-ECA3-4E1C-B493-B512525F9FF6",
              name: "Post-Bureau Affordability",
              dataType: DmnBuiltInDataType.Boolean,
              logicType: ExpressionDefinitionLogicType.Literal,
              content: "Post-bureau affordability",
              width: 811,
            },
          },
        ],

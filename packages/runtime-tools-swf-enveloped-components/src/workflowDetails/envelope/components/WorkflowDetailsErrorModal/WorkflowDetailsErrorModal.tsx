...
const WorkflowDetailsErrorModal: React.FC<IOwnProps & OUIAProps> = ({
  errorString,
  errorModalOpen,
  errorModalAction,
  handleErrorModal,
  ...
  return (
    <Modal
      ...
      {...componentOuiaProps(ouiaId, "workflow-details-error-modal", ouiaSafe)}
    >
      {errorModalContent()}
    </Modal>
  );
...
export default WorkflowDetailsErrorModal;

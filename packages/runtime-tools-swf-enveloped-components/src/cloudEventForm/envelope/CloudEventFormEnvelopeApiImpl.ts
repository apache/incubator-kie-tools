...
import { Association, CloudEventFormChannelApi, CloudEventFormEnvelopeApi, CloudEventFormInitArgs } from "../api";
import { CloudEventFormEnvelopeViewApi } from "./CloudEventFormEnvelopeView";

/**
 * Implementation of the CloudEventFormEnvelopeApi
 */
export class CloudEventFormEnvelopeApiImpl implements CloudEventFormEnvelopeApi {
  ...
  cloudEventForm__init = async (association: Association, args: CloudEventFormInitArgs): Promise<void> => {

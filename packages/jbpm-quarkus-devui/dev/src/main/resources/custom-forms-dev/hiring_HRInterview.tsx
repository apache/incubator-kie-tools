...
const Form__hiring_HRInterview: React.FC<any> = (props: any) => {
  ...
  const getFormData = useCallback(() => {
    ...
    formData.baseSalary = baseSalary;
    formData.bonus = bonus;
    formData.category = category;
    return formData;
  }, [approve, baseSalary, bonus, category]);
  ...
  return (
    <div className={"pf-c-form"}>
      ...
      <FormGroup fieldId={"uniforms-0008-0003"} label={"Base salary"} isRequired={false}>
        <TextInput
          type={"number"}
          name={"baseSalary"}
          isDisabled={false}
      ...
      <FormGroup fieldId={"uniforms-0008-0005"} label={"Bonus"} isRequired={false}>
        <TextInput
          type={"number"}
          name={"bonus"}
          isDisabled={false}
      ...
      <FormGroup fieldId={"uniforms-0008-0006"} label={"Candidate"} isRequired={false}>
        <TextInput
          name={"candidate"}
          id={"uniforms-0008-0006"}
          isDisabled={true}
          placeholder={""}
          type={"text"}
          value={candidate}
      ...
      <FormGroup fieldId={"uniforms-0008-0007"} label={"Category"} isRequired={false}>
        <TextInput
          name={"category"}

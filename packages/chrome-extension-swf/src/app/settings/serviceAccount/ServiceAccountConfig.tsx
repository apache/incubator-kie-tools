...
export const SERVICE_ACCOUNT_CLIENT_ID_COOKIE_NAME =
  "KIE-TOOLS-COOKIE__serverless-workflow-chrome-extension--service-account-client-id";
export const SERVICE_ACCOUNT_CLIENT_SECRET_COOKIE_NAME =
  "KIE-TOOLS-COOKIE__serverless-workflow-chrome-extension--service-account-client-secret";

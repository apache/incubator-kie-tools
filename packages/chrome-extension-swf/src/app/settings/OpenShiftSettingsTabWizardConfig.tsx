    ...
    () => [
      {
        ...
        name: i18n.openshift.configWizard.steps.first.name,
        component: (
          <div>
            <Text component={TextVariants.p}>{i18n.openshift.configWizard.steps.first.introduction}</Text>
            <List component={ListComponent.ol} type={OrderType.number} className="pf-u-mt-md">
                ...
                <TextContent>
                  <Text component={TextVariants.p}>
                    <a href={DEVELOPER_SANDBOX_GET_STARTED_URL} target={"_blank"}>
                      {i18n.openshift.configWizard.steps.first.goToGetStartedPage}
              ...
              <ListItem>
                <TextContent>
                  <Text component={TextVariants.p}>{i18n.openshift.configWizard.steps.first.followSteps}</Text>
                </TextContent>
              </ListItem>
              <ListItem>
                <TextContent>
                  <Text component={TextVariants.p}>{i18n.openshift.configWizard.steps.first.informNamespace}</Text>
                </TextContent>
              </ListItem>
            </List>
            <Form isHorizontal={true} className="pf-u-mt-md" onSubmit={(e) => e.preventDefault()}>
              <FormGroup
                ...
                helperTextInvalid={i18n.openshift.common.requiredField}
              >
                <InputGroup>
                  <TextInput
                    autoFocus={true}
                    ...
                    placeholder={i18n.openshift.configWizard.steps.first.namespacePlaceholder}
            ...
            <Text className="pf-u-my-md" component={TextVariants.p}>
              {i18n.openshift.configWizard.steps.first.inputReason}
            </Text>
          </div>
        ),
      },
      {
        ...
        name: i18n.openshift.configWizard.steps.second.name,
        component: (
          <div>
            <Text component={TextVariants.p}>{i18n.openshift.configWizard.steps.second.introduction}</Text>
            <List className="pf-u-my-md" component={ListComponent.ol} type={OrderType.number}>
              <ListItem>
                <TextContent>
                  <Text component={TextVariants.p}>
                    <I18nHtml>{i18n.openshift.configWizard.steps.second.accessLoginCommand}</I18nHtml>
                  </Text>
                </TextContent>
              </ListItem>
              <ListItem>
                <TextContent>
                  <Text component={TextVariants.p}>
                    <I18nHtml>{i18n.openshift.configWizard.steps.second.accessDisplayToken}</I18nHtml>
                  </Text>
                </TextContent>
              </ListItem>
              <ListItem>
                <TextContent>
                  <Text component={TextVariants.p}>
                    <I18nHtml>{i18n.openshift.configWizard.steps.second.copyInformation}</I18nHtml>
                  </Text>
                </TextContent>
              </ListItem>
            </List>
              ...
              >
                <InputGroup>
                  <TextInput
                    ...
                    value={config.host}
                    placeholder={i18n.openshift.configWizard.steps.second.hostPlaceholder}
              ...
              >
                <InputGroup>
                  <TextInput
                    ...
                    value={config.token}
                    placeholder={i18n.openshift.configWizard.steps.second.tokenPlaceholder}
            ...
            <Text className="pf-u-my-md" component={TextVariants.p}>
              {i18n.openshift.configWizard.steps.second.inputReason}
            </Text>
          </div>
        ),
      },
      {
        ...
        name: i18n.openshift.configWizard.steps.final.name,
        component: (
          <>
            {isConnectLoading && (
            ...
            {!isConnectLoading && isConfigValidated && (
              <div>
                <Alert
                  variant={"default"}
                  isInline={true}
                  title={i18n.openshift.configWizard.steps.final.connectionSuccess}
                />
                <Text className="pf-u-mt-md" component={TextVariants.p}>
                  {i18n.openshift.configWizard.steps.final.introduction}
                </Text>
                <Text className="pf-u-mt-md" component={TextVariants.p}>
                  {i18n.openshift.configWizard.steps.final.configNote}
                </Text>
              </div>
            )}
            {!isConnectLoading && !isConfigValidated && (
              <div>
                <Alert
                  variant={"danger"}
                  isInline={true}
                  title={i18n.openshift.configWizard.steps.final.connectionError}
                />
                <Text className="pf-u-mt-md" component={TextVariants.p}>
                  {i18n.openshift.configWizard.steps.final.connectionErrorLong}
                </Text>
                <Text className="pf-u-mt-md" component={TextVariants.p}>
                  {i18n.openshift.configWizard.steps.final.possibleErrorReasons.introduction}
                </Text>
                <List className="pf-u-my-md">
                  <ListItem>
                    <TextContent>
                      <Text component={TextVariants.p}>
                        {i18n.openshift.configWizard.steps.final.possibleErrorReasons.emptyField}
                      </Text>
                    </TextContent>
                  </ListItem>
                  <ListItem>
                    <TextContent>
                      <Text component={TextVariants.p}>
                        {i18n.openshift.configWizard.steps.final.possibleErrorReasons.instanceExpired}
                      </Text>
                    </TextContent>
                  </ListItem>
                  <ListItem>
                    <TextContent>
                      <Text component={TextVariants.p}>
                        {i18n.openshift.configWizard.steps.final.possibleErrorReasons.tokenExpired}
                      </Text>
                    </TextContent>
                  </ListItem>
                </List>
                <Text className="pf-u-mt-md" component={TextVariants.p}>
                  {i18n.openshift.configWizard.steps.final.checkInfo}
                </Text>
              </div>
            )}
          </>
      ...
      <WizardFooter>
        <WizardContextConsumer>
          {({ activeStep, goToStepByName, goToStepById, onNext, onBack }) => {
            if (activeStep.name !== i18n.openshift.configWizard.steps.final.name) {
              return (
                <>
                  ...
                  <Button
                    variant="secondary"
                    onClick={onBack}
                    isDisabled={activeStep.name === i18n.openshift.configWizard.steps.first.name}
                  >
                    {i18n.terms.back}
                  </Button>
            ...
            return (
              <>
                ...
                >
                  {isSaveLoading ? i18n.openshift.common.saving : i18n.terms.save}
                </Button>

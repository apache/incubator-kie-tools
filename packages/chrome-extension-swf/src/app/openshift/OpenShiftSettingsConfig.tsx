...
export const OPENSHIFT_PROXY_COOKIE_NAME = "KIE-TOOLS-COOKIE__serverless-workflow-chrome-extension--connection-proxy";
export const OPENSHIFT_NAMESPACE_COOKIE_NAME =
  "KIE-TOOLS-COOKIE__serverless-workflow-chrome-extension--connection-namespace";
export const OPENSHIFT_HOST_COOKIE_NAME = "KIE-TOOLS-COOKIE__serverless-workflow-chrome-extension--connection-host";
export const OPENSHIFT_TOKEN_COOKIE_NAME = "KIE-TOOLS-COOKIE__serverless-workflow-chrome-extension--connection-token";

...
import { DEFAULT_NODE_SIZES, MIN_NODE_SIZES } from "./SwfDefaultSizes";
...
export const EventState = React.memo(
  ({
    ...
    type,
    id,
  }: RF.NodeProps<SwfDiagramNodeData<Specification.Eventstate & { __$$element: "eventstate" }>>) => {
...
export const OperationState = React.memo(
  ({
    ...
    type,
    id,
  }: RF.NodeProps<SwfDiagramNodeData<Specification.Operationstate & { __$$element: "operationstate" }>>) => {
    const ref = useRef<HTMLDivElement>(null);
...
export const SleepState = React.memo(
  ({
    ...
    type,
    id,
  }: RF.NodeProps<SwfDiagramNodeData<Specification.Sleepstate & { __$$element: "sleepstate" }>>) => {
    const ref = useRef<HTMLDivElement>(null);
...
export const ParallelState = React.memo(
  ({
    ...
    type,
    id,
  }: RF.NodeProps<SwfDiagramNodeData<Specification.Parallelstate & { __$$element: "parallelstate" }>>) => {
    const ref = useRef<HTMLDivElement>(null);
...
export const InjectState = React.memo(
  ({
    ...
    type,
    id,
  }: RF.NodeProps<SwfDiagramNodeData<Specification.Injectstate & { __$$element: "injectstate" }>>) => {
    const ref = useRef<HTMLDivElement>(null);
...
export const ForEachState = React.memo(
  ({
    ...
    type,
    id,
  }: RF.NodeProps<SwfDiagramNodeData<Specification.Foreachstate & { __$$element: "foreachstate" }>>) => {
    const ref = useRef<HTMLDivElement>(null);
...
export const CallbackState = React.memo(
  ({
    ...
    type,
    id,
  }: RF.NodeProps<SwfDiagramNodeData<Specification.Callbackstate & { __$$element: "callbackstate" }>>) => {
    const ref = useRef<HTMLDivElement>(null);

...
export function checkIsValidConnection(
  nodesById: Map<string, RF.Node<SwfDiagramNodeData>>,
...
export function _checkIsValidConnection(
  sourceNode: { type?: string; data: SwfDiagramNodeData } | undefined,
  targetNode: { type?: string; data: SwfDiagramNodeData } | undefined,

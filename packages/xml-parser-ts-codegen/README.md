...
For more information about `@kie-tools/xml-parser-ts`, go to [@kie-tools/xml-parser-ts](../xml-parser-ts/README.md)

This package was created to provide a way to marshall/unmarshall BPMN, DMN, Test Scenario, and PMML files, so it is only tested against those formats XSDs.

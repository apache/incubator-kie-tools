...
replace (
	cloud.google.com/go v0.75.0 => cloud.google.com/go v0.100.2 // indirect
	github.com/docker/docker v20.10.7+incompatible => github.com/docker/docker v20.10.3-0.20220915165713-82c19beec4c2+incompatible
)

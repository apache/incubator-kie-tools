...
import "./NodeIcons.css";

export const radius = 34;
export const svgViewboxPadding = Math.sqrt(Math.pow(radius, 2) / 2) - radius / 2; // This lets us create a square that will perfectly fit inside the button circle.

export const nodeSvgProps = { width: 200, height: 120, x: 16, y: 48, strokeWidth: 16 };

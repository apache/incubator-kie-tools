...
export function SectionHeader(props: {
  ...
  const i18n = kieDiagramI18n.setLocale(props.locale).getCurrent();
  const propertiesPanelHeaderClass = useMemo(() => {
    let className = "kie-dmn-editor--properties-panel-header kie-dmn-editor--properties-panel-header-border";
    if (props.fixed) {
    ...
    <div className={propertiesPanelHeaderClass}>
      <div className={"kie-dmn-editor--properties-panel-header-items"}>
        {props.expands && (
          ...
          >
            <Button
              title={i18n.diagram.expandCollapse(typeof props.title === "string" ? props.title : "undefined")}

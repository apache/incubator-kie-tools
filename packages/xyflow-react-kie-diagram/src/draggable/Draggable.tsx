...
export function Draggable(props: {
  ...
  const rowClassName = useMemo(() => {
    let className = "xyflow-react-kie-diagram--draggable-row";

    if (hovered) {
      className += " xyflow-react-kie-diagram--draggable-row-hovered";
    }

    if (isDragging) {
      className += " xyflow-react-kie-diagram--draggable-row-is-dragging";
    }
  ...
  return (
    ...
    >
      {!props.isDisabled ? (
        <Icon
          className={"xyflow-react-kie-diagram--draggable-icon"}
        ...
        >
          <GripVerticalIcon
            className={
              hovered
                ? "xyflow-react-kie-diagram--draggable-icon-handler-hovered"
                : "xyflow-react-kie-diagram--draggable-icon-handler"
            }
          />
        </Icon>
      ) : (
      ...
      <div
        ...
        className={`xyflow-react-kie-diagram--draggable-children ${props.childrenClassName ? props.childrenClassName : ""}`}
      >

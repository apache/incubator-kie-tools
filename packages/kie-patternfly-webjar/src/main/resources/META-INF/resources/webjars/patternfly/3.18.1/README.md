...
The HTML pages in `dist/tests` are generated using Jekyll. Do _not_ edit these files directly. See `tests/pages` to change these files.
...
_Important:_ starting with the v2.0.0 release, **PatternFly no longer supports Internet Explorer 8**.

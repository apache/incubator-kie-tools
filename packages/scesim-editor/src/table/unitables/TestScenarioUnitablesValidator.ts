...
import { TestScenarioUnitablesI18n } from "../../i18n";
import { TestScenarioUnitablesJsonSchemaBridge } from "./TestScenarioUnitablesJsonSchemaBridge";
...
export class TestScenarioUnitablesValidator extends UnitablesValidator {
  //protected readonly dmnRunnerAjv = new DmnRunnerAjv();

  constructor(i18n: TestScenarioUnitablesI18n) {
    super(i18n);
  }
  ...
  public getBridge(): TestScenarioUnitablesJsonSchemaBridge {
    return new TestScenarioUnitablesJsonSchemaBridge({}, () => {}, this.i18n);
  }
}

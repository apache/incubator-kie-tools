...
| image            | object | `{"account":"apache","name":"incubator-kie-sandbox-webapp","pullPolicy":"IfNotPresent","registry":"docker.io","tag":"10.0.x"}`                                                                                                                   | Image source configuration for the KIE Sandbox image                                                                                      |

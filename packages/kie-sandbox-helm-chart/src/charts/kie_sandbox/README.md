...
| image            | object | `{"account":"apache","name":"incubator-kie-sandbox-webapp","pullPolicy":"IfNotPresent","registry":"docker.io","tag":"10.1.x"}`                                                                                                                   | Image source configuration for the KIE Sandbox image                                                                                      |

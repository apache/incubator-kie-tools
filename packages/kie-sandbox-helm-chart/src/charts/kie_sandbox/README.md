...
| image            | object | `{"account":"apache","name":"incubator-kie-sandbox-webapp","pullPolicy":"IfNotPresent","registry":"docker.io","tag":"10.2.0"}`                                                                                                                   | Image source configuration for the KIE Sandbox image                                                                                      |

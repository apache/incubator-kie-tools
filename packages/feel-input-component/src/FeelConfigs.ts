...
export const feelTheme = (): Monaco.editor.IStandaloneThemeData => {
  return {
    ...
    rules: [
      ...
      { token: "input-node", foreground: "#917632", fontStyle: "underline" },
      { token: "bkm-node", foreground: "#917632", fontStyle: "underline italic" },
      { token: "invalid-variable", foreground: "#ff0000", fontStyle: "underline bold" },
      { token: "parameter", foreground: "#036e9b", fontStyle: "italic" },
    ],
    colors: {

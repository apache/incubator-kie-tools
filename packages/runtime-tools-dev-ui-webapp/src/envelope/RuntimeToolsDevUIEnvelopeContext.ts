...
export const RuntimeToolsDevUIEnvelopeContext = React.createContext<RuntimeToolsDevUIEnvelopeContextType>(
  {} as RuntimeToolsDevUIEnvelopeContextType
);

export function useRuntimeToolsDevUIEnvelopeContext() {
  return useContext(RuntimeToolsDevUIEnvelopeContext) as RuntimeToolsDevUIEnvelopeContextType;
}

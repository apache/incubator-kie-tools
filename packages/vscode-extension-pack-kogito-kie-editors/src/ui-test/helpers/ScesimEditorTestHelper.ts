...
export default class ScesimEditorTestHelper {
  ...
  public getSettings = async (): Promise<WebElement> => {
    return await this.webview.findWebElement(
      By.xpath("//button[@data-title='Settings']")
    );
  };
  ...
  public getTestTools = async (): Promise<WebElement> => {
    return await this.webview.findWebElement(
      By.xpath("//button[@data-title='Test Tools']")
    );
  };
  ...
  public getScenarioCheatsheet = async (): Promise<WebElement> => {
    return await this.webview.findWebElement(
      By.className("docks-item-E-org.drools.scenariosimulation.CheatSheet")
    );
  };
  ...
  public openSettings = async (): Promise<WebElement> => {
    ...
    const expandedSettingsPanel = await this.webview.findWebElement(
      expandedDocksBarE()
    );
    await assertWebElementIsDisplayedEnabled(
      await settings.findElement(By.xpath(h3ComponentWithText("Settings")))
    );
  ...
  public openTestTools = async (): Promise<WebElement> => {
    ...
    const expandedTestToolsPanel = await this.webview.findWebElement(
      expandedDocksBarE()
    );
    await assertWebElementIsDisplayedEnabled(
      await testTools.findElement(By.xpath(h3ComponentWithText("Test Tools")))
    );
  ...
  public openScenarioCheatsheet = async (): Promise<WebElement> => {
    ...
    await assertWebElementIsDisplayedEnabled(
      await scenarioCheatsheet.findElement(
        By.xpath(h3ComponentWithText("Scenario Cheatsheet"))
      )
    );

...
export const KOGITO_IFRAME_FULLSCREEN_CONTAINER_CLASS =
  "kogito-iframe-fullscreen-container";
export const KOGITO_OPEN_WITH_ONLINE_EDITOR_LINK_CONTAINER_PR_CLASS =
  "kogito-open-with-online-editor-link-container-pr";
export const KOGITO_VIEW_ORIGINAL_LINK_CONTAINER_PR_CLASS =
  "kogito-view-original-link-container-pr";

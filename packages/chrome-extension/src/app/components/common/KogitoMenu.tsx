                            ...
                            <div style={{position: "relative"}}>
                                ...
                                {isInfoPopOverOpen && (
                                    <div className={"info-popover"}>
                                        ...
                                        <hr/>
                                        <p>
                                            We use your GitHub OAuth Token to provide a better experience while using
                                            custom editors. The
                                            official GitHub API has a throttling mechanism with a fairly low threshold
                                            for unauthenticated
                                            requests.
                                        </p>
                                        <p>
                                            By authenticating with your OAuth Token we are able to avoid delays when
                                            fetching recently updated
                                            files and also provide features that need to read from your repositories,
                                            like Work Item
                                        ...
                                        <p>
                                            ...
                                            <b>For public repositories, no special permissions are required</b>. In
                                            fact, you can generate a
                                            Token without ticking any checkbox. For private repositories, however, you

...
const defaultOperatorImage = "docker.io/apache/incubator-kie-sonataflow-operator:10.0.x"
...
func installSonataFlowUsingYaml() error {
	...
	tempFilePath, err := framework.CreateTemporaryFile("sonataflow-operator*.yaml", yamlContent)
	if err != nil {

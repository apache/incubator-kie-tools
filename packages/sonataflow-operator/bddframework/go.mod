module github.com/apache/incubator-kie-tools/packages/sonataflow-operator/bddframework
...
replace github.com/apache/incubator-kie-tools/packages/sonataflow-operator v0.0.0 => ../

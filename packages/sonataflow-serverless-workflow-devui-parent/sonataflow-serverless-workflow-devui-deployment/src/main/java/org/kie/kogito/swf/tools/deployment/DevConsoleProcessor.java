...
public class DevConsoleProcessor {
    ...
    private static final String BASE_RELATIVE_URL = "/q/dev-v1/org.kie.kogito.sonataflow-serverless-workflow-devui";
    ...
    public void deployStaticResources(final DevConsoleRecorder recorder,
        ...
        ResolvedDependency devConsoleResourcesArtifact = WebJarUtil.getAppArtifact(curateOutcomeBuildItem,
                "org.kie.kogito",
                "sonataflow-serverless-workflow-devui-deployment");

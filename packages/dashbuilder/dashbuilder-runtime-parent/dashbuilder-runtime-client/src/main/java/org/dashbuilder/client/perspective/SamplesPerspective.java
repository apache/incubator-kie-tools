...
@ApplicationScoped
@WorkbenchPerspective(identifier = SamplesPerspective.ID)
public class SamplesPerspective {

    public static final String ID = "SamplesPerspective";
    ...
    public PerspectiveDefinition buildPerspective() {
        ...
        perspective.getRoot().addPart(samplesScreen);
        perspective.setName("Samples");
        return perspective;
    }

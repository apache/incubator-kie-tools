define(
  ...
  function (e, t, n) {
    ...
    (t.handler = {
      ...
      attach: function (e) {
        e.on("click", t.onCursorMove),
          s.currentMode !== "insert" && r.coreCommands.stop.exec(e),
          (e.$vimModeHandler = this),
          this.updateMacCompositionHandlers(e, !0);
      },
      detach: function (e) {
        e.removeListener("click", t.onCursorMove),
          s.noMode(e),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../../lib/lang"),
        ...
        v = function (e) {
          var t = e.renderer,
            ...
            r = n.top,
            i = p * t.layerConfig.lineHeight;
          2 * i > t.$size.scrollerHeight && (i = t.$size.scrollerHeight / 2),
            t.scrollTop > r - i && t.session.setScrollTop(r - i),
            t.scrollTop + t.$size.scrollerHeight < r + i + t.lineHeight &&
        ...
        m = (t.actions = {
          z: {
            ...
            fn: function (e, t, n, r) {
              switch (r) {
                case "z":
                  e.renderer.alignCursor(null, 0.5);
                  break;
                case "t":
          ...
          "~": {
            fn: function (e, t, n) {
              d(function () {
                ...
                var n = e.session.getTextRange(t),
                  r = n.toUpperCase();
                r != n
          ...
          V: {
            fn: function (e, t, n, r) {
              ...
              e.selection.moveTo(s, 0),
                e.selection.selectLineEnd(),
                (e.selection.visualLineStart = s),
                i.visualMode(e, !0);
            },
            acceptsMotion: !0,
          },
        ...
        g = (t.inputBuffer = {
          ...
          push: function (e, t, n) {
            ...
            if (a) this.exec(e, a, t);
              ...
              } else if (u[t] && this.isAccepting(c)) (u[t].operator.count = this.getCount()), this.exec(e, u[t]);
            ...
            return (
              ...
              this.status != r && e._emit("changeStatus"),
              i
            );
          },
          ...
          exec: function (e, t, n) {
            ...
            if (!r && !a && u && n) o[u.ch].fn(e, null, u.count, n), this.reset();
              ...
              var f = function (t) {
                  t &&
                    typeof t == "function" &&
                    (r.count && !l.handlesCount ? d(t, r.count, [e, null, r.count, n]) : t(e, null, r.count, n));
                },
                l = s[r.ch],
                c = l.sel;
              u
        ...
        append: {
          exec: function S(e) {
            var t = e.getCursorPosition(),
              n = e.session.getLine(t.row).length;
      ...
      var b = (t.onCursorMove = function (e, t) {
        ...
        t && (i.onVisualLineMode || i.onVisualMode) && (e.selection.clearSelection(), i.normalMode(e)),
          (b.running = !0);
        var o = e.getCursorPosition(),
          u = e.session.getLine(o.row).length;
    ...
    function (e, t, n) {
      ...
      i.importCssString(
        ...
        (n.exports = {
          ...
          currentMode: "normal",
          noMode: function (e) {
            e.unsetStyle("insert-mode"),
              e.unsetStyle("normal-mode"),
              e.commands.recording && e.commands.toggleRecording(e),
              e.setOverwrite(!1);
          },
          insertMode: function (e) {
            (this.currentMode = "insert"),
              e.setStyle("insert-mode"),
              e.unsetStyle("normal-mode"),
              e.setOverwrite(!1),
              (e.keyBinding.$data.buffer = ""),
              (e.keyBinding.$data.vimState = "insertMode"),
              (this.onVisualMode = !1),
              (this.onVisualLineMode = !1),
              this.onInsertReplaySequence
                ? ((e.commands.macro = this.onInsertReplaySequence),
                  e.commands.replay(e),
          ...
          normalMode: function (e) {
            ...
            var t;
            return (
              e.getOverwrite() || ((t = e.getCursorPosition()), t.column > 0 && e.navigateLeft()),
              e.setOverwrite(!0),
              (e.keyBinding.$data.buffer = ""),
              (e.keyBinding.$data.vimState = "start"),
              (this.onVisualMode = !1),
              (this.onVisualLineMode = !1),
              e._emit("changeStatus"),
              e.commands.recording ? (e.commands.toggleRecording(e), e.commands.macro) : []
            );
          },
          ...
          copyLine: function (e) {
            ...
            e.selection.moveTo(t.row, t.column),
              ...
              (r._default.isLine = !0),
              (r._default.text = e.getCopyText().replace(/\n$/, "")),
              e.selection.moveTo(t.row, t.column);
          },
        });
    }
    ...
    function (e, t, n) {
      ...
      var r = e("./util"),
        ...
        f = function (e, t) {
          ...
          var r = e.session.getLine(this.row),
            i = e.session.getLength();
          (this.ch = r[this.col] || "\n"),
            (this.skippedLines = 0),
            (this.next = function () {
            ...
            (this.handleNewLine = function (t) {
              if (t == 1)
                return this.col == r.length
                  ...
                  : this.row == i - 1
                  ? ""
                  : ((this.col = 0), this.row++, (r = e.session.getLine(this.row)), this.skippedLines++, r[0] || "\n");
              if (t == -1)
                return this.row === 0
                  ? ""
                  : (this.row--, (r = e.session.getLine(this.row)), (this.col = r.length), this.skippedLines--, "\n");
            }),
            (this.debug = function () {
      ...
      (n.exports = {
        ...
        l: {
          nav: function (e) {
            var t = e.getCursorPosition(),
              n = t.column,
              r = e.session.getLine(t.row).length;
          ...
          nav: function (e, t, n, i) {
            ...
            o.length &&
              (s > 0
                ...
                : (e.session.insert({ row: 0, column: 0 }, o), e.navigateUp()),
              r.insertMode(e));
          },
        },
        "%": new s(function (e) {
        ...
        (n.exports.backspace = n.exports.left = n.exports.h),
        (n.exports.space = n.exports["return"] = n.exports.right = n.exports.l),
        (n.exports.up = n.exports.k),
        (n.exports.down = n.exports.j),
        (n.exports.pagedown = n.exports["ctrl-d"]),
        (n.exports.pageup = n.exports["ctrl-u"]),
        (n.exports.home = n.exports[0]),
        (n.exports.end = n.exports.$);
    }
  ),
  define(
    "ace/keyboard/vim/maps/operators",
      ...
      n.exports = {
        d: {
          selFn: function (e, t, n, s) {
            (i._default.text = e.getCopyText()),
              (i._default.isLine = r.onVisualLineMode),
              r.onVisualLineMode ? e.removeLines() : e.session.remove(t),
              r.normalMode(e);
          },
          fn: function (e, t, n, r) {
            n = n || 1;
            switch (r) {
              ...
              default:
                t &&
                  (e.selection.setSelectionRange(t),
                  (i._default.text = e.getCopyText()),
                  (i._default.isLine = !1),
                  e.session.remove(t),
                  e.selection.clearSelection());
  ...
  "use strict",
  define("ace/keyboard/vim/maps/aliases", ["require", "exports", "module"], function (e, t, n) {
    n.exports = {

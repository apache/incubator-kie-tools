...
(function (e) {
  ...
  define(
    ...
    ["require", "exports", "module", "ace/mode/coffee/lexer", "ace/mode/coffee/parser", "ace/mode/coffee/nodes"],
    function (e, t, n) {
      var r = e("./lexer").Lexer,
        i = e("./parser"),
        s = new r();
      (i.lexer = {
        lex: function () {
          ...
          return (
            ...
            t
              ? ((e = t[0]), (this.yytext = t[1]), (this.yylloc = t[2]), (this.yylineno = this.yylloc.first_line))
              : (e = ""),
            e
          );
        },
  ...
  define(
    ...
    ["require", "exports", "module", "ace/mode/coffee/rewriter", "ace/mode/coffee/helpers"],
    function (e, t, n) {
      var r,
        i,
        s,
      ...
      (et = e("./rewriter")),
        ...
        (G = tt.repeat),
        ($ = tt.invertLiterate),
        (Q = tt.locationDataToString),
        (Z = tt.throwSyntaxError),
        (t.Lexer = k =
          (function () {
            function e() {}
            return (
              (e.prototype.tokenize = function (e, t) {
                ...
                return (
                  ...
                  (i = this.ends.pop()) && this.error("missing " + i),
                  t.rewrite === !1 ? this.tokens : new F().rewrite(this.tokens)
                );
              }),
              (e.prototype.clean = function (e) {
                return (
                  e.charCodeAt(0) === r && (e = e.slice(1)),
                  (e = e.replace(/\r/g, "").replace(U, "")),
                  W.test(e) && ((e = "\n" + e), this.chunkLine--),
                  this.literate && (e = $(e)),
                  e
                );
                  ...
                  ? ((s = o[0]),
                    ...
                    r === "own" && this.tag() === "FOR"
                      ...
                      : ((n =
                        ...
                        (h = "IDENTIFIER"),
                        !n &&
                          (nt.call(x, r) >= 0 || nt.call(f, r) >= 0) &&
                          ((h = r.toUpperCase()),
                          h === "WHEN" && ((v = this.tag()), nt.call(T, v) >= 0)
                            ? (h = "LEADING_WHEN")
                            : h === "FOR"
                            ? (this.seenFor = !0)
                            : h === "UNLESS"
                            ...
                            ? (h = "UNARY")
                            : nt.call(B, h) >= 0 &&
                              (h !== "INSTANCEOF" && this.seenFor
                                ? ((h = "FOR" + h), (this.seenFor = !1))
                                : ((h = "RELATION"),
                                  this.value() === "!" && ((l = this.tokens.pop()), (r = "!" + r))))),
                        nt.call(S, r) >= 0 &&
                          (n
                            ? ((h = "IDENTIFIER"), (r = new String(r)), (r.reserved = !0))
                            : nt.call(j, r) >= 0 && this.error('reserved word "' + r + '"')),
                        n ||
                          (nt.call(u, r) >= 0 && (r = a[r]),
                          (h = (function () {
                            switch (r) {
                        ...
                        (p = this.token(h, r, 0, i)),
                        l &&
                          ((m = [l[2].first_line, l[2].first_column]),
                          (p[2].first_line = m[0]),
                          (p[2].first_column = m[1])),
                        e && ((t = s.lastIndexOf(":")), this.token(":", ":", t, e.length)),
                        s.length))
                  : 0;
              }),
              (e.prototype.numberToken = function () {
                ...
                (r = n[0]),
                  /^0[BOX]/.test(r)
                    ...
                    : /E/.test(r) && !/^0x/.test(r)
                    ? this.error("exponential notation '" + r + "' must be indicated with a lowercase 'e'")
                    : /^0\d*[89]/.test(r)
                    ? this.error("decimal literal '" + r + "' must not be prefixed with '0'")
                    : /^0\d+/.test(r) && this.error("octal literal '" + r + "' must be prefixed with '0o'"),
                  (t = r.length);
              ...
              (e.prototype.stringToken = function () {
                ...
                return n
                  ? ((r = this.removeNewlines(n.slice(1, -1))),
                    t === '"' && 0 < n.indexOf("#{", 1)
                      ? this.interpolateString(r, { strOffset: 1, lexedLength: n.length })
                      : this.token("STRING", t + this.escapeLines(r) + t, 0, n.length),
                    (e = /^(?:\\.|[^\\])*\\(?:0[0-7]|[1-7])/.test(n)) &&
                      this.error("octal escape sequences " + n + " are not allowed"),
                    n.length)
                  : 0;
              }),
              (e.prototype.heredocToken = function () {
                var e, t, n, r;
                return (n = p.exec(this.chunk))
                  ? ((t = n[0]),
                    (r = t.charAt(0)),
                    (e = this.sanitizeHeredoc(n[2], { quote: r, indent: null })),
                    r === '"' && 0 <= e.indexOf("#{")
                      ? this.interpolateString(e, { heredoc: !0, strOffset: 3, lexedLength: t.length })
                      : this.token("STRING", this.makeString(e, r, !0), 0, t.length),
                    t.length)
                  : 0;
              }),
              (e.prototype.commentToken = function () {
                var e, t, n;
                return (n = this.chunk.match(l))
                  ? ((e = n[0]),
                    (t = n[1]),
                    t &&
                      this.token(
                        "HERECOMMENT",
                        this.sanitizeHeredoc(t, { herecomment: !0, indent: G(" ", this.indent) }),
                        0,
                        e.length
                      ),
                    e.length)
              ...
              (e.prototype.jsToken = function () {
                var e, t;
                return this.chunk.charAt(0) !== "`" || !(e = E.exec(this.chunk))
                  ? 0
                  : (this.token("JS", (t = e[0]).slice(1, -1), 0, t.length), t.length);
              }),
              (e.prototype.regexToken = function () {
                ...
                return this.chunk.charAt(0) !== "/"
                  ? 0
                  : (n = m.exec(this.chunk))
                  ? ((t = this.heregexToken(n)), t)
                  : ((r = K(this.tokens)),
                    r && ((s = r[0]), nt.call(r.spaced ? M : _, s) >= 0)
                      ? 0
                      : (n = H.exec(this.chunk))
                      ? ((o = n),
                        (n = o[0]),
                        (i = o[1]),
                        (e = o[2]),
                        i.slice(0, 2) === "/*" && this.error("regular expressions cannot begin with `*`"),
                        i === "//" && (i = "/(?:)/"),
                        this.token("REGEX", "" + i + e, 0, n.length),
                        n.length)
                      : 0);
              }),
              (e.prototype.heregexToken = function (e) {
                ...
                if (0 > t.indexOf("#{"))
                  return (
                    (u = this.escapeLines(t.replace(g, "$1$2").replace(/\//g, "\\/"), !0)),
                    u.match(/^\*/) && this.error("regular expressions cannot begin with `*`"),
                    this.token("REGEX", "/" + (u || "(?:)") + "/" + n, 0, i.length),
                    i.length
                  );
                this.token("IDENTIFIER", "RegExp", 0, 0),
                  this.token("CALL_START", "(", 0, 0),
                  (l = []),
                  (d = this.interpolateString(t, { regex: !0 }));
                ...
                return (
                  l.pop(),
                  ((v = l[0]) != null ? v[0] : void 0) !== "STRING" &&
                    (this.token("STRING", '""', 0, 0), this.token("+", "+", 0, 0)),
                  (m = this.tokens).push.apply(m, l),
                  n &&
                    ((r = i.lastIndexOf(n)),
                    this.token(",", ",", r, 0),
                    this.token("STRING", '"' + n + '"', r, n.length)),
              ...
              (e.prototype.lineToken = function () {
                ...
                if (i - this.indebt === this.indent)
                  return r ? this.suppressNewlines() : this.newlineToken(0), t.length;
                if (i > this.indent) {
                  ...
                  i < this.baseIndent
                    ...
                    : ((this.indebt = 0), this.outdentToken(this.indent - i, r, t.length));
                return (this.indent = i), t.length;
              }),
              (e.prototype.outdentToken = function (e, t, n) {
                var r, i;
                while (e > 0)
                  (i = this.indents.length - 1),
                    this.indents[i] === void 0
                      ? (e = 0)
                      : this.indents[i] === this.outdebt
                      ? ((e -= this.outdebt), (this.outdebt = 0))
                      : this.indents[i] < this.outdebt
                      ? ((this.outdebt -= this.indents[i]), (e -= this.indents[i]))
                      : ((r = this.indents.pop() + this.outdebt),
                        (e -= r),
                        (this.outdebt = 0),
                        this.pair("OUTDENT"),
                        this.token("OUTDENT", r, 0, n));
                r && (this.outdebt -= e);
              ...
              (e.prototype.whitespaceToken = function () {
                ...
                return !(e = W.exec(this.chunk)) && !(t = this.chunk.charAt(0) === "\n")
                  ? 0
                  : ((n = K(this.tokens)), n && (n[e ? "spaced" : "newLine"] = !0), e ? e[0].length : 0);
              }),
              ...
              (e.prototype.literalToken = function () {
                var e, t, n, r, i, u, a, f;
                (e = P.exec(this.chunk)) ? ((r = e[0]), o.test(r) && this.tagParameters()) : (r = this.chunk.charAt(0)),
                  (n = r),
                  (t = K(this.tokens));
                if (r === "=" && t) {
                  !t[1].reserved &&
              ...
              (e.prototype.balancedString = function (e, t) {
                ...
                for (r = a = 1, f = e.length; 1 <= f ? a < f : a > f; r = 1 <= f ? ++a : --a) {
                  ...
                  t !== "}" || (i !== '"' && i !== "'")
                    ? t === "}" && i === "/" && (s = m.exec(e.slice(r)) || H.exec(e.slice(r)))
                      ? (n += s[0].length - 1)
                      : t === "}" && i === "{"
                      ? u.push((t = "}"))
                      : t === '"' && o === "#" && i === "{" && u.push((t = "}"))
              ...
              (e.prototype.interpolateString = function (t, n) {
                ...
                while ((l = t.charAt((o += 1)))) {
                  ...
                  if (u.length) {
                    (L = this.getLineAndColumnFromChunk(E + o + 1)),
                      (h = L[0]),
                      (r = L[1]),
                      (d = new e().tokenize(u, { line: h, column: r, rewrite: !1 })),
                      (y = d.pop()),
                      ((A = d[0]) != null ? A[0] : void 0) === "TERMINATOR" && (y = d.shift());
                    if ((f = d.length))
                      f > 1 &&
                        (d.unshift(this.makeToken("(", "(", E + o + 1, 0)),
                        d.push(this.makeToken(")", ")", E + o + 1 + u.length, 0))),
                        T.push(["TOKENS", d]);
                  }
                  (o += i.length), (m = o + 1);
                }
                ...
                T[0][0] !== "NEOSTRING" && T.unshift(this.makeToken("NEOSTRING", "", v)),
                  (a = T.length > 1) && this.token("(", "(", v, 0);
                for (o = C = 0, k = T.length; C < k; o = ++C)
                  (x = T[o]),
                    ...
                    S === "TOKENS"
                      ? (O = this.tokens).push.apply(O, N)
                      : S === "NEOSTRING"
                      ? ((x[0] = "STRING"), (x[1] = this.makeString(N, '"', s)), this.tokens.push(x))
                      : this.error("Unexpected " + S);
                return a && ((w = this.makeToken(")", ")", v + c, 0)), (w.stringEnd = !0), this.tokens.push(w)), T;
              }),
              (e.prototype.pair = function (e) {
                var t, n;
                return e !== (n = K(this.ends))
                  ? ("OUTDENT" !== n && this.error("unmatched " + e),
                    (this.indent -= t = K(this.indents)),
              ...
              (e.prototype.getLineAndColumnFromChunk = function (e) {
                ...
                return e === 0
                  ...
                  : (e >= this.chunk.length ? (i = this.chunk) : (i = this.chunk.slice(0, +(e - 1) + 1 || 9e9)),
                    (n = V(i, "\n")),
                    (t = this.chunkColumn),
                    n > 0 ? ((r = i.split("\n")), (t = K(r).length)) : (t += i.length),
                    [this.chunkLine + n, t]);
              }),
              (e.prototype.makeToken = function (e, t, n, r) {
                ...
                return (
                  ...
                  r == null && (r = t.length),
                  (s = {}),
                  (u = this.getLineAndColumnFromChunk(n)),
                  (s.first_line = u[0]),
                  (s.first_column = u[1]),
                  (i = Math.max(0, r - 1)),
                  (a = this.getLineAndColumnFromChunk(n + i)),
                  (s.last_line = a[0]),
                  (s.last_column = a[1]),
                  (o = [e, t, s]),
                  o
              ...
              (e.prototype.makeString = function (e, t, n) {
                return e
                  ? ((e = e.replace(RegExp("\\\\(" + t + "|\\\\)", "g"), function (e, n) {
                      return n === t ? n : e;
                    })),
              ...
              (e.prototype.error = function (e, t) {
                ...
                return (
                  t == null && (t = 0),
                  (i = this.getLineAndColumnFromChunk(t)),
                  (r = i[0]),
                  (n = i[1]),
                  Z(e, { first_line: r, first_column: n })
                );
              }),
              e
            );
        ...
        (f = ["undefined", "then", "unless", "until", "loop", "of", "by", "when"]),
        (a = {
          and: "&&",
          or: "||",
          is: "==",
        ...
        (R = ["arguments", "eval"]),
        (S = x.concat(j).concat(R)),
        (t.RESERVED = j.concat(x).concat(f).concat(R)),
        (t.STRICT_PROSCRIBED = R),
        (r = 65279),
        (y = /^([$A-Za-z_\x7f-\uffff][$\w\x7f-\uffff]*)([^\n\S]*:(?!:))?/),
        ...
        (B = ["IN", "OF", "INSTANCEOF"]),
        (i = ["TRUE", "FALSE"]),
        (M = ["NUMBER", "REGEX", "BOOL", "NULL", "UNDEFINED", "++", "--"]),
        (_ = M.concat(")", "}", "THIS", "IDENTIFIER", "STRING", "]")),
        (s = ["IDENTIFIER", "STRING", "REGEX", ")", "]", "}", "?", "::", "@", "THIS", "SUPER"]),
        (b = s.concat("NUMBER", "BOOL", "NULL", "UNDEFINED")),
        (T = ["INDENT", "OUTDENT", "TERMINATOR"]);
    }
  ),
  define("ace/mode/coffee/rewriter", ["require", "exports", "module"], function (e, t, n) {
        ...
        return (
          ...
          (e.prototype.findTagsBackwards = function (e, t) {
            ...
            while (
              e >= 0 &&
              (n.length ||
                (((s = this.tag(e)), S.call(t, s) < 0) &&
                  (((a = this.tag(e)), S.call(u, a) < 0) || this.tokens[e].generated) &&
                  ((f = this.tag(e)), S.call(p, f) < 0)))
            )
              ((r = this.tag(e)), S.call(o, r) >= 0) && n.push(this.tag(e)),
                ((i = this.tag(e)), S.call(u, i) >= 0) && n.length && n.pop(),
                (e -= 1);
              ...
              this.scanTokens(function (t, n, r) {
                ...
                (H = t[0]),
                  ...
                  (D = function (t, i) {
                    ...
                    i == null && (i = !0),
                      (s = t != null ? t : n),
                      e.push(["{", s, { sameLine: !0, startsLine: i, ours: !0 }]),
                      r.splice(s, 0, m("{", m(new String("{"))));
                    if (t == null) return (n += 1);
                  }),
                  (d = function (t) {
                ...
                if (
                  !y() ||
                  (H !== "IF" && H !== "TRY" && H !== "FINALLY" && H !== "CATCH" && H !== "CLASS" && H !== "SWITCH")
                ) {
                  if (H === "INDENT" && g()) {
                    if (
                      T !== "=>" &&
                  ...
                  if (
                    ((S.call(l, H) >= 0 && t.spaced && !t.stringEnd) || (H === "?" && n > 0 && !r[n - 1].spaced)) &&
                    (S.call(a, E) >= 0 ||
                      (S.call(c, E) >= 0 &&
                        ((B = r[n + 1]) != null ? !B.spaced : !void 0) &&
                        ((j = r[n + 1]) != null ? !j.newLine : !void 0)))
                  )
                    return H === "?" && (H = t[0] = "FUNC_EXIST"), _(n + 1), v(2);
                  if (
                    S.call(l, H) >= 0 &&
                    this.matchTags(n + 1, "INDENT", null, ":") &&
                    !this.findTagsBackwards(n, [
                      "CLASS",
                      "EXTENDS",
                      "IF",
                      "CATCH",
                    ...
                    return _(n + 1), e.push(["INDENT", n + 2]), v(3);
                  if (H === ":") {
                    ...
                    if (O()) {
                      (I = O()), (A = I[0]), (L = I[1]);
                      if (
                        (A === "{" || (A === "INDENT" && this.tag(L - 1) === "{")) &&
                        (P || this.tag(C - 1) === "," || this.tag(C - 1) === "{")
                      )
                        return v(1);
                    }
                    return D(C, !!P), v(2);
                  ...
                  if (
                    H === "," &&
                    !this.looksObjectish(n + 1) &&
                    w() &&
                    (E !== "TERMINATOR" || !this.looksObjectish(n + 2))
                  ) {
                    x = E === "OUTDENT" ? 1 : 0;
                    while (w()) d(n + x);
                  }
          ...
          (e.prototype.addLocationDataToGeneratedTokens = function () {
            return this.scanTokens(function (e, t, n) {
              ...
              return e[2]
                ...
                ? 1
                : (e[0] === "{" && (s = (u = n[t + 1]) != null ? u[2] : void 0)
                    ? ((i = s.first_line), (r = s.first_column))
                    : (o = (a = n[t - 1]) != null ? a[2] : void 0)
                    ? ((i = o.last_line), (r = o.last_column))
                    : (i = r = 0),
                  (e[2] = { first_line: i, first_column: r, last_line: i, last_column: r }),
                  1);
            });
          }),
            ...
            return (
              ...
              (t = function (e, t) {
                ...
                return (
                  (e[1] !== ";" &&
                    ((n = e[0]), S.call(d, n) >= 0) &&
                    !(e[0] === "TERMINATOR" && ((r = this.tag(t + 1)), S.call(s, r) >= 0)) &&
                    (e[0] !== "ELSE" || o === "THEN") &&
                    (((u = e[0]) !== "CATCH" && u !== "FINALLY") || (o !== "->" && o !== "=>"))) ||
                  (((a = e[0]), S.call(i, a) >= 0) && this.tokens[t - 1].newLine)
                );
              }),
              (e = function (e, t) {
              ...
              this.scanTokens(function (i, u, a) {
                ...
                l = i[0];
                if (l === "TERMINATOR") {
                  if (this.tag(u + 1) === "ELSE" && this.tag(u - 1) !== "OUTDENT")
                    return a.splice.apply(a, [u, 1].concat(x.call(this.indentation()))), 1;
                ...
                return S.call(v, l) >= 0 && this.tag(u + 1) !== "INDENT" && (l !== "ELSE" || this.tag(u + 1) !== "IF")
                  ? ((o = l),
                    (d = this.indentation(!0)),
                    (n = d[0]),
                    (r = d[1]),
                    o === "THEN" && (n.fromThen = !0),
                    a.splice(u + 1, 0, n),
          ...
          (e.prototype.tagPostfixConditionals = function () {
            ...
            return (
              ...
              (t = function (e, t) {
                var n, r;
                return (
                  (r = e[0]), (n = this.tokens[t - 1][0]), r === "TERMINATOR" || (r === "INDENT" && S.call(v, n) < 0)
                );
              }),
              (e = function (e, t) {
          ...
          (e.prototype.indentation = function (e) {
            ...
            return (
              ...
              e || (t.explicit = n.explicit = !0),
              [t, n]
            );
          }),
          (e.prototype.generate = m),
    ...
    (s = ["CATCH", "THEN", "ELSE", "FINALLY"].concat(o)),
      (l = ["IDENTIFIER", "SUPER", ")", "CALL_END", "]", "INDEX_END", "@", "THIS"]),
      (a = [
        "IDENTIFIER",
        "NUMBER",
        "STRING",
      ...
      (c = ["+", "-"]),
      (f = ["POST_IF", "FOR", "WHILE", "UNTIL", "WHEN", "BY", "LOOP", "TERMINATOR"]),
      (v = ["ELSE", "->", "=>", "TRY", "FINALLY", "THEN"]),
      (d = ["TERMINATOR", "CATCH", "FINALLY", "ELSE", "OUTDENT", "LEADING_WHEN"]),
      (p = ["TERMINATOR", "INDENT", "OUTDENT"]),
      (i = [".", "?.", "::", "?::"]);
  }),
  define("ace/mode/coffee/helpers", ["require", "exports", "module"], function (e, t, n) {
    ...
    (t.starts = function (e, t, n) {
        ...
        return (
          ...
          (n = (function () {
            ...
            for (n = 0, i = s.length; n < i; n++)
              (t = s[n]),
                r && /^([ ]{4}|[ ]{0,3}\t)/.test(t) ? o.push(t) : (r = /^\s*$/.test(t)) ? o.push(t) : o.push("# " + t);
            return o;
          })()),
          n.join("\n")
        );
      ...
      (t.locationDataToString = function (e) {
        var t;
        return (
          "2" in e && "first_line" in e[2] ? (t = e[2]) : "first_line" in e && (t = e),
          t
            ? "" +
              (t.first_line + 1) +
              ":" +
      ...
      (t.baseFileName = function (e, t, n) {
        ...
        return (
          ...
          (e = r[r.length - 1]),
          t && e.indexOf(".") >= 0
            ? ((r = e.split(".")), r.pop(), r[r.length - 1] === "coffee" && r.length > 1 && r.pop(), r.join("."))
            : e
        );
      }),
      ...
      (t.throwSyntaxError = function (e, t) {
        var n;
        throw (
          (t.last_line == null && (t.last_line = t.first_line),
          t.last_column == null && (t.last_column = t.first_column),
          (n = new SyntaxError(e)),
          (n.location = t),
          (n.toString = a),
          (n.stack = n.toString()),
      ...
      (t.updateSyntaxError = function (e, t, n) {
        return (
          e.toString === a && (e.code || (e.code = t), e.filename || (e.filename = n), (e.stack = e.toString())), e
        );
      }),
      (a = function () {
        ...
        (h = this.location),
          ...
          typeof process != "undefined" &&
            process !== null &&
            (n = process.stdout.isTTY && !process.env.NODE_DISABLE_COLORS);
        if ((p = this.colorful) != null ? p : n)
          (t = function (e) {
            return "[1;31m" + e + "[0m";
          }),
            (e = e.slice(0, c) + t(e.slice(c, r)) + e.slice(r)),
            (l = t(l));
  ...
  define("ace/mode/coffee/parser", ["require", "exports", "module"], function (e, t, n) {
    ...
    var i = {
        ...
        switch (i) {
          ...
          case 39:
            this.$ = r.addLocationDataFn(
              o[u - 2],
              o[u]
            )(new r.Assign(r.addLocationDataFn(o[u - 2])(new r.Value(s[u - 2])), s[u], "object"));
            break;
          case 40:
            this.$ = r.addLocationDataFn(
              o[u - 4],
              o[u]
            )(new r.Assign(r.addLocationDataFn(o[u - 4])(new r.Value(s[u - 4])), s[u - 1], "object"));
            break;
          case 41:
            this.$ = s[u];
            break;
          ...
          case 81:
            this.$ = r.addLocationDataFn(
              ...
              r.addLocationDataFn(o[u - 1])(new r.Access(new r.Literal("prototype"))),
          ...
          case 82:
            this.$ = r.addLocationDataFn(
              ...
              r.addLocationDataFn(o[u - 1])(new r.Access(new r.Literal("prototype"), "soak")),
              r.addLocationDataFn(o[u])(new r.Access(s[u])),
            ]);
            break;
          case 83:
          ...
          case 113:
            this.$ = r.addLocationDataFn(
              ...
              new r.Value(
                r.addLocationDataFn(o[u - 1])(new r.Literal("this")),
                [r.addLocationDataFn(o[u])(new r.Access(s[u]))],
                "this"
              )
            );
          ...
          case 147:
            this.$ = r.addLocationDataFn(
              o[u - 1],
              o[u]
            )(s[u].addBody(r.addLocationDataFn(o[u - 1])(r.Block.wrap([s[u - 1]]))));
            break;
          case 148:
            this.$ = r.addLocationDataFn(
              o[u - 1],
          ...
          case 150:
            this.$ = r.addLocationDataFn(
              o[u - 1],
              o[u]
            )(new r.While(r.addLocationDataFn(o[u - 1])(new r.Literal("true"))).addBody(s[u]));
            break;
          case 151:
            this.$ = r.addLocationDataFn(
              o[u - 1],
              ...
              new r.While(r.addLocationDataFn(o[u - 1])(new r.Literal("true"))).addBody(
                r.addLocationDataFn(o[u])(r.Block.wrap([s[u]]))
              )
            );
            break;
          case 152:
          ...
          case 181:
            this.$ = r.addLocationDataFn(
              o[u - 4],
              o[u]
            )(s[u - 4].addElse(r.addLocationDataFn(o[u - 2], o[u])(new r.If(s[u - 1], s[u], { type: s[u - 2] }))));
            break;
          case 182:
            this.$ = s[u];
            break;
          ...
          case 184:
            this.$ = r.addLocationDataFn(
              ...
              new r.If(s[u], r.addLocationDataFn(o[u - 2])(r.Block.wrap([s[u - 2]])), { type: s[u - 1], statement: !0 })
            );
            break;
          case 185:
            this.$ = r.addLocationDataFn(
            ...
            this.$ = r.addLocationDataFn(
              ...
              (function () {
                return s[u - 1].charAt(0) === "!"
                  ? new r.Op(s[u - 1].slice(1), s[u - 2], s[u]).invert()
      ...
      parse: function (e) {
        ...
        for (;;) {
          y = i[i.length - 1];
          if (this.defaultActions[y]) b = this.defaultActions[y];
          else {
          ...
          if (typeof b == "undefined" || !b.length || !b[0]) {
            ...
            this.lexer.showPosition
              ? (k = "Expecting " + C.join(", ") + ", got '" + (this.terminals_[m] || m) + "'")
              : (k = "Unexpected " + (m == p ? "end of input" : "'" + (this.terminals_[m] || m) + "'")),
              this.lexer.yylloc.first_line !== d.first_line && (d = this.lexer.yylloc),
              this.parseError(k, {
          ...
          switch (b[0]) {
            ...
            case 2:
              (T = this.productions_[b[1]][1]),
                ...
                v && (S._$.range = [o[o.length - (T || 1)].range[0], o[o.length - 1].range[1]]),
                (E = this.performAction.call(S, a, l, f, this.yy, b[1], s, o));
              if (typeof E != "undefined") return E;
              T && ((i = i.slice(0, -1 * T * 2)), (s = s.slice(0, -1 * T)), (o = o.slice(0, -1 * T))),
                i.push(this.productions_[b[1]][0]),
                s.push(S.$),
                o.push(S._$),
                (N = u[i[i.length - 2]][i[i.length - 1]]),
                i.push(N);
              break;
            case 3:
              return !0;
  ...
  define(
    ...
    ["require", "exports", "module", "ace/lib/oop", "ace/worker/mirror", "ace/mode/coffee/coffee-script"],
    function (e, t, n) {
      var r = e("../lib/oop"),
        i = e("../worker/mirror").Mirror,
        s = e("../mode/coffee/coffee-script");
  ...
  define(
    ...
    ["require", "exports", "module", "ace/mode/coffee/scope", "ace/mode/coffee/lexer", "ace/mode/coffee/helpers"],
    function (e, t, n) {
      var r,
        i,
        s,
      ...
      (Error.stackTraceLimit = Infinity),
        ...
        (ct = St.last),
        (mt = St.some),
        (nt = St.addLocationDataFn),
        (ht = St.locationDataToString),
        (yt = St.throwSyntaxError),
        (t.extend = ot),
        (t.addLocationDataFn = nt),
        (tt = function () {
          return !0;
        }),
        (D = function () {
        ...
        (t.CodeFragment = c =
          (function () {
            function e(e, t) {
              var n;
              (this.code = "" + t),
                (this.locationData = e != null ? e.locationData : void 0),
                (this.type = (e != null ? ((n = e.constructor) != null ? n.name : void 0) : void 0) || "unknown");
            }
            return (
            ...
            return (
              ...
              (e.prototype.compileToFragments = function (e, t) {
                ...
                return (
                  ...
                  (n.tab = e.indent),
                  e.level === A || !n.isStatement(e) ? n.compileNode(e) : n.compileClosure(e)
                );
              }),
              (e.prototype.compileClosure = function (e) {
                var t, n, i, s, o;
                (s = this.jumps()) && s.error("cannot use a pure statement in an expression"),
                  (e.sharedScope = !0),
                  (i = new l([], u.wrap([this]))),
                  (t = []);
                if ((n = this.contains(ft)) || this.contains(lt))
                  (t = [new O("this")]),
                    n ? ((o = "apply"), t.push(new O("arguments"))) : (o = "call"),
                    (i = new Z(i, [new r(new O(o))]));
                return new a(i, t).compileNode(e);
              }),
              (e.prototype.cache = function (e, t, n) {
                var r, i;
                return this.isComplex()
                  ? ((r = new O(n || e.scope.freeVariable("ref"))),
                    (i = new s(r, this)),
                    t ? [i.compileToFragments(e, t), [this.makeCode(r.value)]] : [i, r])
              ...
              (e.prototype.toString = function (e, t) {
                ...
                return (
                  e == null && (e = ""),
                  t == null && (t = this.constructor.name),
                  (n = "\n" + e + t),
                  this.soak && (n += "?"),
          ...
          (function (e) {
            ...
            return (
                ...
                while (n--) {
                  ...
                  if (!(t instanceof h)) {
                    (this.expressions[n] = t.makeReturn(e)),
                      t instanceof R && !t.expression && this.expressions.splice(n, 1);
                    break;
                  }
                }
                return this;
              ...
              (t.prototype.compileToFragments = function (e, n) {
                return (
                  e == null && (e = {}), e.scope ? t.__super__.compileToFragments.call(this, e, n) : this.compileRoot(e)
                );
              }),
              (t.prototype.compileNode = function (e) {
                var n, r, i, s, o, u, a, f, l;
                (this.tab = e.indent), (u = e.level === A), (r = []), (l = this.expressions);
                for (s = a = 0, f = l.length; a < f; s = ++a)
                  (o = l[s]),
                    (o = o.unwrapAll()),
                    (o = o.unfoldSoak(e) || o),
                    o instanceof t
                      ? r.push(o.compileNode(e))
                      : u
                      ? ((o.front = !0),
                        (i = o.compileToFragments(e)),
                        o.isStatement(e) || (i.unshift(this.makeCode("" + this.tab)), i.push(this.makeCode(";"))),
                        r.push(i))
                      : r.push(o.compileToFragments(e, C));
                return u
                  ? this.spaced
                    ? [].concat(this.joinFragmentArrays(r, "\n\n"), this.makeCode("\n"))
                    : this.joinFragmentArrays(r, "\n")
                  : (r.length ? (n = this.joinFragmentArrays(r, ", ")) : (n = [this.makeCode("void 0")]),
                    r.length > 1 && e.level >= C ? this.wrapInBraces(n) : n);
              }),
              (t.prototype.compileRoot = function (e) {
                ...
                return (
                  ...
                  e.bare ||
                    ...
                    (u = this.expressions.slice(o.length)),
                    (this.expressions = o),
                    o.length && ((s = this.compileNode(pt(e, { indent: "" }))), s.push(this.makeCode("\n"))),
                    (this.expressions = u)),
              ...
              (t.prototype.compileWithDeclarations = function (e) {
                ...
                return (
                  (e = pt(e, { level: A })),
                  s &&
                    ((u = this.expressions.splice(s, 9e9)),
                    (d = [this.spaced, !1]),
                    (f = d[0]),
                    (this.spaced = d[1]),
                    (v = [this.compileNode(e), f]),
                    (i = v[0]),
                    (this.spaced = v[1]),
                    (this.expressions = u)),
                  ...
                  a.expressions === this &&
                    ...
                    n || t
                      ? (s && i.push(this.makeCode("\n")),
                        ...
                        n && i.push(this.makeCode(a.declaredVariables().join(", "))),
                        t &&
                          (n && i.push(this.makeCode(",\n" + (this.tab + J))),
                          i.push(this.makeCode(a.assignedVariables().join(",\n" + (this.tab + J))))),
        ...
        (t.Literal = O =
          (function (e) {
            ...
            return (
              ...
              (t.prototype.jumps = function (e) {
                if (this.value === "break" && !((e != null ? e.loop : void 0) || (e != null ? e.block : void 0)))
                  return this;
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  (n =
                    this.value === "this"
                      ? ((r = e.scope.method) != null ? r.bound : void 0)
        ...
        (t.Return = R =
          (function (e) {
            ...
            return (
              ...
              (t.prototype.isStatement = tt),
              (t.prototype.makeReturn = K),
              (t.prototype.jumps = K),
              (t.prototype.compileToFragments = function (e, n) {
                var r, i;
                return (
                  (r = (i = this.expression) != null ? i.makeReturn() : void 0),
                  !r || r instanceof t ? t.__super__.compileToFragments.call(this, e, n) : r.compileToFragments(e, n)
                );
              }),
              (t.prototype.compileNode = function (e) {
                var t;
          ...
          (function (e) {
            function t(e, n, r) {
              return !n && e instanceof t
                ? e
                : ((this.base = e), (this.properties = n || []), r && (this[r] = !0), this);
            }
            return (
              Tt(t, e),
              ...
              (t.prototype.looksStatic = function (e) {
                ...
                return (
                  ...
                  ((t = this.properties[0].name) != null ? t.value : void 0) !== "prototype"
                );
              }),
              (t.prototype.unwrap = function () {
              ...
              (t.prototype.cacheReference = function (e) {
                var n, r, i, o;
                return (
                  (i = ct(this.properties)),
                  this.properties.length < 2 && !this.base.isComplex() && (i != null ? !i.isComplex() : !void 0)
                    ? [this, this]
                    : ((n = new t(this.base, this.properties.slice(0, -1))),
                      n.isComplex() && ((r = new O(e.scope.freeVariable("base"))), (n = new t(new F(new s(r, n))))),
                      i
                        ? (i.isComplex() &&
                            ((o = new O(e.scope.freeVariable("name"))), (i = new x(new s(o, i.index))), (o = new x(o))),
                          [n.add(i), new t(r || n.base, [o || i])])
                        : [n, r])
                );
              }),
              (t.prototype.compileNode = function (e) {
                ...
                (this.base.front = this.front),
                  (r = this.properties),
                  (t = this.base.compileToFragments(e, r.length ? T : null)),
                  (this.base instanceof F || r.length) && U.test(at(t)) && t.push(this.makeCode("."));
                  ...
                  : (this.unfoldedSoak = (function (n) {
                      return function () {
                        ...
                        for (i = l = 0, c = d.length; l < c; i = ++l) {
                          ...
                          return (
                            (u.soak = !1),
                            (r = new t(n.base, n.properties.slice(0, i))),
                            (f = new t(n.base, n.properties.slice(i))),
                            r.isComplex() &&
                              ((a = new O(e.scope.freeVariable("ref"))), (r = new F(new s(a, r))), (f.base = a)),
                            new E(new p(r), f, { soak: !0 })
                          );
                        }
                        return !1;
                      };
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.compileNode = function (e, t) {
                var n, r;
                return (
                  (r = this.comment.replace(/^(\s*)#/gm, "$1 *")),
                  (n = "/*" + dt(r, this.tab) + (Nt.call(r, "\n") >= 0 ? "\n" + this.tab : "") + " */"),
                  (t || e.level) === A && (n = e.indent + n),
                  [this.makeCode("\n"), this.makeCode(n)]
                );
              }),
              t
          ...
          (function (e) {
            function t(e, t, n) {
              (this.args = t != null ? t : []),
                (this.soak = n),
                (this.isNew = !1),
                (this.isSuper = e === "super"),
                (this.variable = this.isSuper ? null : e),
                e instanceof Z && e.isNotCallable() && e.error("literal is not a function");
            }
            return (
              Tt(t, e),
              (t.prototype.children = ["variable", "args"]),
              (t.prototype.newInstance = function () {
                var e, n;
                return (
                  (e = ((n = this.variable) != null ? n.base : void 0) || this.variable),
                  e instanceof t && !e.isNew ? e.newInstance() : (this.isNew = !0),
                  this
                );
              }),
              (t.prototype.superReference = function (e) {
                ...
                return (
                  ...
                  (n != null ? n.klass : void 0)
                    ? ((t = [new r(new O("__super__"))]),
                      n["static"] && t.push(new r(new O("constructor"))),
                      t.push(new r(new O(n.name))),
                      new Z(new O(n.klass), t).compile(e))
                    : (n != null ? n.ctor : void 0)
                    ? "" + n.name + ".__super__.constructor"
              ...
              (t.prototype.unfoldSoak = function (e) {
                ...
                if (this.soak) {
                  ...
                  return (
                    (o = new t(o, this.args)),
                    (o.isNew = this.isNew),
                    (i = new O("typeof " + i.compile(e) + ' === "function"')),
                    new E(i, new Z(o), { soak: !0 })
                  );
                }
                (n = this), (s = []);
                for (;;) {
                ...
                for (u = 0, a = l.length; u < a; u++)
                  (n = l[u]),
                    r && (n.variable instanceof t ? (n.variable = r) : (n.variable.base = r)),
                    (r = bt(e, n, "variable"));
                return r;
              }),
              (t.prototype.compileNode = function (e) {
                ...
                (r = []), (l = this.args);
                for (n = u = 0, a = l.length; u < a; n = ++u)
                  (t = l[n]), n && r.push(this.makeCode(", ")), r.push.apply(r, t.compileToFragments(e, C));
                return (
                  (s = []),
                  this.isSuper
                    ? ((o = this.superReference(e) + (".call(" + this.superThis(e))),
                      r.length && (o += ", "),
              ...
              (t.prototype.compileSplat = function (e, t) {
                ...
                return this.isSuper
                  ? [].concat(
                      this.makeCode("" + this.superReference(e) + ".apply(" + this.superThis(e) + ", "),
                      t,
                      this.makeCode(")")
                    )
                  : this.isNew
                  ...
                  : ((n = []),
                    ...
                    (o = r.properties.pop()) && r.isComplex()
                      ...
                      : ((i = r.compileToFragments(e, T)),
                        U.test(at(i)) && (i = this.wrapInBraces(i)),
                        o ? ((u = at(i)), i.push.apply(i, o.compileToFragments(e))) : (u = "null"),
                        (n = n.concat(i))),
                    (n = n.concat(this.makeCode(".apply(" + u + ", "), t, this.makeCode(")"))));
              }),
              t
            );
          })(o)),
            ...
            return (
              ...
              (t.prototype.compileVariables = function (e) {
                ...
                (e = pt(e, { top: !0 })),
                  ...
                  (this.fromC = n[0]),
                  (this.fromVar = n[1]),
                  (r = this.cacheToCodeFragments(this.to.cache(e, C))),
                  (this.toC = r[0]),
                  (this.toVar = r[1]);
                if ((t = it(e, "step")))
                  (i = this.cacheToCodeFragments(t.cache(e, C))), (this.step = i[0]), (this.stepVar = i[1]);
                ...
                return (
                  ...
                  e.index
                    ? ((u = this.fromNum && this.toNum),
                      ...
                      (f = o && o !== s),
                      (h = "" + s + " = " + this.fromC),
                      this.toC !== this.toVar && (h += ", " + this.toC),
                      this.step !== this.stepVar && (h += ", " + this.step),
                      (p = ["" + s + " <" + this.equals, "" + s + " >" + this.equals]),
                      (a = p[0]),
                      (i = p[1]),
                      (n = this.stepNum
                        ? vt(this.stepNum[0]) > 0
                          ...
                          : "" + i + " " + this.toVar
                        : u
                        ? ((d = [vt(this.fromNum[0]), vt(this.toNum[0])]),
                          (r = d[0]),
                          (c = d[1]),
                          d,
                          r <= c ? "" + a + " " + c : "" + i + " " + c)
                        : ((t = this.stepVar ? "" + this.stepVar + " > 0" : "" + this.fromVar + " <= " + this.toVar),
                          "" + t + " ? " + a + " " + this.toVar + " : " + i + " " + this.toVar)),
                      (l = this.stepVar
                        ? "" + s + " += " + this.stepVar
                        : u
                        ? f
              ...
              (t.prototype.compileArray = function (e) {
                ...
                if (this.fromNum && this.toNum && Math.abs(this.fromNum - this.toNum) <= 20)
                  return (
                    (f = function () {
                      v = [];
                      for (var e = (p = +this.fromNum), t = +this.toNum; p <= t ? e <= t : e >= t; p <= t ? e++ : e--)
                        v.push(e);
                      return v;
                    }.apply(this)),
                ...
                (o = this.tab + J),
                  ...
                  this.fromNum && this.toNum
                    ...
                    : ((c = "" + s + " = " + this.fromC + (this.toC !== this.toVar ? ", " + this.toC : "")),
            ...
            return (
              ...
              (t.prototype.compileNode = function (e) {
                ...
                (u = this.range),
                  (s = u.to),
                  (r = u.from),
                  (i = (r && r.compileToFragments(e, L)) || [this.makeCode("0")]);
                if (s) {
                  (t = s.compileToFragments(e, L)), (n = at(t));
                  if (!!this.range.exclusive || +n !== -1)
                    o =
                      ", " +
                      (this.range.exclusive
                        ...
                        : U.test(n)
                        ? "" + (+n + 1)
                        : ((t = s.compileToFragments(e, T)), "+" + at(t) + " + 1 || 9e9"));
                }
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.compileNode = function (e) {
                ...
                for (n = p = 0, v = l.length; p < v; n = ++p)
                  (f = l[n]),
                    (o = n === l.length - 1 ? "" : f === u || f instanceof h ? "\n" : ",\n"),
                    (i = f instanceof h ? "" : r),
                    f instanceof s &&
                      f.variable instanceof Z &&
                      f.variable.hasProperties() &&
                      f.variable.error("Invalid object key"),
                    f instanceof Z && f["this"] && (f = new s(f.properties[0].name, f, "object")),
                    f instanceof h ||
                      (f instanceof s || (f = new s(f, f, "object")), ((f.variable.base || f.variable).asKey = !0)),
                    i && t.push(this.makeCode(i)),
                    t.push.apply(t, f.compileToFragments(e, A)),
                    o && t.push(this.makeCode(o));
                return (
                  t.unshift(this.makeCode("{" + (l.length && "\n"))),
        ...
        (t.Class = f =
          (function (e) {
            function t(e, t, n) {
              (this.variable = e),
                (this.parent = t),
                (this.body = n != null ? n : new u()),
                (this.boundFuncs = []),
                (this.body.classBody = !0);
            }
            return (
              Tt(t, e),
              (t.prototype.children = ["variable", "parent", "body"]),
              (t.prototype.determineName = function () {
                var e, t;
                return this.variable
                  ? ((e = (t = ct(this.variable.properties))
                      ? t instanceof r && t.name.value
                      : this.variable.base.value),
                    Nt.call(z, e) >= 0 && this.variable.error("class variable name may not be " + e),
                    e && (e = g.test(e) && e))
                  : null;
              }),
              ...
              (t.prototype.addBoundFunctions = function (e) {
                ...
                for (i = 0, s = o.length; i < s; i++)
                  (t = o[i]),
                    (n = new Z(new O("this"), [new r(t)]).compile(e)),
                    this.ctor.body.unshift(new O("" + n + " = " + wt("bind") + "(" + n + ", this)"));
              }),
              (t.prototype.addProperties = function (e, t, n) {
                var i, o, u, a, f;
                return (
                  (f = e.base.properties.slice(0)),
                  (u = function () {
                    var e;
                    e = [];
                    while ((i = f.shift()))
                      i instanceof s &&
                        ...
                        (a = i.value),
                        o.value === "constructor"
                          ? (this.ctor && i.error("cannot define more than one constructor in a class"),
                            a.bound && i.error("cannot define a constructor as a bound function"),
                            a instanceof l
                              ? (i = this.ctor = a)
                              : ((this.externalCtor = n.classScope.freeVariable("class")),
                                (i = new s(new O(this.externalCtor), a))))
                          : i.variable["this"]
                          ? (a["static"] = !0)
                          : ((i.variable = new Z(new O(t), [new r(new O("prototype")), new r(o)])),
                            a instanceof l && a.bound && (this.boundFuncs.push(o), (a.bound = !1)))),
                        e.push(i);
                    return e;
                  }.call(this)),
                  rt(u)
                ...
                return this.traverseChildren(
                  ...
                  (function (r) {
                    return function (i) {
                      ...
                      if (i instanceof u) {
                        p = a = i.expressions;
                        for (f = c = 0, h = p.length; c < h; f = ++c)
                          (l = p[f]),
                            l instanceof s && l.variable.looksStatic(e)
                              ? (l.value["static"] = !0)
                              : l instanceof Z && l.isObject(!0) && ((o = !1), (a[f] = r.addProperties(l, e, n)));
              ...
              (t.prototype.ensureConstructor = function (e) {
                return (
                  this.ctor ||
                    ((this.ctor = new l()),
                    this.externalCtor
                      ? this.ctor.body.push(new O("" + this.externalCtor + ".apply(this, arguments)"))
                      : this.parent &&
                        this.ctor.body.push(new O("" + e + ".__super__.constructor.apply(this, arguments)")),
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  (i = this.body.jumps()) && i.error("Class bodies cannot contain pure statements"),
                  (n = this.body.contains(ft)) && n.error("Class bodies shouldn't reference arguments"),
                  (c = this.determineName() || "_Class"),
                  c.reserved && (c = "_" + c),
                  (f = new O(c)),
                  (r = new l([], u.wrap([this.body]))),
                  (t = []),
                  ...
                  this.parent &&
                    ((h = new O(e.classScope.freeVariable("super", !1))),
                    this.body.expressions.unshift(new d(f, h)),
                    r.params.push(new j(h)),
                    t.push(this.parent)),
                  (p = this.body.expressions).unshift.apply(p, this.directives),
                  (o = new F(new a(r, t))),
                  this.variable && (o = new s(this.variable, o)),
                  o.compileToFragments(e)
                );
              }),
              t
          ...
          (function (e) {
            function t(e, t, n, r) {
              ...
              (this.variable = e),
                ...
                (i = ((o = s = this.variable.unwrapAll().value), Nt.call(z, o) >= 0)),
                i && this.context !== "object" && this.variable.error('variable name may not be "' + s + '"');
            }
            return (
              Tt(t, e),
              (t.prototype.children = ["variable", "value"]),
              (t.prototype.isStatement = function (e) {
              ...
              (t.prototype.compileNode = function (e) {
                ...
                if (!this.context) {
                  (u = this.variable.unwrapAll()),
                    u.isAssignable() || this.variable.error('"' + this.variable.compile(e) + '" cannot be assigned');
                  if (typeof u.hasProperties == "function" ? !u.hasProperties() : !void 0)
                    this.param ? e.scope.add(s, "var") : e.scope.find(s);
                }
                return (
                  this.value instanceof l &&
                    (i = M.exec(s)) &&
                    (i[2] && (this.value.klass = i[1]),
                    (this.value.name = (f = (c = i[3]) != null ? c : i[4]) != null ? f : i[5])),
                  (o = this.value.compileToFragments(e, C)),
                  this.context === "object"
                    ? n.concat(this.makeCode(": "), o)
                    : ((t = n.concat(this.makeCode(" " + (this.context || "=") + " "), o)),
                      e.level <= C ? t : this.wrapInBraces(t))
                );
              }),
              (t.prototype.compilePatternMatch = function (e) {
                ...
                if (!b || d !== 1 || (h = p[0]) instanceof V) {
                  ...
                  if (!g.test(T) || this.variable.assigns(T))
                    i.push([this.makeCode("" + (v = e.scope.freeVariable("ref")) + " = ")].concat(Ct.call(S))),
                      (S = [this.makeCode(v)]),
                      (T = v);
                  for (u = N = 0, L = p.length; N < L; u = ++N)
                    (h = p[u]),
                      ...
                      f &&
                        (h instanceof t
                          ? ((P = h), (H = P.variable), (a = H.base), (h = P.value))
                          : h.base instanceof F
                          ? ((B = new Z(h.unwrapAll()).cacheReference(e)), (h = B[0]), (a = B[1]))
                          : (a = h["this"] ? h.properties[0].name : h)),
                      !y && h instanceof V
                        ? ((c = h.name.unwrap().value),
                          (h = h.unwrap()),
                          (w = "" + d + " <= " + T + ".length ? " + wt("slice") + ".call(" + T + ", " + u),
                          (m = d - u - 1)
                            ? ((l = e.scope.freeVariable("i")),
                              (w += ", " + l + " = " + T + ".length - " + m + ") : (" + l + " = " + u + ", [])"))
                            : (w += ") : []"),
                          (w = new O(w)),
                          (y = "" + l + "++"))
                        : ((c = h.unwrap().value),
                          h instanceof V && h.error("multiple splats are disallowed in an assignment"),
                          typeof a == "number"
                            ? ((a = new O(y || a)), (n = !1))
                            : (n = f && g.test(a.unwrap().value || 0)),
                          (w = new Z(new O(T), [new (n ? r : x)(a)]))),
                      c != null && Nt.call(I, c) >= 0 && h.error("assignment to a reserved word: " + h.compile(e)),
                      i.push(new t(h, w, null, { param: this.param, subpattern: !0 }).compileToFragments(e, C));
                  return (
                    !b && !this.subpattern && i.push(S),
                    (o = this.joinFragmentArrays(i, ", ")),
                    e.level < C ? o : this.wrapInBraces(o)
                  );
                }
                return (
                  h instanceof t
                    ? ((M = h), (_ = M.variable), (a = _.base), (h = M.value))
                    : (a = f ? (h["this"] ? h.properties[0].name : h) : new O(0)),
                  (n = g.test(a.unwrap().value || 0)),
                  (E = new Z(E)),
                  E.properties.push(new (n ? r : x)(a)),
                  ((D = h.unwrap().value), Nt.call(I, D) >= 0) &&
                    h.error("assignment to a reserved word: " + h.compile(e)),
                  new t(h, E, null, { param: this.param }).compileToFragments(e, A)
                );
              }),
              (t.prototype.compileConditional = function (e) {
                ...
                return (
                  ...
                  Nt.call(this.context, "?") >= 0
                    ? ((e.isExistentialEquals = !0),
                      new E(new p(r), i, { type: "if" }).addElse(new t(i, this.value, "=")).compileToFragments(e))
                    : ((n = new B(this.context.slice(0, -1), r, new t(i, this.value, "=")).compileToFragments(e)),
                      e.level <= C ? n : this.wrapInBraces(n))
                );
              }),
              (t.prototype.compileSplice = function (e) {
                ...
                return (
                  ...
                  r ? ((c = this.cacheToCodeFragments(r.cache(e, k))), (i = c[0]), (s = c[1])) : (i = s = "0"),
                  u
                    ? r instanceof Z && r.isSimpleNumber() && u instanceof Z && u.isSimpleNumber()
                      ? ((u = u.compile(e) - s), n || (u += 1))
                      : ((u = u.compile(e, T) + " - " + s), n || (u += " + 1"))
                    : (u = "9e9"),
                  (h = this.value.cache(e, C)),
                  (a = h[0]),
                  (f = h[1]),
                  (t = [].concat(
                    this.makeCode("[].splice.apply(" + o + ", [" + i + ", " + u + "].concat("),
                    a,
                    this.makeCode(")), "),
                    f
                  )),
                  e.level > A ? this.wrapInBraces(t) : t
                );
              }),
              t
            );
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.compileNode = function (e) {
                ...
                this.bound &&
                  ((F = e.scope.method) != null ? F.bound : void 0) &&
                  (this.context = e.scope.method.context);
                if (this.bound && !this.context)
                  return (
                    (this.context = "_this"),
                    (w = new t([new j(new O(this.context))], new u([this]))),
                    (r = new a(w, [new O("this")])),
                    r.updateLocationDataIfMissing(this.locationData),
                    r.compileNode(e)
                  );
                ...
                for (x = 0, L = q.length; x < L; x++) {
                  ...
                  for (N = 0, A = R.length; N < A; N++)
                    (h = R[N].name),
                      h["this"] && (h = h.properties[0].name),
                      h.value && e.scope.add(h.value, "var", !0);
                  m = new s(
                    new Z(
                      new i(
                        function () {
                ...
                for (C = 0, M = U.length; C < M; C++)
                  (p = U[C]),
                    p.isComplex()
                      ? ((y = v = p.asReference(e)),
                        p.value && (y = new B("?", v, p.value)),
                        f.push(new s(new Z(p.name), y, "=", { param: !0 })))
                      : ((v = p),
                        p.value &&
                          ((c = new O(v.name.value + " == null")),
                          (y = new s(new Z(p.name), p.value, "=")),
                          f.push(new E(c, y)))),
                    m || d.push(v);
                (b = this.body.isEmpty()),
                  m && f.unshift(m),
                  f.length && (z = this.body.expressions).unshift.apply(z, f);
                for (l = P = 0, _ = d.length; P < _; l = ++P)
                ...
                (g = []),
                  ...
                  !b && !this.noReturn && this.body.makeReturn(),
                  (o = "function"),
                  this.ctor && (o += " " + this.name),
                  (o += "("),
                  (n = [this.makeCode(o)]);
                for (l = H = 0, D = d.length; H < D; l = ++H)
                ...
                return (
                  ...
                  n.push(this.makeCode("}")),
                  this.ctor
                    ? [this.makeCode(this.tab)].concat(Ct.call(n))
          ...
          (function (e) {
            function t(e, t, n) {
              ...
              (this.name = e),
                (this.value = t),
                (this.splat = n),
                ((r = e = this.name.unwrapAll().value), Nt.call(z, r) >= 0) &&
                  this.name.error('parameter name "' + e + '" is not allowed');
            }
            return (
              Tt(t, e),
              ...
              (t.prototype.asReference = function (e) {
                ...
                return this.reference
                  ...
                  : ((t = this.name),
                    t["this"]
                      ? ((t = t.properties[0].name), t.value.reserved && (t = new O(e.scope.freeVariable(t.value))))
                      : t.isComplex() && (t = new O(e.scope.freeVariable("arg"))),
                    (t = new Z(t)),
                    this.splat && (t = new V(t)),
              ...
              (t.prototype.eachName = function (e, t) {
                ...
                for (o = 0, u = a.length; o < u; o++)
                  (i = a[o]),
                    i instanceof s
                      ? this.eachName(e, i.value.unwrap())
                      : i instanceof V
                      ? ((r = i.name.unwrap()), e(r.value, r))
                      : i instanceof Z
                      ? i.isArray() || i.isObject()
                        ? this.eachName(e, i.base)
                        : i["this"]
                        ? n(i)
                        : e(i.base.value, i.base)
            ...
            return (
              ...
              (t.compileSplattedArray = function (e, n, r) {
                ...
                if (n.length === 1)
                  return (
                    (c = n[0]),
                    (a = c.compileToFragments(e, C)),
                    r ? a : [].concat(c.makeCode("" + wt("slice") + ".call("), a, c.makeCode(")"))
                  );
                i = n.slice(l);
                for (f = h = 0, p = i.length; h < p; f = ++h)
                  (c = i[f]),
                    (o = c.compileToFragments(e, C)),
                    (i[f] =
                      c instanceof t
                        ? [].concat(c.makeCode("" + wt("slice") + ".call("), o, c.makeCode(")"))
                        : [].concat(c.makeCode("["), o, c.makeCode("]")));
                return l === 0
                  ? ((c = n[0]),
                    (u = c.joinFragmentArrays(i.slice(1), ", ")),
                    i[0].concat(c.makeCode(".concat("), u, c.makeCode(")")))
                  : ((s = (function () {
                      var t, r, i, s;
                      (i = n.slice(0, l)), (s = []);
                    ...
                    [].concat(n[0].makeCode("["), s, n[l].makeCode("].concat("), u, ct(n).makeCode(")")));
              }),
              t
            );
          })(o)),
        (t.While = et =
          (function (e) {
            function t(e, t) {
              (this.condition = (t != null ? t.invert : void 0) ? e.invert() : e),
                (this.guard = t != null ? t.guard : void 0);
            }
            return (
              Tt(t, e),
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  ...
                  n.isEmpty()
                    ? (n = this.makeCode(""))
                    : (this.returns &&
                        (n.makeReturn((r = e.scope.freeVariable("results"))), (i = "" + this.tab + r + " = [];\n")),
                      this.guard &&
                        (n.expressions.length > 1
                          ? n.expressions.unshift(new E(new F(this.guard).invert(), new O("continue")))
                          : this.guard && (n = u.wrap([new E(this.guard, n)]))),
                      (n = [].concat(this.makeCode("\n"), n.compileToFragments(e, A), this.makeCode("\n" + this.tab)))),
                  (t = [].concat(
                    this.makeCode(i + this.tab + "while ("),
                    this.condition.compileToFragments(e, L),
                    this.makeCode(") {"),
                    n,
                    this.makeCode("}")
                  )),
        ...
        (t.Op = B =
          (function (e) {
            ...
            return (
              ...
              (n = { "==": "===", "!=": "!==", of: "in" }),
              (r = { "!==": "===", "===": "!==" }),
              (t.prototype.children = ["first", "second"]),
              (t.prototype.isSimpleNumber = D),
              ...
              (t.prototype.invert = function () {
                ...
                return (s = r[this.operator])
                  ? ((this.operator = s), this.first.unwrap() instanceof t && this.first.invert(), this)
                  : this.second
                  ? new F(this).invert()
                  : this.operator === "!" &&
                    (i = this.first.unwrap()) instanceof t &&
                    ((o = i.operator) === "!" || o === "in" || o === "instanceof")
                  ? i
                  : new t("!", this);
              }),
              (t.prototype.unfoldSoak = function (e) {
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  ...
                  ((r = this.operator) === "--" || r === "++") &&
                    ((i = this.first.unwrapAll().value), Nt.call(z, i) >= 0) &&
                  ...
                  this.isUnary()
                    ...
                    ? this.compileChain(e)
                    : this.operator === "?"
                    ? this.compileExistence(e)
                    : ((t = [].concat(
                        this.first.compileToFragments(e, k),
                        this.makeCode(" " + this.operator + " "),
                        this.second.compileToFragments(e, k)
                      )),
                      e.level <= k ? t : this.wrapInBraces(t))
                );
              }),
              (t.prototype.compileChain = function (e) {
                ...
                return (
                  ...
                  (r = i[1]),
                  (n = this.first.compileToFragments(e, k)),
                  (t = n.concat(
              ...
              (t.prototype.compileExistence = function (e) {
                ...
                return (
                  this.first.isComplex()
                    ? ((n = new O(e.scope.freeVariable("ref"))), (t = new F(new s(n, this.first))))
                    : ((t = this.first), (n = t)),
                  new E(new p(t), n, { type: "if" }).addElse(this.second).compileToFragments(e)
                );
              }),
              (t.prototype.compileUnary = function (e) {
                var n, r, i;
                (r = []), (n = this.operator), r.push([this.makeCode(n)]);
                if (n === "!" && this.first instanceof p)
                  return (this.first.negated = !this.first.negated), this.first.compileToFragments(e);
                ...
                if ((i && this.first instanceof t) || (n === "new" && this.first.isStatement(e)))
                  this.first = new F(this.first);
                return (
                  r.push(this.first.compileToFragments(e, k)), this.flip && r.reverse(), this.joinFragmentArrays(r, "")
                );
              }),
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.compileOrTest = function (e) {
                ...
                for (r = a = 0, f = h.length; a < f; r = ++a)
                  (i = h[r]),
                    r && u.push(this.makeCode(n)),
                    (u = u.concat(r ? s : o, this.makeCode(t), i.compileToFragments(e, T)));
                return e.level < k ? u : this.wrapInBraces(u);
              }),
              (t.prototype.compileLoopTest = function (e) {
                var t, n, r, i;
                return (
                  (i = this.object.cache(e, C)),
                  (r = i[0]),
                  (n = i[1]),
                  (t = [].concat(
                    this.makeCode(wt("indexOf") + ".call("),
                    this.array.compileToFragments(e, C),
                    this.makeCode(", "),
                    n,
                    this.makeCode(") " + (this.negated ? "< 0" : ">= 0"))
                  )),
                  at(r) === at(n) ? t : ((t = r.concat(this.makeCode(", "), t)), e.level < C ? t : this.wrapInBraces(t))
                );
              }),
              (t.prototype.toString = function (e) {
        ...
        (t.Try = G =
          (function (e) {
            ...
            return (
              ...
              (t.prototype.makeReturn = function (e) {
                return (
                  this.attempt && (this.attempt = this.attempt.makeReturn(e)),
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  (e.indent += J),
                  (i = this.attempt.compileToFragments(e, A)),
                  (t = this.recovery
                    ? ((r = new O("_error")),
                      this.errorVariable ? this.recovery.unshift(new s(this.errorVariable, r)) : void 0,
                      [].concat(
                        this.makeCode(" catch ("),
                        r.compileToFragments(e),
                        this.makeCode(") {\n"),
                        this.recovery.compileToFragments(e, A),
                        this.makeCode("\n" + this.tab + "}")
                      ))
                  ...
                  (n = this.ensure
                    ? [].concat(
                        ...
                        this.ensure.compileToFragments(e, A),
                        this.makeCode("\n" + this.tab + "}")
                      )
                    : []),
            ...
            return (
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  ...
                  (r = this.expression.compile(e, k)),
                  g.test(r) && !e.scope.check(r)
                    ? ((i = this.negated ? ["===", "||"] : ["!==", "&&"]),
                      (t = i[0]),
                      (n = i[1]),
                      (r = "typeof " + r + " " + t + ' "undefined" ' + n + " " + r + " " + t + " null"))
                    : (r = "" + r + " " + (this.negated ? "==" : "!=") + " null"),
                  [this.makeCode(e.level <= N ? r : "(" + r + ")")]
                );
              }),
              t
            );
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  ...
                  n instanceof Z && n.isAtomic()
                    ...
                    : ((r = n.compileToFragments(e, L)),
                      (t = e.level < k && (n instanceof B || n instanceof a || (n instanceof v && n.returns))),
          ...
          (function (e) {
            function t(e, t) {
              ...
              (this.source = t.source),
                ...
                (this.range =
                  this.source instanceof Z && this.source.base instanceof q && !this.source.properties.length),
            ...
            return (
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  (t = u.wrap([this.body])),
                  (S = (z = ct(t.expressions)) != null ? z.jumps() : void 0),
                  S && S instanceof R && (this.returns = !1),
                  (H = this.range ? this.source.base : this.source),
                  (D = e.scope),
                  (T = this.name && this.name.compile(e, C)),
                  (m = this.index && this.index.compile(e, C)),
                  T && !this.pattern && D.find(T),
                  m && D.find(m),
                  this.returns && (_ = D.freeVariable("results")),
                  (y = (this.object && m) || D.freeVariable("i")),
                  (b = (this.range && T) || m || y),
                  (w = b !== y ? "" + b + " = " : ""),
                  this.step &&
                    !this.range &&
                    ((W = this.cacheToCodeFragments(this.step.cache(e, C))), (B = W[0]), (I = W[1]), (j = I.match(P))),
                  this.pattern && (T = y),
                  (U = ""),
                  (p = ""),
                  (f = ""),
                  (d = this.tab + J),
                  this.range
                    ? (h = H.compileToFragments(pt(e, { index: y, name: T, step: this.step })))
                    : ((q = this.source.compile(e, C)),
                      (T || this.own) &&
                        !g.test(q) &&
                        ((f += "" + this.tab + (k = D.freeVariable("ref")) + " = " + q + ";\n"), (q = k)),
                      T && !this.pattern && (N = "" + T + " = " + q + "[" + b + "]"),
                      this.object ||
                        (B !== I && (f += "" + this.tab + B + ";\n"),
                        (this.step && j && (c = vt(j[0]) < 0)) || (x = D.freeVariable("len")),
                        (o = "" + w + y + " = 0, " + x + " = " + q + ".length"),
                        (a = "" + w + y + " = " + q + ".length - 1"),
                        (r = "" + y + " < " + x),
                        (i = "" + y + " >= 0"),
                  ...
                  this.guard &&
                    (t.expressions.length > 1
                      ? t.expressions.unshift(new E(new F(this.guard).invert(), new O("continue")))
                      : this.guard && (t = u.wrap([new E(this.guard, t)]))),
                  this.pattern && t.expressions.unshift(new s(this.name, new O("" + q + "[" + b + "]"))),
                  (l = [].concat(this.makeCode(f), this.pluckDirectCall(e, t))),
                  N && (U = "\n" + d + N + ";"),
                  this.object &&
                    ((h = [this.makeCode("" + b + " in " + q)]),
                    this.own && (p = "\n" + d + "if (!" + wt("hasProp") + ".call(" + q + ", " + b + ")) continue;")),
                  (n = t.compileToFragments(pt(e, { indent: d }), A)),
                  n && n.length > 0 && (n = [].concat(this.makeCode("\n"), n, this.makeCode("\n"))),
                  [].concat(
                    l,
                    this.makeCode("" + (L || "") + this.tab + "for ("),
                    h,
                    this.makeCode(") {" + p + U),
                    n,
                    this.makeCode("" + this.tab + "}" + (M || ""))
                  )
                );
              }),
                ...
                for (u = h = 0, p = d.length; h < p; u = ++h) {
                  ...
                  if (
                    !(
                      c instanceof l ||
                      (c instanceof Z &&
                        ((m = c.base) != null ? m.unwrapAll() : void 0) instanceof l &&
                        c.properties.length === 1 &&
                        ((g = (y = c.properties[0].name) != null ? y.value : void 0) === "call" || g === "apply"))
                    )
                  )
                    continue;
                  (o = ((b = c.base) != null ? b.unwrapAll() : void 0) || c),
                    (f = new O(e.scope.freeVariable("fn"))),
                    (n = new Z(f)),
                    c.base && ((w = [n, c]), (c.base = w[0]), (n = w[1])),
                    (t.expressions[u] = new a(n, i.args)),
                    (r = r.concat(this.makeCode(this.tab), new s(f, o).compileToFragments(e, A), this.makeCode(";\n")));
                }
                return r;
              }),
              t
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.makeReturn = function (e) {
                ...
                return (
                  e && (this.otherwise || (this.otherwise = new u([new O("void 0")]))),
                  (s = this.otherwise) != null && s.makeReturn(e),
                  this
                );
              }),
              (t.prototype.compileNode = function (e) {
                ...
                (a = e.indent + J),
                  ...
                  (o = [].concat(
                    ...
                    this.subject ? this.subject.compileToFragments(e, L) : this.makeCode("false"),
                    this.makeCode(") {\n")
                  )),
                  (d = this.cases);
                for (u = l = 0, h = d.length; l < h; u = ++l) {
                  ...
                  for (c = 0, p = m.length; c < p; c++)
                    (r = m[c]),
                      ...
                      (o = o.concat(this.makeCode(a + "case "), r.compileToFragments(e, L), this.makeCode(":\n")));
                ...
                return (
                  this.otherwise &&
                    ...
                    o.push.apply(
                      o,
                      [this.makeCode(a + "default:\n")].concat(Ct.call(this.otherwise.compileToFragments(e, A)), [
                        this.makeCode("\n"),
                      ])
                    ),
        ...
        (t.If = E =
          (function (e) {
            function t(e, t, n) {
              (this.body = t),
                n == null && (n = {}),
                (this.condition = n.type === "unless" ? e.invert() : e),
                (this.elseBody = null),
                (this.isChain = !1),
                (this.soak = n.soak);
            }
            return (
              ...
              (t.prototype.isStatement = function (e) {
                var t;
                return (
                  (e != null ? e.level : void 0) === A ||
                  this.bodyNode().isStatement(e) ||
                  ((t = this.elseBodyNode()) != null ? t.isStatement(e) : void 0)
                );
              }),
              (t.prototype.jumps = function (e) {
                var t;
              ...
              (t.prototype.makeReturn = function (e) {
                return (
                  e && (this.elseBody || (this.elseBody = new u([new O("void 0")]))),
                  this.body && (this.body = new u([this.body.makeReturn(e)])),
                  this.elseBody && (this.elseBody = new u([this.elseBody.makeReturn(e)])),
                  this
                );
              }),
              ...
              (t.prototype.compileStatement = function (e) {
                ...
                return (
                  ...
                  o
                    ? new t(this.condition.invert(), this.elseBodyNode(), { type: "if" }).compileToFragments(e)
                    : ((a = e.indent + J),
                      (s = this.condition.compileToFragments(e, L)),
                      (r = this.ensureBlock(this.body).compileToFragments(pt(e, { indent: a }))),
                      (u = [].concat(
                        this.makeCode("if ("),
                        s,
                        this.makeCode(") {\n"),
                      ...
                      this.elseBody
                        ? ((n = u.concat(this.makeCode(" else "))),
                          this.isChain
                            ? ((e.chainChild = !0), (n = n.concat(this.elseBody.unwrap().compileToFragments(e, A))))
                            : (n = n.concat(
                                this.makeCode("{\n"),
                                this.elseBody.compileToFragments(pt(e, { indent: a }), A),
                                this.makeCode("\n" + this.tab + "}")
                              )),
                          n)
                        : u)
        ...
        (lt = function (e) {
          return (
            (e instanceof O && e.value === "this" && !e.asKey) ||
            (e instanceof l && e.bound) ||
            (e instanceof a && e.isSuper)
          );
        }),
        (bt = function (e, t, n) {
          var r;
          ...
          return (
            ...
            (e.prototype.add = function (e, t, n) {
              return this.shared && !n
                ...
                : (this.positions[e] = this.variables.push({ name: e, type: t }) - 1);
            }),
            (e.prototype.namedMethod = function () {
              var e;
              return ((e = this.method) != null ? e.name : void 0) || !this.parent
                ? this.method
            ...
            (e.prototype.temporary = function (e, t) {
              return e.length > 1
                ? "_" + e + (t > 1 ? t - 1 : "")
                : "_" + (t + parseInt(e, 36)).toString(36).replace(/\d/g, "a");
            }),

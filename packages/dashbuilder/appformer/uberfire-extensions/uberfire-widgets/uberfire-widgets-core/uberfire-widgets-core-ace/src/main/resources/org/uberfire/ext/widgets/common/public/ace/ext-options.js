define("ace/ext/options", ["require", "exports", "module"], function (e, t, n) {
  function u(e, t) {
    ...
    localStorage && localStorage.getItem(e) && (n.checked = localStorage.getItem(e) == "1");
    var r = function () {
  ...
  function a(e, t) {
    var n = document.getElementById(e);
    localStorage && localStorage.getItem(e) && (n.value = localStorage.getItem(e));
    var r = function () {
  ...
  var r = modelist.modesByName,
    i = [
      [
        ...
        function (e) {
          doclist.loadDoc(e, function (e) {
            if (!e) return;
            (e = env.split.setSession(e)), updateUIEditorOptions(), env.editor.focus();
          });
        },
        doclist.all,
      ],
      [
        "Mode",
        function (e) {
          env.editor.session.setMode(r[e].mode || r.text.mode), (env.editor.session.modeName = e);
        },
        function (e) {
      ...
      [
        ...
        function (e) {
          var t = env.split;
          if (e == "none") t.getSplits() == 2 && (env.secondSession = t.getEditor(1).session), t.setSplits(1);
          else {
            var n = t.getSplits() == 1;
            e == "below" ? t.setOrientation(t.BELOW) : t.setOrientation(t.BESIDE), t.setSplits(2);
            if (n) {
      ...
      [
        "Code Folding",
        function (e) {
          env.editor.getSession().setFoldStyle(e), env.editor.setShowFoldWidgets(e !== "manual");
        },

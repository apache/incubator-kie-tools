define(
  ...
  function (e, t, n) {
    var r = e("../lib/oop"),
      ...
      a = e("./curly_highlight_rules").CurlyHighlightRules,
      f = function () {
        ...
        (this.getFoldWidget = function (e, t, n) {
          ...
          (this._pop = function (e, t) {
            while (e.length) {
              ...
              if (this.voidElements.hasOwnProperty(t.tagName)) return;
  ...
  define(
    ...
    function (e, t, n) {
      var r = e("../lib/oop"),
        ...
        s = function () {
          i.call(this),
            this.$rules.start.unshift({ token: "variable", regex: "{{", push: "curly-start" }),
            (this.$rules["curly-start"] = [{ token: "variable", regex: "}}", next: "pop" }]),
            this.normalizeRules();
        };

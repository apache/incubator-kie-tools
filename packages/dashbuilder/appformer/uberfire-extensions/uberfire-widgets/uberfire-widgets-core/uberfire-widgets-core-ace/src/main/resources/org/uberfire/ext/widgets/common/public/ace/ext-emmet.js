  ...
  function (e, t, n) {
      ...
      (a.prototype = {
        setupContext: function (e) {
          (this.ace = e),
            ...
            u || (u = window.emmet),
            u.require("resources").setVariable("indentation", this.indentation),
            (this.$syntax = null),
        ...
        replaceContent: function (e, t, n, r) {
          ...
          var i = this.ace,
            u = o.fromPoints(i.indexToPosition(t), i.indexToPosition(n));
        ...
        $updateTabstops: function (e) {
          ...
          return (
            (e = s.processText(e, a)),
            o.variables.insert_final_tabstop && !/\$\{0\}$/.test(e)
              ? (e += "${0}")
              : r && (e = u.require("utils").replaceSubstring(e, "${0}", r)),
            e
          );
        },
      });
    ...
    var h = function (e, n) {
      ...
      var i = r.session.$modeId,
        s = i && /css|less|scss|sass|stylus|html|php/.test(i);
      e.enableEmmet === !1 && (s = !1),
        s ? r.keyBinding.addKeyboardHandler(t.commands) : r.keyBinding.removeKeyboardHandler(t.commands);
    };
    (t.AceEmmetEditor = a),

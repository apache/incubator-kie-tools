  ...
  define("ace/mode/css/csslint", ["require", "exports", "module"], function (require, exports, module) {
          ...
          read: function () {
            ...
            return (
              this._cursor < this._input.length &&
                (this._input.charAt(this._cursor) == "\n" ? (this._line++, (this._col = 1)) : this._col++,
          ...
          mustMatch: function (e, t) {
            ...
            if (!this.match.apply(this, arguments))
              throw (
                ((r = this.LT(1)),
                new n(
                  "Expected " + this._tokenData[e[0]].name + " at line " + r.startLine + ", col " + r.startCol + ".",
                  r.startLine,
                  r.startCol
                ))
              );
      ...
      (function () {
        ...
        function PropertyValuePart(text, line, col) {
          ...
          if (/^([+\-]?[\d\.]+)([a-z]+)$/i.test(text)) {
            ...
            /^([+\-]?[\d\.]+)%$/i.test(text)
              ...
              ? ((this.type = "color"), (this.red = +RegExp.$1), (this.green = +RegExp.$2), (this.blue = +RegExp.$3))
              : /^rgb\(\s*(\d+)%\s*,\s*(\d+)%\s*,\s*(\d+)%\s*\)/i.test(text)
              ? ((this.type = "color"),
              ...
              n = {
                            ...
                            switch (i) {
                              case Tokens.CHARSET_SYM:
                                throw (
                                  ((r = e.LT(1)),
                                  this._charset(!1),
                                  new SyntaxError("@charset not allowed here.", r.startLine, r.startCol))
                                );
                              case Tokens.IMPORT_SYM:
                                throw (
                                  ((r = e.LT(1)),
                                  this._import(!1),
                                  new SyntaxError("@import not allowed here.", r.startLine, r.startCol))
                                );
                              case Tokens.NAMESPACE_SYM:
                                throw (
                                  ((r = e.LT(1)),
                                  this._namespace(!1),
                                  new SyntaxError("@namespace not allowed here.", r.startLine, r.startCol))
                                );
                              default:
                ...
                _import: function (e) {
                  ...
                  t.mustMatch(Tokens.IMPORT_SYM),
                    ...
                    t.mustMatch(Tokens.SEMICOLON),
                    this._readWhitespace(),
                    e !== !1 && this.fire({ type: "import", uri: r, media: s, line: i.startLine, col: i.startCol });
                },
                ...
                _media_query: function () {
                  ...
                  e.match(Tokens.IDENT) &&
                    ...
                    e.peek() == Tokens.IDENT
                      ...
                      : e.peek() == Tokens.LPAREN && (r === null && (r = e.LT(1)), i.push(this._media_expression()));
                ...
                _media_expression: function () {
                  ...
                  return (
                    ...
                    this._readWhitespace(),
                    e.match(Tokens.COLON) && (this._readWhitespace(), (n = e.LT(1)), (r = this._expression())),
                ...
                _page: function () {
                  ...
                  e.mustMatch(Tokens.PAGE_SYM),
                    ...
                    this._readWhitespace(),
                    e.match(Tokens.IDENT) &&
                      ((r = e.token().value), r.toLowerCase() === "auto" && this._unexpectedToken(e.token())),
                ...
                _operator: function (e) {
                  var t = this._tokenStream,
                    n = null;
                  if (t.match([Tokens.SLASH, Tokens.COMMA]) || (e && t.match([Tokens.PLUS, Tokens.STAR, Tokens.MINUS])))
                ...
                _combinator: function () {
                  ...
                  return (
                    e.match([Tokens.PLUS, Tokens.GREATER, Tokens.TILDE]) &&
                      ((n = e.token()), (t = new Combinator(n.value, n.startLine, n.startCol)), this._readWhitespace()),
                    t
                  );
                },
                ...
                _property: function () {
                  ...
                  return (
                    e.peek() == Tokens.STAR &&
                      ...
                      (e.get(), (i = e.token()), (n = i.value), (s = i.startLine), (o = i.startCol)),
                    e.match(Tokens.IDENT) &&
                      ((i = e.token()),
                      (r = i.value),
                      r.charAt(0) == "_" && this.options.underscoreHack && ((n = "_"), (r = r.substring(1))),
                ...
                _ruleset: function () {
                  ...
                  try {
                    ...
                    if (r instanceof SyntaxError && !this.options.strict) {
                      this.fire({ type: "error", error: r, message: r.message, line: r.line, col: r.col }),
                  ...
                  return (
                    n &&
                      (this.fire({ type: "startrule", selectors: n, line: n[0].line, col: n[0].col }),
                      this._readDeclarations(!0),
                ...
                _selector: function () {
                  ...
                  do {
                    ...
                    if (r !== null)
                      ...
                      (i = new Combinator(e.token().value, e.token().startLine, e.token().startCol)),
                        (r = this._combinator()),
                        (n = this._simple_selector_sequence()),
                        n === null
                    ...
                    i = [
                      function () {
                        return e.match(Tokens.HASH)
                          ? new SelectorSubPart(e.token().value, "id", e.token().startLine, e.token().startCol)
                          : null;
                      },
                      this._class,
                      this._attrib,
                ...
                _element_name: function () {
                  ...
                  return e.match(Tokens.IDENT)
                    ? ((t = e.token()), new SelectorSubPart(t.value, "elementName", t.startLine, t.startCol))
                    : null;
                },
                ...
                _pseudo: function () {
                  ...
                  return (
                    e.match(Tokens.COLON) &&
                      ...
                      e.match(Tokens.IDENT)
                        ? ((t = e.token().value), (r = e.token().startLine), (i = e.token().startCol - n.length))
                ...
                _term: function () {
                  var e = this._tokenStream,
                    ...
                    s;
                  return (
                    (t = this._unary_operator()),
                    t !== null && ((i = e.token().startLine), (s = e.token().startCol)),
                    e.peek() == Tokens.IE_FUNCTION && this.options.ieFilters
                      ? ((n = this._ie_function()), t === null && ((i = e.token().startLine), (s = e.token().startCol)))
                      : e.match([
                          Tokens.NUMBER,
                          Tokens.PERCENTAGE,
                          Tokens.LENGTH,
                      ...
                      : ((r = this._hexcolor()),
                        r === null
                          ? (t === null && ((i = e.LT(1).startLine), (s = e.LT(1).startCol)),
                            n === null &&
                              (e.LA(3) == Tokens.EQUALS && this.options.ieFilters
                                ? (n = this._ie_function())
                                : (n = this._function())))
                          : ((n = r.value), t === null && ((i = r.startLine), (s = r.startCol)))),
                    n !== null ? new PropertyValuePart(t !== null ? t + n : n, i, s) : null
                  );
                },
                _function: function () {
                  var e = this._tokenStream,
                ...
                _keyframes: function () {
                  ...
                  e.mustMatch(Tokens.KEYFRAMES_SYM),
                    ...
                    this._readWhitespace(),
                    e.mustMatch(Tokens.LBRACE),
                    this.fire({ type: "startkeyframes", name: r, prefix: i, line: t.startLine, col: t.startCol }),
                    this._readWhitespace(),
                    (n = e.peek());
                  while (n == Tokens.IDENT || n == Tokens.PERCENTAGE)
                    this._keyframe_rule(), this._readWhitespace(), (n = e.peek());
                  this.fire({ type: "endkeyframes", name: r, prefix: i, line: t.startLine, col: t.startCol }),
                    this._readWhitespace(),
                    e.mustMatch(Tokens.RBRACE);
                },
                ...
                _readDeclarations: function (e, t) {
                  ...
                  try {
                    ...
                    this.fire({ type: "error", error: i, message: i.message, line: i.line, col: i.col }),
                ...
                _unexpectedToken: function (e) {
                  throw new SyntaxError(
                    "Unexpected token '" + e.value + "' at line " + e.startLine + ", col " + e.startCol + ".",
                    e.startLine,
                    e.startCol
                  );
                },
        ...
        var Properties = {
            ...
            if (e.hasNext())
              throw (
                ...
                i
                  ...
                  : new ValidationError("Expected (<'azimuth'>) but found '" + s + "'.", s.line, s.col))
              );
          },
            ...
            if (e.hasNext())
              throw (
                ...
                t
                  ...
                  : new ValidationError("Expected (<'border-radius'>) but found '" + u + "'.", u.line, u.col))
              );
          },
          ...
          "box-shadow": function (e) {
            ...
            if (!ValidationTypes.isAny(e, "none")) Validation.multiProperty("<shadow>", e, !0, Infinity);
              ...
              throw (
                ((n = e.next()), new ValidationError("Expected end of value but found '" + n + "'.", n.line, n.col))
              );
          },
        ...
        TokenStream.prototype = mix(new TokenStreamBase(), {
          ...
          identOrFunctionToken: function (e, t, n) {
            ...
            return (
              r.peek() == "("
                ? ((i += r.read()),
                  i.toLowerCase() == "url("
                    ? ((s = Tokens.URI), (i = this.readURI(i)), i.toLowerCase() == "url(" && (s = Tokens.FUNCTION))
                    : (s = Tokens.FUNCTION))
                : r.peek() == ":" && i.toLowerCase() == "progid" && ((i += r.readTo("(")), (s = Tokens.IE_FUNCTION)),
          ...
          notToken: function (e, t, n) {
            ...
            return (
              r.mark(),
              (i += r.readCount(4)),
              i.toLowerCase() == ":not(" ? this.createToken(Tokens.NOT, i, t, n) : (r.reset(), this.charToken(e, t, n))
            );
          },
            ...
            return (
              isIdentStart(u)
                ? ((s = this.readName(r.read())),
                  (i += s),
                  /^em$|^ex$|^px$|^gd$|^rem$|^vw$|^vh$|^vm$|^ch$|^cm$|^mm$|^in$|^pt$|^pc$/i.test(s)
                    ? (o = Tokens.LENGTH)
        ...
        var Validation = {
          ...
          singleProperty: function (e, t, n, r) {
            ...
            if (!i)
              throw t.hasNext() && !t.isFirst()
                ? ((u = t.peek()), new ValidationError("Expected end of value but found '" + u + "'.", u.line, u.col))
                : new ValidationError("Expected (" + e + ") but found '" + s + "'.", s.line, s.col);
            if (t.hasNext())
              throw (
                ((u = t.next()), new ValidationError("Expected end of value but found '" + u + "'.", u.line, u.col))
              );
          },
          multiProperty: function (e, t, n, r) {
            ...
            if (!i)
              throw t.hasNext() && !t.isFirst()
                ? ((a = t.peek()), new ValidationError("Expected end of value but found '" + a + "'.", a.line, a.col))
                : ((a = t.previous()),
                  n && a == ","
            ...
            if (t.hasNext())
              throw (
                ((a = t.next()), new ValidationError("Expected end of value but found '" + a + "'.", a.line, a.col))
              );
          },
          groupProperty: function (e, t, n) {
            ...
            if (!r)
              throw u && t.hasNext()
                ? ((f = t.peek()), new ValidationError("Expected end of value but found '" + f + "'.", f.line, f.col))
                : new ValidationError("Expected (" + e + ") but found '" + i + "'.", i.line, i.col);
            if (t.hasNext())
              throw (
                ((f = t.next()), new ValidationError("Expected end of value but found '" + f + "'.", f.line, f.col))
              );
          },
        };
              ...
              return (
                o < 3
                  ? ValidationTypes.isAny(e, i + " | center | " + r)
                    ...
                    : ValidationTypes.isAny(e, s) && ((n = !0), ValidationTypes.isAny(e, i + " | center"))
                ...
                e.hasNext() &&
                  ...
                  ValidationTypes.isLiteral(r, "repeat-x | repeat-y")
                    ...
                    : ValidationTypes.isLiteral(r, n) &&
                      ((t = !0), e.hasNext() && ValidationTypes.isLiteral(e.peek(), n) && e.next())),
                t
              );
            },
            "<shadow>": function (e) {
              ...
              if (e.hasNext()) {
                ...
                e.hasNext() && (i || ValidationTypes.isAny(e, "<color>"), r || ValidationTypes.isAny(e, "inset")),
                  (t = n >= 2 && n <= 4);
              }
              return t;
            },
    ...
    var CSSLint = (function () {
      function e(e, t) {
        ...
        return (
          s &&
            ((n = { true: 2, "": 1, false: 0, 2: 2, 1: 1, 0: 0 }),
            s
              .toLowerCase()
              .split(",")
              .forEach(function (e) {
      ...
      return (
        ...
        (i.verify = function (n, i) {
          var s = 0,
            ...
            a,
            f,
            l = new parserlib.css.Parser({ starHack: !0, ieFilters: !0, underscoreHack: !0, strict: !1 });
          ...
          return (
            (f = { messages: u.messages, stats: u.stats, ruleset: u.ruleset }),
    ...
    (Reporter.prototype = {
      ...
      CSSLint.addRule({
        ...
        init: function (e, t) {
              ...
              if (u.height)
                for (e in o)
                  o.hasOwnProperty(e) &&
                    u[e] &&
                    ((n = u[e].value),
                    (e != "padding" || n.parts.length !== 2 || n.parts[0].value !== 0) &&
                      t.report(
                        "Using height with " + e + " can sometimes make elements larger than you expect.",
                        u[e].line,
                        u[e].col,
                        i
                      ));
              if (u.width)
                for (e in s)
                  s.hasOwnProperty(e) &&
                    u[e] &&
                    ((n = u[e].value),
                    (e != "padding" || n.parts.length !== 2 || n.parts[1].value !== 0) &&
                      t.report(
                        "Using width with " + e + " can sometimes make elements larger than you expect.",
                        u[e].line,
                        u[e].col,
                        i
                      ));
          ...
          var i = this,
            s = { border: 1, "border-left": 1, "border-right": 1, padding: 1, "padding-left": 1, "padding-right": 1 },
          ...
          e.addListener("startrule", n),
            ...
            e.addListener("property", function (e) {
              ...
              o[t] || s[t]
                ? !/^0\S*$/.test(e.value) &&
                  (t != "border" || e.value != "none") &&
                  (u[t] = { line: e.property.line, col: e.property.col, value: e.value })
                : /^(width|height)/i.test(t) && /^(length|percentage)/.test(e.value.parts[0].type)
                ? (u[t] = 1)
                : t == "box-sizing" && (a = !0);
            }),
            e.addListener("endrule", r),
            e.addListener("endfontface", r),
            e.addListener("endpage", r),
            e.addListener("endpagemargin", r),
            e.addListener("endkeyframerule", r);
        },
      }),
      CSSLint.addRule({
        id: "box-sizing",
        ...
        init: function (e, t) {
          ...
          e.addListener("startfontface", function (e) {
            ...
            e.addListener("endfontface", function (e) {
              (i = !1),
                o && t.report("@font-face declaration doesn't follow the fontspring bulletproof syntax.", u, a, n);
            });
        },
      }),
      CSSLint.addRule({
            ...
            e.addListener("endrule", function (e) {
              ...
              for (o = 0, u = i.length; o < u; o++) {
                ...
                for (f in r)
                  r.hasOwnProperty(f) &&
                    ((l = r[f]),
                    CSSLint.Util.indexOf(l, a.text) > -1 &&
                      (s[f] || (s[f] = { full: l.slice(0), actual: [], actualNodes: [] }),
                      CSSLint.Util.indexOf(s[f].actual, a.text) === -1 &&
                        (s[f].actual.push(a.text), s[f].actualNodes.push(a))));
              }
              for (f in s)
                if (s.hasOwnProperty(f)) {
                  ...
                  if (h.length > p.length)
                    for (o = 0, u = h.length; o < u; o++)
                      (d = h[o]),
                        CSSLint.Util.indexOf(p, d) === -1 &&
                          ((v = p.length === 1 ? p[0] : p.length == 2 ? p.join(" and ") : p.join(", ")),
                          t.report(
                            "The property " + d + " is compatible with " + v + " and should be included as well.",
                            c.actualNodes[0].line,
                            c.actualNodes[0].col,
                            n
                          ));
                }
      ...
      CSSLint.addRule({
        ...
        init: function (e, t) {
          function n(e, n, r) {
            u[e] &&
              (typeof o[e] != "string" || u[e].value.toLowerCase() != o[e]) &&
              t.report(r || e + " can't be used with display: " + n + ".", u[e].line, u[e].col, s);
          }
          function r() {
            u = {};
          }
          ...
          e.addListener("startrule", r),
            e.addListener("startfontface", r),
            e.addListener("startkeyframerule", r),
            e.addListener("startpagemargin", r),
            e.addListener("startpage", r),
            e.addListener("property", function (e) {
              var t = e.property.text.toLowerCase();
              o[t] && (u[t] = { value: e.value.text, line: e.property.line, col: e.property.col });
            }),
            e.addListener("endrule", i),
            e.addListener("endfontface", i),
            e.addListener("endkeyframerule", i),
            e.addListener("endpagemargin", i),
            e.addListener("endpage", i);
        },
      }),
      CSSLint.addRule({
        ...
        init: function (e, t) {
          ...
          e.addListener("startrule", n),
            ...
            e.addListener("property", function (e) {
              ...
              i[o] &&
                (s != o || i[o] == e.value.text) &&
                t.report("Duplicate property '" + e.property + "' found.", e.line, e.col, r),
                (i[o] = e.value.text),
                (s = o);
            });
        },
                  ...
                  u[a].type == "color" &&
                    ("alpha" in u[a] || "hue" in u[a]
                      ? (/([^\)]+)\(/.test(u[a]) && (f = RegExp.$1.toUpperCase()),
                        (!i || i.property.text.toLowerCase() != o || i.colorType != "compat") &&
                          t.report(
      ...
      CSSLint.addRule({
        ...
        init: function (e, t) {
          ...
          e.addListener("property", function (e) {
            ...
            e.addListener("endstylesheet", function () {
              t.stat("font-sizes", r),
                r >= 10 && t.rollupWarn("Too many font-size declarations (" + r + "), abstraction needed.", n);
            });
        },
      }),
      CSSLint.addRule({
      ...
      CSSLint.addRule({
        ...
        init: function (e, t) {
          function n(e) {
            e.selectors
              ? (s = { line: e.line, col: e.col, selectors: e.selectors, propCount: 0, outline: !1 })
              : (s = null);
          }
          function r(e) {
            s &&
              s.outline &&
              (s.selectors.toString().toLowerCase().indexOf(":focus") == -1
                ? t.report("Outlines should only be modified using :focus.", s.line, s.col, i)
                : s.propCount == 1 &&
                  t.report("Outlines shouldn't be hidden unless other visual changes are made.", s.line, s.col, i));
          }
          var i = this,
            s;
          e.addListener("startrule", n),
                  ...
                  for (c = 0; c < u.modifiers.length; c++)
                    (a = u.modifiers[c]),
                      u.elementName && a.type == "id"
                        ? t.report(
                            "Element (" + u + ") is overqualified, just use " + a + " without element name.",
                            u.line,
                            u.col,
                            n
                          )
                        : a.type == "class" && (r[a] || (r[a] = []), r[a].push({ modifier: a, part: u }));
              }
            }
          }),
            e.addListener("endstylesheet", function () {
              ...
              for (a = 0; a < s.parts.length; a++)
                (o = s.parts[a]),
                  o.type == e.SELECTOR_PART_TYPE &&
                    ...
                    a > 0 &&
                    t.report("Heading (" + o.elementName + ") should not be qualified.", o.line, o.col, n);
            }
          });
        },
      }),
                ...
                if (o.type == e.SELECTOR_PART_TYPE)
                  for (l = 0; l < o.modifiers.length; l++)
                    (u = o.modifiers[l]),
                      u.type == "attribute" &&
                        /([\~\|\^\$\*]=)/.test(u) &&
                        t.report("Attribute selectors with " + RegExp.$1 + " are slow!", u.line, u.col, n);
              }
            }
          });
        },
          ...
          function r(e) {
            ...
            for (n in l)
              if (l.hasOwnProperty(n)) {
                ...
                o == l[n].length &&
                  t.report("The properties " + l[n].join(", ") + " can be replaced by " + n + ".", e.line, e.col, i);
              }
          }
          var i = this,
            s,
            ...
            for (a = 0; a < i.length; a++) {
              ...
              if (o.elementName && /(h[1-6])/i.test(o.elementName.toString())) {
                ...
                u ||
                  (r[RegExp.$1]++,
                  r[RegExp.$1] > 1 &&
                    t.report("Heading (" + o.elementName + ") has already been defined.", o.line, o.col, n));
              }
            }
          }),
            ...
            for (r = 0, o = c.length; r < o; r++)
              (f = c[r].needed),
                ...
                s[f]
                  ? s[f][0].pos < s[l][0].pos &&
                    t.report(
                      "Standard property '" + f + "' should come after vendor-prefixed property '" + l + "'.",
                      s[l][0].name.line,
                      s[l][0].name.col,
                      i
                    )
                  : t.report(
                      "Missing standard property '" + f + "' to go along with '" + l + "'.",
                      s[l][0].name.line,
                      s[l][0].name.col,
                      i
                    );
        ...
        CSSLint.addFormatter({
          ...
          formatResults: function (t, n, r) {
            ...
            return (
              i.length > 0 &&
                (s.push('<file name="' + n + '">'),
                CSSLint.Util.forEach(i, function (t, n) {
                  t.rollup ||
                    s.push(
                      '<error line="' +
                        t.line +
        ...
        formatResults: function (e, t, n) {
          ...
          return r.length === 0
            ? n.quiet
              ? ""
              : t + ": Lint Free!"
            : (CSSLint.Util.forEach(r, function (e, n) {
                e.rollup
          ...
          return (
            r.length > 0 &&
              (r.forEach(function (e, t) {
                ...
                e.rollup ||
                  (i.push('<testcase time="0" name="' + o(e.rule) + '">'),
                  i.push(
                    "<" +
                      n +
                      ' message="' +

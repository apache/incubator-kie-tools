  ...
  function (e, t, n) {
    ...
    (t.handler.attach = function (e) {
      u ||
        ((u = !0),
        r.importCssString(
          "            .emacs-mode .ace_cursor{                border: 2px rgba(50,250,50,0.8) solid!important;                -moz-box-sizing: border-box!important;                -webkit-box-sizing: border-box!important;                box-sizing: border-box!important;                background-color: rgba(0,250,0,0.9);                opacity: 0.5;            }            .emacs-mode .ace_hidden-cursors .ace_cursor{                opacity: 1;                background-color: transparent;            }            .emacs-mode .ace_overwrite-cursors .ace_cursor {                opacity: 1;                background-color: transparent;                border-width: 0 0 2px 2px !important;            }            .emacs-mode .ace_text-layer {                z-index: 4            }            .emacs-mode .ace_cursor-layer {                z-index: 2            }",
          "emacsMode"
        )),
    ...
    d.forEach(function (e) {
      ...
      (t.handler.handleKeyboard = function (e, t, n, r) {
        ...
        if (o == "c-" || e.universalArgument) {
          var u = String(e.count || 0),
            a = parseInt(n[n.length - 1]);
        ...
        typeof f != "string" &&
          ((l = f.args),
          f.command && (f = f.command),
          f === "goorselect" && ((f = i.emacsMark() ? l[1] : l[0]), (l = null)));
        if (typeof f == "string") {
          (f === "insertstring" || f === "splitline" || f === "togglecomment") && i.pushEmacsMark(),
            (f = this.commands[f] || i.commands.commands[f]);
          if (!f) return undefined;
        }
            ...
            (this.highlight = function (e) {
              var t = this.$editor.session,
                n = (t.$isearchHighlight =
                  t.$isearchHighlight || t.addDynamicMarker(new o(null, "ace_isearch-result", "text")));
            ...
            (this.highlightAndFindWithNeedle = function (e, t) {
              ...
              return (
                s &&
                  ...
                  this.$editor.moveCursorToPosition(s.end),
        ...
        function () {
          (this.attach = function (e) {
            ...
            s.call(this, t.iSearchCommands, e.commands.platform),
              (this.$commandExecHandler = e.commands.addEventListener("exec", function (e) {

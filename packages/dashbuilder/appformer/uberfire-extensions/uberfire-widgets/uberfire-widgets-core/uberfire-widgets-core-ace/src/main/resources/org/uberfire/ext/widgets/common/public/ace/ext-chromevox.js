define("ace/ext/chromevox", ["require", "exports", "module", "ace/editor", "ace/config"], function (e, t, n) {
  ...
  var b = null,
    ...
    vt = function () {
      (r.editor = editor),
        editor.getSession().selection.on("changeCursor", J),
        editor.getSession().selection.on("changeSelection", K),
        editor.getSession().on("change", Q),
        editor.getSession().on("changeAnnotation", Z),
        editor.on("changeStatus", ft),
        editor.on("findSearchBox", ht),
        editor.container.addEventListener("keydown", at),
        (b = editor.selection.getCursor());
    },
    mt = function (e) {
      vt(),

(function () {
  ...
  var n = function (e, t, r) {
      ...
      arguments.length == 2 && (r = t),
        n.modules || ((n.modules = {}), (n.payloads = {})),
        (n.payloads[e] = r),
        (n.modules[e] = null);
    },
    r = function (e, t, n) {
    ...
    s = function (e, t) {
      ...
      if (!s) {
        ...
        if (typeof s == "function") {
          var o = {},
            u = { id: t, uri: "", exports: o, packaged: !0 },
            a = function (e, n) {
              return r(t, e, n);
            },
            f = s(a, o, u);
    ...
    function (e, t, n) {
      ...
      e("./worker/worker_client"),
        ...
        (t.edit = function (e) {
          ...
          var u = new s(new a(e));
          u.setSession(o);
          var f = { document: o, editor: u, onResize: u.resize.bind(u, null) };
          return (
        ...
        function i(s) {
          ...
          for (var u = 0; u < o.length; u++) {
            ...
            !a.regex &&
              ...
              ((a.regex = a.start),
              a.next || (a.next = []),
              a.next.push({ defaultToken: a.token }, { token: a.token + ".end", regex: a.end || a.start, next: "pop" }),
        ...
        (this.getFoldAt = function (e, t, n) {
          ...
          (this.getCommentFoldRange = function (e, t, n) {
            ...
            if (s && /^comment|string/.test(s.type)) {
              ...
              return (
                (u.end.row = i.getCurrentTokenRow()), (u.end.column = i.getCurrentTokenColumn() + s.value.length - 2), u
              );
            }
          }),
          ...
          (this.$toggleFoldWidget = function (e, t) {
            ...
            if (t.siblings) {
              ...
              t.children
                ? ((f = o ? o.end.row : this.getLength()), this.foldAll(e + 1, o.end.row, t.all ? 1e4 : 0))
    ...
    (function () {
      (this.$setMaxTokenCount = function (e) {
        ...
        (this.getLineTokens = function (e, t) {
          ...
          while ((a = u.exec(e))) {
            ...
            for (var g = 0; g < a.length - 2; g++) {
              ...
              (p = s[o[g]]),
                ...
                p.next &&
                  (typeof p.next == "string" ? (i = p.next) : (i = p.next(i, n)),
                  (s = this.states[i]),
                  s ||
            ...
            if (d)
              if (typeof h == "string")
                (!!p && p.merge === !1) || c.type !== h
                  ? (c.type && f.push(c), (c = { type: h, value: d }))
                  : (c.value += d);
              else if (h) {
          ...
          return (
            c.type && f.push(c), n.length > 1 && n[0] !== i && n.unshift(i), { tokens: f, state: n.length ? n : i }
          );
        });
    }.call(i.prototype),
      (t.Tokenizer = i));
      ...
      (function () {
        (this.tokenRe = new RegExp(
          ...
          (this.nonTokenRe = new RegExp(
            "^(?:[^" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]|\\s])+",
            "g"
          )),
            ...
            if (!this.lineCommentStart) {
              ...
              var c = this.blockComment.start,
                ...
                v = function (e, t) {
                  if (g(e, t)) return;
                  if (!s || /\S/.test(e))
                    i.insertInLine({ row: t, column: e.length }, h), i.insertInLine({ row: t, column: a }, c);
                },
                m = function (e, t) {
                  var n;
              ...
              var m = function (e, t) {
                ...
                v = function (e, t) {
                  if (!s || /\S/.test(e))
                    b(e, a, a) ? i.insertInLine({ row: t, column: a }, y) : i.insertInLine({ row: t, column: a }, c);
                },
                g = function (e, t) {
                  return p.test(e);
                },
        ...
        r.implement(this, o),
          ...
          (this.onChange = function (e) {
            ...
            !this.$fromUndo &&
              ...
              n && n.length != 0 && this.$deltasFold.push({ action: "removeFolds", folds: n }),
            ...
            if (e) {
              ...
              (this.$syncInformUndoManager = function () {
                t.$informUndoManager.cancel(),
                  ...
                  t.$deltas.length > 0 &&
                    e.execute({ action: "aceupdate", args: [t.$deltas, t], merge: t.mergeUndoDeltas }),
                  (t.mergeUndoDeltas = !1),
                  (t.$deltas = []);
              }),
            ...
            (this.$modeId = r),
              s.loadModule(
                ...
                function (e) {
                  ...
                  e &&
                    e.Mode &&
                    ((e = new e.Mode(n)), n || ((this.$modes[r] = e), (e.$id = r)), this.$onChangeMode(e), t && t());
                }.bind(this)
              ),
          ...
          (this.setWrapLimitRange = function (e, t) {
            if (this.$wrapLimitRange.min !== e || this.$wrapLimitRange.max !== t)
              (this.$wrapLimitRange = { min: e, max: t }), (this.$modified = !0), this._signal("changeWrapMode");
          }),
              ...
              if (r.indexOf("remove") != -1) {
                ...
                if (l) {
                  ...
                  v == 0
                    ...
                    : v == -1 && (l.addRemoveChars(i, 0, u.column - o.column), l.shiftRow(n)),
                    (c = f.indexOf(l) + 1);
                }
                for (c; c < f.length; c++) {
                  var l = f[c];
            ...
            set: function (e) {
              (e = e == "auto" ? this.$mode.type != "text" : e != "text"),
                e != this.$wrapAsCode &&
                  ((this.$wrapAsCode = e),
                  this.$useWrapMode &&
                    ((this.$modified = !0), this.$resetRowCache(0), this.$updateWrapData(0, this.getLength() - 1)));
            },
            initialValue: "auto",
          },
          firstLineNumber: {
        ...
        function () {
          r.implement(this, s),
            (this.exec = function (e, t, n) {
              ...
              var r = { editor: t, command: e, args: n },
                i = this._emit("exec", r);
        ...
        (this.CHANGE_CURSOR = 1),
          ...
          (this.$computeLayerConfig = function () {
            ...
            f && ((this.$horizScroll = a), this.scrollBarH.setVisible(a)),
              !this.$maxLines &&
                this.$scrollPastEnd &&
                (i += (t.scrollerHeight - this.lineHeight) * this.$scrollPastEnd);
            ...
            c && ((this.$vScroll = l), this.scrollBarV.setVisible(l)),
              ...
              this.session.setScrollLeft(
                Math.max(
                  ...
                  Math.min(this.scrollLeft, u + 2 * this.$padding - t.scrollerWidth + this.scrollMargin.right)
                )
              );
            ...
            if (f || c)
              (b = this.$updateCachedSize(!0, this.gutterWidth, t.width, t.height)),
  ...
  define(
    "ace/config",
    ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/lib/net", "ace/lib/event_emitter"],
    function (e, t, n) {
      "no use strict";
      function f(r) {
      ...
      var c = {
          ...
          setOption: function (e, t) {
            ...
            if (!n)
              return (
                typeof console != "undefined" && console.warn && console.warn('misspelled option "' + e + '"'),
                undefined
              );
      ...
      function f(e) {
        ...
        (this.onDragStart = function (e) {
          ...
          (i.effectAllowed = t.getReadOnly() ? "copy" : "copyMove"),
            s.isOpera && (t.container.appendChild(n), (n._top = n.offsetTop)),
      ...
      (function () {
        r.implement(this, u),
                ...
                this.showInvisibles
                  ? t.push(
                      "<span class='ace_invisible ace_invisible_tab'>" +
                        this.TAB_CHAR +
                        s.stringRepeat("\xa0", n - 1) +
                        "</span>"
                    )
                  : t.push(s.stringRepeat("\xa0", n));
              if (this.displayIndentGuides) {
                ...
                if (this.showInvisibles) {
                  ...
                  var u = s.stringRepeat(this.SPACE_CHAR, this.tabSize),
                    a = this.TAB_CHAR + s.stringRepeat("\xa0", this.tabSize - 1);
                } else
                  var u = s.stringRepeat("\xa0", this.tabSize),
                    a = u;
          ...
          (this.updateLines = function (e, t, n) {
            ...
            for (;;) {
              a > l &&
                ((a = f.end.row + 1), (f = this.session.getNextFoldLine(a, f)), (l = f ? f.start.row : Infinity));
              if (a > s) break;
              var c = o[u++];
              if (c) {
                var h = [];
          ...
          (this.$renderToken = function (e, t, n, r) {
            var i = this,
              o =
                /\t|&|<|( +)|([\x00-\x1f\x80-\xa0\u1680\u180E\u2000-\u200f\u2028\u2029\u202F\u205F\u3000\uFEFF])|[\u1100-\u115F\u11A3-\u11A7\u11FA-\u11FF\u2329-\u232A\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFB\u3000-\u303E\u3041-\u3096\u3099-\u30FF\u3105-\u312D\u3131-\u318E\u3190-\u31BA\u31C0-\u31E3\u31F0-\u321E\u3220-\u3247\u3250-\u32FE\u3300-\u4DBF\u4E00-\uA48C\uA490-\uA4C6\uA960-\uA97C\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFAFF\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE66\uFE68-\uFE6B\uFF01-\uFF60\uFFE0-\uFFE6]/g,
              u = function (e, n, r, o, u) {
                ...
                return r
                  ? "<span class='ace_invisible ace_invisible_space ace_invalid'>" + i.SPACE_CHAR + "</span>"
                  : ((t += 1),
        ...
        function () {
          (this.classSuffix = "-v"),
            (this.onScroll = function () {
              this.skipEvent ||
                ((this.scrollTop = this.element.scrollTop), this._emit("scroll", { data: this.scrollTop })),
                (this.skipEvent = !1);
            }),
            (this.getWidth = function () {
    ...
    function (e, t, n) {
      ...
      (function () {
        (this.onMouseDown = function (e) {
          ...
          return (
            this.captureMouse(e),
            !t || this.$clickSelection || e.getShiftKey() || r.inMultiSelectMode
              ? this.startSelect(n)
              : t && ((this.mousedownEvent.time = Date.now()), this.startSelect(n)),
            e.preventDefault()
          );
        }),
          (this.startSelect = function (e) {
            ...
            n ? t.selection.selectToPosition(e) : this.$clickSelection || t.selection.moveToPosition(e),
      ...
      (function () {
        r.implement(this, u),
          ...
          (this.$testFractionalRect = function () {
            ...
            t > 0 && t < 1 ? (a = 1) : (a = 100), e.parentNode.removeChild(e);
          }),
          ...
          (this.$measureSizes = function () {
            ...
            else var t = { height: this.$measureNode.clientHeight, width: this.$measureNode.clientWidth / a };
      ...
      var r = e("../lib/event"),
        ...
        f = function (e, t) {
          ...
          r.addListener(n, "compositionstart", B),
            ...
            (this.onContextMenu = function (e) {
              ...
              t.renderer.$keepTextAreaAtCursor && (t.renderer.$keepTextAreaAtCursor = null),
                i.isWin && r.capture(t.container, c, q);
            }),
          ...
          if (!i.isGecko || i.isMac) {
            ...
            r.addListener(t.renderer.scroller, "contextmenu", R), r.addListener(n, "contextmenu", R);
          }
        };
      t.TextInput = f;
    }
        ...
        r.implement(this, d),
          (this.$initOperationListeners = function () {
            ...
            (this.selections = []),
              ...
              this.commands.on(
                ...
                function (e) {
                  var t = e.command;
                  t.aceCommandGroup == "fileJump" &&
                    this.lastFileJumpPos &&
                    !this.curOp.selectionChanged &&
              ...
              if (e && e.scrollIntoView) {
                ...
                switch (e.scrollIntoView) {
                  ...
                  case "selectionPart":
                    ...
                    (t.start.row >= n.lastRow || t.end.row <= n.firstRow) &&
            ...
            (this.$highlightTagPending = !0),
              setTimeout(function () {
                ...
                var n = t.getCursorPosition(),
                  r = new y(t.session, n.row, n.column),
                  i = r.getCurrentToken();
                if (!i || i.type.indexOf("tag-name") === -1) {
                  e.removeMarker(e.$tagHighlight), (e.$tagHighlight = null);
                  return;
                }
                var s = i.value,
                  o = 0,
                ...
                e.$tagHighlight &&
                  l.compareRange(e.$backMarkers[e.$tagHighlight].range) !== 0 &&
                  (e.removeMarker(e.$tagHighlight), (e.$tagHighlight = null)),
                  l && !e.$tagHighlight && (e.$tagHighlight = e.addMarker(l, "ace_bracket", "text"));
              }, 50);
          }),
          (this.focus = function () {
            var e = this;
            ...
            s &&
              ...
              (s.selection.length == 2
                ...
                : this.selection.setSelectionRange(
                    new p(i.row + s.selection[0], s.selection[1], i.row + s.selection[2], s.selection[3])
                  ));
            ...
            (r = (n && n.cursor) || r),
              r &&
                (e
                  ...
                  : this.selection.moveTo(r.row, r.column));
          }),
          ...
          (this.find = function (e, t, n) {
            ...
            t.needle == null &&
              ...
              e || ((i = this.session.getWordRange(i.start.row, i.start.column)), (e = this.session.getTextRange(i))),
              ...
              this.pos.on("change", function (t) {
                n.removeMarker(e.markerId),
                  (e.markerId = n.addMarker(
                    new r(t.value.row, t.value.column, t.value.row, t.value.column + e.length),
                    e.mainClass,
                    null,
                    !1
                  ));
                  ...
                  n.on("change", function (i) {
                    e.removeMarker(n.markerId),
                      (n.markerId = e.addMarker(
                        new r(i.value.row, i.value.column, i.value.row, i.value.column + t.length),
                        t.othersClass,
                        null,
                        !1
                      ));
        ...
        (this.updateSelectionMarkers = function () {
          ...
          (this.selectMore = function (e, t) {
            var n = this.session,
              ...
              i = r.toOrientedRange();
            i.isEmpty() &&
              ((i = n.getWordRange(i.start.row, i.start.column)),
            ...
            if (!n.length) {
              ...
              if (u) {
                var f = this.session.getLength(),
                  l;
                do l = this.session.getLine(o);
                while (/[=:]/.test(l) && ++o < f);
                do l = this.session.getLine(s);
                while (/[=:]/.test(l) && --s > 0);
                s < 0 && (s = 0), o >= f && (o = f - 1);
              }
              var c = this.session.doc.removeLines(s, o);
              (c = this.$reAlignText(c, u)),
                this.session.doc.insert({ row: s, column: 0 }, c.join("\n") + "\n"),
                u || ((r.start.column = 0), (r.end.column = c[c.length - 1].length)),
      ...
      if (o && !n && !s && u === 0) {
        ...
        a.$blockScrolling++,
          a.once("mouseup", function () {
            var e = f.toOrientedRange();
            S && e.isEmpty() && i(S.cursor, e.cursor)
              ? f.substractPoint(e.cursor)
              : (E && (a.removeSelectionMarker(E), f.addRange(E)), f.addRange(e)),
              a.$blockScrolling--;
          });
      } else if (n && u === 0) {
    ...
    (t.addListener = function (e, t, n) {
      ...
      (t.getButton = function (e) {
        return e.type == "dblclick"
          ? 0
          : e.type == "contextmenu" || (e.ctrlKey && i.isMac)
          ? 2
          : e.preventDefault
          ? e.button
        ...
        (this.getRowLength = function (e) {
          ...
          (this.attach = function (e) {
            ...
            this.detach(),
              ...
              e.setOption("enableLineWidgets", !0),

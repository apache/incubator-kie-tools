          ...
          return (
            ...
            (i.getNextLineIndent = function (e, t, r) {
              ...
              return (
                ...
                (!s.length || s[s.length - 1].type !== "comment") && e === "start" && n.test(t) && (i += r),
                i
              );
            }),
            (i.toggleCommentLines = function (t, n, r, i) {
              ...
              for (u = r; u <= i; ++u)
                (a = u),
                  (f = s.test((l = n.getLine(a)))) ? (l = l.replace(s, "$1")) : (l = l.replace(/^\s*/, "$&#")),
                  (o.end.row = o.start.row = a),
                  (o.end.column = l.length + 1),
                  n.replace(o, l);
              return 1 - f * 2;
            }),

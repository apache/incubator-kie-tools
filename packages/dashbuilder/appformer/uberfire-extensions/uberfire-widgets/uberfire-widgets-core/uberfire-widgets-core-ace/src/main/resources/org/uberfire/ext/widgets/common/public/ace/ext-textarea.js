define(
  ...
  function (e, t, n) {
    ...
    var u = function (e, t, n) {
      var r = e.style[n];
      r ||
        (window.getComputedStyle ? (r = window.getComputedStyle(e, "").getPropertyValue(n)) : (r = e.currentStyle[n]));
    ...
    (t.transformTextarea = function (e, t) {
      ...
      a(u, { top: "0px", left: "0px", right: "0px", bottom: "0px", border: "1px solid gray", position: "absolute" }),
        s.appendChild(u);

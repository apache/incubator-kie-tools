...
!(function () {
    ...
    H.createCoreModule("DomRange", ["DomUtil"], function (a, b) {
      ...
      function o(a) {
        ...
        return (
          ...
          b +
          "(" +
          J.inspectNode(a.startContainer) +
          ":" +
          a.startOffset +
          ", " +
  ...
  rangy.createModule("TextRange", ["WrappedSelection"], function (a, b) {
    ...
    function x(a, b, c) {
      return function (d) {
        var e = this.cache;
        if (e.hasOwnProperty(a)) return pa++, e[a];
        qa++;
          ...
          return (
            0 == g
              ...
              : e.isCharacterDataNode()
                ? ((b = f), (c = g - 1))
                : ((d = f.childNodes[g - 1]),
                  h.getNodeWrapper(d).containsPositions()
                    ? ((b = d), (c = S.getNodeLength(d)))
                    : ((b = f), (c = g - 1))),
          ...
          : (h && 3 !== h.nodeType && 1 !== h.nodeType
              ...
              : h && 3 === h.nodeType && /^\s*$/.test(h.textContent)
                ...
                : c && h && 1 === h.nodeType
                  ...
                  : h ||
                    b === this.contain ||
                    ((g = b.parentNode), g !== this.contain && (h = this.getPreviousNode(g, c))),
            h !== this.contain ? h : !1);
      },
            ...
            : d && 3 === d.nodeType && d === e && 1 === d.parentNode.childNodes.length
              ? void (
                  ...
                  c !== b.element &&
                    "LI" !== c.nodeName &&
                    "TD" !== c.nodeName &&
                    (a.setStartBefore(c), a.setEndAfter(c)))
                )
              : void 0;
    }
    function p(b) {
    ...
    var b = a.dom,
      ...
      f = {
        ...
        fixDeleteInTheBeginningOfLi: function (b) {
          if (a.browser.hasLiDeletingProblem()) {
            var d,
              e,
              d,
              f,
    ...
    a.views.SourceView = Base.extend({
      ...
      _observe: function () {
        this.editor.on(
          "change_view",
          function (a) {
            "composer" === a ? this.switchToComposer(!0) : "textarea" === a && this.switchToTextarea(!0);
          }.bind(this)
        );
      },
    });

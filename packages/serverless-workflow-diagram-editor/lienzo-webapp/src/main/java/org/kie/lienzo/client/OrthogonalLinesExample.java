...
public class OrthogonalLinesExample extends BaseExample implements Example {
    ...
    public OrthogonalLinesExample(final String title) {
        super(title);
    }

...
public class StateShape extends ServerlessWorkflowShape<StateShapeView> implements HasShapeState {
    ...
    protected StateShape(State state, ResourceContentService resourceContentService) {
        this(state.getName(), resourceContentService);
    }

    protected StateShape(String name, ResourceContentService resourceContentService) {
    ...
    public static StateShape create(State state, ResourceContentService resourceContentService) {
        switch (state.getType()) {
            case "inject":
                return new InjectStateShape(state, resourceContentService);
            case "switch":
                return new SwitchStateShape(state, resourceContentService);
            case "operation":
                return new OperationStateShape(state, resourceContentService);
            case "event":
                return new EventStateShape(state, resourceContentService);
            case "callback":
                return new CallbackStateShape(state, resourceContentService);
            case "foreach":
                return new ForEachStateShape(state, resourceContentService);
            case "parallel":
                return new ParallelStateShape(state, resourceContentService);
            case "sleep":

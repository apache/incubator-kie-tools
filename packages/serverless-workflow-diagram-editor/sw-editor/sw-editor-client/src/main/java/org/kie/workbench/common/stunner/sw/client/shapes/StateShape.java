...
public class StateShape extends NodeShapeImpl implements HasShapeState {
    ...
    public static final String EVENT_STATE_ICON = "M24,4v4h16V4c0-2.21,1.79-4,4-4s4,1.79,4,4v4h6c3.31,0,6,2.69,6,6v6H4v-6c0-3.31,2.69-6,6-6h6V4c0-2.21,1.79-4,4-4s4,1.79,4,4ZM4,24H60V58c0,3.31-2.69,6-6,6H10c-3.31,0-6-2.69-6-6V24Zm10,8c-1.1,0-2,.9-2,2v12c0,1.1,.9,2,2,2h12c1.1,0,2-.9,2-2v-12c0-1.1-.9-2-2-2H14Z";

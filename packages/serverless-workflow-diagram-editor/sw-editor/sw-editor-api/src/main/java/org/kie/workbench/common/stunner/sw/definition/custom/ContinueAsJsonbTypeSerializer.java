...
public class ContinueAsJsonbTypeSerializer implements JsonbSerializer<Object> {
    ...
    public void serialize(Object obj, JsonGenerator generator, SerializationContext ctx) {
        if (obj instanceof String) {
            stringJsonSerializer.serialize((String) obj, "continueAs", generator, ctx);
        } else if (obj instanceof ContinueAs) {
            serializer.serialize((ContinueAs) obj, "continueAs", generator, ctx);
        }
    }
}
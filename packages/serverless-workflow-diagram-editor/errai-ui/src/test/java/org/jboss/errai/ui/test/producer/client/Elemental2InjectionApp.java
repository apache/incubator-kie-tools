...
public class Elemental2InjectionApp {
  ...
  @Inject
  HTMLDivElement erraiDomWrapperDiv; //works because of ElementProviderExtension
  ...
  @Inject
  @Named("div")
  HTMLElement erraiDomWrapperHTMLElementDiv; //works because of HTMLElementProvider

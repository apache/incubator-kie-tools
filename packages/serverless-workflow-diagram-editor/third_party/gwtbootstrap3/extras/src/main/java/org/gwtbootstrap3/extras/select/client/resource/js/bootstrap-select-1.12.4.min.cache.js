  ...
  !(function (a) {
    ...
    String.prototype.includes ||
      !(function () {
        ...
        b
          ? b(String.prototype, "includes", { value: d, configurable: !0, writable: !0 })
      ...
      String.prototype.startsWith ||
        !(function () {
          ...
          a
            ? a(String.prototype, "startsWith", { value: c, configurable: !0, writable: !0 })
    ...
    (a.fn.triggerNative = function (a) {
      var b,
        c = this[0];
      c.dispatchEvent
        ? (f ? (b = new Event(a, { bubbles: !0 })) : ((b = document.createEvent("Event")), b.initEvent(a, !0, !1)),
          c.dispatchEvent(b))
        : c.fireEvent
            ...
            m.each(function (b) {
              ...
              if ((g++, !f.hasClass("bs-title-option"))) {
                var k,
                  ...
                  r =
                    "undefined" != typeof f.data("icon")
                      ? '<span class="' + c.options.iconBase + " " + f.data("icon") + '"></span> '
                      : "",
                  s = f.parent(),
                ...
                if (("" !== r && v && (r = "<span>" + r + "</span>"), c.options.hideDisabled && ((v && !t) || u)))
                  return (
                    (k = f.data("prevHiddenIndex")), f.next().data("prevHiddenIndex", void 0 !== k ? k : b), void g--
                  );
                if (
                  (f.data("content") || (o = r + '<span class="text">' + o + q + "</span>"),
                  t && f.data("divider") !== !0)
                ) {
                    ...
                    var y = s[0].label,
                      z =
                        "undefined" != typeof s.data("subtext")
                          ...
                          : "",
                      A = s.data("icon")
                        ? '<span class="' + c.options.iconBase + " " + s.data("icon") + '"></span> '
                        : "";
        ...
        render: function (b) {
          ...
          b !== !1 &&
            e.each(function (a) {
              ...
              d.setDisabled(
                a,
                this.disabled || ("OPTGROUP" === this.parentNode.tagName && this.parentNode.disabled),
                b
              ),
                  ...
                  var b,
                    ...
                    e =
                      c.data("icon") && d.options.showIcon
                        ? '<i class="' + d.options.iconBase + " " + c.data("icon") + '"></i> '
                        : "";
                  return (
                    (b =
          ...
          if (
            ...
            if ((y(), "auto" === this.options.size)) {
              var z = function () {
                ...
                y(),
                  ...
                  "auto" === j.options.dropdownAlignRight &&
                    k.toggleClass("dropdown-menu-right", h > i && c - w.horiz < e - o),
              ...
              (b = p * this.options.size + B * u + v.vert),
                j.options.container
                  ? (k.data("height") || k.data("height", k.height()), (d = k.data("height")))
                  : (d = k.height()),
                    ...
                    if ((n && p) || (o && q))
                      if (n && 1 == n)
                        ...
                        t[2] &&
                          ...
                          n &&
                            p &&
                            (w.append(a("<div>" + u + "</div>")), (i = !1), b.$element.trigger("maxReached.bs.select")),
                          o &&
                            q &&
        ...
        liveSearchListener: function () {
          ...
          this.$button.on("click.dropdown.data-api", function () {
            c.$menuInner.find(".active").removeClass("active"),
              c.$searchbox.val() &&
                (c.$searchbox.val(""), c.$lis.not(".is-hidden").removeClass("hidden"), d.parent().length && d.remove()),
              ...
              i.options.liveSearch
                ? (b.preventDefault(),
                  g.hasClass("dropdown-toggle") ||
                    (c.removeClass("active").eq(d).addClass("active").children("a").focus(), g.focus()))

...
public abstract class TreeLogger {
  ...
  /**
   * Calls {@link #branch(Type, String, Throwable, HelpInfo)} with a <code>
   ...
   */
  public abstract TreeLogger branch(Type type, String msg, Throwable caught, HelpInfo helpInfo);
  ...
  /**
   * Calls {@link #log(Type, String, Throwable, HelpInfo)} with a <code>null</code> <code>caught
   * </code> and <code>helpInfo</code>.
   */
  ...
  /**
   * Calls {@link #log(Type, String, Throwable, HelpInfo)} with a <code>null</code> <code>helpInfo
   * </code>.
   */
   ...
   *     information to the user
   */
  public abstract void log(Type type, String msg, Throwable caught, HelpInfo helpInfo);
}

...
public class HashSetDeserializer<T> extends CollectionDeserializer<Set<T>, T> {

  public HashSetDeserializer(JsonbDeserializer<T> deserializer) {
    super(deserializer);
  }

  public HashSet<T> deserialize(JsonValue json, DeserializationContext ctx) throws JsonException {

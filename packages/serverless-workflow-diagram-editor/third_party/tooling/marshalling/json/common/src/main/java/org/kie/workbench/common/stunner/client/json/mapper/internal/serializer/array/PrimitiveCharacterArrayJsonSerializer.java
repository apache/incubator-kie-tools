...
public class PrimitiveCharacterArrayJsonSerializer extends BasicArrayJsonSerializer<char[]> {

  private final CharacterJsonSerializer serializer = new CharacterJsonSerializer();

  @Override
  public void serialize(
      char[] obj, String property, JsonGenerator generator, SerializationContext ctx) {
    if (obj != null) {

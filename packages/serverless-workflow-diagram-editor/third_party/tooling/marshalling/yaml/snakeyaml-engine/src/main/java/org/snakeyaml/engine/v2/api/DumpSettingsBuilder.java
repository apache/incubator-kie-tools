...
public final class DumpSettingsBuilder {
  ...
  /**
   * Define max key length to use simple key (without '?'). <a
   * href="https://yaml.org/spec/1.2/spec.html#id2798057">More info</a>
   *
   ...
   * default {@link JsonSchema}. These 3 are available {@link

...
public abstract class UnicodeEscaper implements Escaper {
  ...
  private static final char[] DEST_TL = new char[ARRAY_SIZE];
   ...
   * <p>
   *
   * <p>Unlike {@link #escape(String)} it is permitted to append arbitrarily split input to this
   ...
   * and will be silently ignored. This is unavoidable since the Appendable interface has no {@code
   * close()} method, and it is impossible to determine when the last characters have been appended.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>For well formed <a href="http://en.wikipedia.org/wiki/UTF-16">UTF-16</a> the escaping
   * behavior is identical to that of {@link #escape(String)} and the following code is equivalent
   * to (but much slower than) {@code escaper.escape(string)}:
   *
   * <pre>
   * {
   *   &#064;code

 ...
 *
 * <p>This event is followed by a number of key value pairs. <br>
 ...
 *
 * <p>There must be an even number of node events between the start and end event.
 *
 * @see MappingEndEvent
 */
public final class MappingStartEvent extends CollectionStartEvent {
  ...
  public MappingStartEvent(
      Optional<Anchor> anchor, Optional<String> tag, boolean implicit, FlowStyle flowStyle) {

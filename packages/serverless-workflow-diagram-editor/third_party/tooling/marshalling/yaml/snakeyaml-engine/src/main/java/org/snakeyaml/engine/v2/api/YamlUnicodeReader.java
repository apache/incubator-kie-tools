 ...
 *
 * <p>Original pseudocode : Thomas Weidenfeller Implementation tweaked: Aki Nieminen Implementation
 ...
 *
 * <p>http://www.unicode.org/unicode/faq/utf_bom.html BOMs: 00 00 FE FF = UTF-32, big-endian FF FE
 * 00 00 = UTF-32, little-endian FE FF = UTF-16, big-endian FF FE = UTF-16, little-endian EF BB BF =
 * UTF-8
 *
 * <p>
 *
 * <p>Win2k Notepad: Unicode format = UTF-16LE *
 */
...
public class YamlUnicodeReader extends Reader {
  ...
  protected void init() throws IOException {
    ...
    if ((bom[0] == (byte) 0x00)
      ...
      // encoding = UTF32BE;
      // unread = n - 4;
      throw new IOException("UTF-32BE is not supported!");
      ...
      // encoding = UTF32LE;
      // unread = n - 4;
      throw new IOException("UTF-32LE is not supported!");
      ...
      // encoding = UTF16BE;
      // unread = n - 2;
      throw new IOException("UTF-16BE is not supported!");
    } else if ((bom[0] == (byte) 0xFF) && (bom[1] == (byte) 0xFE)) {
      // encoding = UTF16LE;
      // unread = n - 2;
      throw new IOException("UTF-16LE is not supported!");
    } else {
    ...
    // UTF-8 is used by default in J2CL

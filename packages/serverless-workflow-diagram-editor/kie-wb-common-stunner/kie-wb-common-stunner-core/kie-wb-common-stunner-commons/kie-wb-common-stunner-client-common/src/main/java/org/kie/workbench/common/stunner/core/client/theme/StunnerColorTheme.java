...
public interface StunnerColorTheme {

    String getShapeStrokeColorSelected();

    String getShapeStrokeColorHighlight();

    String getShapeStrokeColorInvalid();

    String getShapeFillColorSelected();

    String getShapeFillColorInvalid();

    String getEdgeTextFillColor();

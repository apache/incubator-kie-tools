...
public class AssignmentImpl extends BaseElementImpl implements Assignment {
		...
		if (newFrom != from) {
			...
			if (from != null)
				msgs = ((InternalEObject) from).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmn2Package.ASSIGNMENT__FROM, null, msgs);
			if (newFrom != null)
	...
	public NotificationChain basicSetTo(Expression newTo, NotificationChain msgs) {
		...
		to = newTo;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Bpmn2Package.ASSIGNMENT__TO,
					oldTo, newTo);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTo(Expression newTo) {
		if (newTo != to) {
			NotificationChain msgs = null;
			if (to != null)
				msgs = ((InternalEObject) to).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Bpmn2Package.ASSIGNMENT__TO,
						null, msgs);
			if (newTo != null)
				msgs = ((InternalEObject) newTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Bpmn2Package.ASSIGNMENT__TO,
						null, msgs);

...
public class ErrorImpl extends RootElementImpl implements org.eclipse.bpmn2.Error {
	...
	public void setErrorCode(String newErrorCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.ERROR__ERROR_CODE, oldErrorCode,
					errorCode));
	}
	...
	public ItemDefinition getStructureRef() {
		if (structureRef != null && structureRef.eIsProxy()) {
			...
			if (structureRef != oldStructureRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.ERROR__STRUCTURE_REF,
	...
	public void setStructureRef(ItemDefinition newStructureRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.ERROR__STRUCTURE_REF, oldStructureRef,
					structureRef));
	}

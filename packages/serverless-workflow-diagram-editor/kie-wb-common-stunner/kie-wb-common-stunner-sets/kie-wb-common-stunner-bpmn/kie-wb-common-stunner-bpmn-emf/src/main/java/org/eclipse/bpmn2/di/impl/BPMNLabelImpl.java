...
public class BPMNLabelImpl extends LabelImpl implements BPMNLabel {
		...
		if (labelStyle != null && labelStyle.eIsProxy()) {
			...
			if (labelStyle != oldLabelStyle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BpmnDiPackage.BPMN_LABEL__LABEL_STYLE,
	...
	public void setLabelStyle(BPMNLabelStyle newLabelStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BpmnDiPackage.BPMN_LABEL__LABEL_STYLE, oldLabelStyle,
					labelStyle));
	}

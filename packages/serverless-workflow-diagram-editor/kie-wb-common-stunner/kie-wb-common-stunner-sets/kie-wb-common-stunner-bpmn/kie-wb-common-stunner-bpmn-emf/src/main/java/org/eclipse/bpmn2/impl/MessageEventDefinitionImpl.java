...
public class MessageEventDefinitionImpl extends EventDefinitionImpl implements MessageEventDefinition {
	...
	public void setOperationRef(Operation newOperationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.MESSAGE_EVENT_DEFINITION__OPERATION_REF,
	...
	public void setMessageRef(Message newMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.MESSAGE_EVENT_DEFINITION__MESSAGE_REF,

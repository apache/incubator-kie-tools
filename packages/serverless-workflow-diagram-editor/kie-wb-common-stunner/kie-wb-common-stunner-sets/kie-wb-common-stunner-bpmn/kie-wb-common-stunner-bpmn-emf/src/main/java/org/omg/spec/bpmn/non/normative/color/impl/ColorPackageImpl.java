...
public class ColorPackageImpl extends EPackageImpl implements ColorPackage {
	...
	public static ColorPackage init() {
		...
		Object registeredColorPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ColorPackageImpl theColorPackage = registeredColorPackage instanceof ColorPackageImpl ? (ColorPackageImpl)registeredColorPackage : new ColorPackageImpl();

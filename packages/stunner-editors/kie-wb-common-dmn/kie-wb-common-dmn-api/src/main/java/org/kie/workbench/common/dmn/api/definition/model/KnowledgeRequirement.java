...
@CanConnect(startRole = "decision-service", endRole = "decision")
@CanConnect(startRole = "decision-service", endRole = "business-knowledge-model")
...
public class KnowledgeRequirement extends DMNModelInstrumentedBase {
    ...
    @Labels
    private static final Set<String> stunnerLabels = Stream.of("knowledge-requirement").collect(Collectors.toSet());

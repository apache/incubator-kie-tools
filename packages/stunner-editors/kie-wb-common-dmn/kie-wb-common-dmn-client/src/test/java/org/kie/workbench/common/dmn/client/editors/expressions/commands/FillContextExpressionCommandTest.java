...
public class FillContextExpressionCommandTest {

    private FillContextExpressionCommand command;

    @Mock
    private HasExpression hasExpression;

    @Mock
    private ContextProps expressionProps;
    ...
    public void setup() {
        ...
        command = spy(new FillContextExpressionCommand(hasExpression,
                                                       expressionProps,
                                                       editorSelectedEvent,
                                                       "nodeUUID",
                                                       itemDefinitionUtils,
    ...
    public void testGetNewExpression() {
        ...
        assertTrue(newExpression instanceof Context);
    }

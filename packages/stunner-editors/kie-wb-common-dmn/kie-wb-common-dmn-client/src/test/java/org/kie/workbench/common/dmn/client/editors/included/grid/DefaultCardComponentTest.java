...
public class DefaultCardComponentTest extends BaseCardComponentTest<DefaultCardComponent, DefaultCardComponent.ContentView, DefaultIncludedModelActiveRecord> {

    @Override
    protected DefaultCardComponent.ContentView getCardView() {
        return mock(DefaultCardComponent.ContentView.class);
    }

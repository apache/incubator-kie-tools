...
public class FillRelationExpressionCommandTest {

    private FillRelationExpressionCommand command;

    @Mock
    private HasExpression hasExpression;

    @Mock
    private RelationProps expressionProps;
    ...
    public void setup() {
        ...
        command = spy(new FillRelationExpressionCommand(hasExpression,
                                                        expressionProps,
                                                        editorSelectedEvent,
                                                        nodeUUID,
                                                        itemDefinitionUtils,
    ...
    public void testGetNewExpression() {
        ...
        assertTrue(newExpression instanceof Relation);
    }

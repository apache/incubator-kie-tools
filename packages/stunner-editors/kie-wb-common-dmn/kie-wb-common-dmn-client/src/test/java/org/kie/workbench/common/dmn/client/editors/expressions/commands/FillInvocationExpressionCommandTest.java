...
public class FillInvocationExpressionCommandTest {

    private FillInvocationExpressionCommand command;

    @Mock
    private HasExpression hasExpression;

    @Mock
    private InvocationProps expressionProps;
    ...
    public void setup() {
        ...
        command = spy(new FillInvocationExpressionCommand(hasExpression,
                                                          expressionProps,
                                                          editorSelectedEvent,
                                                          "nodeUUID",
                                                          itemDefinitionUtils,
    ...
    public void testGetNewExpression() {
        ...
        assertTrue(newExpression instanceof Invocation);
    }

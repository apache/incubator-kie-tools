...
public class DiagramElementNameProviderImplTest {
    ...
    @Before
    public void setup() {
        nameProvider = new DiagramElementNameProviderImpl();
    }

    @Test
    public void testGetDefinitionSetId() {
        final String expected = "org.kie.workbench.common.dmn.api.DMNDefinitionSet";
        final String actual = nameProvider.getDefinitionSetId();

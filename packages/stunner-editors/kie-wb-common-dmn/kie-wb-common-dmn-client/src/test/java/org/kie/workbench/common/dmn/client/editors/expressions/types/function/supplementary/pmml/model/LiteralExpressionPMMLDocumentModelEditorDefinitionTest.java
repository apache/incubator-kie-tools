...
public class LiteralExpressionPMMLDocumentModelEditorDefinitionTest {
    ...
    public void setup() {
        ...
        this.definition = new LiteralExpressionPMMLDocumentModelEditorDefinition(definitionUtils,
                                                                                 sessionManager,
    ...
    public void testName() {
        assertEquals(DMNEditorConstants.ExpressionEditor_LiteralExpressionType + "-PMMLDocumentModel",
                     definition.getName());
    }

    @Test
    public void testModelDefinition() {
        final Optional<LiteralExpressionPMMLDocumentModel> oModel = definition.getModelClass();

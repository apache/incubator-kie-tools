...
public class RemovePMMLIncludedModelCommandTest {

    @Mock
    private DMNCardsGridComponent grid;

    @Mock
    private PMMLIncludedModelActiveRecord includedModel;
    ...
    private RemovePMMLIncludedModelCommand command;

    @Before
    public void setup() {
        command = spy(new RemovePMMLIncludedModelCommand(grid,
                                                         includedModel,
                                                         client,
    ...
    public void testRestoreDeletedModel() {
        ...
        final Integer modelCount = 27;

        command.setModelCount(modelCount);

        final PMMLIncludedModelActiveRecord restored = command.restoreDeletedModel();

        assertEquals(modelCount, restored.getModelCount());
    }
    ...
    public void testSaveDeletedIncludedModelData() {
        ...
        assertEquals(modelCount, command.getModelCount());

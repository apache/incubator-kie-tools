...
public class DMNConnectorShape
        extends BasicConnectorShape<DMNDefinition, ConnectorShapeDef<DMNDefinition, WiresConnectorViewExt>, WiresConnectorViewExt> {

    public DMNConnectorShape(final ConnectorShapeDef<DMNDefinition, WiresConnectorViewExt> shapeDef,

...
import org.kie.workbench.common.dmn.client.shape.view.connections.KnowledgeRequirementConnection;
...
public class KnowledgeRequirementView extends WiresConnectorViewExt<AbstractConnectorView> {

    public KnowledgeRequirementView(final double x1,
                                    final double y1,
                                    final double x2,
                                    final double y2) {
        this(new KnowledgeRequirementConnection(x1,
                                                y1,
                                                x2,
                                                y2));
    }

    private KnowledgeRequirementView(final KnowledgeRequirementConnection line) {

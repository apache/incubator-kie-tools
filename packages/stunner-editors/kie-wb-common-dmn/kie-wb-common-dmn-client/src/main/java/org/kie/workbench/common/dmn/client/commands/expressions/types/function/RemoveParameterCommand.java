...
public class RemoveParameterCommand extends AbstractCanvasGraphCommand implements VetoExecutionCommand,
                                                                                  VetoUndoCommand {
    ...
    private final int oldParameterIndex;

    public RemoveParameterCommand(final FunctionDefinition function,
        ...
        this.oldParameterIndex = function.getFormalParameter().indexOf(parameter);
    }
    ...
    protected Command<GraphCommandExecutionContext, RuleViolation> newGraphCommand(final AbstractCanvasHandler handler) {
        return new AbstractGraphCommand() {
            ...
            public CommandResult<RuleViolation> undo(final GraphCommandExecutionContext gce) {
                function.getFormalParameter().add(oldParameterIndex,
                                                  parameter);

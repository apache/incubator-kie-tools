...
public class AuthorityRequirementConnection extends Connection {

    static final double DECORATOR_RADIUS = 3;
    static final double DASHES = 4;
    static final double DASH = 4;

    public AuthorityRequirementConnection(final double x1,
                                          final double y1,
                                          final double x2,
                                          final double y2) {
        super(x1, y1, x2, y2);
    ...
    protected void setDashArray(final PolyLine line) {
        line.setDashArray(new DashArray(DASH, DASHES));
    }
}

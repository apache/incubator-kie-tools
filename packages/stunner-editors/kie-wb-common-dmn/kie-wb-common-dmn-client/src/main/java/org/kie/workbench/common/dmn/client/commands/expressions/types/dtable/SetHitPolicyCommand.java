...
public class SetHitPolicyCommand extends AbstractCanvasGraphCommand implements VetoExecutionCommand,
                                                                               VetoUndoCommand {
    ...
    private final Optional<HitPolicy> oldHitPolicy;

    public SetHitPolicyCommand(final DecisionTable dtable,
        ...
        this.oldHitPolicy = Optional.ofNullable(dtable.getHitPolicy());
    }
    ...
    protected Command<GraphCommandExecutionContext, RuleViolation> newGraphCommand(final AbstractCanvasHandler handler) {
        return new AbstractGraphCommand() {
            ...
            public CommandResult<RuleViolation> undo(final GraphCommandExecutionContext gce) {
                dtable.setHitPolicy(oldHitPolicy.orElse(HitPolicy.UNIQUE));

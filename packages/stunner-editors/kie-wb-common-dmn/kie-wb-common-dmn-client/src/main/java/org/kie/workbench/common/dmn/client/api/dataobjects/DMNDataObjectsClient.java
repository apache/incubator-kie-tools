...
public class DMNDataObjectsClient extends DMNServiceClient {
    ...
    @Inject
    public DMNDataObjectsClient(final DMNClientServicesProxy clientServicesProxy) {
        super(clientServicesProxy);
    }

    public void loadDataObjects(final Consumer<List<DataObject>> listConsumer) {
        clientServicesProxy.loadDataObjects(

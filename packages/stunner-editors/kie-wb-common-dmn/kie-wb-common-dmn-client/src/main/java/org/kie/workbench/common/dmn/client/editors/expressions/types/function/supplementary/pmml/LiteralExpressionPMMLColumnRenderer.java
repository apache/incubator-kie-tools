...
public class LiteralExpressionPMMLColumnRenderer extends StringColumnRenderer {
    ...
    @Override
    protected boolean isPlaceHolderToBeShown(final GridCell<String> cell) {
        return cell != null && cell.getValue() != null && StringUtils.isEmpty(cell.getValue().getValue()) && cell.getValue().getPlaceHolder() != null;
    }
}

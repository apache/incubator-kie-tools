...
import org.kie.workbench.common.dmn.client.shape.view.connections.InformationRequirementConnection;
...
public class InformationRequirementView extends WiresConnectorViewExt<AbstractConnectorView> {
    ...
    public InformationRequirementView(final double x1,
                                      ...
                                      final double x2,
                                      final double y2) {
        this(new InformationRequirementConnection(x1,
                                                  y1,
                                                  x2,
                                                  y2));
    }

    private InformationRequirementView(final InformationRequirementConnection line) {

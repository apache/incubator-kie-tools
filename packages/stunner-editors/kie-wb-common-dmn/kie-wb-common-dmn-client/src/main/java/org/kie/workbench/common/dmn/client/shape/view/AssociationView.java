...
import org.kie.workbench.common.dmn.client.shape.view.connections.AssociationViewConnection;
...
public class AssociationView extends WiresConnectorViewExt<AbstractConnectorView> {
    ...
    public AssociationView(final double x1,
                           ...
                           final double x2,
                           final double y2) {
        this(new AssociationViewConnection(x1,
                                           y1,
                                           x2,
                                           y2));
    }

    private AssociationView(final AssociationViewConnection line) {

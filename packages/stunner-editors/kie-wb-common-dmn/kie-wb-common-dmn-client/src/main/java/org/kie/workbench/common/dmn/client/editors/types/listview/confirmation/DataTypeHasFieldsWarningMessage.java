...
@Dependent
public class DataTypeHasFieldsWarningMessage extends WarningMessage {

    @Inject
    public DataTypeHasFieldsWarningMessage(final TranslationService translationService) {
        super(translationService);
    }

    @Override
    String getStrongMessage(final DataType dataType) {
        return translationService.format(DataTypeWithFieldsWarningMessage_StrongMessage);
    }

    @Override
    String getRegularMessage() {
        return translationService.format(DataTypeWithFieldsWarningMessage_RegularMessage);
    }
}

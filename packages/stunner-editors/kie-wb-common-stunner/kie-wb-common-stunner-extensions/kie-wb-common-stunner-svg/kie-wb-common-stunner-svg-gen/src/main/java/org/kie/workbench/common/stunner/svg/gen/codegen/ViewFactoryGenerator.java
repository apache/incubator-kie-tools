...
/**
 * Generates the source code for a managed bean that produces the different SVG shape views
 * that has been processes.
 */
public interface ViewFactoryGenerator {

    StringBuffer generate(final ViewFactory viewFactory) throws GeneratorException;
}

 ...
 */
//const testerHtmlTemplatePath = "https://raw.githubusercontent.com/kiegroup/kogito-editors-java/main/kie-wb-common-stunner/kie-wb-common-stunner-extensions/kie-wb-common-stunner-svg/kie-wb-common-stunner-svg-gen/src/test/resources/org/kie/workbench/common/stunner/svg/gen/tester/svg-shape-tester.html";
...
SVGStencilTester.prototype.navigateTo = function (target) {
  ...
  if ("shape-tester" === target) {
    ...
    const tester = self.diagramTesters.filter(function (e) {
...
SVGDiagramTester.prototype.generateCompositeSvg = function () {
  var content =
    '<svg id="' +
    this.svgDiagram.id +
    '" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" width="' +
    this.svgDiagram.width +
    'px" height="' +
    this.svgDiagram.height +
    'px">';
...
SVGDiagramTester.prototype.populateNodes = function (tester, diagramTesterPanel, index, onComplete) {
  ...
  const stencil = tester.stencilSet.stencils.filter(function (e) {

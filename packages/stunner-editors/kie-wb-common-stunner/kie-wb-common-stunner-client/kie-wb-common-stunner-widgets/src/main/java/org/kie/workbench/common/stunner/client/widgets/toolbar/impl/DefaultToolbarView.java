...
@Dependent
public class DefaultToolbarView extends Composite implements ToolbarView<Toolbar> {

    interface ViewBinder extends UiBinder<Widget, DefaultToolbarView> {
    ...
    private Toolbar presenter;

    @Override
    public void init(final Toolbar presenter) {

...
public class AttributeValueTextBoxTest {
    ...
    private AttributeValueTextBox textBox;
    ...
    public AttributeValueTextBoxTest(boolean caseSensitive) {
    ...
    public void testIsValidValue() {
        ...
        isValidResult = textBox.isValidValue(null,
                                             true);
        assertEquals("some error reg exp: ",
                     isValidResult);
        ...
        textBox.invalidValues = null;
        isValidResult = textBox.makeValidValue("AbC");
        assertEquals("AbC",
                     isValidResult);
    }

...
public class AppendNoneTaskShortcutTest extends BaseAppendNodeShortcutTest {

    @Override
    public AbstractAppendNodeShortcut getTestedShortcut() {
        return new AppendNoneTaskShortcut(toolboxDomainLookups,
    ...
    public List<KeyboardEvent.Key> getAcceptableKeys() {
        return Collections.singletonList(KeyboardEvent.Key.T);
    }

    @Override
    public Object getAcceptableTargetDefinition() {
        return BpmnNode.NONE_TASK.getDefinition();
    }

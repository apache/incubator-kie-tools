...
public class ScriptTypeFieldEditorWidget
        extends FieldEditorEditorWidget<ScriptTypeValue, ScriptTypeFieldEditorPresenter> {

    @Inject
    public ScriptTypeFieldEditorWidget(final ScriptTypeFieldEditorPresenter editor) {
        super(editor);
    }

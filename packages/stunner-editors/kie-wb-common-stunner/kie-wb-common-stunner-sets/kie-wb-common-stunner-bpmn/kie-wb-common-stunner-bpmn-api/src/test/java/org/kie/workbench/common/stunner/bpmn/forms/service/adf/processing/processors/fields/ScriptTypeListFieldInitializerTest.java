...
public class ScriptTypeListFieldInitializerTest
        extends ScriptTypeModeBasedFieldInitializerTestBase {

    @Override
    protected FieldDefinition mockFieldDefinition() {
        return mock(ScriptTypeListFieldDefinition.class);
    }

    @Override
    protected FieldInitializer newFieldInitializer() {
        return new ScriptTypeListFieldInitializer();
    }
    ...
    protected void checkModeWasSet(ScriptTypeMode mode) {
        verify(((ScriptTypeListFieldDefinition) fieldDefinition),

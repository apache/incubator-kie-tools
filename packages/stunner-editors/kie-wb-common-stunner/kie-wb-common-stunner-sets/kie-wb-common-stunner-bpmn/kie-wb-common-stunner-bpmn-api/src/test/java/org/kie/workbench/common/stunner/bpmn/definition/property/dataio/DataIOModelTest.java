...
public class DataIOModelTest {
    ...
    public void setUp() throws Exception {
        tested = new FakeDataIOModel();
    }

    @Test
    public void hasInputVars() {
        assertFalse(tested.hasInputVars());
    }

    @Test
    public void isSingleInputVar() {
        assertFalse(tested.isSingleInputVar());
    }

    @Test
    public void hasOutputVars() {
        assertFalse(tested.hasOutputVars());
    }

    @Test
    public void isSingleOutputVar() {
        assertFalse(tested.isSingleOutputVar());
    }

...
@Dependent
public class AssignmentsEditorFieldInitializer implements FieldInitializer<AssignmentsEditorFieldDefinition> {

    @Override
    public boolean supports(FieldDefinition fieldDefinition) {
        return fieldDefinition instanceof AssignmentsEditorFieldDefinition;
    }

    @Override
    public void initialize(AssignmentsEditorFieldDefinition field,

...
public class MessageExpression implements BPMNProperty {
    ...
    public MessageExpression(@MapsTo("value") final ScriptTypeValue value) {
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof MessageExpression) {
            MessageExpression other = (MessageExpression) o;

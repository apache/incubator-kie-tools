...
public class MultipleInstanceDataOutput implements BPMNProperty {
    ...
    public boolean equals(Object o) {
        if (o instanceof MultipleInstanceDataOutput) {
            MultipleInstanceDataOutput other = (MultipleInstanceDataOutput) o;

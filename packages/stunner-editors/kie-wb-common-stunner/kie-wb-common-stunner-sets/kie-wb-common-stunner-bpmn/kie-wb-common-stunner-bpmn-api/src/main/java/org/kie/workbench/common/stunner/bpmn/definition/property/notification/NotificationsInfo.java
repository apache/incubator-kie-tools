...
public class NotificationsInfo implements BPMNProperty {

    @Type
    public static final PropertyType type = new NotificationsType();

    @Value
    @FieldValue
    private NotificationTypeListValue value;

    public NotificationsInfo() {
        this.value = new NotificationTypeListValue();
    }

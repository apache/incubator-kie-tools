...
public class DataExpression implements BPMNProperty {
    ...
    public DataExpression(@MapsTo("value") final ScriptTypeValue value) {
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof DataExpression) {
            DataExpression other = (DataExpression) o;

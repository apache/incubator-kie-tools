...
public class MultipleInstanceDataInput implements BPMNProperty {
    ...
    public MultipleInstanceDataInput(final String value) {
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof MultipleInstanceDataInput) {
            MultipleInstanceDataInput other = (MultipleInstanceDataInput) o;

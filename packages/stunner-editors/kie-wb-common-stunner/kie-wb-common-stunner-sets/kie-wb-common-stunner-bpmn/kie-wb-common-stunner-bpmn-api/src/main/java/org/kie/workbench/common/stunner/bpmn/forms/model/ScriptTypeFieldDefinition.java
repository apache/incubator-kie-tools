...
@Portable
@Bindable
public class ScriptTypeFieldDefinition extends AbstractFieldDefinition {

    public static final ScriptTypeFieldType FIELD_TYPE = new ScriptTypeFieldType();

    private ScriptTypeMode mode = ACTION_SCRIPT;

    public ScriptTypeFieldDefinition() {
        super(ScriptTypeValue.class.getName());
    }

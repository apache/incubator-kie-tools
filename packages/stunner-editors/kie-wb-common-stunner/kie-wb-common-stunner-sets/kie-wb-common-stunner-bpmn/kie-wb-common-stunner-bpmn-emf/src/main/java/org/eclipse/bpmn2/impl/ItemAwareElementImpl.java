...
public class ItemAwareElementImpl extends BaseElementImpl implements ItemAwareElement {
		...
		if (newDataState != dataState) {
			...
			if (dataState != null)
				msgs = ((InternalEObject) dataState).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmn2Package.ITEM_AWARE_ELEMENT__DATA_STATE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.ITEM_AWARE_ELEMENT__DATA_STATE,
	...
	public void setItemSubjectRef(ItemDefinition newItemSubjectRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.ITEM_AWARE_ELEMENT__ITEM_SUBJECT_REF,

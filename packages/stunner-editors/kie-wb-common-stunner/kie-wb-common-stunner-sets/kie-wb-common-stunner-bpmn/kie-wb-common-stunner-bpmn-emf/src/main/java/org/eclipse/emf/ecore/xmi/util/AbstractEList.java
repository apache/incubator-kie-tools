...
public abstract class AbstractEList<E> extends AbstractList<E> implements EList<E> {
     ...
     * @throws IllegalArgumentException if a constraint prevents the object from being added.
     */
     ...
     * @throws IndexOutOfBoundsException if the index isn't within the size range.
     * @see #resolve
     * @see #get
     */
     ...
     * @throws IndexOutOfBoundsException if the index isn't within the size range.
     * @throws IllegalArgumentException if there is a constraint violation, e.g., non-uniqueness.
     * @see #setUnique
     */
    @Override
     ...
     * @param object the object to be added.
     * @throws IllegalArgumentException if {@link #isUnique uniqueness} is required,
     ...
     * @throws IndexOutOfBoundsException if the index isn't within the size range or the object isn't contained by the list.
     */
     ...
     * @throws IndexOutOfBoundsException if either index isn't within the size range.
     */
    ...
    protected class EIterator<E1> implements Iterator<E1> {
         ...
         * @throws NoSuchElementException if the iterator is done.
         */
        @SuppressWarnings("unchecked")
        public E1 next() {
            return (E1) doNext();
    ...
    protected class NonResolvingEIterator<E1> extends EIterator<E1> {
         ...
         * @throws UnsupportedOperationException always because it's not supported.
         */
        @Override
        public void remove() {
    ...
    protected class EListIterator<E1> extends EIterator<E1> implements ListIterator<E1> {
         ...
         * @param object the object to set.
         * @throws IllegalStateException if <code>next</code> or <code>previous</code> have not yet been called,

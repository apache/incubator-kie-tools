...
public class MessageFlowImpl extends BaseElementImpl implements MessageFlow {
		...
		if (messageRef != null && messageRef.eIsProxy()) {
			...
			if (messageRef != oldMessageRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.MESSAGE_FLOW__MESSAGE_REF,
	...
	public void setMessageRef(Message newMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.MESSAGE_FLOW__MESSAGE_REF, oldMessageRef,
					messageRef));
	}
	...
	public InteractionNode getSourceRef() {
		if (sourceRef != null && sourceRef.eIsProxy()) {
			...
			if (sourceRef != oldSourceRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.MESSAGE_FLOW__SOURCE_REF,
	...
	public void setSourceRef(InteractionNode newSourceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.MESSAGE_FLOW__SOURCE_REF, oldSourceRef,
					sourceRef));
	}
	...
	public InteractionNode getTargetRef() {
		if (targetRef != null && targetRef.eIsProxy()) {
			...
			if (targetRef != oldTargetRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.MESSAGE_FLOW__TARGET_REF,
	...
	public void setTargetRef(InteractionNode newTargetRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.MESSAGE_FLOW__TARGET_REF, oldTargetRef,
					targetRef));
	}

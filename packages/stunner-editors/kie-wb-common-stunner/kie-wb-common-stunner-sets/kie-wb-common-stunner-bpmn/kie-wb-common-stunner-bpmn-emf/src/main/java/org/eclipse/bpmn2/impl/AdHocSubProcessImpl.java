...
public class AdHocSubProcessImpl extends SubProcessImpl implements AdHocSubProcess {
		...
		if (newCompletionCondition != completionCondition) {
			...
			if (completionCondition != null)
				msgs = ((InternalEObject) completionCondition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmn2Package.AD_HOC_SUB_PROCESS__COMPLETION_CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.AD_HOC_SUB_PROCESS__COMPLETION_CONDITION,
	...
	public void setOrdering(AdHocOrdering newOrdering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.AD_HOC_SUB_PROCESS__ORDERING,

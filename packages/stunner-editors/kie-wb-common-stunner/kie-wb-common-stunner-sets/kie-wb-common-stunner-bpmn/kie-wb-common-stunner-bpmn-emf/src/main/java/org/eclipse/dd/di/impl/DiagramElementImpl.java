...
public class DiagramElementImpl extends EObjectImpl implements DiagramElement {
	...
	public EObject getModelElement() {
		if (modelElement != null && modelElement.eIsProxy()) {
			...
			if (modelElement != oldModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiPackage.DIAGRAM_ELEMENT__MODEL_ELEMENT,
	...
	public Style getStyle() {
		if (style != null && style.eIsProxy()) {
			...
			if (style != oldStyle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiPackage.DIAGRAM_ELEMENT__STYLE,
							oldStyle, style));
			}
		}
		return style;

...
public class SendTaskImpl extends TaskImpl implements SendTask {
	...
	public Message getMessageRef() {
		if (messageRef != null && messageRef.eIsProxy()) {
			...
			if (messageRef != oldMessageRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.SEND_TASK__MESSAGE_REF,
	...
	public void setMessageRef(Message newMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEND_TASK__MESSAGE_REF, oldMessageRef,
					messageRef));
	}
	...
	public Operation getOperationRef() {
		if (operationRef != null && operationRef.eIsProxy()) {
			...
			if (operationRef != oldOperationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.SEND_TASK__OPERATION_REF,

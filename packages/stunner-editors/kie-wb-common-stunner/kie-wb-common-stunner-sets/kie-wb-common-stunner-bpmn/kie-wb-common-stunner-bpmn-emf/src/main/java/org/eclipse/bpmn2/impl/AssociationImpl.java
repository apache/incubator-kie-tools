...
public class AssociationImpl extends ArtifactImpl implements Association {
	...
	public void setAssociationDirection(AssociationDirection newAssociationDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.ASSOCIATION__ASSOCIATION_DIRECTION,
	...
	public BaseElement getSourceRef() {
		if (sourceRef != null && sourceRef.eIsProxy()) {
			...
			if (sourceRef != oldSourceRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.ASSOCIATION__SOURCE_REF,
	...
	public void setSourceRef(BaseElement newSourceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.ASSOCIATION__SOURCE_REF, oldSourceRef,
					sourceRef));
	}
	...
	public BaseElement getTargetRef() {
		if (targetRef != null && targetRef.eIsProxy()) {
			...
			if (targetRef != oldTargetRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.ASSOCIATION__TARGET_REF,
	...
	public void setTargetRef(BaseElement newTargetRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.ASSOCIATION__TARGET_REF, oldTargetRef,
					targetRef));
	}

		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmn2Package.COMPLEX_BEHAVIOR_DEFINITION__CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.COMPLEX_BEHAVIOR_DEFINITION__CONDITION,
		...
		if (newEvent != event) {
			...
			if (event != null)
				msgs = ((InternalEObject) event).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmn2Package.COMPLEX_BEHAVIOR_DEFINITION__EVENT, null, msgs);
			if (newEvent != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.COMPLEX_BEHAVIOR_DEFINITION__EVENT,
					newEvent, newEvent));
	}

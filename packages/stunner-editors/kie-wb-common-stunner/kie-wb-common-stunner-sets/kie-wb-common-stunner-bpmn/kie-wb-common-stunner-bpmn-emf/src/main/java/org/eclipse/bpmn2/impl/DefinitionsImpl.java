...
public class DefinitionsImpl extends BaseElementImpl implements Definitions {
	...
	public void setExporter(String newExporter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.DEFINITIONS__EXPORTER, oldExporter,
					exporter));
	}
	...
	public void setExporterVersion(String newExporterVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.DEFINITIONS__EXPORTER_VERSION,
	...
	public void setExpressionLanguage(String newExpressionLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.DEFINITIONS__EXPRESSION_LANGUAGE,
	...
	public void setTargetNamespace(String newTargetNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.DEFINITIONS__TARGET_NAMESPACE,
	...
	public void setTypeLanguage(String newTypeLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.DEFINITIONS__TYPE_LANGUAGE,
					oldTypeLanguage, typeLanguage));
	}

...
/**
 * This {@link WorkspaceService} implementation is used when the envelope API is not available.
 */
public class DefaultWorkspaceServiceImpl implements WorkspaceService {

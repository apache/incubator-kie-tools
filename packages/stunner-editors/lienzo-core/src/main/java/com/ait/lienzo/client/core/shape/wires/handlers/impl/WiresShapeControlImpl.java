...
public class WiresShapeControlImpl
    ...
    public void onMoveStart(final double x,
        ...
        m_child_connectors = getShape().getChildShapes() != null && !getShape().getChildShapes().isEmpty() ?
                lookupChildrenConnectorsToUpdate() :
                Collections.emptyList();

        forEachConnectorControl(lookupChildrenConnectorsToUpdate(), new Consumer<WiresConnectorControl>() {
            @Override
    ...
    private Collection<WiresConnector> lookupChildrenConnectorsToUpdate() {
        return WiresShapeControlUtils.lookupChildrenConnectorsToUpdate(getShape()).values();
    }
    ...
    public void execute() {
        ...
        if (null == m_child_connectors || m_child_connectors.isEmpty()) {
            forEachConnectorControl(lookupChildrenConnectorsToUpdate(), WiresControl::execute);
        }
    ...
    public void clear() {
        ...
        if (null == m_child_connectors || m_child_connectors.isEmpty()) {
            forEachConnectorControl(lookupChildrenConnectorsToUpdate(), WiresControl::clear);
        }
    ...
    public void reset() {
        ...
        getShape().shapeMoved();
        if (null == m_child_connectors || m_child_connectors.isEmpty()) {
            forEachConnectorControl(lookupChildrenConnectorsToUpdate(), WiresControl::reset);
        }

...
@Dependent
public class IntegerEditableColumnGenerator extends AbstractNumericEditableColumnGenerator<Integer> {
    ...
    public boolean doValidate(String flatValue,
                                 TableEntry<Integer> model,
                                 CellEditionHandler<Integer> cellEditionHandler) {
    ...
    @Override
    public Integer doConvert(String flatValue) {
        return Integer.valueOf(flatValue);
    }
}

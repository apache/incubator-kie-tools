...
public class DoubleEditableColumnGeneratorTest extends AbstractNumericEditableColumnGeneratorTest<Double, DoubleEditableColumnGenerator> {

    private String correctFlatValue = "123456.908";

    private Double correctValue = new Double(correctFlatValue);

    private String wrongFlatValue = "abcd";

    @Override
    protected DoubleEditableColumnGenerator getGeneratorInstance(TranslationService translationService) {
        return new DoubleEditableColumnGenerator(translationService);
    }
    ...
    @Override
    protected Double getCorrectValue() {
        return correctValue;
    }
}

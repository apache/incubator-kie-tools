...
public class BigDecimalEditableColumnGeneratorTest extends AbstractNumericEditableColumnGeneratorTest<BigDecimal, BigDecimalEditableColumnGenerator> {

    private String correctFlatValue = "1234567890.1234567890";

    private BigDecimal correctValue = new BigDecimal(correctFlatValue);

    private String wrongFlatValue = "abcd";

    @Override
    protected BigDecimalEditableColumnGenerator getGeneratorInstance(TranslationService translationService) {
        return new BigDecimalEditableColumnGenerator(translationService);
    }
    ...
    @Override
    protected BigDecimal getCorrectValue() {
        return correctValue;
    }
}

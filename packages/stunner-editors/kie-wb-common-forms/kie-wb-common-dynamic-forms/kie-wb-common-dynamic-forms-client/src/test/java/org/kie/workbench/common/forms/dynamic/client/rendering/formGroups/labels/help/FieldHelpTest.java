...
public class FieldHelpTest {
    ...
    public void testFunctionality() {
        ...
        fieldHelp = new FieldHelp(view);

        verify(view).init(fieldHelp);

        fieldHelp.showHelpMessage(HELP_MESSAGE);

        verify(view).showHelpMessage(HELP_MESSAGE);

        fieldHelp.getElement();

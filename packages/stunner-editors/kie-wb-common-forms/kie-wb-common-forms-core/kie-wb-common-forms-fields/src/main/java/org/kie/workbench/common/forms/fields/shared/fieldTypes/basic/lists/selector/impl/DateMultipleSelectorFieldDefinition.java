...
public class DateMultipleSelectorFieldDefinition extends AbstractMultipleSelectorFieldDefinition<Date> {
    ...
    public DateMultipleSelectorFieldDefinition() {
        super(Date.class.getName());
    }

    @Override
    public List<Date> getListOfValues() {
        return listOfValues;
    }

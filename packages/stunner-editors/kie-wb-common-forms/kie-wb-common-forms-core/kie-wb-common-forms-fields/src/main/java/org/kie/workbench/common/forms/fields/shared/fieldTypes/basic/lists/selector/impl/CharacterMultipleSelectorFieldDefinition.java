...
public class CharacterMultipleSelectorFieldDefinition extends AbstractMultipleSelectorFieldDefinition<Character> {
    ...
    private List<Character> listOfValues = new ArrayList<>();

    public CharacterMultipleSelectorFieldDefinition() {
        super(Character.class.getName());
    }

    @Override
    public List<Character> getListOfValues() {
        return listOfValues;
    }

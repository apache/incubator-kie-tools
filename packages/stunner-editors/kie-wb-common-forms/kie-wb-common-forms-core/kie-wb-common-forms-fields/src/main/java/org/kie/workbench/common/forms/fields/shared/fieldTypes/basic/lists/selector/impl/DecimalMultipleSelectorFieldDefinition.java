...
public class DecimalMultipleSelectorFieldDefinition extends AbstractMultipleSelectorFieldDefinition<Double> {
    ...
    public DecimalMultipleSelectorFieldDefinition() {

...
public class BooleanMultipleSelectorFieldDefinition extends AbstractMultipleSelectorFieldDefinition<Boolean> {
    ...
    public BooleanMultipleSelectorFieldDefinition() {
        super(Boolean.class.getName());
    }

    @Override
    public List<Boolean> getListOfValues() {
        return listOfValues;
    }

...
public class DefaultSelectorOptionTest extends AbstractSelectorOptionTest<Object> {
    ...
    @Override
    protected SelectorOption newSelectorOption(Object value, String text) {
        return new DefaultSelectorOption(value, text);
    }

    @Test
    public void testDefaultConstructor() {
        option = new DefaultSelectorOption();
    ...
    public void testSetValue() {
        DefaultSelectorOption opt = new DefaultSelectorOption();
        opt.setValue(valueB);

...
public class CharacterMultipleSelectorFieldDefinitionTest extends AbstractFieldDefinitionTest<CharacterMultipleSelectorFieldDefinition> {

    @Override
    protected CharacterMultipleSelectorFieldDefinition getEmptyFieldDefinition() {
        return new CharacterMultipleSelectorFieldDefinition();
    }

    @Override
    protected CharacterMultipleSelectorFieldDefinition getFullFieldDefinition() {
        CharacterMultipleSelectorFieldDefinition fieldDefinition = new CharacterMultipleSelectorFieldDefinition();

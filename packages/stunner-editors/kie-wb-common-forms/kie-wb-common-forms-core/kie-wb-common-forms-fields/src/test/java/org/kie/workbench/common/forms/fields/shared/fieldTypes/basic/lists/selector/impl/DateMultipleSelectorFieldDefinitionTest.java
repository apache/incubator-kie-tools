...
public class DateMultipleSelectorFieldDefinitionTest extends AbstractFieldDefinitionTest<DateMultipleSelectorFieldDefinition> {
    ...
    @Override
    protected DateMultipleSelectorFieldDefinition getEmptyFieldDefinition() {
        return new DateMultipleSelectorFieldDefinition();
    }

    @Override
    protected DateMultipleSelectorFieldDefinition getFullFieldDefinition() {
        DateMultipleSelectorFieldDefinition fieldDefinition = new DateMultipleSelectorFieldDefinition();

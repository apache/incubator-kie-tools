...
public class CharacterSelectorOptionTest extends AbstractSelectorOptionTest<Character> {
    ...
    @Override
    protected SelectorOption newSelectorOption(Character value, String text) {
        return new CharacterSelectorOption(value, text);
    }
    ...
    public void testSetValue() {
        CharacterSelectorOption opt = new CharacterSelectorOption();
        opt.setValue(valueB);

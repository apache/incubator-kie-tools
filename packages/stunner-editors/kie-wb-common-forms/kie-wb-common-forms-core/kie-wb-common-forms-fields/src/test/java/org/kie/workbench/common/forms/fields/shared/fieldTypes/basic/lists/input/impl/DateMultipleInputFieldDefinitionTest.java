...
public class DateMultipleInputFieldDefinitionTest extends AbstractFieldDefinitionTest<DateMultipleInputFieldDefinition> {
    ...
    @Override
    protected DateMultipleInputFieldDefinition getEmptyFieldDefinition() {
        return new DateMultipleInputFieldDefinition();
    }

    @Override
    protected DateMultipleInputFieldDefinition getFullFieldDefinition() {
        DateMultipleInputFieldDefinition fieldDefinition = new DateMultipleInputFieldDefinition();

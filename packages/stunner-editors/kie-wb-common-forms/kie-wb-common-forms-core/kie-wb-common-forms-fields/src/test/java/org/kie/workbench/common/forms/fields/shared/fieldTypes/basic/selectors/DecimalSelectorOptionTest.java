...
public class DecimalSelectorOptionTest extends AbstractSelectorOptionTest<Double> {
    ...
    @Override
    protected SelectorOption newSelectorOption(Double value, String text) {
        return new DecimalSelectorOption(value, text);
    }
    ...
    public void testSetValue() {
        DecimalSelectorOption opt = new DecimalSelectorOption();
        opt.setValue(valueB);

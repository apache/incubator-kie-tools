...
public class DecimalMultipleSelectorFieldDefinitionTest extends AbstractFieldDefinitionTest<DecimalMultipleSelectorFieldDefinition> {
    ...
    @Override
    protected DecimalMultipleSelectorFieldDefinition getEmptyFieldDefinition() {
        return new DecimalMultipleSelectorFieldDefinition();
    }

    @Override
    protected DecimalMultipleSelectorFieldDefinition getFullFieldDefinition() {
        DecimalMultipleSelectorFieldDefinition fieldDefinition = new DecimalMultipleSelectorFieldDefinition();

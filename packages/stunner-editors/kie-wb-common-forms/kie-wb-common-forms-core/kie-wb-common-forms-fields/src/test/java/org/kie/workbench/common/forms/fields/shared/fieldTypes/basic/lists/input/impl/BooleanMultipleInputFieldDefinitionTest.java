...
public class BooleanMultipleInputFieldDefinitionTest extends AbstractFieldDefinitionTest<BooleanMultipleInputFieldDefinition> {
    ...
    @Override
    protected BooleanMultipleInputFieldDefinition getEmptyFieldDefinition() {
        return new BooleanMultipleInputFieldDefinition();
    }

    @Override
    protected BooleanMultipleInputFieldDefinition getFullFieldDefinition() {
        BooleanMultipleInputFieldDefinition fieldDefinition = new BooleanMultipleInputFieldDefinition();

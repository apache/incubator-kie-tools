...
public class CharacterMultipleInputFieldDefinitionTest extends AbstractFieldDefinitionTest<CharacterMultipleInputFieldDefinition> {
    ...
    @Override
    protected CharacterMultipleInputFieldDefinition getEmptyFieldDefinition() {
        return new CharacterMultipleInputFieldDefinition();
    }

    @Override
    protected CharacterMultipleInputFieldDefinition getFullFieldDefinition() {
        CharacterMultipleInputFieldDefinition fieldDefinition = new CharacterMultipleInputFieldDefinition();

...
@Dependent
public class DoubleSliderFieldInitializer extends AbstractSliderFieldInitializer<DoubleSliderDefinition, Double> {
    ...
    @Override
    protected Double parseValue(String rawValue) {

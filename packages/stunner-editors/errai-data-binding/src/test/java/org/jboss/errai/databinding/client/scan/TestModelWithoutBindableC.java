...
public class TestModelWithoutBindableC {
  ...
  public TestModelWithoutBindableC(String value) {
    this.value = value;
  }
  ...
  public void setChild(TestModelWithoutBindableC child) {
    this.child = child;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    TestModelWithoutBindableC other = (TestModelWithoutBindableC) obj;
    if (child == null) {
      if (other.child != null)
        return false;
    }

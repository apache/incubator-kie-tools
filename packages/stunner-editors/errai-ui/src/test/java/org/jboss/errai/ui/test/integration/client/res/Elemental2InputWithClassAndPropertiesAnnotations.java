 ...
 */
@ClassNames({ "foo", "bar" })
@Properties({ @Property(name = "id", value = "foo"), @Property(name = "placeholder", value = "bar") })
@JsType(isNative = true, namespace = JsPackage.GLOBAL, name = "HTMLElement")
public class Elemental2InputWithClassAndPropertiesAnnotations extends HTMLInputElement {
}

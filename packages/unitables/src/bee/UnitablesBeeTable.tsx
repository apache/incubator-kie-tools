...
function UnitablesBeeTableCell({
  ...
  // FIXME: Decouple from DMN --> ahttps://github.com/apache/incubator-kie-issues/issues/166
  const setValue = useCallback(
    (newValue?: string) => {
      ...
      if (field.enum) {
        ...
        // FIXME: Support lists --> ahttps://github.com/apache/incubator-kie-issues/issues/167

 ...
 *
 * <ul>
 *   <li>is annotated with {@code @Qualifier}, {@code @Retention(RUNTIME)}, and typically
 *       {@code @Documented}.
 *   <li>can have attributes.
 *   <li>may be part of the public API, much like the dependency type, but unlike implementation
 *       types which needn't be part of the public API.
 *   <li>may have restricted usage if annotated with {@code @Target}. While this specification
 *       covers applying qualifiers to fields and parameters only, some injector configurations

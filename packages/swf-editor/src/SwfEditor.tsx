...
export type SwfEditorProps = {
  ...
  /**
   * To show information about execution results directly on the SWF diagram, use this prop.
   */
  evaluationResults?: EvaluationResults;
  /**
   * To show information about validation messages directly on the SWF diagram, use this prop.
   */
  ...
  /**
   * All paths inside the SWF Editor are relative. To be able to resolve them and display them as absolute paths, this function is called.

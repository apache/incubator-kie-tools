...
import { generateUuid } from "../swfUtils";
...
export function Draggable(props: {
  ...
  const rowClassName = useMemo(() => {
    let className = "kie-swf-editor--draggable-row";

    if (hovered) {
      className += " kie-swf-editor--draggable-row-hovered";
    }

    if (isDragging) {
      className += " kie-swf-editor--draggable-row-is-dragging";
    }
  ...
  return (
    <div
      ...
      data-testid={`kie-tools--swf-editor--draggable-row-${props.index}`}
    >
      {!props.isDisabled ? (
        <div data-testid={"kie-tools--swf-editor--draggable-icon"}>
          <Icon
            className={"kie-swf-editor--draggable-icon"}
          ...
          >
            <GripVerticalIcon
              className={
                hovered ? "kie-swf-editor--draggable-icon-handler-hovered" : "kie-swf-editor--draggable-icon-handler"
              }
            />
          </Icon>
        </div>
      ...
      <div
        ...
        className={`kie-swf-editor--draggable-children ${props.childrenClassName ? props.childrenClassName : ""}`}
        data-testid={"kie-tools--swf-editor--draggable-children"}
      >

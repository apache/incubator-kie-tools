...
export function EvaluationHighlightsBadge() {
  ...
  const isEvaluationHighlightsEnabled = useSwfEditorStore((s) => s.diagram.overlays.enableEvaluationHighlights);

  return (
    <aside className={"kie-swf-editor--evaluation-highlights-panel-toggle"}>
      <Label
      ...
      >
        Evaluation highlights: {swfEditorStoreApi.getState().diagram.overlays.enableEvaluationHighlights ? "on" : "off"}
      </Label>
    </aside>
  );
}

...
export interface DMN12__tDMNElement {
  ...
  extensionElements?: DMN12__tDMNElement__extensionElements; // from type DMN12__tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tDMNElement__extensionElements {}

export interface DMN12__tNamedElement {
  ...
  extensionElements?: DMN12__tNamedElement__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tNamedElement__extensionElements {}

export type DMN12__tDMNElementReference = {
  "@_href": string; // from type DMN12__tDMNElementReference @ DMN12.xsd
};

export interface DMN12__tDefinitions extends XmlParserTsRootElementBaseType {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tDefinitions__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tDefinitions__extensionElements {}

export interface DMN12__tImport {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tImport__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tImport__extensionElements {}

export interface DMN12__tElementCollection {
  drgElement?: DMN12__tDMNElementReference[]; // from type DMN12__tElementCollection @ DMN12.xsd
  "@_name": string; // from type tNamedElement @ DMN12.xsd
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tElementCollection__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tElementCollection__extensionElements {}

export interface DMN12__tDRGElement {
  "@_name": string; // from type tNamedElement @ DMN12.xsd
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tDRGElement__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tDRGElement__extensionElements {}

export interface DMN12__tDecision {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tDecision__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tDecision__extensionElements {}

export interface DMN12__tBusinessContextElement {
  "@_URI"?: string; // from type DMN12__tBusinessContextElement @ DMN12.xsd
  "@_name": string; // from type tNamedElement @ DMN12.xsd
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tBusinessContextElement__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tBusinessContextElement__extensionElements {}

export interface DMN12__tPerformanceIndicator {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tPerformanceIndicator__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tPerformanceIndicator__extensionElements {}

export interface DMN12__tOrganizationUnit {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tOrganizationUnit__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tOrganizationUnit__extensionElements {}

export interface DMN12__tInvocable {
  variable?: DMN12__tInformationItem; // from type DMN12__tInvocable @ DMN12.xsd
  "@_name": string; // from type tNamedElement @ DMN12.xsd
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tInvocable__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tInvocable__extensionElements {}

export interface DMN12__tBusinessKnowledgeModel {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tBusinessKnowledgeModel__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tBusinessKnowledgeModel__extensionElements {}

export interface DMN12__tInputData {
  variable?: DMN12__tInformationItem; // from type DMN12__tInputData @ DMN12.xsd
  "@_name": string; // from type tNamedElement @ DMN12.xsd
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tInputData__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tInputData__extensionElements {}

export interface DMN12__tKnowledgeSource {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tKnowledgeSource__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tKnowledgeSource__extensionElements {}

export interface DMN12__tInformationRequirement {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tInformationRequirement__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tInformationRequirement__extensionElements {}

export interface DMN12__tKnowledgeRequirement {
  requiredKnowledge: DMN12__tDMNElementReference; // from type DMN12__tKnowledgeRequirement @ DMN12.xsd
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tKnowledgeRequirement__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tKnowledgeRequirement__extensionElements {}

export interface DMN12__tAuthorityRequirement {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tAuthorityRequirement__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tAuthorityRequirement__extensionElements {}

export interface DMN12__tExpression {
  "@_typeRef"?: string; // from type DMN12__tExpression @ DMN12.xsd
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tExpression__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tExpression__extensionElements {}

export interface DMN12__tItemDefinition {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tItemDefinition__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tItemDefinition__extensionElements {}

export interface DMN12__tLiteralExpression {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tLiteralExpression__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tLiteralExpression__extensionElements {}

export interface DMN12__tInvocation {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tInvocation__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tInvocation__extensionElements {}
...
export interface DMN12__tInformationItem {
  "@_typeRef"?: string; // from type DMN12__tInformationItem @ DMN12.xsd
  "@_name": string; // from type tNamedElement @ DMN12.xsd
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tInformationItem__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tInformationItem__extensionElements {}

export interface DMN12__tDecisionTable {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tDecisionTable__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tDecisionTable__extensionElements {}

export interface DMN12__tInputClause {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tInputClause__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tInputClause__extensionElements {}

export interface DMN12__tOutputClause {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tOutputClause__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tOutputClause__extensionElements {}

export type DMN12__tRuleAnnotationClause = {
  "@_name"?: string; // from type DMN12__tRuleAnnotationClause @ DMN12.xsd
};

export interface DMN12__tDecisionRule {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tDecisionRule__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tDecisionRule__extensionElements {}

export type DMN12__tRuleAnnotation = {
  text?: string; // from type DMN12__tRuleAnnotation @ DMN12.xsd
};

export interface DMN12__tImportedValues {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tImportedValues__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tImportedValues__extensionElements {}

export interface DMN12__tArtifact {
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tArtifact__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tArtifact__extensionElements {}

export interface DMN12__tTextAnnotation {
  "@_textFormat"?: string; // from type DMN12__tTextAnnotation @ DMN12.xsd
  text?: string; // from type DMN12__tTextAnnotation @ DMN12.xsd
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tTextAnnotation__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tTextAnnotation__extensionElements {}

export interface DMN12__tAssociation {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tAssociation__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tAssociation__extensionElements {}

export interface DMN12__tContext {
  contextEntry?: DMN12__tContextEntry[]; // from type DMN12__tContext @ DMN12.xsd
  "@_typeRef"?: string; // from type tExpression @ DMN12.xsd
  "@_id"?: string; // from type tDMNElement @ DMN12.xsd
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tContext__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tContext__extensionElements {}

export interface DMN12__tContextEntry {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tContextEntry__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tContextEntry__extensionElements {}

export interface DMN12__tFunctionDefinition {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tFunctionDefinition__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tFunctionDefinition__extensionElements {}

export interface DMN12__tRelation {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tRelation__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tRelation__extensionElements {}

export interface DMN12__tList {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tList__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tList__extensionElements {}
...
export interface DMN12__tUnaryTests {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tUnaryTests__extensionElements; // from type tDMNElement @ DMN12.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMN12__tUnaryTests__extensionElements {}

export interface DMN12__tDecisionService {
  ...
  "@_label"?: string; // from type tDMNElement @ DMN12.xsd
  description?: string; // from type tDMNElement @ DMN12.xsd
  extensionElements?: DMN12__tDecisionService__extensionElements; // from type tDMNElement @ DMN12.xsd
}
...
export interface DMNDI12__DMNDiagram {
  ...
  "di:extension"?: DMNDI12__DMNDiagram__extension; // from type DiagramElement @ DI.xsd
...
export interface DMNDI12__DMNShape {
  ...
  "@_sharedStyle"?: string; // from type DiagramElement @ DI.xsd
  "@_id"?: string; // from type DiagramElement @ DI.xsd
  "di:extension"?: DMNDI12__DMNShape__extension; // from type DiagramElement @ DI.xsd
  "dmndi:DMNStyle"?: DMNDI12__DMNStyle; // from type di:Style @ DI.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMNDI12__DMNShape__extension {}

export interface DMNDI12__DMNDecisionServiceDividerLine {
  "di:waypoint"?: DC__Point[]; // from type Edge @ DI.xsd
  "@_sharedStyle"?: string; // from type DiagramElement @ DI.xsd
  "@_id"?: string; // from type DiagramElement @ DI.xsd
  "di:extension"?: DMNDI12__DMNDecisionServiceDividerLine__extension; // from type DiagramElement @ DI.xsd
  "dmndi:DMNStyle"?: DMNDI12__DMNStyle; // from type di:Style @ DI.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMNDI12__DMNDecisionServiceDividerLine__extension {}

export interface DMNDI12__DMNEdge {
  ...
  "@_sharedStyle"?: string; // from type DiagramElement @ DI.xsd
  "@_id"?: string; // from type DiagramElement @ DI.xsd
  "di:extension"?: DMNDI12__DMNEdge__extension; // from type DiagramElement @ DI.xsd
  "dmndi:DMNStyle"?: DMNDI12__DMNStyle; // from type di:Style @ DI.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMNDI12__DMNEdge__extension {}

export interface DMNDI12__DMNLabel {
  "dmndi:Text"?: string; // from type DMNDI12__DMNLabel @ DMNDI12.xsd
  "dc:Bounds"?: DC__Bounds; // from type dc:Bounds @ DI.xsd
  "@_sharedStyle"?: string; // from type DiagramElement @ DI.xsd
  "@_id"?: string; // from type DiagramElement @ DI.xsd
  "di:extension"?: DMNDI12__DMNLabel__extension; // from type DiagramElement @ DI.xsd
  "dmndi:DMNStyle"?: DMNDI12__DMNStyle; // from type di:Style @ DI.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMNDI12__DMNLabel__extension {}

export interface DMNDI12__DMNStyle {
  ...
  "di:extension"?: DMNDI12__DMNStyle__extension; // from type Style @ DI.xsd
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface DMNDI12__DMNStyle__extension {}

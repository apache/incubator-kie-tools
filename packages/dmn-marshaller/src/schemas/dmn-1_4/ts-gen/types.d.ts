...
import { DMN14__tDMNElementExtensionType } from "../ts-gen-extensions/DMN14__tDMNElementExtensionType";
...
export type DMN14__tDMNElement = {
  ...
  extensionElements?: any; // from type DMN14__tDMNElement @ DMN14.xsd
} & DMN14__tDMNElementExtensionType;

export type DMN14__tNamedElement = {
  ...
  extensionElements?: any; // from type tDMNElement @ DMN14.xsd
};
...
export type DMN14__tDefinitions = Partial<{ [k: `@_xmlns:${string}`]: string }> & { "@_xmlns"?: string } & {
...
export type DMN14__tElementCollection = {
...
export type DMN14__tDRGElement = {
  "@_name": string; // from type tNamedElement @ DMN14.xsd
  "@_id"?: string; // from type tDMNElement @ DMN14.xsd
  "@_label"?: string; // from type tDMNElement @ DMN14.xsd
  description?: string; // from type tDMNElement @ DMN14.xsd
...
export type DMN14__tBusinessContextElement = {
...
export type DMN14__tPerformanceIndicator = {
...
export type DMN14__tOrganizationUnit = {
...
export type DMN14__tBusinessKnowledgeModel = {
...
export type DMN14__tKnowledgeSource = {
...
export type DMN14__tInformationRequirement = {
...
export type DMN14__tKnowledgeRequirement = {
...
export type DMN14__tAuthorityRequirement = {
...
export type DMN14__tExpression = {
...
export type DMN14__tItemDefinition = {
...
export type DMN14__tFunctionItem = {
...
export type DMN14__tLiteralExpression = {
...
export type DMN14__tInvocation = {
...
export type DMN14__tInformationItem = {
...
export type DMN14__tDecisionTable = {
...
export type DMN14__tInputClause = {
...
export type DMN14__tOutputClause = {
...
export type DMN14__tDecisionRule = {
...
export type DMN14__tImportedValues = {
...
export type DMN14__tTextAnnotation = {
...
export type DMN14__tAssociation = {
...
export type DMN14__tContextEntry = {
...
export type DMN14__tFunctionDefinition = {
...
export type DMN14__tUnaryTests = {
...
export type DMN14__tDecisionService = {
...
export type DMN14__tQuantified = {
...
export type DMN14__tConditional = {
...
export type DMNDI13__DMNDiagram = {
...
export type DMNDI13__DMNDecisionServiceDividerLine = {

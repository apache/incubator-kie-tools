...
import { DMN13__tDMNElementExtensionType } from "../ts-gen-extensions/DMN13__tDMNElementExtensionType";
...
export type DMN13__tDMNElement = {
  ...
  extensionElements?: any; // from type DMN13__tDMNElement @ DMN13.xsd
} & DMN13__tDMNElementExtensionType;

export type DMN13__tNamedElement = {
  ...
  extensionElements?: any; // from type tDMNElement @ DMN13.xsd
};
...
export type DMN13__tDefinitions = Partial<{ [k: `@_xmlns:${string}`]: string }> & { "@_xmlns"?: string } & {
...
export type DMN13__tElementCollection = {
...
export type DMN13__tDRGElement = {
  "@_name": string; // from type tNamedElement @ DMN13.xsd
  "@_id"?: string; // from type tDMNElement @ DMN13.xsd
  "@_label"?: string; // from type tDMNElement @ DMN13.xsd
  description?: string; // from type tDMNElement @ DMN13.xsd
...
export type DMN13__tBusinessContextElement = {
...
export type DMN13__tPerformanceIndicator = {
...
export type DMN13__tOrganizationUnit = {
...
export type DMN13__tBusinessKnowledgeModel = {
...
export type DMN13__tKnowledgeSource = {
...
export type DMN13__tInformationRequirement = {
...
export type DMN13__tKnowledgeRequirement = {
...
export type DMN13__tAuthorityRequirement = {
...
export type DMN13__tExpression = {
...
export type DMN13__tItemDefinition = {
...
export type DMN13__tFunctionItem = {
...
export type DMN13__tLiteralExpression = {
...
export type DMN13__tInvocation = {
...
export type DMN13__tInformationItem = {
...
export type DMN13__tDecisionTable = {
...
export type DMN13__tInputClause = {
...
export type DMN13__tOutputClause = {
...
export type DMN13__tDecisionRule = {
...
export type DMN13__tImportedValues = {
...
export type DMN13__tTextAnnotation = {
...
export type DMN13__tAssociation = {
...
export type DMN13__tContextEntry = {
...
export type DMN13__tFunctionDefinition = {
...
export type DMN13__tUnaryTests = {
...
export type DMN13__tDecisionService = {

...
import { ns as dmn15ns } from "../dmn-1_5/ts-gen/meta";
import { ns as dmn16ns } from "./ts-gen/meta";
...
export const DMN16_SPEC = {
  ...
  expressionLanguage: { default: `https://www.omg.org/spec/DMN/20240513/FEEL/` },
  typeLanguage: { default: `https://www.omg.org/spec/DMN/20240513/FEEL/` },
  IMPORT: {
    name: {
      isValid: (id: string, name: string, allUniqueNames: UniqueNameIndex) => {
        ...
        // Source: https://www.omg.org/spec/DMN/1.6/Beta1/PDF. PDF page 40, document page 32. Section "6.3.3 Import Metamodel".
        return name === "" || DMN16_SPEC.namedElement.isValidName(id, name, allUniqueNames);
      },
    },
  },
  BOXED: {

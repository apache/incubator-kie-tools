...
import { AttributeLabelsEditMode } from "./AttributeLabelsEditMode";
...
export const AttributeLabels = (props: AttributeLabelsProps) => {
  const { activeAttribute, viewAttribute } = props;
  ...
  return (
    <>
      ...
      <AttributeLabelsEditMode viewAttribute={viewAttribute} />
    </>
  );
};

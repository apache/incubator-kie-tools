...
export interface ServerlessWorkflowDiagramEditorEnvelopeApi extends KogitoEditorEnvelopeApi, CanvasEnvelopeApi {
  kogitoSwfLanguageService__highlightNode2(args: { nodeName: string; documentUri?: string }): void;
  kogitoSwfLanguageService__highlightNode3(args: { nodeName: string; documentUri?: string }): Promise<void>;
}

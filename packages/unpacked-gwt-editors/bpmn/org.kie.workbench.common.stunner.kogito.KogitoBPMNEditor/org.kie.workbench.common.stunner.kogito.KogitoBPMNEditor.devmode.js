...
var __gwtModuleFunction = $wnd.org_kie_workbench_common_stunner_kogito_KogitoBPMNEditor;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.org.kie.workbench.common.stunner.kogito.KogitoBPMNEditor=");
    idx += (13 + "org.kie.workbench.common.stunner.kogito.KogitoBPMNEditor".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=org.kie.workbench.common.stunner.kogito.KogitoBPMNEditor-0.js

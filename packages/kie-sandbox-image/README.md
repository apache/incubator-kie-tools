...
1. Run a container with custom environment variables:
   ...
   |                `KIE_SANDBOX_CORS_PROXY_URL`                 |                       The URL that points to the CORS proxy for interacting with external servicesƒ.                        | See [ defaultEnvJson.ts ](../online-editor/build/defaultEnvJson.ts) |

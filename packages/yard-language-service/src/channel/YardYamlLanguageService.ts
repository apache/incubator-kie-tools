...
export class YardYamlLanguageService implements IEditorLanguageService {
  private readonly ls: YardLanguageService;
  private readonly yamlELs: EditorYamlLanguageService;
  private readonly codeCompletionStrategy: YardYamlCodeCompletionStrategy;
...
export class YardYamlCodeCompletionStrategy implements CodeCompletionStrategy {

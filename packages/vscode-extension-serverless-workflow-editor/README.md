...
| `kogito.swf.svgFilenameTemplate`                               | Filename template to be used when generating SVG files                                                                                                                                                                                                  | `${fileBasenameNoExtension}-svg.svg`                                             |
...
| `kogito.swf.serviceRegistryUrl`                                | The Service Registry URL to fetch artifacts that improve the functions autocompletion mechanism.                                                                                                                                                        | `(empty)`                                                                        |

...
export class EmbeddedWorkflowFormChannelApiImpl implements WorkflowFormChannelApi {
  ...
  workflowForm__startWorkflow(endpoint: string, data: Record<string, any>): Promise<void> {

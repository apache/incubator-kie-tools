...
export class ServerlessWorkflowMermaidViewerResources extends BaseEditorResources {
  public get(args: { resourcesPathPrefix: string }) {
    ...
    return swfMermaidViewerResources;
  }
  ...
  public getTemplatePath() {
    return "dist/resources/swf/swfMermaidViewerEnvelopeIndex.template";
  }

  public getHtmlOutputPath() {
    return "dist/resources/swf/swfMermaidViewerEnvelopeIndex.html";
  }
}

    ...
    tasks: [
      ...
      },
      {
        ...
        description: `<div class="sectionbody">
          ...
          <div class="paragraph">
          <p>For more information, see <a href="#proc-setting-github-token-serverless-logic-web-tools">Setting your GitHub token in Serverless Logic Web Tools</a>.</p>
          </div>
          </li>
          </ul>
          </div>
          ...
          <div class="content"><img src="images/quickstarts/serverless-logic-web-tools-github-repo.png" alt="serverless logic web tools github repo"></div>
          ...
          <td class="content">
          <div class="paragraph">
          <p><strong>NOTE</strong><br>Currently, Serverless Logic Web Tools cannot resolve the merge conflicts. Therefore, ensure that you always pull changes before working on your files.</p>
          </div>
          </td>
          </tr>
          </tbody>

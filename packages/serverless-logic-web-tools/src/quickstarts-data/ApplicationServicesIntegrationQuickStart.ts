...
export const ApplicationServicesIntegrationQuickStart: QuickStart = {
  ...
  spec: {
    ...
    description: "",
    introduction: ` Some of the features in Serverless Logic Web Tools require integration with Red Hat OpenShift Application and Data Services. Consider uploading OpenAPI specifications to a service registry and deploying Serverless Workflow that requires Apache Kafka as examples of integration with Red Hat OpenShift Application and Data Services.
    ...
    tasks: [
      {
        ...
        description: `<div class="sectionbody">
          ...
          <div class="ulist">
          <div class="title"><strong><em>Prerequisites</em></strong></div>
          <ul>
          <li>
          ...
          <div class="title"><strong><em>Procedure</em></strong></div>
          <ol class="arabic">
          <li>
          ...
          <td class="content">
          <div class="paragraph">
          <p><b>NOTE</b><br />You can skip this step if you already have a service account.</p>
          </div>
          </td>
          </tr>
          </tbody></table>
      ...
      },
      {
        ...
        description: `<div class="sectionbody">
          ...
          <div class="ulist">
          <div class="title"><em><strong>Prerequisites</strong></em></div>
          <ul>
          <li>
          <p>You have access to the Red Hat OpenShift Application and Data Services console.</p>
          </li>
          ...
          <div class="paragraph">
          <p>For information about creating a service account, see <a href="#proc-create-service-account-serverless-logic-web-tools">Creating a service account in Red Hat OpenShift application and Data Services</a>.</p>
          </div>
          </li>
          </ul>
          </div>
          <div class="olist arabic">
          <div class="title"><em><strong>Procedure</strong></em></div>
          <ol class="arabic">
          <li>
          ...
          <td class="content">
          <div class="paragraph">
          <p><strong>NOTE</strong><br>You can skip this step if you already have a Service Registry instance.</p>
          </div>
          </td>
          </tr>
          </tbody>
          ...
          <td class="content">
          <div class="paragraph">
          <p><strong>IMPORTANT<br></strong>You must select the role as Manager or Administrator to have the read and write access.</p>
          </div>
          </td>
          </tr>
          </tbody>
      ...
      {
        title: "Creating Streams for Apache Kafka in Red Hat OpenShift application and Data Services",
        description: `<div class="sectionbody">
<div class="paragraph">
<p>You can create or use a Kafka instance from Red Hat OpenShift Application and Data Services console and add the instance to the Serverless Logic Web Tools.</p>
</div>
<div class="ulist">
<div class="title"><em><strong>Prerequisites</strong></em></div>
<ul>
...
<ol class="arabic">
<li>
<p>To create an Apache Kafka instance in Red Hat Openshift Application and Data Services console, perform the following steps:</p>
<div class="openblock">
<div class="content">
<div class="admonitionblock note">
<table>
...
<td class="content">
<div class="paragraph">
<p><strong>NOTE<br></strong>You can skip this step if you already have an Apache Kafka instance.</p>
</div>
</td>
</tr>
</tbody>
...
<ol class="loweralpha" type="a">
<li>
<p>Go to <a href="https://console.redhat.com/application-services/streams/kafkas">Streams for Apache Kafka | Red Hat OpenShift Application and Data Services</a>.</p>
</li>
<li>
<p>Click <strong>Create Kafka instance</strong>.</p>
</li>
<li>
<p>In the <strong>Create a Kafka instance</strong> window, enter the name for a Kafka instance.</p>
<div class="paragraph">
<p>You can also fill the other fields or leave those fields with default values.</p>
</div>
</li>
<li>
...
<li>
<p>Reload the <strong>Kafka instances</strong> page for the list of instances to reflect the instance you created.</p>
</li>
<li>
<p>Once the status of the Kafka instance you created is updated as <strong>Ready</strong>, click on the instance.</p>
</li>
<li>
<p>Go to the <strong>Topics</strong> tab and create a new topic.</p>
</li>
<li>
<p>Go to the <strong>Access</strong> tab, click <strong>Manage Access</strong>, and select <strong>All Accounts</strong> or the service account you created.</p>
</li>
<li>
...
<ul>
<li>
<p><em>Consumer group is " * " | Allow All | All Accounts</em>;</p>
</li>
<li>
<p><em>Topic is " * " | Allow All | All Accounts</em>;</p>
</li>
</ul>
</div>
</li>
...
<li>
<p>Copy the value of <strong>Bootstrap server</strong>.</p>
</li>
</ol>
</div>
</div>
...
<li>
<p>If you already have a Kafka instance, find the value of <strong>Bootstrap server</strong> of your Kafka instance.</p>
</li>
<li>
<p>In the Serverless Logic Web Tools web application, click on the <strong>Cog wheel</strong> (⚙️) on the top-right corner and go to the <strong>Streams for Apache Kafka</strong> tab.</p>
</li>
<li>
<p>Enter the value of <strong>Bootstrap server</strong>.</p>
</li>
<li>
<p>Enter the name of topic you created in the <strong>Topic</strong> field and click <strong>Apply</strong>.</p>
<div class="paragraph">
<p>The content in the <strong>Streams for Apache Kafka</strong> tab updates and displays <strong>Your Streams for Apache Kafka information is set</strong> message.</p>
</div>
</li>
</ol>
</div>
...
<td class="content">
<div class="paragraph">
<p><strong>NOTE<br></strong>The procedures in this document make the integration easy for you. However, you can also create specific service accounts, topics, and consumer groups.</p>
</div>
</td>
</tr>
</tbody>

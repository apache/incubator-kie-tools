                          ...
                          <tr>
                            ...
                            <td class="content">
                              <div class="paragraph">
                                <p>
                                  <strong>NOTE <br>
                                  </strong>You can skip this step if you already have an Apache Kafka instance.
                                </p>
                              </div>
                            </td>
                          </tr>
                        ...
                        <li>
                          ...
                          <div class="ulist">
                            <ul>
                              <li>
                                <p>
                                  <em>Consumer group is " * " | Allow All | All Accounts</em>;
                                </p>
                              </li>
                              <li>
                                <p>
                                  <em>Topic is " * " | Allow All | All Accounts</em>;
                                </p>
                              </li>
                            </ul>
                          </div>
                ...
                <tr>
                  ...
                  <td class="content">
                    <div class="paragraph">
                      <p>
                        <strong>NOTE <br>
                        </strong>The procedures in this document make the integration easy for you. However, you can also create specific service accounts, topics, and consumer groups.
                      </p>
                    </div>
                  </td>
                </tr>

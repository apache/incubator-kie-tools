    ...
    tasks: [
      ...
      },
      {
        ...
        description: `<div class="sect1">
          ...
          <div class="content"><img src="images/quickstarts/serverless-logic-web-tools-openshift-project.png" alt="serverless logic web tools openshift project"></div>
          ...
          <div class="imageblock">
          <div class="content"><img src="images/quickstarts/serverless-logic-web-tools-openshift-info.png" alt="serverless logic web tools openshift info"></div>
          ...
          <td class="content">
          <div class="paragraph">
          <p><b>NOTE</b><br />If your OpenShift instance uses self-signed certificates, then you might need to enable <code>InsecureSkipVerify</code> on KIE Sandbox Extended Services.</p>
          </div>
          </td>
          </tr>
          </tbody>

...
import { GeneralRegressionModel, MiningSchema } from "../../model/pmml4_4";
 ...
 */
export const GENERAL_REGRESSION_MODEL: string = `
...
//Construction of a GeneralRegressionModel data-structure can be peformed in the JSONata mapping however
...
export function generalRegressionModelFactory(): GeneralRegressionModel {

...
import { MiningSchema, NeuralNetwork } from "../../model/pmml4_4";
 ...
 */
export const NEURAL_NETWORK_MODEL: string = `
...
//Construction of a NeuralNetwork data-structure can be peformed in the JSONata mapping however
...
export function neuralNetworkFactory(): NeuralNetwork {

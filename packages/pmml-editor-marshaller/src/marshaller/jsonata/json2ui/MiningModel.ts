...
import { MiningModel, MiningSchema } from "../../model/pmml4_4";
 ...
 */
export const MINING_MODEL: string = `
...
//Construction of a MiningModel data-structure can be peformed in the JSONata mapping however

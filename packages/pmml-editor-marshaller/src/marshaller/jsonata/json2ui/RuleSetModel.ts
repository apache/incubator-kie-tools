...
export const RULE_SET_MODEL: string = `
...
//Construction of a RuleSetModel data-structure can be peformed in the JSONata mapping however
...
export function ruleSetModelFactory(): RuleSetModel {

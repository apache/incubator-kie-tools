 ...
 */
export const BAYESIAN_NETWORK_MODEL: string = `
...
//Construction of a BayesianNetworkModel data-structure can be peformed in the JSONata mapping however
...
export function bayesianNetworkModelFactory(): BayesianNetworkModel {

...
export const SUPPORT_VECTOR_MACHINE_MODEL: string = `
...
//Construction of a SupportVectorMachineModel data-structure can be peformed in the JSONata mapping however
...
export function supportVectorMachineModelFactory(): SupportVectorMachineModel {

 ...
 */
export const ANOMALY_DETECTION_MODEL: string = `
...
//Construction of a AnomalyDetectionModel data-structure can be peformed in the JSONata mapping however
...
export function anomalyDetectionModelFactory(): AnomalyDetectionModel {

 ...
 */
import { MiningSchema, TreeModel } from "../../model/pmml4_4";
...
export const TREE_MODEL: string = `
...
//Construction of a TreeModel data-structure can be peformed in the JSONata mapping however
...
export function treeModelFactory(): TreeModel {

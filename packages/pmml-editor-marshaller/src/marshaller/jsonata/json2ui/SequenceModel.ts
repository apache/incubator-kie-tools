...
export const SEQUENCE_MODEL: string = `
...
//Construction of a SequenceModel data-structure can be peformed in the JSONata mapping however
...
export function sequenceModelFactory(): SequenceModel {

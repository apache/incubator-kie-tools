 ...
 */
export const ASSOCIATION_MODEL: string = `
...
//Construction of a AssociationModel data-structure can be peformed in the JSONata mapping however
...
export function associationModelFactory(): AssociationModel {

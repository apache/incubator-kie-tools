 ...
 */
export const GAUSSIAN_PROCESS_MODEL: string = `
...
//Construction of a GaussianProcessModel data-structure can be peformed in the JSONata mapping however
...
export function gaussianProcessModelFactory(): GaussianProcessModel {

...
export type CompoundPredicateBooleanOperator =
  | "or"
  | "and"
  | "xor"
  | "surrogate";
...
export type OutputFieldAlgorithm =
  | "recommendation"
...
export type TextIndexLocalTermWeights =
  | "termFrequency"
  | "binary"
  | "logarithmic"
...
export type DecisionTreeNoTrueChildStrategy =
...
export type TreeModelNoTrueChildStrategy =
  | "returnNullPrediction"
  | "returnLastPrediction";

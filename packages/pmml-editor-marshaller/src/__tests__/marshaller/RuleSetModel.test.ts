...
import { DataDictionary, Model, PMML, RuleSetModel } from "../../marshaller/model/pmml4_4";
...
describe("RuleSetModel tests", () => {
  test("RuleSetModel::Basics for DMN", () => {
    ...
    expect(models[0]).toBeInstanceOf(RuleSetModel);

    const model: RuleSetModel = models[0] as RuleSetModel;

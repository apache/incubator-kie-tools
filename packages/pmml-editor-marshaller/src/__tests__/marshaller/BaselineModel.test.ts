...
import { BaselineModel, DataDictionary, Model, PMML } from "../../marshaller/model/pmml4_4";
...
describe("BaselineModel tests", () => {
  test("BaselineModel::Basics for DMN", () => {
    ...
    expect(models[0]).toBeInstanceOf(BaselineModel);

    const model: BaselineModel = models[0] as BaselineModel;

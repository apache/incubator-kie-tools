 ...
 */
import { BayesianNetworkModel, DataDictionary, Model, PMML, XML2PMML } from "@kogito-tooling/pmml-editor-marshaller";
...
describe("BayesianNetworkModel tests", () => {
  test("BayesianNetworkModel::Basics for DMN", () => {
    ...
    expect(models[0]).toBeInstanceOf(BayesianNetworkModel);

    const model: BayesianNetworkModel = models[0] as BayesianNetworkModel;

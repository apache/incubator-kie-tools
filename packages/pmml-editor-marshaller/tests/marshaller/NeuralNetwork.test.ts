 ...
 */
import { DataDictionary, Model, NeuralNetwork, PMML, XML2PMML } from "@kogito-tooling/pmml-editor-marshaller";
...
describe("NeuralNetwork tests", () => {
  test("NeuralNetwork::Basics for DMN", () => {
    ...
    expect(models[0]).toBeInstanceOf(NeuralNetwork);

    const model: NeuralNetwork = models[0] as NeuralNetwork;

 ...
 */
import { DataDictionary, Model, PMML, SequenceModel, XML2PMML } from "@kogito-tooling/pmml-editor-marshaller";
...
describe("SequenceModel tests", () => {
  test("SequenceModel::Basics for DMN", () => {
    ...
    expect(models[0]).toBeInstanceOf(SequenceModel);

    const model: SequenceModel = models[0] as SequenceModel;

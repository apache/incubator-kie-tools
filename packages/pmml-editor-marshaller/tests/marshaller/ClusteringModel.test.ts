 ...
 */
import { ClusteringModel, DataDictionary, Model, PMML, XML2PMML } from "@kogito-tooling/pmml-editor-marshaller";
...
describe("ClusteringModel tests", () => {
  test("ClusteringModel::Basics for DMN", () => {
    ...
    expect(models[0]).toBeInstanceOf(ClusteringModel);

    const model: ClusteringModel = models[0] as ClusteringModel;

...
export const open = (args: { container: Element; initialContent: Promise<string>; readOnly?: boolean }): any => {
  const container = document.getElementById("serverlessworkflow-editor-container")!;
  ...
  init({
    container: args.container.appendChild(iframe),

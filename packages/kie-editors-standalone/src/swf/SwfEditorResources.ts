...
export class ServerlessworkflowEditorResources extends BaseEditorResources {
  public get(args: { resourcesPathPrefix: string }) {
    ...
    const swfEditorResources: any = {
      envelopeJsResource: this.createResource({ path: `dist/envelope/swf-envelope.js` }),
  ...
  public getTemplatePath() {
    return "dist/resources/swf/swfEnvelopeIndex.template";
  }

  public getHtmlOutputPath() {
    return "dist/resources/swf/swfEnvelopeIndex.html";
  }
}

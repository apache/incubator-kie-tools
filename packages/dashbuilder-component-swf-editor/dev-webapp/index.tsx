...
import { SwfEditorComponent } from "../src/SwfEditorComponent";

const api = new ComponentApi();

ReactDOM.render(<SwfEditorComponent controller={api.getComponentController()} />, document.getElementById("app")!);

...
export type BpmnEditorStandaloneResource = { contentType: "text" | "binary"; content: Promise<string> };

export class BpmnEditorStandaloneChannelApiImpl implements KogitoEditorChannelApi {
  constructor(

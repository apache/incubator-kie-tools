...
- Auto-genreated TypeScript type definitions for a JSON-friendly representation of BPMN models (using `@kie-tools/xml-parser-ts-gen`).
...
```ts
import { BPMN20__tDefinitions } from "@kie-tools/bpmn-marshaller";

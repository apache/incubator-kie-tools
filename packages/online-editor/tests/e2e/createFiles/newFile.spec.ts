...
test.describe("New file", () => {
  ...
  test.describe("Home", () => {
    ...
    test("should create BPMN new file", async ({ page, onlineEditor }) => {
    ...
    test("should create DMN new file", async ({ page, onlineEditor }) => {
    ...
    test("should create PMML new file", async ({ page, onlineEditor }) => {

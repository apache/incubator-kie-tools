...
export const en: OnlineI18n = {
  ...
  devDeployments: {
    common: {
      ...
      selectAuthentication: "Select authentication",
      authenticationExpired: "Authentication expired",
      devDeployments: "Dev Deployments",
      selectCloudProvider: "Select Cloud Provider",
      errorFetchingDevDeployments: "Error fetching Dev Deployments.",
      noDeploymentsFound: "No Dev Deployments found",
      chooseCloudProvider: "Choose a Cloud provider to see your Dev Deployments.",
      selectCloudForDev: "Select Cloud provider for this Dev Deployment...",
      deployWorkspace: `Deploy ${"{name}"}`,
      forDevelopmentOnly: "For development only!",
    },
    ...
    dropdown: {
      ...
      selectCloudProviderInDropdown: "Select Cloud provider...",
      refreshToken: (refreshCountdownInSeconds: number) => `Refreshing in ${refreshCountdownInSeconds} seconds...`,
    ...
    deployConfirmModal: {
      ...
      devDeploymentNamespace: `This Dev Deployment will be created at the ${"{namespace}"} namespace.`,
      precomputedValues:
        "You can use tokens with pre-computed values for your resources and parameters. Check a list of the available tokens below:",
    },
    deleteConfirmModal: {
      ...
      resourcesToBeDeleted: "The following resources will be deleted:",
      loading: "Loading",
    },
    alerts: {
      deployStartedError:
  ...
  homePage: {
    uploadFile: {
      ...
      dragAndDropDescription: "Drag & drop files and folders here...",
      upload: "Upload",
      uploadItems: (count: number) => `Upload ${count} items(s).`,
      uploadingItems: (count: number) => `Uploading ${count} file(s).`,
      selectFiles: "Select files...",
      selectFolders: "Select folder...",
      trySampleinHomepage: "Try sample",
      trySampleModels: "Try sample models",
      newTitle: (name: string) => `New ${name}`,
      nothingHere: "Nothing here",
      startByAdding: "Start by adding a new model",
      create: "Create",
      import: "Import",
      recentModels: "Recent models",
      errorObtainingInfo: (workspaceId: string) => `There was an error obtaining information for '${workspaceId}'`,
      addFile: "Add file",
      modelsInFile: (name: string) => `Models in '${name}'`,
      newEditorAvailable: `New Editor available!`,
      delete: "Delete",
      deleteFileName: `Delete ${"{fileName}"}`,
      errorFetchingWorkspace: (error: string) => `Error fetching workspaces: ${error}`,
    },
    openUrl: {

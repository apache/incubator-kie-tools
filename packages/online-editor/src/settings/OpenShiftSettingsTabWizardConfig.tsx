...
// import { useDmnDevSandbox } from "../editor/DmnDevSandbox/DmnDevSandboxContext";
...
// import { DEVELOPER_SANDBOX_GET_STARTED_URL } from "../editor/DmnDevSandbox/OpenShiftService";
//
// enum WizardStepIds {
//   NAMESPACE = "NAMESPACE",
...
// }
//
// export function OpenShiftSettingsTabWizardConfig() {
...
//       resetConfig(config);
//     },
//     [config, dmnDevSandboxContext, isContinueEditingLoading, isDeployLoading, resetConfig]
//   );
//
...
//
//   return (
//     <Wizard steps={wizardSteps} height={480} footer={wizardFooter} onNext={onStepChanged} onGoToStep={onStepChanged} />
//   );
// }

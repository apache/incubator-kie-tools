...
import { Association, TaskFormChannelApi, TaskFormEnvelopeApi, TaskFormInitArgs } from "../api";
...
export class TaskFormEnvelopeApiImpl implements TaskFormEnvelopeApi {
  ...
  taskForm__init = async (association: Association, initArgs: TaskFormInitArgs): Promise<void> => {

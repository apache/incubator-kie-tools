...
export class ProcessFormEnvelopeViewDriver implements ProcessFormDriver {
  constructor(private readonly channelApi: MessageBusClientApi<ProcessFormChannelApi>) {}

  getProcessFormSchema(processDefinitionData: ProcessDefinition): Promise<Record<string, any>> {
    return this.channelApi.requests.processForm__getProcessFormSchema(processDefinitionData);
  }

...
import { TaskInboxEnvelopeView, TaskInboxEnvelopeViewApi } from "./TaskInboxEnvelopeView";
...
export function init(args: { config: EnvelopeDivConfig; container: HTMLDivElement; bus: EnvelopeBus }) {
  ...
  const envelopeViewDelegate = async () => {
    ...
    return new Promise<() => TaskInboxEnvelopeViewApi>((res) => {
      ReactDOM.render(<TaskInboxEnvelopeView ref={ref} channelApi={envelope.channelApi} />, args.container, () =>
        res(() => ref.current!)
      );
    });
  };

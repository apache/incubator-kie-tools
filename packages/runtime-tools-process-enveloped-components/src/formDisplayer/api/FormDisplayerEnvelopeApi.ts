...
import { Association, FormDisplayerInitArgs, FormSubmitContext, FormSubmitResponse } from "./types";

export interface FormDisplayerEnvelopeApi {
  formDisplayer__init(association: Association, initArgs: FormDisplayerInitArgs): Promise<void>;

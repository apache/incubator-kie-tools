...
export const FormsListEnvelopeView = React.forwardRef<FormsListEnvelopeViewApi, Props>((props, forwardedRef) => {
  ...
  return (
    <React.Fragment>
      <FormsList isEnvelopeConnectedToChannel={isEnvelopeConnectedToChannel} channelApi={props.channelApi} />
    </React.Fragment>
  );
});

...
import { Job, JobStatus, JobsSortBy, OrderBy } from "@kie-tools/runtime-tools-swf-gateway-api/dist/types";
import {
  BulkListType,
  IOperationResults,
  IOperations,
} from "@kie-tools/runtime-tools-components/dist/components/BulkList";
import { OperationType } from "@kie-tools/runtime-tools-swf-gateway-api/dist/types";
...
import "../styles.css";
import { formatForBulkListJob, setTitle } from "@kie-tools/runtime-tools-components/dist/utils/Utils";
...
const JobsManagement: React.FC<JobsManagementProps & OUIAProps> = ({
  ...
  const handleJobReschedule = async (job, repeatInterval, repeatLimit, scheduleDate) => {

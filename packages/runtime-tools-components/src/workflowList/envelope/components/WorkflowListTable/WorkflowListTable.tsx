...
import { WorkflowInstance, TitleType, WorkflowInstanceState } from "@kie-tools/runtime-tools-common";
...
import { EndpointLink } from "@kie-tools/runtime-tools-common/dist/components/EndpointLink";
import {
  KogitoEmptyState,
  KogitoEmptyStateType,
} from "@kie-tools/runtime-tools-common/dist/components/KogitoEmptyState";
import { KogitoSpinner } from "@kie-tools/runtime-tools-common/dist/components/KogitoSpinner";
import { ItemDescriptor } from "@kie-tools/runtime-tools-common/dist/components/ItemDescriptor";

...
import { WorkflowInstanceState, WorkflowInstance } from "@kie-tools/runtime-tools-common";
import { BulkListItem } from "@kie-tools/runtime-tools-common/dist/components/BulkList";

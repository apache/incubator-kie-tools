...
import { WorkflowInstance, WorkflowInstanceState, WorkflowInstanceFilter } from "@kie-tools/runtime-tools-common";
import { BulkListType, IOperationResults, IOperations } from "@kie-tools/runtime-tools-common/dist/components/BulkList";

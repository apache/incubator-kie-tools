...
export function getNodeLabelSvgTextAlignmentProps(
  ...
  switch (labelPosition) {
    case "center-bottom":
      const cbTx = n.position.x! + (n.measured?.width ?? 0) / 2;
      const cbTy = n.position.y! + (n.measured?.height ?? 0) + 4;
      const cbWidth = n.measured?.width ?? 0;
      return {
    ...
    case "center-center":
      const ccTx = n.position.x! + (n.measured?.width ?? 0) / 2;
      const ccTy = n.position.y! + (n.measured?.height ?? 0) / 2;
      const ccWidth = (n.measured?.width ?? 0) - 2 * SVG_NODE_LABEL_TEXT_PADDING_ALL;
      return {
    ...
    case "top-center":
      const tcTx = n.position.x! + (n.measured?.width ?? 0) / 2;
      const tcTy = n.position.y! + SVG_NODE_LABEL_TEXT_PADDING_ALL;
      const tcWidth = (n.measured?.width ?? 0) - 2 * SVG_NODE_LABEL_TEXT_PADDING_ALL;
      return {
        verticalAnchor: "start",
        textAnchor: "middle",
    ...
    case "center-left":
      ...
      const clTy = n.position.y! + (n.measured?.height ?? 0) / 2;
      const clWidth = (n.measured?.width ?? 0) - 2 * SVG_NODE_LABEL_TEXT_PADDING_ALL;
      return {
        verticalAnchor: "middle",
        textAnchor: "start",
    ...
    case "top-left":
      ...
      const tlWidth =
        (n.measured?.width ?? 0) -
        2 * SVG_NODE_LABEL_TEXT_PADDING_ALL -
        2 * SVG_NODE_LABEL_TEXT_ADDITIONAL_PADDING_TOP_LEFT;
      return {
        verticalAnchor: "start",
        textAnchor: "start",

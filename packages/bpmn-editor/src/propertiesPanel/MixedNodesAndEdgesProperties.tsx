  ...
  return (
    <>
      <Form>
                ...
                <Flex justifyContent={{ default: "justifyContentCenter" }}>
                  <TextContent>
                    <Text component={TextVariants.h4}>
                      <Truncate
                        content={i18n.propertiesPanel.edgesNodesSelected(size)}
                        position={"middle"}
        ...
        >
          <br />
          <FormSection style={{ textAlign: "center" }}>{i18n.propertiesPanel.cantEditProperties}</FormSection>
        </FormSection>
      </Form>
      <br />
      <br />
      <Flex justifyContent={{ default: "justifyContentSpaceBetween" }}>
        ...
        >
          {i18n.propertiesPanel.selectOnlyNodes}
        </Button>
        <Button
          variant={ButtonVariant.link}
          onClick={() => {
        ...
        >
          {i18n.propertiesPanel.selectOnlyEdges}
        </Button>
      </Flex>
    </>
  );

    ...
    in`) === 0;
      ...
      var ReactElement = function (type, key, ref, self2, source, owner, props) {
        ...
        return (
          ...
          Object.defineProperty(element, "_self", { configurable: !1, enumerable: !1, writable: !1, value: self2 }),
      ...
      function createElement2(type, config, children) {
        ...
        if (type && type.defaultProps) {
          ...
          for (propName in defaultProps) props[propName] === void 0 && (props[propName] = defaultProps[propName]);
        }
        if (key || ref) {
      ...
      function getPooledTraverseContext(mapResult, keyPrefix, mapFunction, mapContext) {
        ...
        } else return { result: mapResult, keyPrefix, func: mapFunction, context: mapContext, count: 0 };
      }
        ...
        if (Array.isArray(children))
          ...
          if (typeof iteratorFn == "function") {
            iteratorFn === children.entries &&
              ...
              (didWarnAboutMaps = !0));
            for (var iterator = iteratorFn.call(children), step, ii = 0; !(step = iterator.next()).done; )
              (child = step.value),
...
Check the top-level render call using <` +
      ...
      var createElement$1 = createElementWithValidation,
        ...
        Children = { map: mapChildren, forEach: forEachChildren, count: countChildren, toArray, only: onlyChild };
    ...
    (function () {
      ...
      function handleTimeout(currentTime) {
        if (((isHostTimeoutScheduled = !1), advanceTimers(currentTime), !isHostCallbackScheduled))
          if (peek2(taskQueue) !== null) (isHostCallbackScheduled = !0), requestHostCallback(flushWork);
          else {
      ...
      function getValueForProperty(node2, name, expected, propertyInfo) {
        if (propertyInfo.mustUseProperty) {
          ...
          if (propertyInfo.type === OVERLOADED_BOOLEAN) {
            ...
            if (shouldRemoveAttribute(name, expected, propertyInfo, !1)) return node2.getAttribute(attributeName);
        ...
        if (!shouldIgnoreAttribute(name, propertyInfo, isCustomComponentTag)) {
          if (
            ...
            if (isAttributeNameSafe(name)) {
              ...
              value === null ? node2.removeAttribute(_attributeName) : node2.setAttribute(_attributeName, "" + value);
            }
            return;
          }
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`,
      ...
      function getValueFromNode(node2) {
        var value = "";
        return (
          node2 && (isCheckable(node2) ? (value = node2.checked ? "true" : "false") : (value = node2.value)), value
        );
      }
      ...
      function updateWrapper(element, props) {
        ...
        if (value != null)
          type === "number"
            ? ((value === 0 && node2.value === "") || node2.value != value) && (node2.value = toString(value))
        ...
        props.hasOwnProperty("value")
          ...
          props.checked == null && props.defaultChecked != null && (node2.defaultChecked = !!props.defaultChecked);
      }
...
Check the render method of \`` +
      ...
      function postMountWrapper$2(element, props) {
        ...
        value != null
          ...
          : props.defaultValue != null && updateOptions(node2, !!props.multiple, props.defaultValue, !0);
      }
      ...
      function updateWrapper$1(element, props) {
        ...
        if (value != null) {
          ...
          newValue !== node2.value && (node2.value = newValue),
            props.defaultValue == null && node2.defaultValue !== newValue && (node2.defaultValue = newValue);
        }
      ...
      var createMicrosoftUnsafeLocalFunction = function (func) {
        ...
        setInnerHTML = createMicrosoftUnsafeLocalFunction(function (node2, html) {
          if (node2.namespaceURI === Namespaces.svg && !("innerHTML" in node2)) {
            ...
            for (var svgNode = reusableSVGContainer.firstChild; node2.firstChild; ) node2.removeChild(node2.firstChild);
      ...
      function getNearestMountedFiber(fiber) {
        ...
        if (fiber.alternate) for (; node2.return; ) node2 = node2.return;
          ...
          do
            (node2 = nextNode),
              (node2.effectTag & (Placement | Hydrating)) !== NoEffect && (nearestMounted = node2.return),
      ...
      function findCurrentHostFiberWithNoPortals(parent) {
        ...
        if (!currentParent) return null;
        for (var node2 = currentParent; ; ) {
          if (node2.tag === HostComponent || node2.tag === HostText || enableFundamentalAPI) return node2;
      ...
      function accumulateInto(current2, next2) {
        if (next2 == null) throw Error("accumulateInto(...): Accumulated items must not be null or undefined.");
        ...
        for (var styleName in styles)
          if (styles.hasOwnProperty(styleName)) {
            ...
            styleName === "float" && (styleName = "cssFloat"),
              isCustomProperty2 ? style2.setProperty(styleName, styleValue) : (style2[styleName] = styleValue);
          }
      }
...
`
      ...
      function getNodeForCharacterOffset(root2, offset) {
        for (var node2 = getLeafNode(root2), nodeStart = 0, nodeEnd = 0; node2; ) {
          if (node2.nodeType === TEXT_NODE) {
            if (((nodeEnd = nodeStart + node2.textContent.length), nodeStart <= offset && nodeEnd >= offset))
      ...
      function getModernOffsetsFromPoints(outerNode, anchorNode, anchorOffset, focusNode, focusOffset) {
        ...
        outer: for (;;) {
          ...
          for (;;) {
            ...
            if (
              (parentNode === anchorNode && ++indexWithinAnchor === anchorOffset && (start = length2),
        ...
        EnterLeaveEventPlugin = {
          ...
          extractEvents: function (topLevelType, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags) {
            ...
            var fromNode = from2 == null ? win : getNodeFromInstance$1(from2),
              ...
              leave = eventInterface.getPooled(leaveEventType, from2, nativeEvent, nativeEventTarget);
      ...
      function push(cursor2, value, fiber) {
        index++, (valueStack[index] = cursor2.current), (fiberStack[index] = fiber), (cursor2.current = value);
      }
          ...
          do {
            switch (node2.tag) {
              ...
              case ClassComponent: {
                ...
                if (isContextProvider(Component)) return node2.stateNode.__reactInternalMemoizedMergedChildContext;
                break;
              }
            }
            node2 = node2.return;
...
Learn more about this warning here: https://fb.me/react-legacy-context%s`,
      ...
      function findChildHostInstancesForFiberShallowly(fiber, hostInstances) {
        for (var node2 = fiber, foundHostInstances = !1; ; ) {
          if (node2.tag === HostComponent) (foundHostInstances = !0), hostInstances.add(node2.stateNode);
...
Incoming: %s`,
      ...
      function mountTransition(config) {
        var _mountState2 = mountState(!1),
          ...
          start = mountCallback(startTransition.bind(null, setPending, config), [setPending, config]);
      ...
      function updateTransition(config) {
        var _updateState2 = updateState(),
          ...
          start = updateCallback(startTransition.bind(null, setPending, config), [setPending, config]);
        return [start, isPending];
      }
        ...
        InvalidNestedHooksDispatcherOnRerenderInDEV = null;
      {
        ...
        (HooksDispatcherOnMountInDEV = {
          ...
          (HooksDispatcherOnUpdateInDEV = {
            ...
            useLayoutEffect: function (create3, deps) {
              return (
                (currentHookNameInDev = "useLayoutEffect"), updateHookTypesDev(), updateLayoutEffect(create3, deps)
              );
            },
            useMemo: function (create3, deps) {
              (currentHookNameInDev = "useMemo"), updateHookTypesDev();
...
Check the render method of \`` +
      ...
      function propagateSuspenseContextChange(workInProgress2, firstChild, renderExpirationTime2) {
        for (var node2 = firstChild; node2 !== null; ) {
          ...
          } else if (node2.tag === SuspenseListComponent) scheduleWorkOnFiber(node2, renderExpirationTime2);
          else if (node2.child !== null) {
            (node2.child.return = node2), (node2 = node2.child);
            continue;
          }
      ...
      (appendAllChildren = function (parent, workInProgress2, needsVisibilityToggle, isHidden) {
        for (var node2 = workInProgress2.child; node2 !== null; ) {
          if (node2.tag === HostComponent || node2.tag === HostText) appendInitialChild(parent, node2.stateNode);
...
Learn more about data fetching with Hooks: https://fb.me/react-hooks-data-fetching`)
      ...
      function hideOrUnhideAllChildren(finishedWork, isHidden) {
        for (var node2 = finishedWork; ; ) {
          if (node2.tag === HostComponent) {
            ...
            isHidden ? hideInstance(instance) : unhideInstance(node2.stateNode, node2.memoizedProps);
          } else if (node2.tag === HostText) {
            var _instance3 = node2.stateNode;
            isHidden ? hideTextInstance(_instance3) : unhideTextInstance(_instance3, node2.memoizedProps);
          } else if (
                ...
                var firstEffect = lastEffect.next;
                {
                  ...
                  runWithPriority$1(priorityLevel, function () {
                    ...
                    do {
                      ...
                      _destroy !== void 0 && safelyCallDestroy(current2, _destroy), (effect = effect.next);
                    } while (effect !== firstEffect);
                  });
                }
              }
      ...
      function commitNestedUnmounts(finishedRoot, root2, renderPriorityLevel) {
        for (var node2 = root2; ; ) {
          if (
            (commitUnmount(finishedRoot, node2, renderPriorityLevel), node2.child !== null && node2.tag !== HostPortal)
          ) {
            (node2.child.return = node2), (node2 = node2.child);
            continue;
          }
      ...
      function getHostSibling(fiber) {
        ...
        siblings: for (;;) {
          ...
          for (
            node2.sibling.return = node2.return, node2 = node2.sibling;
            node2.tag !== HostComponent && node2.tag !== HostText && node2.tag !== DehydratedFragment;

          ) {
            if (node2.effectTag & Placement || node2.child === null || node2.tag === HostPortal) continue siblings;
            (node2.child.return = node2), (node2 = node2.child);
          }
      ...
      function unmountHostComponents(finishedRoot, current2, renderPriorityLevel) {
        for (var node2 = current2, currentParentIsValid = !1, currentParent, currentParentIsContainer; ; ) {
          ...
          } else if ((commitUnmount(finishedRoot, node2, renderPriorityLevel), node2.child !== null)) {
            (node2.child.return = node2), (node2 = node2.child);
            continue;
          }
        ...
        if (node2 === null && fiber.tag === HostRoot) root2 = fiber.stateNode;
          ...
          for (; node2 !== null; ) {
            if (
              ...
              node2.childExpirationTime < expirationTime && (node2.childExpirationTime = expirationTime),
              alternate !== null &&
...
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`,
  ...
  processStyleValue = function (key, value) {
    ...
    return unitlessKeys[key] !== 1 && !isCustomProperty(key) && typeof value == "number" && value !== 0
      ? value + "px"
      : value;
  };
(contentValuePattern =
...
var cursor,
  ...
  EmotionCacheContext = React2.createContext(typeof HTMLElement < "u" ? createCache({ key: "css" }) : null);
  ...
  Emotion = withEmotionCache(function (props, cache, ref) {
    ...
    return (
      ...
      React2.createElement(
        React2.Fragment,
        null,
        React2.createElement(Insertion, { cache, serialized, isStringTag: typeof WrappedComponent == "string" }),
...
var pkg = {
  ...
  jsx = function (type, props) {
    var args = arguments;
    if (props == null || !hasOwnProperty.call(props, "css")) return React2.createElement.apply(void 0, args);
...
var Insertion3 = function (_ref) {
  ...
  ClassNames = withEmotionCache(function (props, cache) {
    ...
    return (
      (hasRendered = !0),
      React2.createElement(React2.Fragment, null, React2.createElement(Insertion3, { cache, serializedArr }), ele)
    );
  });
      ...
      var Styled = withEmotionCache(function (props, cache, ref) {
        ...
        return (
          ...
          React2.createElement(
            React2.Fragment,
            null,
            React2.createElement(Insertion5, { cache, serialized, isStringTag: typeof FinalTag == "string" }),

  ...
  (() => {
    ...
    var se = (e, t, s, o) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let i of ne(t))
          !ie.call(e, i) && i !== s && F(e, i, { get: () => t[i], enumerable: !(o = re(t, i)) || o.enumerable });
      return e;
    };
    var le = (e, t, s) => (
      (s = e != null ? te(oe(e)) : {}),
            ...
            2: [
              function (o, i, g) {
                ...
                (l.prototype.get = function (n) {
                  ...
                  if (((r = this.indexOf(n)), r >= 0)) return (this.lastItem = this.list[r]), this.list[r].val;
                }),
                    ...
                    return this.lastItem && this.isEqual(this.lastItem.key, n)
                      ...
                      : ((u = this.indexOf(n)),
                        u >= 0
                          ...
                          : ((this.lastItem = { key: n, val: r }), this.list.push(this.lastItem), this.size++, this));
                  }),
                  (l.prototype.delete = function (n) {
                    var r;
                    if (
                      (this.lastItem && this.isEqual(this.lastItem.key, n) && (this.lastItem = void 0),
                      (r = this.indexOf(n)),
                      r >= 0)
                    )
                  ...
                  (l.prototype.forEach = function (n, r) {
                    var u;
                    for (u = 0; u < this.size; u++) n.call(r || this, this.list[u].val, this.list[u].key, this);
                  }),
      ...
      var i = o.reduce(function (n, r) {
        ...
        return u
          ? n.concat(
              u.map(function (a) {
                var h, c;
                return (c = (h = a.match(/[\t ]/g)) === null || h === void 0 ? void 0 : h.length) !== null &&
                  c !== void 0
                  ? c
                  : 0;
              })
...
`)),
    ...
    var X = "storybook/background",
      ...
      fe = (0, H.default)(10)((e, t, s) => {
        ...
        return t !== "transparent" ? [ee("reset", "Clear background", "transparent", null, s, !1), ...o] : o;
      }),

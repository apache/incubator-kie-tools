try {
  (() => {
    ...
    function Cn(e, t, r) {
      ...
      if (typeof e == "object" && t === void 0 && r === void 0) return gt(e.hue, e.saturation, e.lightness);
      throw new ve(1);
    }
    function xn(e, t, r, n) {
    ...
    function zt(e, t, r) {
      if (typeof e == "number" && typeof t == "number" && typeof r == "number") return Lt("#" + We(e) + We(t) + We(r));
      if (typeof e == "object" && t === void 0 && r === void 0) return Lt("#" + We(e.red) + We(e.green) + We(e.blue));
      throw new ve(6);
    }
    function bt(e, t, r, n) {
    ...
    var Vn = Object.create,
      ...
      Xe = ((e) =>
        typeof ze < "u" ? ze : typeof Proxy < "u" ? new Proxy(e, { get: (t, r) => (typeof ze < "u" ? ze : t)[r] }) : e)(
        function (e) {
      ...
      Zn = (e, t, r, n) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let a of Br(t))
            !Xn.call(e, a) && a !== r && zr(e, a, { get: () => t[a], enumerable: !(n = Kn(t, a)) || n.enumerable });
        return e;
      },
      xe = (e, t, r) => (
        (r = e != null ? Vn(Jn(e)) : {}),
          ...
          function n(a, u) {
            ...
            if (Object.getOwnPropertySymbols) {
              ...
              for (p = 0; p < m.length; p++)
                (c = m[p]), !(u.indexOf(c) >= 0) && Object.prototype.propertyIsEnumerable.call(a, c) && (o[c] = a[c]);
            }
            return o;
          }
          t.exports = n;
      ...
      ea = Ce({
        "../../node_modules/@devtools-ds/themes/node_modules/@babel/runtime/helpers/defineProperty.js"(e, t) {
          function r(n, a, u) {
            return (
              a in n
                ? Object.defineProperty(n, a, { value: u, enumerable: !0, configurable: !0, writable: !0 })
                : (n[a] = u),
              n
            );
          }
      ...
      fa = ((e) =>
        typeof Xe < "u" ? Xe : typeof Proxy < "u" ? new Proxy(e, { get: (t, r) => (typeof Xe < "u" ? Xe : t)[r] }) : e)(
        function (e) {
      ...
      da = (e, t, r, n) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let a of Wr(t))
            !ma.call(e, a) && a !== r && Dr(e, a, { get: () => t[a], enumerable: !(n = sa(t, a)) || n.enumerable });
        return e;
      },
      Ge = (e, t, r) => (
        (r = e != null ? ua(pa(e)) : {}),
          ...
          function a() {
            ...
            for (let [c, p] of Object.entries(o)) {
              for (let [m, h] of Object.entries(p))
                (o[m] = { open: `\x1B[${h[0]}m`, close: `\x1B[${h[1]}m` }), (p[m] = o[m]), u.set(h[0], h[1]);
                ...
                rgbToAnsi256: {
                  value: (c, p, m) =>
                    c === p && p === m
                      ...
                      : 16 + 36 * Math.round((c / 255) * 5) + 6 * Math.round((p / 255) * 5) + Math.round((m / 255) * 5),
                  enumerable: !1,
                },
                hexToRgb: {
                  value: (c) => {
          ...
          function r(o, c, p, m, h, b, f = ": ") {
            ...
            if (!y.done) {
              ...
              for (; !y.done; ) {
                ...
                (v += _ + f + O), (y = o.next()), y.done ? c.min || (v += ",") : (v += `,${c.spacingInner}`);
              }
              v += c.spacingOuter + p;
            }
            return v;
            ...
            if (v.length) {
              ...
              for (let y = 0; y < v.length; y++) {
                let S = v[y],
                  _ = b(S, c, d, m, h),
                  O = b(o[S], c, d, m, h);
                (f += `${d + _}: ${O}`), y < v.length - 1 ? (f += `,${c.spacingInner}`) : c.min || (f += ",");
              }
              f += c.spacingOuter + p;
            }
            return f;
          ...
          var t = St(),
            ...
            u = (m, h, b, f, v, d) => {
              ...
              if (y === "ArrayContaining" || y === "ArrayNotContaining")
                return ++f > h.maxDepth ? `[${y}]` : `${y + a}[${(0, t.printListItems)(m.sample, h, b, f, v, d)}]`;
              ...
              if (typeof m.toAsymmetricMatcher != "function")
                throw new Error(`Asymmetric matcher ${m.constructor.name} does not implement toAsymmetricMatcher()`);
                ...
                : (f.min ? "" : _ + r) +
                    (n.indexOf(_) !== -1
                      ? `{${(0, t.printObjectProperties)(
                          c(b) ? Array.from(b).reduce((O, C) => ((O[C.name] = C.value), O), {}) : { ...b },
                          f,
                          v,
                          d,
                          y,
...
`) !== -1 && (N = b.spacingOuter + S + N + b.spacingOuter + f),
                    (N = `{${N}}`)),
                  `${b.spacingInner + f + _.prop.open + O + _.prop.close}=${_.value.open}${N}${_.value.close}`
                );
              })
              .join("");
          };
          e.printProps = n;
          var a = (m, h, b, f, v, d) =>
            m.map((y) => h.spacingOuter + b + (typeof y == "string" ? u(y, h) : d(y, h, b, f, v))).join("");
          e.printChildren = a;
          var u = (m, h) => {
          ...
          var c = (m, h, b, f, v) => {
            ...
            return `${d.open}<${m}${h && d.close + h + f.spacingOuter + v + d.open}${
              b ? `>${d.close}${b}${f.spacingOuter}${v}${d.open}</${m}` : `${h && !f.min ? "" : " "}/`
            }>${d.close}`;
          };
          e.printElement = c;
          var p = (m, h) => {
            ...
            return ++C > _.maxDepth
              ...
              : (0, t.printElement)(
                  ...
                  (0, t.printProps)(
                    ...
                    f(S) ? {} : Array.from(S.attributes).reduce((T, E) => ((T[E.name] = E.value), T), {}),
                    _,
                    O + _.indent,
                    C,
                    N,
      ...
      va = ye({
        "../../node_modules/pretty-format/build/plugins/Immutable.js"(e) {
          ...
          var t = St(),
            ...
            d = "\u2026",
            y = (E, A, q, z, D, G, B) =>
              ++z > A.maxDepth ? f(b(B)) : `${b(B) + v}{${(0, t.printIteratorEntries)(E.entries(), A, q, z, D, G)}}`;
          function S(E) {
            let A = 0;
            return {
              next() {
          ...
          var _ = (E, A, q, z, D, G) => {
              ...
              return ++z > A.maxDepth ? f(B) : `${B + v}{${(0, t.printIteratorEntries)(S(E), A, q, z, D, G)}}`;
            },
            O = (E, A, q, z, D, G) => {
              let B = b("Seq");
              return ++z > A.maxDepth
            ...
            C = (E, A, q, z, D, G, B) =>
              ++z > A.maxDepth ? f(b(B)) : `${b(B) + v}[${(0, t.printIteratorValues)(E.values(), A, q, z, D, G)}]`,
            N = (E, A, q, z, D, G) =>
              E[u]
          ...
          function q(g, F, W, X, V, x) {
            ...
            return Te === "[object Arguments]"
              ...
              ? ae
                ? `[${g.constructor.name}]`
                : `${
                    oe || (!F.printBasicPrototype && g.constructor.name === "Array") ? "" : `${g.constructor.name} `
...
${Te}`
            ...
            if (typeof ae != "string")
              throw new Error(`pretty-format: Plugin must return type "string" but instead returned "${typeof ae}".`);
            return ae;
          }
          function G(g, F) {
          ...
          var ie = { comment: "gray", content: "reset", prop: "yellow", tag: "cyan", value: "green" },
            L = Object.keys(ie),
            ee = (g) => g,
            R = ee({
              callToJSON: !0,
          ...
          function M(g) {
            ...
            if (g.theme !== void 0) {
              if (g.theme === null) throw new Error('pretty-format: Option "theme" must not be null.');
          ...
          var I = (g) =>
            ...
            K = () => L.reduce((g, F) => ((g[F] = { close: "", open: "" }), g), Object.create(null)),
            ...
            me = (g) => ({
              ...
              compareKeys:
                typeof g?.compareKeys == "function" || g?.compareKeys === null ? g.compareKeys : R.compareKeys,
              escapeRegex: ne(g),
              escapeString: pe(g),
      ...
      Hr = ye({
        "../../node_modules/diff-sequences/build/index.js"(e) {
          ...
          var t = "diff-sequences",
                  ...
                  if (pe <= j && ne - 1 <= N[pe]) {
                    ...
                    if (
                      ...
                      let le = A + M - (R ? ee - 1 : ee + 1),
                        fe = n(M, S, le, O, C);
                      (E.nCommonFollowing = fe), fe !== 0 && ((E.aCommonFollowing = M), (E.bCommonFollowing = le));
                      let we = M + fe,
                        Ee = le + fe;
                      d - 1 === S + O - we - Ee
                        ? ((E.aStartFollowing = S), (E.bStartFollowing = O))
            ...
            b = (d, y) => {
              if (typeof y != "number") throw new TypeError(`${t}: ${d} typeof ${typeof y} is not a number`);
              if (!Number.isSafeInteger(y)) throw new RangeError(`${t}: ${d} value ${y} is not a safe integer`);
          ...
          (function (r, n) {
            ...
            function c(l, s) {
              if (l) {
                ...
                if ((w === "Object" && l.constructor && (w = l.constructor.name), w === "Map" || w === "Set"))
                  return Array.from(l);
                if (w === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(w)) return p(l, s);
              }
            }
            function p(l, s) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function v(l, s) {
              var w = h[b[s]] || h[s];
              return w ? "\x1B[".concat(w[0], "m").concat(String(l), "\x1B[").concat(w[1], "m") : String(l);
            }
            function d() {
            ...
            function y(l, s) {
              ...
              var P = w.length,
                $ = l.length;
              return P > s && $ > P ? w : $ > s && $ > P ? "".concat(l.slice(0, s - P)).concat(w) : l;
            }
            function S(l, s, w) {
              ...
              for (var U = s.truncate, Q = "", re = "", he = "", ge = 0; ge < $; ge += 1) {
                ...
                if (
                  ...
                  (!Re && !Le && et > U) ||
                  ((re = Re ? "" : w(l[ge + 1], s) + (Le ? "" : P)), !Re && Le && et > U && Ye + re.length > U)
                )
                  break;
            ...
            function O(l, s) {
              ...
              return (
                (s.truncate -= 2),
                typeof P == "string" ? (P = _(P)) : typeof P != "number" && (P = "[".concat(s.inspect(P, s), "]")),
                (s.truncate -= P.length),
                ($ = s.inspect($, s)),
                "".concat(P, ": ").concat($)
              );
            ...
            function A(l, s) {
              ...
              for (var $ = "", U = 0; U < l.length; U++) {
                var Q = "".concat(s.stylize(y(l[U], s.truncate), "number")).concat(U === l.length - 1 ? "" : ", ");
            ...
            function q(l, s) {
              ...
              var P = w.split("T"),
                $ = P[0];
              return s.stylize("".concat($, "T").concat(y(P[1], s.truncate - $.length - 1)), "date");
            }
            function z(l, s) {
              var w = T(l);
              return w
            ...
            function le(l, s) {
              return K.test(l) && (l = l.replace(K, me)), s.stylize("'".concat(y(l, s.truncate - 2), "'"), "string");
            }
            function fe(l) {
            ...
            function V(l, s) {
              ...
              if (((s.truncate -= 4), (s.seen = s.seen || []), s.seen.indexOf(l) >= 0)) return "[Circular]";
              s.seen.push(l);
              var $ = S(
                  w.map(function (re) {
                    return [re, l[re]];
            ...
            function oe(l, s) {
              return l.length === 0 ? "Arguments[]" : ((s.truncate -= 13), "Arguments[ ".concat(S(l, s), " ]"));
            }
            var Te = [
              "stack",
              "line",
            ...
            function tn(l, s) {
              ...
              return (
                (s.truncate -= 3),
                $
                  ? "".concat(s.stylize(P, "yellow"), "=").concat(s.stylize('"'.concat($, '"'), "string"))
...
`
            ...
            rr.prototype = {
              ...
              set: function (l, s) {
                Object.isExtensible(l) && Object.defineProperty(l, this.key, { value: s, configurable: !0 });
              },
            };
    ...
    Ge(Hr(), 1);
    Ge(qr(), 1);
    var Y = ((e) => ((e.DONE = "done"), (e.ERROR = "error"), (e.ACTIVE = "active"), (e.WAITING = "waiting"), e))(
        Y || {}
      ),
      He = {
          ...
          i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement(
                  De,
                  { trigger: "hover", hasChrome: !1, tooltip: i.createElement(at, { note: "Go to start" }) },
                  i.createElement(
                    Ma,
                ...
                i.createElement(
                  De,
                  { trigger: "hover", hasChrome: !1, tooltip: i.createElement(at, { note: "Go back" }) },
                  i.createElement(
                    ot,
                ...
                i.createElement(
                  De,
                  { trigger: "hover", hasChrome: !1, tooltip: i.createElement(at, { note: "Go forward" }) },
                  i.createElement(
                    ot,
                ...
                i.createElement(
                  De,
                  { trigger: "hover", hasChrome: !1, tooltip: i.createElement(at, { note: "Go to end" }) },
                  i.createElement(
                    ot,
                ...
                i.createElement(
                  De,
                  { trigger: "hover", hasChrome: !1, tooltip: i.createElement(at, { note: "Rerun" }) },
                  i.createElement(
                    za,
    ...
    function qt(e) {
      ...
      if (e)
        if (typeof e == "object")
          if (Array.isArray(e)) for (t = 0; t < e.length; t++) e[t] && (r = qt(e[t])) && (n && (n += " "), (n += r));
          else for (t in e) e[t] && (r = qt(t)) && (n && (n += " "), (n += r));
        else typeof e != "boolean" && !e.call && (n && (n += " "), (n += e));
      return n;
    }
    function je() {
      for (var e = 0, t, r = ""; e < arguments.length; ) (t = qt(arguments[e++])) && (r && (r += " "), (r += t));
      return r;
    }
    var Xt = (e) => Array.isArray(e) || (ArrayBuffer.isView(e) && !(e instanceof DataView)),
      ...
      Ya = (e) => {
        let { children: t } = e,
          r = (0, Ga.default)(e, Ua),
          n = i.useContext(Gt);
        return i.createElement(Gt.Provider, { value: (0, Nr.default)((0, Nr.default)({}, n), r) }, t);
      },
      wt = (e, t = {}) => {
      ...
      Ja = ["theme", "hover", "colorScheme", "children", "label", "className", "onUpdate", "onSelect", "open"],
      vt = (e) => {
        let {
            theme: t,
            hover: r,
        ...
        let y = (R) => {
          ...
          k = (R, M) => {
            ...
            for (let K = 0; K < I.length; K++) {
              ...
              if (Z.getAttribute("aria-selected") === "true") {
                M === "up" && I[K - 1] ? _(I[K - 1], Z) : M === "down" && I[K + 1] && _(I[K + 1], Z);
                return;
              }
            }
            _(I[0]);
          ...
          A = (R) => {
            ...
            !M.contains(document.activeElement) && M.getAttribute("role") === "tree" && M.setAttribute("tabindex", "0");
          },
          q = (R) => {
            let M = R.target;
        ...
        if (!G)
          return i.createElement(
            "ul",
            (0, Bt.default)(
              { role: "tree", tabIndex: 0, className: je(Se.tree, Se.group, b, o), onFocus: q, onBlur: A },
              h
            ),
            i.createElement(Dt.Provider, { value: { isChild: !0, depth: 0, hasHover: L } }, i.createElement(vt, e))
          );
        if (!S)
          return i.createElement(
            "li",
        ...
        return i.createElement(
          ...
          i.createElement(
            ...
            v &&
              i.Children.map(a, (R) =>
                i.createElement(Dt.Provider, { value: { isChild: !0, depth: B + 1, hasHover: L } }, R)
              )
          )
        );
      };
    ...
    var Vr = Yr,
      ...
      Kr = (e) => {
        let { ast: t, theme: r, previewMax: n, open: a, colorScheme: u, className: o } = e,
          ...
          f = t.depth <= 0,
          v = () => i.createElement("span", { className: h ? te.prototype : te.key }, f ? "" : `${t.key}: `);
        return t.type === "array"
          ? i.createElement("span", (0, Ze.default)({ className: b }, c), i.createElement(v, null), ro(t, a, n, m))
          : t.type === "function"
          ? i.createElement(
              "span",
              (0, Ze.default)({ className: b }, c),
              i.createElement(v, null),
              m === "chrome" && i.createElement("span", { className: te.functionDecorator }, "\u0192 "),
              i.createElement("span", { className: je({ [te.function]: !h }) }, `${t.value.name}()`)
            )
          : t.type === "promise"
          ? i.createElement("span", (0, Ze.default)({ className: b }, c), i.createElement(v, null), ao(t, a, n))
          : t.type === "map"
          ? i.createElement("span", (0, Ze.default)({ className: b }, c), i.createElement(v, null), oo(t, a, n, m))
          : t.type === "set"
          ? i.createElement("span", (0, Ze.default)({ className: b }, c), i.createElement(v, null), io(t, a, n))
          : i.createElement("span", (0, Ze.default)({ className: b }, c), i.createElement(v, null), no(t, a, n, m));
      };
        ...
        return (
          ...
          a
            ? i.createElement(
                ...
                a.children.map((p) =>
                  i.createElement(Zt, { key: p.key, ast: p, depth: n + 1, expandLevel: r, onSelect: e.onSelect })
                )
              )
            : i.createElement(vt, {
                hover: !1,
    ...
    var co = Zt,
      uo = ["data", "expandLevel", "sortKeys", "includePrototypes", "className", "theme", "colorScheme", "onSelect"],
      Jr = (e) => {
        let {
            data: t,
            expandLevel: r,
          ...
          m = (0, Wa.default)(e, uo),
          [h, b] = Pe(void 0),
          { themeClass: f, currentTheme: v, currentColorScheme: d } = wt({ theme: o, colorScheme: c }, te);
        return (
          Be(() => {
    ...
    var so = {
      ...
      Zr = (e, t) => e.flatMap((r, n) => (n === e.length - 1 ? [r] : [r, i.cloneElement(t, { key: `sep${n}` })])),
      ...
      ho = ({ value: e, ...t }) => {
        let r = de();
        return i.createElement("span", { style: { color: r.string }, ...t }, JSON.stringify(Xr(e, 50)));
      },
      yo = ({ value: e, ...t }) => {
        let r = de();
      ...
      vo = ({ value: e, nested: t = !1, callsById: r }) => {
        ...
        let a = e
            .slice(0, 3)
            .map((o) => i.createElement(qe, { key: JSON.stringify(o), value: o, nested: !0, callsById: r })),
          u = Zr(a, i.createElement("span", null, ", "));
        return e.length <= 3
          ? i.createElement("span", { style: { color: n.base } }, "[", u, "]")
          : i.createElement("span", { style: { color: n.base } }, "(", e.length, ") [", u, ", \u2026]");
      },
      ...
      wo = ({ name: e }) => {
        ...
        return e
          ...
          : i.createElement("span", { style: { color: t.nullish, fontStyle: "italic" } }, "anonymous");
      },
        ...
        return i.createElement(
          ...
          !r &&
            ...
            i.createElement(
              ...
              i.createElement("span", { key: `${u}_close_tag`, style: { color: o.tag.name } }, "/", u),
      ...
      Ro = ({ name: e, message: t }) => {
        ...
        return i.createElement(
          ...
          e,
          t && ": ",
          t && i.createElement("span", { style: { color: r.error.message }, title: t.length > 50 ? t : "" }, Xr(t, 50))
        );
      },
      Co = ({ flags: e, source: t }) => {
        let r = de();
      ...
      Qt = ({ call: e, callsById: t }) => {
        if (!e) return null;
        if (e.method === "step" && e.path.length === 0) return i.createElement(Ao, { label: e.args[0] });
        let r = e.path.flatMap((u, o) => {
          ...
          n = e.args.flatMap((u, o, c) => {
            ...
            return o < c.length - 1
              ? [p, i.createElement("span", { key: `comma${o}` }, ",\xA0"), i.createElement("wbr", { key: `wbr${o}` })]
              : [p];
          }),
          a = de();
        return i.createElement(
      ...
      jo = J.span(({ theme: e }) => ({ color: e.base === "light" ? e.color.positiveText : e.color.positive })),
      Io = J.span(({ theme: e }) => ({ color: e.base === "light" ? e.color.negativeText : e.color.negative })),
      yt = ({ value: e, parsed: t }) =>
        t
      ...
      Et = ({ value: e, parsed: t }) =>
        t
          ? typeof e == "string" && e.startsWith("called with")
            ...
            : i.createElement(qe, { showObjectInspector: !0, value: e, style: { color: "#16B242" } })
...
`);
        return i.createElement(
          ...
          r.flatMap((n, a) => {
            ...
            if (n.match(/^\s*- /))
              return [i.createElement(Et, { key: n + a, value: n }), i.createElement("br", { key: `br${a}` })];
            if (n.match(/^\s*\+ /))
              return [i.createElement(yt, { key: n + a, value: n }), i.createElement("br", { key: `br${a}` })];
            ...
            return m
              ...
              : [i.createElement("span", { key: n + a }, n), i.createElement("br", { key: `br${a}` })];
          })
        );
      },
      ...
      Mo = J(ke)(({ theme: e, status: t }) => {
        ...
        return { width: t === Y.WAITING ? 6 : 12, height: t === Y.WAITING ? 6 : 12, color: r, justifySelf: "center" };
      }),
      Qr = ({ status: e, className: t }) => {
        let r = { [Y.DONE]: "check", [Y.ERROR]: "stopalt", [Y.ACTIVE]: "play", [Y.WAITING]: "circle" }[e];
        return i.createElement(Mo, { "data-testid": `icon-${e}`, status: e, icon: r, className: t });
      },
      Lo = J.div(() => ({
...
`),
        ...
        return H(
          ...
          e.showDiff && e.diff
            ...
            : H(
                ...
                null,
                H("br", null),
                e.expected && H($e, null, "Expected: ", H(Et, { value: e.expected }), H("br", null)),
          ...
          : H(
              ...
              H(
                ...
                H(
                  ...
                  H(Lo, { style: { marginLeft: 6, marginBottom: 1 } }, H(Qt, { call: e, callsById: t }))
                ),
                H(
                  Wo,
                  null,
                  a?.length > 0 &&
                    H(
                      De,
                      { hasChrome: !1, tooltip: H(qo, { note: `${o ? "Show" : "Hide"} interactions` }) },
                      H(Ho, { containsIcon: !0, onClick: c }, H(ke, { icon: "listunordered" }))
                    )
                )
              ),
              e.status === Y.ERROR && e.exception?.callId === e.id && H(Uo, { exception: e.exception })
            );
      },
      Vo = J.div(({ theme: e, withException: t }) => ({
        minHeight: "100%",
        background: e.background.content,
        ...(t && { backgroundColor: e.base === "dark" ? ht(0.93, e.color.negative) : e.background.warning }),
      })),
      Ko = J.div(({ theme: e }) => ({ padding: 15, fontSize: e.typography.size.s2 - 1, lineHeight: "19px" })),
      Jo = J.code(({ theme: e }) => ({
        margin: "0 1px",
        padding: 3,
      ...
      Lr = ({ log: e, calls: t, collapsed: r, setCollapsed: n }) => {
        ...
        return e
          ...
          .map((o) => {
            let c = o.status === Y.ERROR && a.get(o.ancestors.slice(-1)[0])?.status === Y.ACTIVE ? Y.ACTIVE : o.status;
            return (
              a.set(o.id, { ...o, status: c }),
              {
                ...
                toggleCollapsed: () => n((p) => (p.has(o.id) ? p.delete(o.id) : p.add(o.id), new Set(p))),
              }
            );
          });
      },
      ti = pt(function ({ storyId: e }) {
        ...
        Be(() => {
          r((T) => {
            ...
            return { ...T, interactions: E, interactionsCount: E.filter(({ method: A }) => A !== "step").length };
          });
        }, [u]);
        let O = lr(
            () => ({
    ...
    function ni() {
      ...
      return i.createElement(
        ...
        i.createElement(
          vr,
          { col: 1 },
          i.createElement("span", { style: { display: "inline-block", verticalAlign: "middle" } }, "Interactions"),
      ...
      Ct.add(Pa, {
        ...
        render: ({ active: t }) => {
          ...
          return i.createElement(
            mr,
            { active: t },
            i.createElement(cr, { filter: r }, ({ storyId: n }) => i.createElement(ti, { storyId: n }))
          );
        },
      });
    });

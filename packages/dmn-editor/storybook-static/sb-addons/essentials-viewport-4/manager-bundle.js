  ...
  (() => {
    ...
    var ce = (e, t, o, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let u of ae(t))
          !le.call(e, u) && u !== o && H(e, u, { get: () => t[u], enumerable: !(n = ne(t, u)) || n.enumerable });
      return e;
    };
    var de = (e, t, o) => (
      (o = e != null ? oe(se(e)) : {}),
            ...
            2: [
              function (n, u, f) {
                ...
                (c.prototype.get = function (i) {
                  ...
                  if (((r = this.indexOf(i)), r >= 0)) return (this.lastItem = this.list[r]), this.list[r].val;
                }),
                    ...
                    return this.lastItem && this.isEqual(this.lastItem.key, i)
                      ...
                      : ((m = this.indexOf(i)),
                        m >= 0
                          ...
                          : ((this.lastItem = { key: i, val: r }), this.list.push(this.lastItem), this.size++, this));
                  }),
                  ...
                  (c.prototype.forEach = function (i, r) {
                    var m;
                    for (m = 0; m < this.size; m++) i.call(r || this, this.list[m].val, this.list[m].key, this);
                  }),
      ...
      Ee = F(
        X(({ theme: e }) => {
          ...
          i.find((p) => p.id === n) ||
            ...
            M(() => {
              c({ selected: n || (f.selected && t[f.selected] ? f.selected : C.id), isRotated: o === "landscape" });
            }, [o, n]);
          let { selected: b, isRotated: d } = f,
            S = i.find((p) => p.id === b) || i.find((p) => p.id === n) || i.find((p) => p.default) || C,
            l = Y(),
              ...
              : w.createElement(
                  ...
                  s
                    ? w.createElement(
                        ...
                        w.createElement(re, { title: "Viewport height" }, s.height.replace("px", ""))
                      )
                    : null
                )
          );

try {
  (() => {
    ...
    var ly = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
      uy = (t, e) => {
      ...
      Kl = (t, e, n, r) => {
        if ((e && typeof e == "object") || typeof e == "function")
          for (let o of iy(e))
            !sy.call(t, o) && o !== n && Wr(t, o, { get: () => e[o], enumerable: !(r = oy(e, o)) || r.enumerable });
        return t;
      };
    var cy = (t, e, n) => (
        (n = t != null ? ry(ay(t)) : {}),
        Kl(e || !t || !t.__esModule ? Wr(n, "default", { value: t, enumerable: !0 }) : n, t)
      ),
    ...
    var re,
      gt = Yr(() => {
        re = {
          NODE_ENV: "production",
          NODE_PATH: [
            "/home/jomarko/incubator-kie-tools/node_modules/.pnpm/storybook@7.6.13/node_modules/storybook/node_modules",
            "/home/jomarko/incubator-kie-tools/node_modules/.pnpm/storybook@7.6.13/node_modules",
            "/home/jomarko/incubator-kie-tools/node_modules/.pnpm/node_modules",
          ],
          STORYBOOK: "true",
          PUBLIC_URL: ".",
        };
        ...
        return (function (e) {
          ...
          function (e, n, r) {
            ...
            var o = {
              ...
              easeInOutQuad: function (i, a, s, l) {
                var u = s - a;
                return (i /= l / 2) < 1 ? (u / 2) * i * i + a : (-u / 2) * (--i * (i - 2) - 1) + a;
              },
              ...
              easeInOutCubic: function (i, a, s, l) {
                var u = s - a;
                return (i /= l / 2) < 1 ? (u / 2) * i * i * i + a : (u / 2) * ((i -= 2) * i * i + 2) + a;
              },
              ...
              easeInOutQuart: function (i, a, s, l) {
                var u = s - a;
                return (i /= l / 2) < 1 ? (u / 2) * i * i * i * i + a : (-u / 2) * ((i -= 2) * i * i * i - 2) + a;
              },
              ...
              easeInElastic: function (i, a, s, l) {
                ...
                return (
                  ...
                  i === 0
                    ...
                    ? a + p
                    : ((c = 0) || (c = 0.3 * l),
                      (u = p) < Math.abs(p) ? ((u = p), (f = c / 4)) : (f = (c / (2 * Math.PI)) * Math.asin(p / u)),
                      -u * Math.pow(2, 10 * (i -= 1)) * Math.sin(((i * l - f) * (2 * Math.PI)) / c) + a)
                );
              },
              easeOutElastic: function (i, a, s, l) {
                ...
                return (
                  ...
                  i === 0
                    ...
                    : ((c = 0) || (c = 0.3 * l),
                      (u = p) < Math.abs(p) ? ((u = p), (f = c / 4)) : (f = (c / (2 * Math.PI)) * Math.asin(p / u)),
                      u * Math.pow(2, -10 * i) * Math.sin(((i * l - f) * (2 * Math.PI)) / c) + p + a)
                );
              },
                ...
                return (
                  ...
                  i === 0
                    ...
                    : ((c = 0) || (c = l * 0.44999999999999996),
                      (u = p) < Math.abs(p) ? ((u = p), (f = c / 4)) : (f = (c / (2 * Math.PI)) * Math.asin(p / u)),
                      i < 1
                        ? u * Math.pow(2, 10 * (i -= 1)) * Math.sin(((i * l - f) * (2 * Math.PI)) / c) * -0.5 + a
                        : u * Math.pow(2, -10 * (i -= 1)) * Math.sin(((i * l - f) * (2 * Math.PI)) / c) * 0.5 + p + a)
                );
              },
              easeInBack: function (i, a, s, l, u) {
                return u === void 0 && (u = 1.70158), (s - a) * (i /= l) * i * ((u + 1) * i - u) + a;
              },
              easeOutBack: function (i, a, s, l, u) {
                return u === void 0 && (u = 1.70158), (s - a) * ((i = i / l - 1) * i * ((u + 1) * i + u) + 1) + a;
              },
          ...
          function (e, n, r) {
            ...
            function p(P, T, k) {
              return (
                T in P
                  ? Object.defineProperty(P, T, { value: k, enumerable: !0, configurable: !0, writable: !0 })
                  : (P[T] = k),
                P
              );
            }
            (function (P) {
              (P[(P.Circle = 0)] = "Circle"), (P[(P.Square = 1)] = "Square"), (P[(P.Strip = 2)] = "Strip");
            })(o || (o = {})),
              (function (P) {
                (P[(P.Positive = 1)] = "Positive"), (P[(P.Negative = -1)] = "Negative");
              })(i || (i = {}));
            var d = (function () {
              function P($, Q, V, it) {
                (function (wi, Bn) {
                  if (!(wi instanceof Bn)) throw new TypeError("Cannot call a class as a function");
                })(this, P),
                ...
                (this.context = $),
                  ...
                  (this.h = c(5, 20)),
                  (this.radius = c(5, 10)),
                  (this.vx = typeof Dt == "number" ? c(-Dt, Dt) : c(Dt.min, Dt.max)),
                  (this.vy = typeof an == "number" ? c(-an, 0) : c(an.min, an.max)),
                  (this.shape = ((lt = 0), (ot = 2), Math.floor(lt + Math.random() * (ot - lt + 1)))),
              ...
              (function (Q, V) {
                ...
                h(this, "animate", function () {
                  ...
                  var Ei = C.particles.length,
                    ...
                    xi = Date.now();
                  if (Un < Dt) {
                    lt !== Dt && ((C.tweenInitTime = xi), (C.lastNumberOfPieces = Dt));
                    for (
                      var ql = C.tweenInitTime,
                        ny = wi(xi - ql > Bn ? Bn : Math.max(0, xi - ql), Un, Dt, Bn),
                        Gl = Math.round(ny - Un),
                        Xl = 0;
                      Xl < Gl;
                      Xl++
                  ...
                  return (
                    an &&
                      ...
                      (V.fillStyle = "#333"),
                      (V.textAlign = "right"),
                      V.fillText("Particles: ".concat(Ei), Q.width - 10, Q.height - 20)),
                    C.particles.forEach(function (Hn, _l) {
                      Hn.update(),
                        (Hn.y > Q.height || Hn.y < -100 || Hn.x > Q.width + 100 || Hn.x < -100) &&
                          (Ee && Un <= Dt ? (C.particles[_l] = C.getParticle()) : C.removeParticleAt(_l));
                    }),
                    Ei > 0 || Un < Dt
                  );
                }),
            ...
            function E(P) {
              for (var T = 1; T < arguments.length; T++) {
                ...
                T % 2
                  ...
                  ? Object.defineProperties(P, Object.getOwnPropertyDescriptors(k))
                  : y(Object(k)).forEach(function (C) {
                      Object.defineProperty(P, C, Object.getOwnPropertyDescriptor(k, C));
                    });
              }
              return P;
            }
            ...
            var w = {
              ...
              O = (function () {
                function P($, Q) {
                  var V = this;
                  (function (lt, ot) {
                    if (!(lt instanceof ot)) throw new TypeError("Cannot call a class as a function");
                  })(this, P),
                    ...
                    b(this, "setOptionsWithDefaults", function (lt) {
                      var ot = { confettiSource: { x: 0, y: 0, w: V.canvas.width, h: 0 } };
                      (V._options = E(E(E({}, ot), w), lt)), Object.assign(V, lt.confettiSource);
                    }),
                    b(this, "update", function () {
                      var lt = V.options,
                        ...
                        Ee = V.canvas,
                        Dt = V.context;
                      ot && ((Dt.fillStyle = "white"), Dt.clearRect(0, 0, Ee.width, Ee.height)),
                        V.generator.animate()
                          ? (V.rafId = requestAnimationFrame(V.update))
                          : (Et && typeof Et == "function" && V.generator.particlesGenerated > 0 && Et.call(V, V),
                            (V._options.run = !1));
                    }),
                  ...
                  (k = [
                    {
                      ...
                      set: function ($) {
                        ...
                        this.setOptionsWithDefaults($),
                          ...
                          typeof $.run == "boolean" && $.run && Q === !1 && this.update();
                      },
                    },
                  ]) && x(T.prototype, k),
                  C && x(T, C),
            ...
            function N() {
              return (N =
                ...
                function (P) {
                  for (var T = 1; T < arguments.length; T++) {
                    var k = arguments[T];
                    for (var C in k) Object.prototype.hasOwnProperty.call(k, C) && (P[C] = k[C]);
                  }
                  return P;
                  ...
                  if (!(typeof Symbol > "u" || !(Symbol.iterator in Object(k)))) {
                    ...
                    try {
                      for (
                        ...
                        !(Q = (lt = ot.next()).done) && ($.push(lt.value), !C || $.length !== C);
                        Q = !0
                      );
                    } catch (Et) {
                      (V = !0), (it = Et);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function rt(P, T) {
              if (P) {
                ...
                return (
                  ...
                  k === "Map" || k === "Set"
                    ? Array.from(P)
                    : k === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(k)
                    ? ht(P, T)
                    : void 0
                );
              }
            ...
            function It(P, T) {
              return !T || (M(T) !== "object" && typeof T != "function") ? Wt(P) : T;
            }
            function Wt(P) {
            ...
            var At = s.a.createRef(),
              Z = (function (P) {
                ...
                function Q(V) {
                  var it;
                  Tt(this, Q);
                  for (var lt = arguments.length, ot = new Array(lt > 1 ? lt - 1 : 0), Et = 1; Et < lt; Et++)
                    ot[Et - 1] = arguments[Et];
                  return (
                    Mt(Wt((it = $.call.apply($, [this, V].concat(ot)))), "canvas", s.a.createRef()),
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        return s.a.createElement(
                          "canvas",
                          N({ width: it.width, height: it.height, ref: this.canvas }, lt, { style: ot })
                        );
                      },
                    },
                  ]) && Ct(T.prototype, k),
            ...
            function I(P) {
              var T = {},
                k = {},
                C = [].concat(S(Object.keys(w)), ["confettiSource", "drawShape", "onConfettiComplete"]),
                $ = ["canvasRef"];
              for (var Q in P) {
                var V = P[Q];
                C.includes(Q) ? (T[Q] = V) : $.includes(Q) ? ($[Q] = V) : (k[Q] = V);
              }
              return [T, k, {}];
            }
            Mt(Z, "defaultProps", X({}, w)), Mt(Z, "displayName", "ReactConfetti");
    ...
    var xy = Object.create,
      ...
      yf = (t, e, n, r) => {
        if ((e && typeof e == "object") || typeof e == "function")
          for (let o of Sy(e))
            !Ty.call(t, o) && o !== n && Jo(t, o, { get: () => e[o], enumerable: !(r = Oy(e, o)) || r.enumerable });
        return t;
      },
      le = (t, e, n) => (
        (n = t != null ? xy(Py(t)) : {}),
        yf(e || !t || !t.__esModule ? Jo(n, "default", { value: t, enumerable: !0 }) : n, t)
      ),
    ...
    function Ny(t, e) {
      ...
      for (var n = new DataView(t.buffer), r = new DataView(e.buffer), o = t.byteLength; o--; )
    ...
    function Lt(t, e) {
      ...
      if (t && Ca(t) && e && Ca(e)) {
        ...
        for (var o = n.length; o-- !== 0; ) if (!Object.prototype.hasOwnProperty.call(e, n[o])) return !1;
    ...
    var uu,
      ...
      Ss = v(() => {
        jy(),
          ...
          (Ef = ["bigint", "boolean", "null", "number", "string", "symbol", "undefined"]),
          ...
          (L.empty = function (t) {
            return (
              ...
              (L.object(t) && !L.map(t) && !L.set(t) && Object.keys(t).length === 0) ||
              (L.set(t) && t.size === 0) ||
              (L.map(t) && t.size === 0)
            );
          }),
          ...
          (L.object = function (t) {
            return !L.nullOrUndefined(t) && (L.function(t) || typeof t == "object");
          }),
    ...
    function cu(t, e, n) {
      ...
      return F.undefined(r) || (u = u && l === r), F.undefined(i) || (u = u && s === i), u;
    }
    function pu(t, e, n) {
      var r = n.key,
        o = n.type,
      ...
      return [a, s].every(F.array)
        ...
        : ![a, s].every(function (c) {
          ...
          }) && (o === "added" ? !F.defined(a) && F.defined(s) : F.defined(a) && !F.defined(s));
    }
    function fu(t, e, n) {
      var r = n === void 0 ? {} : n,
        o = r.key,
      ...
      return [i, a].every(F.plainObject) && ((i = Object.keys(i)), (a = Object.keys(a))), [i, a];
    }
    function du(t) {
      return function (e) {
        var n = e[0],
    ...
    function xf() {
      for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
      return t.every(F.array) || t.every(F.number) || t.every(F.plainObject) || t.every(F.string);
    }
    function ue(t, e) {
    ...
    var Hy = v(() => {
      ...
      Wy = v(() => {});
    function ur(t, e) {
      if ([t, e].some(F.nullOrUndefined)) throw new Error("Missing required parameters");
      if (
      ...
      var n = function (f, p) {
        ...
        r = function (f, p, d) {
          try {
            ...
            return [h, m].every(F.array) || [h, m].every(F.plainObject) ? !Lt(h, m) : h !== m;
          } catch {
            return !1;
          }
        },
    ...
    function j(t) {
      ...
      return j.array(t) ? "Array" : j.plainFunction(t) ? "Function" : ko(t) || "Object";
    }
    var mu,
      Sf,
      Pf,
      ...
      Gy = v(() => {
        (mu = ["innerHTML", "ownerDocument", "style", "attributes", "nodeValue"]),
          ...
          (Pf = ["bigint", "boolean", "null", "number", "string", "symbol", "undefined"]),
          (j.array = Array.isArray),
          (j.arrayOf = (t, e) => (!j.array(t) && !j.function(e) ? !1 : t.every((n) => e(n)))),
          ...
          (j.domElement = (t) =>
            j.object(t) && !j.plainObject(t) && t.nodeType === 1 && j.string(t.nodeName) && mu.every((e) => e in t)),
          (j.empty = (t) =>
            (j.string(t) && t.length === 0) ||
            (j.array(t) && t.length === 0) ||
            (j.object(t) && !j.map(t) && !j.set(t) && Object.keys(t).length === 0) ||
            (j.set(t) && t.size === 0) ||
            (j.map(t) && t.size === 0)),
          (j.error = _t("Error")),
          (j.function = ln("function")),
          (j.generator = (t) => j.iterable(t) && j.function(t.next) && j.function(t.throw)),
          (j.generatorFunction = _t("GeneratorFunction")),
          (j.instanceOf = (t, e) => (!t || !e ? !1 : Object.getPrototypeOf(t) === e.prototype)),
          (j.iterable = (t) => !j.nullOrUndefined(t) && j.function(t[Symbol.iterator])),
          (j.map = _t("Map")),
          (j.nan = (t) => Number.isNaN(t)),
          (j.null = (t) => t === null),
          (j.nullOrUndefined = (t) => j.null(t) || j.undefined(t)),
          (j.number = (t) => ln("number")(t) && !j.nan(t)),
          (j.numericString = (t) => j.string(t) && t.length > 0 && !Number.isNaN(Number(t))),
          (j.object = (t) => !j.nullOrUndefined(t) && (j.function(t) || typeof t == "object")),
      ...
      Xy = ee((t, e) => {
        ...
        function a(u) {
          return function (c, f, p, d) {
            (p = p || {}), typeof p == "function" && ((d = p), (p = {})), typeof d != "function" && (d = l);
            var h = i(),
              m = c[u],
              y = p.ease || s,
      ...
      Cf = ee((t, e) => {
        ...
        function m(b, w) {
          return h(b, w) && !(Object.hasOwnProperty.call(b, w) && Object.propertyIsEnumerable.call(b, w));
        }
        function y(b, w, O) {
          var S = {};
          return (
            ...
            d(w).forEach(function (M) {
              m(b, M) || (h(b, M) && O.isMergeableObject(w[M]) ? (S[M] = f(M, O)(b[M], w[M], O)) : (S[M] = u(w[M], O)));
            }),
            S
          );
        }
      ...
      Jy = ee((t) => {
        ...
        var e =
          ...
          r = function (l, u, c, f) {
            return typeof l == "boolean" ? l : typeof l == "function" ? l(u, c, f) : !!l && !!l;
          },
          o = function (l, u) {
          ...
          i = function (l, u, c, f) {
            return f
              ? new Error(f)
              : new Error("Required " + l[u] + " `" + u + "`" + (" was not specified in `" + c + "`."));
          },
          a = function (l, u) {
          ...
          s = function (l, u, c) {
            return (
              a(l, c),
              function (f, p, d) {
                for (var h = arguments.length, m = Array(3 < h ? h - 3 : 0), y = 3; y < h; y++) m[y - 3] = arguments[y];
                return r(u, f, p, d)
                  ? o(f, p)
    ...
    function Rn(t) {
      ...
      for (var e = Fn(10) ? document.body : null, n = t.offsetParent || null; n === e && t.nextElementSibling; )
      ...
      return !r || r === "BODY" || r === "HTML"
        ...
        : ["TH", "TD", "TABLE"].indexOf(n.nodeName) !== -1 && en(n, "position") === "static"
        ? Rn(n)
        : n;
    }
    function t0(t) {
    ...
    function Mn(t) {
      var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "top",
    ...
    function Cs(t, e) {
      ...
      var f = Le({ top: i.top - a.top - u, left: i.left - a.left - c, width: i.width, height: i.height });
      ...
      return (r && !n ? e.contains(s) : e === s && s.nodeName !== "BODY") && (f = e0(f, e)), f;
    }
    function n0(t) {
    ...
    function Df(t) {
      ...
      for (var e = t.parentElement; e && en(e, "transform") === "none"; ) e = e.parentElement;
    ...
    function As(t, e, n, r) {
      ...
      if (r === "viewport") i = n0(a, o);
        ...
        var s = void 0;
        r === "scrollParent"
          ? ((s = Ir(Ts(e))), s.nodeName === "BODY" && (s = t.ownerDocument.documentElement))
          : r === "window"
    ...
    function jf(t, e, n) {
      ...
      var r = Lf(t),
        ...
        l = i ? "height" : "width",
        u = i ? "width" : "height";
      return (o[a] = e[a] + e[l] / 2 - r[l] / 2), n === s ? (o[s] = e[s] - r[u]) : (o[s] = e[Mo(s)]), o;
    }
    function Lr(t, e) {
    ...
    function Ff(t, e, n) {
      ...
      return (
        r.forEach(function (o) {
          ...
          o.enabled &&
            Af(i) &&
            ((e.offsets.popper = Le(e.offsets.popper)), (e.offsets.reference = Le(e.offsets.reference)), (e = i(e, o)));
        }),
        e
      );
    }
    function i0() {
      if (!this.state.isDestroyed) {
        ...
        (t.offsets.reference = If(this.state, this.popper, this.reference, this.options.positionFixed)),
          (t.placement = Nf(
    ...
    function Bf(t, e, n, r) {
      ...
      i.addEventListener(e, n, { passive: !0 }), o || Bf(Ir(i.parentNode), e, n, r), r.push(i);
    }
    function s0(t, e, n, r) {
      (n.updateBound = r), zf(t).addEventListener("resize", n.updateBound, { passive: !0 });
      var o = Ir(t);
      return Bf(o, "scroll", n.updateBound, n.scrollParents), (n.scrollElement = o), (n.eventsEnabled = !0), n;
    }
    function l0() {
      this.state.eventsEnabled || (this.state = s0(this.reference, this.options, this.state, this.scheduleUpdate));
    }
    function u0(t, e) {
      return (
    ...
    function c0() {
      this.state.eventsEnabled &&
        (cancelAnimationFrame(this.scheduleUpdate), (this.state = u0(this.reference, this.state)));
    }
    function Rs(t) {
    ...
    function Ra(t, e) {
      Object.keys(e).forEach(function (n) {
        var r = "";
        ["width", "height", "top", "right", "bottom", "left"].indexOf(n) !== -1 && Rs(e[n]) && (r = "px"),
          (t.style[n] = e[n] + r);
      });
    }
    function p0(t, e) {
    ...
    function f0(t) {
      return (
        ...
        t.arrowElement && Object.keys(t.arrowStyles).length && Ra(t.arrowElement, t.arrowStyles),
        t
      );
    }
    function d0(t, e, n, r, o) {
      var i = If(o, e, t, n.positionFixed),
        a = Nf(n.placement, i, e, t, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
      return e.setAttribute("x-placement", a), Ra(e, { position: n.positionFixed ? "fixed" : "absolute" }), n;
    }
    function h0(t, e) {
      var n = t.offsets,
        r = n.popper,
        ...
        h = e ? (c || f || p ? i : a) : s,
        m = e ? i : s;
      return { left: h(d && !f && e ? r.left - 1 : r.left), top: m(r.top), bottom: m(r.bottom), right: h(r.right) };
    }
    function m0(t, e) {
      var n = e.x,
        r = e.y,
    ...
    function y0(t, e) {
      if (Vf(t.instance.modifiers, "inner") || (t.flipped && t.placement === t.originalPlacement)) return t;
      var n = As(t.instance.popper, t.instance.reference, e.padding, e.boundariesElement, t.positionFixed),
      ...
      return (
        a.forEach(function (s, l) {
          ...
          var u = t.offsets.popper,
            ...
            E = (r === "left" && d) || (r === "right" && h) || (r === "top" && m) || (r === "bottom" && y),
          ...
          (p || E || O) &&
            ...
            O && (i = g0(i)),
            (t.placement = r + (i ? "-" + i : "")),
            (t.offsets.popper = Ut({}, t.offsets.popper, jf(t.instance.popper, t.offsets.reference, t.placement))),
    ...
    function b0(t) {
      var e = t.offsets,
        ...
        u = a ? "width" : "height";
      return (
        n[s] < i(r[l]) && (t.offsets.popper[l] = i(r[l]) - n[u]), n[l] > i(r[s]) && (t.offsets.popper[l] = i(r[s])), t
      );
    }
    function w0(t, e, n, r) {
      var o = t.match(/((?:\-|\+)?\d*\.?\d*)(.*)/),
    ...
    function O0(t, e) {
      ...
      var r = ks("transform"),
        ...
        s = o[r];
      (o.top = ""), (o.left = ""), (o[r] = "");
      var l = As(t.instance.popper, t.instance.reference, e.padding, n, t.positionFixed);
      ...
      var u = e.priority,
        ...
        f = {
          primary: function (p) {
            var d = c[p];
            return c[p] < l[p] && !e.escapeWithReference && (d = Math.max(c[p], l[p])), Ze({}, p, d);
          },
    ...
    var un,
      ...
      Na,
      C0 = v(() => {
        (un = typeof window < "u" && typeof document < "u" && typeof navigator < "u"),
          (Hf = (function () {
          ...
          (so = Ii.slice(3)),
          (lo = { FLIP: "flip", CLOCKWISE: "clockwise", COUNTERCLOCKWISE: "counterclockwise" }),
          (Ou = {
            ...
            computeStyle: { order: 850, enabled: !0, fn: m0, gpuAcceleration: !0, x: "bottom", y: "right" },
            applyStyle: { order: 900, enabled: !0, fn: f0, onLoad: d0, gpuAcceleration: void 0 },
          }),
          (Su = {
            placement: "bottom",
            positionFixed: !1,
          ...
          (Qn = (function () {
            function t(e, n) {
              ...
              Eu(this, t),
                ...
                Object.keys(Ut({}, t.Defaults.modifiers, o.modifiers)).forEach(function (a) {
                  r.options.modifiers[a] = Ut({}, t.Defaults.modifiers[a] || {}, o.modifiers ? o.modifiers[a] : {});
                }),
                ...
                this.modifiers.forEach(function (a) {
                  a.enabled && Af(a.onLoad) && a.onLoad(r.reference, r.popper, r.options, a, r.state);
                }),
                this.update();
    ...
    function Zn(t, e, n) {
      return e && Tu(t.prototype, e), n && Tu(t, n), Object.defineProperty(t, "prototype", { writable: !1 }), t;
    }
    function kt(t, e, n) {
      return (
    ...
    function qr(t) {
      ...
      a &&
        e &&
        n &&
        (console.groupCollapsed("%creact-floater: ".concat(e), "color: #9b00ff; font-weight: bold; font-size: 12px;"),
        Array.isArray(n)
          ? n.forEach(function (l) {
              F.plainObject(l) && l.key ? s.apply(console, [l.key, l.value]) : s.apply(console, [l]);
            })
          : s.apply(console, [n]),
        console.groupEnd());
    }
    ...
    function I0(t) {
      ...
      return {
        wrapper: { cursor: "help", display: "inline-flex", flexDirection: "column", zIndex: e.zIndex },
    ...
    var R,
      ...
      L0 = v(() => {
        (R = le(Ry())),
          ...
          (J = { INIT: "init", IDLE: "idle", OPENING: "opening", OPEN: "open", CLOSING: "closing", ERROR: "error" }),
              ...
              Zn(n, [
                {
                  key: "componentDidMount",
                  value: function () {
                    ie && (this.node || this.appendNode(), cn || this.renderPortal());
                  },
                },
                {
                  key: "componentDidUpdate",
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var r = this.props,
                      o = r.children,
                      i = r.setRef;
                    if ((this.node || this.appendNode(), cn)) return oe.createPortal(o, this.node);
                    ...
                    return (
                      ...
                      g.createElement(
                        ...
                        g.createElement(
                          ...
                          g.createElement(
                            "svg",
                            { width: y, height: E, version: "1.1", xmlns: "http://www.w3.org/2000/svg" },
          ...
          (zi.propTypes = { handleClick: R.default.func.isRequired, styles: R.default.object.isRequired }),
          (Bi = function (t) {
            var e = t.content,
              n = t.footer,
              r = t.handleClick,
              ...
              u = {
                content: g.isValidElement(e)
                  ? e
                  : g.createElement("div", { className: "__floater__content", style: l.content }, e),
              };
            return (
              s &&
                (u.title = g.isValidElement(s)
                  ? s
                  : g.createElement("div", { className: "__floater__title", style: l.title }, s)),
              n &&
                (u.footer = g.isValidElement(n)
                  ? n
                  : g.createElement("div", { className: "__floater__footer", style: l.footer }, n)),
              (a || i) && !F.boolean(o) && (u.close = g.createElement(zi, { styles: l.close, handleClick: r })),
              g.createElement(
                "div",
                    ...
                    return (
                      s ||
                        (a.startsWith("top")
                          ...
                          : a.startsWith("right") && (E.padding = "0 0 0 ".concat(c, "px"))),
                      [J.OPENING, J.OPEN].indexOf(l) !== -1 && (E = ut(ut({}, E), h)),
                  ...
                  value: function () {
                    ...
                    return (
                      ...
                      g.createElement(
                        ...
                        g.createElement("div", { className: "__floater__body" }, u.content, u.arrow)
                      )
                    );
                  },
                },
              ...
              Zn(n, [
                {
                  ...
                  value: function () {
                    ...
                    return p
                      ? g.createElement(
                          "span",
                          { ref: u, style: ut(ut({}, f), c), onClick: i, onMouseEnter: a, onMouseLeave: s },
                          p
                        )
                      : null;
                  },
              ...
              return (
                ...
                kt(he(o), "handleTransitionEnd", function () {
                  ...
                  o.wrapperPopper && o.wrapperPopper.instance.update(),
                    o.setState({ status: i === J.OPENING ? J.OPEN : J.IDLE }, function () {
                ...
                kt(he(o), "handleClick", function () {
                  ...
                  if (!F.boolean(s)) {
                    ...
                    (o.event === "click" || (o.event === "hover" && u)) &&
                      (qr({
                        title: "click",
                        data: [{ event: a, status: c === J.OPEN ? "closing" : "opening" }],
                        debug: o.debug,
                      }),
                      o.toggle());
                  }
                ...
                kt(he(o), "handleMouseEnter", function () {
                  ...
                  if (!(F.boolean(s) || Li())) {
                    ...
                    o.event === "hover" &&
                      l === J.IDLE &&
                      (qr({ title: "mouseEnter", data: [{ key: "originalEvent", value: a }], debug: o.debug }),
                ...
                kt(he(o), "handleMouseLeave", function () {
                  ...
                  if (!(F.boolean(l) || Li())) {
                    var u = o.state,
                      ...
                      f = u.positionWrapper;
                    o.event === "hover" &&
                      (qr({ title: "mouseLeave", data: [{ key: "originalEvent", value: a }], debug: o.debug }),
                      s
              ...
              Zn(n, [
                ...
                },
                {
                  ...
                  value: function (r, o) {
                    if (ie) {
                      ...
                      if (r.open !== s) {
                        var d;
                        F.boolean(s) && (d = s ? J.OPENING : J.CLOSING), this.toggle(d);
                      }
                      (r.wrapperOptions.position !== u.position || r.target !== l) &&
                        this.changeWrapperPosition(this.props),
                        p("status", J.IDLE) && s
                          ? this.toggle(J.OPEN)
                          : f("status", J.INIT, J.IDLE) && a && this.toggle(J.OPEN),
                        this.popper && p("status", J.OPENING) && this.popper.instance.update(),
                        this.floaterRef &&
                          (p("status", J.OPENING) || p("status", J.CLOSING)) &&
                          N0(this.floaterRef, "transitionend", this.handleTransitionEnd),
                  ...
                  value: function () {
                    ...
                    if (f === "center") this.setState({ status: J.IDLE });
                      ...
                      new Na(o, this.floaterRef, {
                        ...
                        onCreate: function (w) {
                          var O;
                          if (((r.popper = w), !((O = r.floaterRef) !== null && O !== void 0 && O.isConnected))) {
                            r.setState({ needsUpdate: !0 });
                            return;
                          }
                          l(w, "floater"),
                            r._isMounted && r.setState({ currentPlacement: w.placement, status: J.IDLE }),
                            f !== w.placement &&
                              setTimeout(function () {
                                w.instance.update();
                              }, 1);
                        ...
                        onUpdate: function (w) {
                          ...
                          r._isMounted && w.placement !== O && r.setState({ currentPlacement: w.placement });
                        },
                      });
                    }
                    if (i) {
                ...
                },
                {
                  ...
                  get: function () {
                    ...
                    return r ? (F.domElement(r) ? r : document.querySelector(r)) : this.childRef || this.wrapperRef;
                  },
                },
                {
                  key: "render",
          ...
          kt(co, "propTypes", {
            ...
            children: R.default.node,
            component: (0, ji.default)(R.default.oneOfType([R.default.func, R.default.element]), function (t) {
              return !t.content;
            }),
    ...
    function ve(t, e, n) {
      return e && Lu(t.prototype, e), n && Lu(t, n), Object.defineProperty(t, "prototype", { writable: !1 }), t;
    }
    function H(t, e, n) {
      return (
        (e = qf(e)),
    ...
    function Gf() {
      var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : navigator.userAgent,
        e = t;
      return (
        typeof window > "u"
          ? (e = "node")
          ...
          : window.chrome
          ? (e = "chrome")
          : /(Version\/([0-9._]+).*Safari|CriOS|FxiOS| Mobile\/)/.test(t) && (e = "safari"),
        e
      );
    }
    function Wi(t) {
    ...
    function ja(t, e) {
      ...
      for (var i in t)
        if (ju(t, i)) {
          ...
          if (
            ((n = Wi(t[i])),
            (["object", "array"].indexOf(n) !== -1 && ja(t[i], e[i])) || (n === "function" && ja(t[i], e[i])))
          )
            continue;
          if (t[i] !== e[i]) return !1;
        }
      ...
      a &&
        (e && n
          ? (console.groupCollapsed(
            ...
            Array.isArray(n)
              ? n.forEach(function (l) {
                  ft.plainObject(l) && l.key ? s.apply(console, [l.key, l.value]) : s.apply(console, [l]);
                })
              : s.apply(console, [n]),
            console.groupEnd())
          ...
          function o() {
            ...
            me(this, o),
              ...
              H(this, "setSteps", function (p) {
                ...
                n.set("steps", p), m === K.WAITING && !h && p.length && (y.status = K.RUNNING), i.setState(y);
              }),
              H(this, "addListener", function (p) {
                i.listener = p;
              }),
              H(this, "update", function (p) {
                if (!B0(p, Va)) throw new Error("State is not valid. Valid keys: ".concat(Va.join(", ")));
                i.setState(
                  D({}, i.getNextState(D(D(D({}, i.getState()), p), {}, { action: p.action || tt.UPDATE }), !0))
                );
              }),
              H(this, "start", function (p) {
                ...
                i.setState(
                  D(
                    D({}, i.getNextState({ action: tt.START, index: ft.number(p) ? p : h }, !0)),
                    {},
              ...
              H(this, "stop", function () {
                ...
                [K.FINISHED, K.SKIPPED].indexOf(m) === -1 &&
                  i.setState(
                    D(D({}, i.getNextState({ action: tt.STOP, index: h + (p ? 1 : 0) })), {}, { status: K.PAUSED })
                  );
              }),
              H(this, "close", function () {
                var p = i.getState(),
                  d = p.index,
                  h = p.status;
                h === K.RUNNING && i.setState(D({}, i.getNextState({ action: tt.CLOSE, index: d + 1 })));
              }),
              H(this, "go", function (p) {
                ...
                if (!(h || m !== K.RUNNING)) {
                  var y = i.getSteps()[p];
                  i.setState(D(D({}, i.getNextState({ action: tt.GO, index: p })), {}, { status: y ? m : K.FINISHED }));
                }
              }),
              ...
              H(this, "next", function () {
                var p = i.getState(),
                  d = p.index,
                  h = p.status;
                h === K.RUNNING && i.setState(i.getNextState({ action: tt.NEXT, index: d + 1 }));
              }),
              H(this, "open", function () {
                var p = i.getState(),
                  d = p.status;
                d === K.RUNNING && i.setState(D({}, i.getNextState({ action: tt.UPDATE, lifecycle: _.TOOLTIP })));
              }),
              H(this, "prev", function () {
                var p = i.getState(),
                  d = p.index,
                  h = p.status;
                h === K.RUNNING && i.setState(D({}, i.getNextState({ action: tt.PREV, index: d - 1 })));
              }),
              H(this, "reset", function () {
                ...
                h ||
                  i.setState(
                    D(D({}, i.getNextState({ action: tt.RESET, index: 0 })), {}, { status: p ? K.RUNNING : K.READY })
                  );
              }),
              H(this, "skip", function () {
                var p = i.getState(),
                  d = p.status;
                d === K.RUNNING && i.setState({ action: tt.SKIP, lifecycle: _.INIT, status: K.SKIPPED });
              }),
              this.setState(
                {
                  action: tt.INIT,
            ...
            ve(o, [
              {
                ...
                value: function (i) {
                  ...
                  e.set("action", u),
                    ...
                    e.set("size", p),
                    e.set("status", d),
                    a && (e.set("controlled", i.controlled), e.set("continuous", i.continuous)),
                    this.listener && this.hasUpdatedState(s) && this.listener(this.getState());
                },
              },
              {
                key: "getState",
    ...
    function W0() {
      var t = document,
        e = t.body,
        n = t.documentElement;
      return !e || !n ? 0 : Math.max(e.scrollHeight, e.offsetHeight, n.clientHeight, n.scrollHeight, n.offsetHeight);
    }
    function Ce(t) {
    ...
    function bn(t) {
      var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "fixed";
      if (!t || !(t instanceof HTMLElement)) return !1;
      var n = t.nodeName;
      return n === "BODY" || n === "HTML" ? !1 : Y0(t).position === e ? !0 : bn(t.parentNode, e);
    }
    function G0(t) {
      if (!t) return !1;
    ...
    function K0(t) {
      var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : yr(),
        n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 300;
      return new Promise(function (r, o) {
        var i = e.scrollTop,
          a = t > i ? t - i : i - t;
        Kf.default.top(e, t, { duration: a < 100 ? 50 : n }, function (s) {
          return s && s.message !== "Element already at target scroll position" ? o(s) : r();
        });
      });
    }
    function Q0(t) {
      function e(r, o, i, a, s, l) {
        ...
        if (o[i] == null)
          return r
            ? new Error("Required ".concat(s, " `").concat(c, "` was not specified in `").concat(u, "`."))
            : null;
        for (var f = arguments.length, p = new Array(f > 6 ? f - 6 : 0), d = 6; d < f; d++) p[d - 6] = arguments[d];
    ...
    function J0() {
      ...
      window.innerWidth > 480 && (n = 380),
        e.width && (window.innerWidth < e.width ? (n = window.innerWidth - 30) : (n = e.width));
      var r = { bottom: 0, left: 0, overflow: "hidden", position: "absolute", right: 0, top: 0, zIndex: e.zIndex },
        o = {
          beacon: D(
            D({}, vn),
            {},
          ...
          buttonNext: D(D({}, vn), {}, { backgroundColor: e.primaryColor, borderRadius: 4, color: "#fff" }),
          buttonBack: D(D({}, vn), {}, { color: e.primaryColor, marginLeft: "auto", marginRight: 5 }),
          buttonClose: D(
            D({}, vn),
            {},
            { color: e.textColor, height: 14, padding: 15, position: "absolute", right: 0, top: 0, width: 14 }
          ),
          buttonSkip: D(D({}, vn), {}, { color: e.textColor, fontSize: 14 }),
          overlay: D(D({}, r), {}, { backgroundColor: e.overlayColor, mixBlendMode: "hard-light" }),
          overlayLegacy: D({}, r),
          ...
          spotlightLegacy: D(
            D({}, za),
            {},
            { boxShadow: "0 0 0 9999px ".concat(e.overlayColor, ", ").concat(e.spotlightShadow) }
          ),
          floaterStyles: { arrow: { color: e.arrowColor }, options: { zIndex: e.zIndex + 100 } },
          options: e,
        };
    ...
    function nr(t, e) {
      if (!t) return null;
      var n = Me.default.all([Z0(e), po.step, t], { isMergeableObject: ft.plainObject }),
        r = J0((0, Me.default)(e.styles || {}, t.styles || {})),
        o = Zo(Ce(t.target), n.disableScrollParentFix),
        i = Me.default.all([e.floaterProps || {}, po.floaterProps, n.floaterProps || {}]);
      return (
        (i.offset = n.offset),
        ...
        D(
          D({}, n),
          {},
          { locale: Me.default.all([po.locale, e.locale || {}, n.locale || {}]), floaterProps: i, styles: r }
        )
      );
    }
    function _f(t) {
      ...
      return ft.plainObject(t)
        ? t.target
          ? !0
          : (_e({ title: "validateStep", data: "target is missing from the step", warn: !0, debug: e }), !1)
        : (_e({ title: "validateStep", data: "step must be an object", warn: !0, debug: e }), !1);
    }
    function zu(t) {
      var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
      return ft.array(t)
        ...
        : (_e({ title: "validateSteps", data: "steps must be an array", warn: !0, debug: e }), !1);
    }
    function $0(t) {
      var e = t.styles;
      return g.createElement("div", { key: "JoyrideSpotlight", className: "react-joyride__spotlight", style: e });
    }
    function tb(t) {
      var e = t.styles,
        n = Io(t, Zf),
    ...
    var Bu,
      ...
      eb = v(() => {
        Of(),
          ...
          (fn = Ci !== void 0),
          (Qf = { action: "", controlled: !1, index: 0, lifecycle: _.INIT, size: 0, status: K.IDLE }),
            ...
            if (
              ...
              H(this, "canHaveFocus", function (o) {
                var i = /input|select|textarea|button|object/,
                  ...
                  s = (i.test(a) && !o.getAttribute("disabled")) || (a === "a" && !!o.getAttribute("href"));
              ...
              H(this, "isHidden", function (o) {
                ...
                return i && !o.innerHTML
                  ? !0
                  : (i && a.getPropertyValue("overflow") !== "visible") || a.getPropertyValue("display") === "none";
              }),
                ...
                },
                {
                  ...
                  value: function () {
                    var r = this.props,
                      ...
                      a = r.onClickOrHover,
                      s = r.styles,
                      l = { "aria-label": i.open, onClick: a, onMouseEnter: a, ref: this.setBeaconRef, title: i.open },
                      u;
                    if (o) {
                      var c = o;
                      ...
                      u = g.createElement(
                        "button",
                        zt(
                          { key: "JoyrideBeacon", className: "react-joyride__beacon", style: s.beacon, type: "button" },
                          l
                        ),
          ...
          (Yu = (function (t) {
            ...
            function n() {
              ...
              return (
                ...
                H(pt(r), "_isMounted", !1),
                H(pt(r), "state", { mouseOverSpotlight: !1, isScrolling: !1, showSpotlight: !0 }),
              ...
              ve(n, [
                ...
                },
                {
                  ...
                  value: function (r) {
                    ...
                    u("lifecycle", _.TOOLTIP) &&
                      (this.scrollParent.addEventListener("scroll", this.handleScroll, { passive: !0 }),
                      setTimeout(function () {
                        var c = o.state.isScrolling;
                        c || o.updateState({ showSpotlight: !0 });
                      }, 100)),
                      (u("spotlightClicks") || u("disableOverlay") || u("lifecycle")) &&
                        (s && a === _.TOOLTIP
                          ? window.addEventListener("mousemove", this.handleMouseMove, !1)
                          : a !== _.TOOLTIP && window.removeEventListener("mousemove", this.handleMouseMove));
                  },
                },
                {
                  key: "componentWillUnmount",
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var d = p.overlay;
                    Vu() && (d = f === "center" ? p.overlayLegacyCenter : p.overlayLegacy);
                    var h = D(
                        { cursor: l ? "default" : "pointer", height: W0(), pointerEvents: o ? "none" : "auto" },
                        d
                      ),
                      m = f !== "center" && i && g.createElement($0, { styles: this.spotlightStyles });
                    if (Gf() === "safari") {
                      h.mixBlendMode, h.zIndex;
                      var y = Io(h, Wu);
                      (m = g.createElement("div", { style: D({}, y) }, m)), delete h.backgroundColor;
                    }
                    return g.createElement("div", { className: "react-joyride__overlay", style: h, onClick: c }, m);
                  },
                },
              ]),
              n
              ...
              ve(n, [
                {
                  ...
                  value: function () {
                    ...
                    return (
                      a &&
                        ((rt.primary = l ? z : X),
                        x && (rt.primary = g.createElement("span", null, rt.primary, " (", s + 1, "/", c, ")"))),
                      b &&
                        !l &&
                        (rt.skip = g.createElement(
                          "button",
                          zt({ style: O.buttonSkip, type: "button", "aria-live": "off" }, f),
                          et
                        )),
                      !m &&
                        s > 0 &&
                        (rt.back = g.createElement("button", zt({ style: O.buttonBack, type: "button" }, o), M)),
                      (rt.close = !y && g.createElement(tb, zt({ styles: O.buttonClose }, i))),
                      g.createElement(
                        "div",
                        zt({ key: "JoyrideTooltip", className: "react-joyride__tooltip", style: O.tooltip }, d),
                        g.createElement(
                          "div",
                          { style: O.tooltipContainer },
                          w && g.createElement("h4", { style: O.tooltipTitle, "aria-label": w }, w),
                        ...
                        !E &&
                          g.createElement(
                            ...
                            g.createElement("div", { style: O.tooltipFooterSpacer }, rt.skip),
                            rt.back,
                            g.createElement("button", zt({ style: O.buttonNext, type: "button" }, u), rt.primary)
                          ),
                        rt.close
                      )
                    );
                ...
                H(pt(r), "getElementsProps", function () {
                  ...
                  return (
                    u && (E = h),
                    {
                      ...
                      tooltipProps: { "aria-modal": !0, ref: c, role: "alertdialog" },
                    }
                  );
                }),
                r
              ...
              ve(n, [
                {
                  ...
                  value: function () {
                    ...
                    if (u) {
                      ...
                      f = g.createElement(
                        qu,
                        zt({}, this.getElementsProps(), { continuous: o, index: i, isLastStep: a, size: s, step: l })
                      );
                    return f;
                  },
                },
              ...
              ve(n, [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      this.node || this.appendNode(), oe.unstable_renderSubtreeIntoContainer(this, r, this.node), null
                    );
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    var r = this.props.children;
                    return this.node || this.appendNode(), oe.createPortal(r, this.node);
                  },
                },
                {
                  key: "render",
              ...
              return (
                ...
                H(pt(r), "handleClickHoverBeacon", function (s) {
                  var l = r.props,
                    u = l.step,
                    c = l.update;
                  (s.type === "mouseenter" && u.event !== "hover") || c({ lifecycle: _.TOOLTIP });
                }),
                ...
                H(pt(r), "setPopper", function (s, l) {
                  ...
                  l === "wrapper" ? (r.beaconPopper = s) : (r.tooltipPopper = s),
                    ...
                    r.beaconPopper &&
                      r.tooltipPopper &&
                      p({ action: c === tt.CLOSE ? tt.CLOSE : c, lifecycle: _.READY });
                }),
                r
              );
            }
              ...
              ve(n, [
                {
                  ...
                  value: function () {
                    var r = this.props,
                      o = r.debug,
                      i = r.index;
                    _e({ title: "step:".concat(i), data: [{ key: "props", value: this.props }], debug: o });
                  },
                },
                {
                  key: "componentDidUpdate",
                  value: function (r) {
                    var o = this.props,
                      ...
                      E = y.changed,
                      x = y.changedFrom,
                      b = { action: i, controlled: l, index: c, lifecycle: f, size: p, status: d },
                      w = s && i !== tt.CLOSE && (c > 0 || i === tt.PREV),
                      O = E("action") || E("index") || E("lifecycle") || E("status"),
                    ...
                    if (
                      (M &&
                        (S || l) &&
                        a(
                          D(D({}, b), {}, { index: r.index, lifecycle: _.COMPLETE, step: r.step, type: Vt.STEP_AFTER })
                        ),
                      h.placement === "center" &&
                        d === K.RUNNING &&
                        E("index") &&
                      ...
                      var N = Ce(h.target),
                        ...
                        X = z && G0(N);
                      X
                        ? (x("status", K.READY, K.RUNNING) || x("lifecycle", _.INIT, _.READY)) &&
                          a(D(D({}, b), {}, { step: h, type: Vt.STEP_BEFORE }))
                        : (console.warn(z ? "Target not visible" : "Target not mounted", h),
                          a(D(D({}, b), {}, { type: Vt.TARGET_NOT_FOUND, step: h })),
                          l || m({ index: c + ([tt.PREV].indexOf(i) !== -1 ? -1 : 1) }));
                    }
                    x("lifecycle", _.INIT, _.READY) && m({ lifecycle: Fu(h) || w ? _.TOOLTIP : _.BEACON }),
                      E("index") &&
                        _e({ title: "step:".concat(f), data: [{ key: "props", value: this.props }], debug: u }),
                      E("lifecycle", _.BEACON) && a(D(D({}, b), {}, { step: h, type: Vt.BEACON })),
                      E("lifecycle", _.TOOLTIP) &&
                        (a(D(D({}, b), {}, { step: h, type: Vt.TOOLTIP })),
                        (this.scope = new Uu(this.tooltip, { selector: "[data-action=primary]" })),
                        this.scope.setFocus()),
                      x("lifecycle", [_.TOOLTIP, _.INIT], _.INIT) &&
                        (this.scope.removeScope(), delete this.beaconPopper, delete this.tooltipPopper);
                  },
                },
                {
                  key: "componentWillUnmount",
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return !_f(p) || !ft.domElement(d)
                      ...
                      : g.createElement(
                          "div",
                          { key: "JoyrideStep-".concat(s), className: "react-joyride__step" },
                          g.createElement(
                            _u,
                            { id: "react-joyride-portal" },
                            g.createElement(
                              Yu,
                              zt({}, p, { debug: i, lifecycle: l, onClickOverlay: this.handleClickOverlay })
                            )
                          ),
                          g.createElement(
                            co,
              ...
              return (
                ...
                H(pt(o), "initStore", function () {
                  var i = o.props,
                    ...
                    l = i.run,
                    u = i.stepIndex;
                  (o.store = new H0(D(D({}, o.props), {}, { controlled: l && ft.number(u) }))),
                ...
                H(pt(o), "handleKeyboard", function (i) {
                  ...
                  l === _.TOOLTIP && f === 27 && c && !c.disableCloseOnEsc && o.store.close();
                }),
              ...
              ve(n, [
                  ...
                  value: function () {
                    if (de) {
                      var r = this.props,
                        ...
                        l = this.store.start;
                      zu(s, i) && a && l(),
                        o || document.body.addEventListener("keydown", this.handleKeyboard, { passive: !0 });
                    }
                  },
                },
                {
                  ...
                  value: function (r, o) {
                    if (de) {
                      var i = this.state,
                        ...
                        Ft = Ce(ht?.target);
                      if (
                        (Tt && (zu(m, p) ? w(m) : console.warn("Steps are not valid", m)),
                        z("run") && (d ? O(h) : S()),
                        Ct)
                      ) {
                        ...
                        a === tt.STOP && (St = tt.START),
                          [K.FINISHED, K.SKIPPED].indexOf(c) === -1 &&
                            M({ action: a === tt.CLOSE ? tt.CLOSE : St, index: h, lifecycle: _.INIT });
                      }
                      !s &&
                        c === K.RUNNING &&
                        l === 0 &&
                        !Ft &&
                        (M({ index: l + 1 }),
                        this.callback(D(D({}, this.state), {}, { type: Vt.TARGET_NOT_FOUND, step: ht })));
                      ...
                      if (Wt && et("status", K.PAUSED)) {
                        ...
                        this.callback(
                          D(D({}, It), {}, { index: o.index, lifecycle: _.COMPLETE, step: ne, type: Vt.STEP_AFTER })
                        );
                      }
                      if (et("status", [K.FINISHED, K.SKIPPED])) {
                        ...
                        s ||
                          this.callback(
                            D(D({}, It), {}, { index: o.index, lifecycle: _.COMPLETE, step: Mt, type: Vt.STEP_AFTER })
                          ),
                          this.callback(D(D({}, It), {}, { index: o.index, step: Mt, type: Vt.TOUR_END })),
                          b();
                      } else
                        rt("status", [K.IDLE, K.READY], K.RUNNING)
                          ? this.callback(D(D({}, It), {}, { type: Vt.TOUR_START }))
                          : et("status")
                          ? this.callback(D(D({}, It), {}, { type: Vt.TOUR_STATUS }))
                          : et("action", tt.RESET) && this.callback(D(D({}, It), {}, { type: Vt.TOUR_STATUS }));
                      ht &&
                        (this.scrollToStep(o),
                        ht.placement === "center" &&
                          c === K.RUNNING &&
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    r || document.body.removeEventListener("keydown", this.handleKeyboard);
                  },
                },
                {
                  key: "scrollToStep",
                  value: function (r) {
                    ...
                    if (m) {
                      var y = Ce(m.target),
                        E = this.shouldScroll(m.disableScrolling, i, f, a, m, y, r);
                      if (s === K.RUNNING && E) {
                        var x = Zo(y, c),
                          b = Lo(y, c),
                        ...
                        if (
                          ...
                          var O = this.beaconPopper,
                            S = O.placement,
                            M = O.popper;
                          ["bottom"].indexOf(S) === -1 && !x && (w = Math.floor(M.top - p));
  ...
  color: ${({ theme: t, variant: e }) =>
    e === "primary" ? t.color.lightest : e === "secondary" || e === "outline" ? t.darkest : t.color.lightest};
  box-shadow: ${({ variant: t }) =>
    t === "primary" ? "none" : t === "secondary" || t === "outline" ? "#D9E8F2 0 0 0 1px inset" : "none"};
  height: 32px;
  font-size: 0.8125rem;
  font-weight: 700;
  ...
  &:hover {
    background-color: ${({ variant: t }) =>
      t === "primary" ? "#0b94eb" : t === "secondary" ? "#eef4f9" : t === "outline" ? "transparent" : "#0b94eb"};
  }
...
`),
          (Bt = ct(({ children: t, onClick: e, variant: n = "primary", ...r }, o) =>
            ...
            g.createElement(
              ...
              !t.hideNextButton &&
                g.createElement(
                  ...
                  g.createElement(
                    Bt,
                    { ...e, ...(t.onNextButtonClick ? { onClick: t.onNextButtonClick } : {}) },
                    "Next"
                  )
                )
            ));
...
`);
    ...
    function sb({ api: t, isFinalStep: e, onFirstTourDone: n, onLastTourDone: r, codeSnippets: o }) {
      let [i, a] = at(),
        s = Mi();
      W(() => {
        t.once(ou, () => {
      ...
      let l = Nt(
          () => document.querySelector("#root div[role=main]") || document.querySelector("#storybook-panel-root"),
          []
        ),
        u = e
          ? [
          ...
          : [
              ...
              },
              {
                ...
                content: g.createElement(
                  ...
                  g.createElement(td, { numberOfPieces: 800, recycle: !1, tweenDuration: 2e4 })
                ),
                placement: "right",
          ...
          (Fo = ct((t, e) => {
            ...
            if (i) {
              let a = i.props.children,
                s = o.map((l) => (l === i ? (Gt.count(a) > 1 ? Gt.only(null) : Pe(a) ? a.props.children : null) : l));
    ...
    function Sb(t, e = globalThis?.document) {
      ...
      return (
        W(() => {
          let o = (i) => {
            i.target && !r.current && xd(Sd, n, { originalEvent: i }, { discrete: !1 });
          };
    ...
    function xd(t, e, n, { discrete: r }) {
      ...
      e && o.addEventListener(t, e, { once: !0 }), r ? wb(o, i) : o.dispatchEvent(i);
    }
    var ho,
      Od,
      Sd,
      ...
      Pb = v(() => {
        Vn(),
          ...
          (lc = Yt({ layers: new Set(), layersWithOutsidePointerEventsDisabled: new Set(), branches: new Set() })),
          (Pd = ct((t, e) => {
            var n;
            let {
              ...
              c = mt(lc),
              [f, p] = at(null),
              d = (n = f?.ownerDocument) !== null && n !== void 0 ? n : globalThis?.document,
              [, h] = at({}),
              m = Cr(e, (N) => p(N)),
              ...
              M = Sb((N) => {
                let z = N.target;
                [...c.branches].some((X) => X.contains(z)) || (a?.(N), s?.(N), N.defaultPrevented || l?.());
              }, d);
            return (
              Eb((N) => {
                b === c.layers.size - 1 && (o?.(N), !N.defaultPrevented && l && (N.preventDefault(), l()));
              }, d),
              W(() => {
                if (f)
                  return (
                    r &&
                      (c.layersWithOutsidePointerEventsDisabled.size === 0 &&
                        ((sc = d.body.style.pointerEvents), (d.body.style.pointerEvents = "none")),
                      c.layersWithOutsidePointerEventsDisabled.add(f)),
                    c.layers.add(f),
                    ac(),
                    () => {
                      r && c.layersWithOutsidePointerEventsDisabled.size === 1 && (d.body.style.pointerEvents = sc);
                    }
                  );
              }, [f, d, r, c]),
              W(
                () => () => {
                  f && (c.layers.delete(f), c.layersWithOutsidePointerEventsDisabled.delete(f), ac());
                },
                [f, c]
              ),
              W(() => {
              ...
              q(
                ...
                Ot({}, u, {
                  ref: m,
                  style: { pointerEvents: w ? (O ? "auto" : "none") : void 0, ...t.style },
                  onFocusCapture: Ke(t.onFocusCapture, M.onFocusCapture),
                  onBlurCapture: Ke(t.onBlurCapture, M.onBlurCapture),
                  onPointerDownCapture: Ke(t.onPointerDownCapture, S.onPointerDownCapture),
                })
              )
            );
          }));
    ...
    function Tb(t, { select: e = !1 } = {}) {
      ...
      for (let r of t) if ((Ae(r, { select: e }), document.activeElement !== n)) return;
    }
    function Cb(t) {
      let e = Td(t),
        n = uc(e, t),
    ...
    var Xr,
      ...
      Db = v(() => {
        Vn(),
          ...
          (Cd = ct((t, e) => {
            let { loop: n = !1, trapped: r = !1, onMountAutoFocus: o, onUnmountAutoFocus: i, ...a } = t,
              [s, l] = at(null),
              u = $e(o),
              c = $e(i),
              f = nt(null),
              ...
              if (r) {
                let m = function (b) {
                  ...
                  E = function (b) {
                    ...
                    for (let O of b) O.removedNodes.length > 0 && ((s != null && s.contains(w)) || Ae(s));
                  };
                ...
                if (s) {
                  ...
                  if (!s.contains(m)) {
                    ...
                    s.addEventListener(Xr, u),
                      s.dispatchEvent(y),
                      y.defaultPrevented || (Tb(Mb(Td(s)), { select: !0 }), document.activeElement === m && Ae(s));
                  }
                  return () => {
                    s.removeEventListener(Xr, u),
                      setTimeout(() => {
                        ...
                        s.addEventListener(_r, c),
                          s.dispatchEvent(y),
                          y.defaultPrevented || Ae(m ?? document.body, { select: !0 }),
                ...
                if (y && E) {
                  ...
                  b && w
                    ? !m.shiftKey && E === w
                      ...
                      : m.shiftKey && E === b && (m.preventDefault(), n && Ae(w, { select: !0 }))
        ...
        jr(),
          ...
          (wr = (t) => {
            let { present: e, children: n } = t,
              r = Lb(e),
              o = typeof n == "function" ? n({ present: r.isPresent }) : Gt.only(n),
              i = Cr(r.ref, o.ref);
            return typeof n == "function" || r.isPresent ? Ve(o, { ref: i }) : null;
          }),
    ...
    function Fb() {
      W(() => {
        ...
        return (
          document.body.insertAdjacentElement("afterbegin", (t = n[0]) !== null && t !== void 0 ? t : pc()),
          document.body.insertAdjacentElement("beforeend", (e = n[1]) !== null && e !== void 0 ? e : pc()),
          mo++,
          () => {
            mo === 1 && document.querySelectorAll("[data-radix-focus-guard]").forEach((r) => r.remove()), mo--;
          }
        );
      }, []);
    }
    ...
    var Ua,
      ...
      Zb = v(() => {
        G(),
          ...
          (Or = ct(function (t, e) {
            var n = nt(null),
              r = at({ onScrollCapture: Qr, onWheelCapture: Qr, onTouchMoveCapture: Qr }),
              o = r[0],
              i = r[1],
              a = t.forwardProps,
              s = t.children,
            ...
            return q(
              ...
              a ? Ve(Gt.only(s), A(A({}, O), { ref: w })) : q(E, A({}, O, { className: l, ref: w }), s)
            );
          })),
      ...
      s1 = v(() => {
        (vc = function (t) {
          ...
          (Xi = function (t, e) {
            ...
            return n[e] !== "hidden" && !(n.overflowY === n.overflowX && !vc(t) && n[e] === "visible");
          }),
          (gc = function (t) {
          ...
          (Wd = function (t, e, n, r, o) {
            ...
            return (
              ((c && ((o && f === 0) || (!o && a > f))) || (!c && ((o && p === 0) || (!o && -a > p)))) && (u = !0), u
            );
          });
      });
    function l1(t) {
        ...
        W(
          function () {
            if (t.inert) {
              ...
              var m = $t([t.lockRef.current], (t.shards || []).map(Ya), !0).filter(Boolean);
              return (
      ...
      var s = xt(function (m, y) {
          ...
          var N = Ha(M, S);
          if (!N) return !0;
          if ((N ? (O = M) : ((O = M === "v" ? "h" : "v"), (N = Ha(M, S))), !N)) return !1;
          if ((!r.current && "changedTouches" in m && (b || w) && (r.current = O), !O)) return !0;
          var z = r.current || O;
          ...
          if (!(!Xe.length || Xe[Xe.length - 1] !== i)) {
            var E = "deltaY" in y ? Wa(y) : pr(y),
              x = e.current.filter(function (O) {
                return O.name === y.type && O.target === y.target && Yd(O.delta, E);
              })[0];
            if (x && x.should) {
      ...
      var d = t.removeScrollBar,
        h = t.inert;
      return q(Se, null, h ? q(i, { styles: qd(o) }) : null, d ? q(Hd, { gapMode: "margin" }) : null);
    }
    var pr,
      Wa,
      Ya,
            ...
            return e
              .map(function (n) {
                ...
                return r && t.contains(r)
                  ? r
                  : (console.error("aria-hidden", n, "in not contained inside", t, ". Doing nothing"), null);
              })
              .filter(function (n) {
                return !!n;
              });
            ...
            return (
              ...
              function () {
                a.forEach(function (f) {
                  ...
                  $r--,
                  $r || ((He = new WeakMap()), (He = new WeakMap()), (or = new WeakMap()), (ir = {}));
              }
            );
          }),
          (Kd = function (t, e, n) {
            ...
            var r = Array.from(Array.isArray(t) ? t : [t]),
              o = e || xc(t);
            return o
              ? (r.push.apply(r, Array.from(o.querySelectorAll("[aria-live]"))), Sc(r, o, n, "aria-hidden"))
              : function () {
                  return null;
                };
          });
    ...
    var Zi,
      ...
      rh = v(() => {
        Vn(),
          ...
          ([Tc, Kt] = $i(Zi)),
          (Cc = (t) => {
            let { __scopeDialog: e, children: n, open: r, defaultOpen: o, onOpenChange: i, modal: a = !0 } = t,
              s = nt(null),
              l = nt(null),
          ...
          (kc = (t) => {
            let { __scopeDialog: e, forceMount: n, children: r, container: o } = t,
              i = Kt(ta, e);
            return q(
              Ac,
              { scope: e, forceMount: n },
              Gt.map(r, (a) => q(wr, { present: n || i.open }, q(Ad, { asChild: !0, container: o }, a)))
            );
          }),
          (to = "DialogOverlay"),
          (Rc = ct((t, e) => {
            ...
            return i.modal ? q(wr, { present: r || i.open }, q(Mc, Ot({}, o, { ref: e }))) : null;
          })),
          (Mc = ct((t, e) => {
            ...
            return q(
              ...
              q(De.div, Ot({ "data-state": Pc(o.open) }, r, { ref: e, style: { pointerEvents: "auto", ...r.style } }))
            );
          })),
          (We = "DialogContent"),
          (Dc = ct((t, e) => {
          ...
          (Ic = ct((t, e) => {
            ...
            return q(
              ...
              Ot({}, t, {
                ...
                onInteractOutside: (i) => {
                  var a, s;
                  (a = t.onInteractOutside) === null || a === void 0 || a.call(t, i),
                    i.defaultPrevented ||
                      ((r.current = !0), i.detail.originalEvent.type === "pointerdown" && (o.current = !0));
                  let l = i.target;
                  !((s = n.triggerRef.current) === null || s === void 0) && s.contains(l) && i.preventDefault(),
          ...
          (na = ct((t, e) => {
            let { __scopeDialog: n, trapFocus: r, onOpenAutoFocus: o, onCloseAutoFocus: i, ...a } = t,
              s = Kt(We, n),
              l = nt(null),
              u = Cr(e, l);
            return (
          ...
          (zc = ct((t, e) => {
            ...
            return q(
              De.button,
              Ot({ type: "button" }, r, { ref: e, onClick: Ke(t.onClick, () => o.onOpenChange(!1)) })
            );
          })),
...
`),
  ...
  `
          ...
          (ih = g.forwardRef(({ width: t, height: e, children: n, ...r }, o) =>
            g.createElement($d, { ref: o, asChild: !0, ...r }, g.createElement(Uc, { width: t, height: e }, n))
          ));
      });
    function ah({
      children: t,
    ...
    function v1() {
      return g.createElement(
        ...
        g.createElement(
          "g",
          null,
          g.createElement("mask", { id: "mask-2", fill: "white" }, g.createElement("use", { xlinkHref: "#path-1" })),
...
`;
        ...
        Ds(),
          ...
          (yh = ({ onProceed: t, skipOnboarding: e }) =>
            g.createElement(
              "div",
              { style: { zIndex: 10 } },
              g.createElement(ah, { width: 540, height: 430, defaultOpen: !0 }, ({ Close: n }) =>
                g.createElement(
                  lh,
                  ...
                  g.createElement(
                    ...
                    g.createElement(Bt, { style: { marginTop: 4 }, onClick: t }, "Start your 3 minute tour")
                  ),
                  g.createElement(fh, { onClick: e }, "Skip tour", g.createElement(dh, { icon: "arrowright" })),
                  g.createElement(
                    hh,
                    null,
      ...
      w1 = ee((t, e) => {
        function n(r, o, i) {
          ...
          function f() {
            var d = Date.now() - u;
            d < o && d >= 0 ? (a = setTimeout(f, o - d)) : ((a = null), i || ((c = r.apply(l, s)), (l = s = null)));
          }
          var p = function () {
            (l = this), (s = arguments), (u = Date.now());
            var d = i && !a;
            return a || (a = setTimeout(f, o)), d && ((c = r.apply(l, s)), (l = s = null)), c;
          };
          return (
            (p.clear = function () {
            ...
            (p.flush = function () {
              a && ((c = r.apply(l, s)), (l = s = null), clearTimeout(a), (a = null));
            }),
            p
          );
        }
    ...
    function E1(t) {
      ...
      let [a, s] = at({ left: 0, top: 0, width: 0, height: 0, bottom: 0, right: 0, x: 0, y: 0 }),
        l = nt({ element: null, scrollContainers: null, resizeObserver: null, lastBounds: a }),
      ...
      let [p, d, h] = Nt(() => {
        let x = () => {
          ...
          let {
            ...
            et = { left: b, top: w, width: O, height: S, bottom: M, right: N, x: z, y: X };
          l.current.element instanceof HTMLElement &&
            o &&
            ((et.height = l.current.element.offsetHeight), (et.width = l.current.element.offsetWidth)),
            Object.freeze(et),
            f.current && !wh(l.current.lastBounds, et) && s((l.current.lastBounds = et));
        };
        return [x, c ? (0, qa.default)(x, c) : x, u ? (0, qa.default)(x, u) : x];
      }, [s, o, u, c]);
      function m() {
        l.current.scrollContainers &&
          (l.current.scrollContainers.forEach((x) => x.removeEventListener("scroll", h, !0)),
          (l.current.scrollContainers = null)),
          l.current.resizeObserver && (l.current.resizeObserver.disconnect(), (l.current.resizeObserver = null));
      }
      function y() {
        l.current.element &&
          ...
          n &&
            l.current.scrollContainers &&
            l.current.scrollContainers.forEach((x) => x.addEventListener("scroll", h, { capture: !0, passive: !0 })));
      }
      let E = (x) => {
        !x || x === l.current.element || (m(), (l.current.element = x), (l.current.scrollContainers = bh(x)), y());
      };
      return (
        O1(h, !!n),
        x1(d),
    ...
    function bh(t) {
      ...
      let { overflow: n, overflowX: r, overflowY: o } = window.getComputedStyle(t);
      return [n, r, o].some((i) => i === "auto" || i === "scroll") && e.push(t), [...e, ...bh(t.parentElement)];
    }
    var qa,
      qc,
      wh,
      ...
      js,
      Eh = v(() => {
        (Gc = "production"), (js = typeof process > "u" || re === void 0 ? Gc : "production");
      });
    function P1(t) {
      for (var e in t)
        t[e] !== null &&
          (e === "projectionNodeConstructor" ? (Dn.projectionNodeConstructor = t[e]) : (Dn[e].Component = t[e]));
    }
    var ae,
      Dn,
      xh = v(() => {
    ...
    function B1(t, e) {
      if (ai(t)) {
        var n = t.initial,
          r = t.animate;
        return { initial: n === !1 || Jt(n) ? n : void 0, animate: Jt(r) ? r : void 0 };
      }
      ...
      function s(l, u) {
        ...
        return (
          ...
          q(
            ...
            p,
            q(Vr.Provider, { value: d }, o(a, l, h, j1(m, d.visualElement, u), m, f.isStatic, d.visualElement))
          )
        );
      }
      return ct(s);
    ...
    function Ys(t) {
      return typeof t != "string" || t.includes("-") ? !1 : !!(Dh.indexOf(t) > -1 || /[A-Z]/.test(t));
    }
    var qs = v(() => {
      tw();
    });
    ...
    function jh(t, e) {
      var n = e.layout,
        r = e.layoutId;
      return Br(t) || Nh(t) || ((n || r !== void 0) && (!!Ar[t] || t === "opacity"));
    }
    var Fh = v(() => {
        Gs(), je();
      }),
    ...
    function rw(t, e, n, r) {
      ...
      for (var f = !1, p = i.length, d = 0; d < p; d++) {
        var h = i[d];
        (c += "".concat(Vh[h] || h, "(").concat(o[h], ") ")), h === "z" && (f = !0);
      }
      return !f && s ? (c += "translateZ(0)") : (c = c.trim()), r ? (c = r(o, n ? "" : c)) : u && n && (c = "none"), c;
    }
    function ow(t) {
      var e = t.originX,
        n = e === void 0 ? "50%" : e,
    ...
    var Vh,
      iw = v(() => {
        je(), (Vh = { x: "translateX", y: "translateY", z: "translateZ", transformPerspective: "perspective" });
      });
    function zh(t) {
      return t.startsWith("--");
    }
    ...
    var Xs,
      ...
      Fe = v(() => {
        (Xs = (t, e) => (n) => Math.max(Math.min(n, e), t)),
          ...
          (Hh = /^(#[0-9a-f]{3}|#(?:[0-9a-f]{2}){2,4}|(rgb|hsl)a?\((-?[\d\.]+%?[,\s]+){2,3}\s*\/*\s*[\d\.]+%?\))$/i);
      }),
      Ie,
      Tn,
      fr,
      ui = v(() => {
        Fe(),
          (Ie = { test: (t) => typeof t == "number", parse: parseFloat, transform: (t) => t }),
      ...
      Ks = v(() => {
        Fe(),
          (ci = (t, e) => (n) =>
            !!((kr(n) && Hh.test(n) && n.startsWith(t)) || (e && Object.prototype.hasOwnProperty.call(n, e)))),
          (_s = (t, e, n) => (r) => {
            if (!kr(r)) return r;
      ...
      Qs = v(() => {
        ui(),
          ...
          Ks(),
          (Kc = Xs(0, 255)),
          (eo = Object.assign(Object.assign({}, Ie), { transform: (t) => Math.round(Kc(t)) })),
          (ye = {
            test: ci("rgb", "red"),
      ...
      _h = v(() => {
        Fe(),
          ...
          (Rt = {
            ...
            parse: (t) => (ye.test(t) ? ye.parse(t) : Ne.test(t) ? Ne.parse(t) : Uo.parse(t)),
            transform: (t) => (kr(t) ? t : t.hasOwnProperty("red") ? ye.transform(t) : Ne.transform(t)),
          });
      });
    function lw(t) {
      var e, n, r, o;
      return (
        isNaN(t) &&
        kr(t) &&
        ((n = (e = t.match(Nn)) === null || e === void 0 ? void 0 : e.length) !== null && n !== void 0 ? n : 0) +
          ((o = (r = t.match(Bo)) === null || r === void 0 ? void 0 : r.length) !== null && o !== void 0 ? o : 0) >
          0
      );
    }
    function Kh(t) {
      ...
      let e = [],
        n = 0,
        r = t.match(Bo);
      r && ((n = r.length), (t = t.replace(Bo, Js)), e.push(...r.map(Rt.parse)));
      let o = t.match(Nn);
      return o && ((t = t.replace(Nn, Zs)), e.push(...o.map(Ie.parse))), { values: e, numColors: n, tokenised: t };
    }
    function Qh(t) {
      return Kh(t).values;
    }
    function Jh(t) {
      ...
      return (i) => {
        let a = r;
        for (let s = 0; s < o; s++) a = a.replace(s < n ? Js : Zs, s < n ? Rt.transform(i[s]) : Pn(i[s]));
        return a;
      };
    }
    function uw(t) {
    ...
    var Js,
      ...
      $h = v(() => {
        _h(),
          ...
          (pe = { test: lw, parse: Qh, createTransformer: Jh, getAnimatableNone: uw });
      });
    function cw(t) {
    ...
    function hw(t, e, n) {
      var r = t.style || {},
        o = {};
      return nm(o, r, t), Object.assign(o, dw(t, e, n)), t.transformValues && (o = t.transformValues(o)), o;
    }
    function mw(t, e, n) {
      var r = {},
        o = hw(t, e, n);
      return (
        t.drag &&
          ...
          (o.touchAction = t.drag === !0 ? "none" : "pan-".concat(t.drag === "x" ? "y" : "x"))),
        (r.style = o),
        r
      );
    }
    ...
    var Jc,
      ...
      bw = v(() => {
        yw(),
          ...
          (Zc = im(function (t) {
            return Jc.test(t) || (t.charCodeAt(0) === 111 && t.charCodeAt(1) === 110 && t.charCodeAt(2) < 91);
          })),
          (sm = Zc);
      });
    function ww(t) {
    ...
    function Ew(t, e, n) {
      var r = {};
      for (var o in t)
        (rl(o) || (n === !0 && Wo(o)) || (!e && !Wo(o)) || (t.draggable && o.startsWith("onDrag"))) && (r[o] = t[o]);
      return r;
    }
    var rl,
      xw = v(() => {
    ...
    function Pw(t, e, n, r, o) {
      n === void 0 && (n = 1), r === void 0 && (r = 0), o === void 0 && (o = !0), (t.pathLength = 1);
      var i = o ? lm : um;
    ...
    function ol(t, e, n, r) {
      var o = e.attrX,
        ...
        f = e.pathOffset,
        p = f === void 0 ? 0 : f,
        d = jt(e, ["attrX", "attrY", "originX", "originY", "pathLength", "pathSpacing", "pathOffset"]);
      ...
      h.transform && (y && (m.transform = h.transform), delete h.transform),
        y &&
          ...
          (m.transformOrigin = Ow(y, a !== void 0 ? a : 0.5, s !== void 0 ? s : 0.5)),
        o !== void 0 && (h.x = o),
        i !== void 0 && (h.y = i),
    ...
    function Mw(t, e, n, r) {
      ...
      var l = t.initial,
        ...
        c = ai(t),
        f = Ch(t);
      e && f && !c && t.inherit !== !1 && (l ?? (l = e.initial), u ?? (u = e.animate));
      var p = i || l === !1,
        d = p ? u : l;
    ...
    var ml,
          ...
          (xm = {
            useVisualState: ml({
              ...
              onMount: function (t, e, n) {
                ...
                ol(r, o, { enableHardwareAcceleration: !1 }, t.transformTemplate), mm(e, r);
              },
            }),
          });
      }),
      Om,
      Nw = v(() => {
        Em(), cl(), nl(), (Om = { useVisualState: ml({ scrapeMotionValuesFromProps: ul, createRenderState: pi }) });
      });
    ...
    function jw(t) {
      var e = t.whileFocus,
        ...
        r = function () {
          var i;
          (i = n.animationState) === null || i === void 0 || i.setActive(st.Focus, !0);
        },
        o = function () {
          var i;
          (i = n.animationState) === null || i === void 0 || i.setActive(st.Focus, !1);
        };
    ...
    function gl(t, e) {
      return e === void 0 && (e = "page"), { point: Pm(t) ? zw(t, e) : Bw(t, e) };
    }
    var Tm,
      yl,
      bl = v(() => {
    ...
    function op(t, e, n) {
      return function (r, o) {
        var i;
        !Sm(r) || Im() || ((i = t.animationState) === null || i === void 0 || i.setActive(st.Hover, e), n?.(r, o));
      };
    }
    function Hw(t) {
    ...
    function qw({ duration: t = 800, bounce: e = 0.25, velocity: n = 0, mass: r = 1 }) {
      let o, i;
    ...
    var yo,
      ...
      Bm,
      Xw = v(() => {
        fe(), El(), (yo = 0.001), (Fm = 0.01), (es = 10), (Vm = 0.05), (zm = 1), (Bm = 12);
      });
    function ip(t, e) {
    ...
    function xl(t) {
      ...
      let a = { done: !1, value: e },
        { stiffness: s, damping: l, mass: u, velocity: c, duration: f, isResolvedFromDuration: p } = _w(i),
        d = ns,
        h = ns;
      function m() {
        let y = c ? -(c / 1e3) : 0,
        ...
        if ((o === void 0 && (o = Math.min(Math.abs(n - e) / 100, 0.4)), x < 1)) {
          ...
          (d = (O) => {
            ...
            return n - S * (((y + x * b * E) / w) * Math.sin(w * O) + E * Math.cos(w * O));
          }),
            (h = (O) => {
              let S = Math.exp(-x * b * O);
              return (
                x * b * S * ((Math.sin(w * O) * (y + x * b * E)) / w + E * Math.cos(w * O)) -
                S * (Math.cos(w * O) * (y + x * b * E) - w * E * Math.sin(w * O))
              );
            });
        } else if (x === 1) d = (w) => n - Math.exp(-b * w) * (E + (y + b * E) * w);
        else {
          let w = b * Math.sqrt(x * x - 1);
          d = (O) => {
            let S = Math.exp(-x * b * O),
              M = Math.min(w * O, 300);
            return n - (S * ((y + x * b * E) * Math.sinh(M) + w * E * Math.cosh(M))) / w;
          };
        }
      }
      return (
    ...
    var Um,
      ...
      Kw = v(() => {
        G(),
          ...
          (xl.needsInterpolation = (t, e) => typeof t == "string" || typeof e == "string"),
          (ns = (t) => 0);
      }),
      Ln,
      Wm = v(() => {
    ...
    var Qw = v(() => {}),
      ...
      Ym = v(() => {
        mi(),
          ...
          (aa = (t) => `'${t}' is not an animatable color. Use the equivalent color code instead.`),
          (Ol = (t, e) => {
            let n = ia(t),
              r = ia(e);
            qt(!!n, aa(t)), qt(!!r, aa(e));
            let o = n.parse(t),
              i = r.parse(e);
            n === Ne && ((o = ap(o)), (n = ye)), r === Ne && ((i = ap(i)), (r = ye));
        ...
        wt(),
          ...
          (Gm = (t, e) => {
            let n = Object.assign(Object.assign({}, t), e),
              r = {};
            for (let o in n) t[o] !== void 0 && e[o] !== void 0 && (r[o] = cp(t[o], e[o]));
            return (o) => {
    ...
    var _m,
      Km = v(() => {
        Wm(), mi(), Ym(), Jw(), wt(), El(), Sl(), fe(), (_m = (t, e) => (n) => dt(t, e, n));
      }),
      dr,
      bo,
      Qm,
      ...
      Cl = v(() => {
        nE(),
          ...
          (rv = dr(hr)),
          (ov = (t) => (t < 0.5 ? 0.5 * (1 - hr(1 - t * 2)) : 0.5 * hr(t * 2 - 1) + 0.5));
      });
    function rE(t, e) {
    ...
    function xo({ from: t = 0, to: e = 1, ease: n, offset: r, duration: o = 300 }) {
    ...
    var as,
      ...
      pE = v(() => {
        (ss = 16.666666666666668),
          (yp = typeof performance < "u" ? () => performance.now() : () => Date.now()),
          (ls = typeof window < "u" ? (t) => window.requestAnimationFrame(t) : (t) => setTimeout(() => t(yp()), ss));
      });
    function fE(t) {
      let e = [],
        n = [],
        ...
        s = {
          schedule: (l, u = !1, c = !1) => {
            let f = c && o,
              p = f ? e : n;
            return u && a.add(l), p.indexOf(l) === -1 && (p.push(l), f && o && (r = e.length)), l;
          },
          cancel: (l) => {
            let u = n.indexOf(l);
    ...
    var dE = v(() => {}),
      ...
      on = v(() => {
        pE(),
          ...
          (wp = mn.reduce((t, e) => {
            let n = ar[e];
            return (t[e] = (r, o = !1, i = !1) => (hn || xp(), n.schedule(r, o, i))), t;
          }, {})),
    ...
    function av(t) {
      ...
      function rt(Tt) {
        ...
        h?.(w), O && (x === 0 && (b ?? (b = a)), x < s ? mE(a, b, u, S) && X() : et());
      }
      function ht() {
        c?.(), (E = i(rt)), E.start();
      }
    ...
    function gE({
      ...
      function x(b) {
        E(Object.assign({ type: "spring", stiffness: a, damping: s, restDelta: l }, b));
      }
        ...
        let w = y(b),
          ...
          N = (z) => {
            (S = M),
              (M = z),
              (e = uv(z - S, Mr().delta)),
              ((O === 1 && z > w) || (O === -1 && z < w)) && x({ from: z, to: w, velocity: e });
          };
        E({
          type: "decay",
          from: t,
    ...
    function PE(t) {
      ...
      function f() {
        var m;
        return c(), (s.current = !1), (m = i.animationState) === null || m === void 0 || m.setActive(st.Tap, !1), !Im();
      }
      function p(m, y) {
      ...
      function h(m, y) {
        ...
        c(),
          !s.current &&
            ((s.current = !0),
            (l.current = Hr(Cn(window, "pointerup", p, u), Cn(window, "pointercancel", d, u))),
            (E = i.animationState) === null || E === void 0 || E.setActive(st.Tap, !0),
            n?.(m, y));
      }
    ...
    function kE(t) {
      ...
      var o = So.get(r),
        i = JSON.stringify(n);
      return o[i] || (o[i] = new IntersectionObserver(gv, A({ root: e }, n))), o[i];
    }
    function RE(t, e, n) {
      var r = kE(e);
      return (
    ...
    function NE(t, e, n, r) {
      ...
      W(
        function () {
          if (t) {
            var u = { root: o?.current, rootMargin: i, threshold: typeof s == "number" ? s : yv[s] },
              c = function (f) {
                var p,
                  d = f.isIntersecting;
                if (e.isInView !== d && ((e.isInView = d), !(l && !d && e.hasEnteredView))) {
                  d && (e.hasEnteredView = !0),
                    (p = n.animationState) === null || p === void 0 || p.setActive(st.InView, d);
                  var h = n.getProps(),
        ...
        function () {
          !t ||
            ...
            requestAnimationFrame(function () {
              ...
              s?.(null), (a = n.animationState) === null || a === void 0 || a.setActive(st.InView, !0);
            }));
        },
        [t]
      );
    ...
    var yv,
      ...
      bv,
      jE = v(() => {
        Fw(), Ww(), TE(), LE(), kl(), (bv = { inView: be(DE), tap: be(PE), focus: be(jw), hover: be(Hw) });
      }),
      Sp,
      Pp,
      wv,
    ...
    var VE = v(() => {}),
      ...
      zE = v(() => {
        G(),
          ...
          (ps = function (t) {
            if (Array.isArray(t)) {
              qt(t.length === 4, "Cubic bezier arrays must contain four numerical values.");
              var e = bt(t, 4),
                n = e[0],
                r = e[1],
                o = e[2],
                i = e[3];
              return OE(n, r, o, i);
            } else if (typeof t == "string") return qt(fa[t] !== void 0, "Invalid easing type '".concat(t, "'")), fa[t];
            return t;
          }),
          (Pv = function (t) {
      ...
      UE = v(() => {
        G(),
          ...
          (sr = function (t) {
            return { type: "spring", stiffness: 550, damping: t === 0 ? 2 * Math.sqrt(550) : 30, restSpeed: 10 };
          }),
          (oo = function () {
          ...
          (Tv = function (t, e) {
            var n;
            return In(e) ? (n = Tp) : (n = da[t] || da.default), A({ to: e }, n(e));
          });
      }),
      Cp,
      gi,
    ...
    function Ml(t, e) {
      var n,
        r = gi(t);
      return r !== Ho && (r = pe), (n = r.getAnimatableNone) === null || n === void 0 ? void 0 : n.call(r, e);
    }
    var Cv = v(() => {
        wt(), Rl();
      }),
    ...
    function YE(t) {
      ...
      return (
        ...
        (r || i || o) &&
          (Fr(!ds, "yoyo, loop and flip have been removed from the API. Replace with repeat and repeatType options."),
          (ds = !0),
    ...
    function GE(t) {
      return Array.isArray(t.to) && t.to[0] === null && ((t.to = $t([], bt(t.to), !1)), (t.to[0] = t.from)), t;
    }
    function XE(t, e, n) {
      var r;
      return (
        ...
        return a.type === "inertia" || a.type === "decay"
          ...
          : av(
              A(A({}, XE(a, p, t)), {
                onUpdate: function (d) {
                  var h;
                  p.onUpdate(d), (h = a.onUpdate) === null || h === void 0 || h.call(a, d);
                },
                onComplete: function () {
                  var d;
              ...
              (this.version = "6.5.1"),
                ...
                (this.updateAndNotify = function (r, o) {
                  ...
                  var i = Mr(),
                    ...
                    s = i.timestamp;
                  n.lastUpdated !== s &&
                    ((n.timeDelta = a), (n.lastUpdated = s), te.postRender(n.scheduleVelocityCheck)),
      ...
      if (l)
        for (var u = 0; u < l; u++) {
          ...
          Array.isArray(f) && (p = f[0]),
            p === null &&
              (p = (o = (r = n[c]) !== null && r !== void 0 ? r : t.readValue(c)) !== null && o !== void 0 ? o : e[c]),
            p != null &&
              (typeof p == "string" && (kv(p) || Rv(p)) ? (p = parseFloat(p)) : !Lv(p) && pe.test(f) && (p = Ml(c, f)),
              t.addValue(c, jn(p)),
    ...
    function rx(t, e, n) {
      ...
      for (var a in t)
        i[a] =
          (r = nx(a, e)) !== null && r !== void 0 ? r : (o = n.getValue(a)) === null || o === void 0 ? void 0 : o.get();
      return i;
    }
    var jv = v(() => {
    ...
    function Fv(t, e, n) {
      ...
      s && (f = s);
      var h = [],
        m = l && ((r = t.animationState) === null || r === void 0 ? void 0 : r.getState()[l]);
      for (var y in d) {
        var E = t.getValue(y),
          x = d[y];
        if (!(!E || x === void 0 || (m && sx(m, y)))) {
          var b = A({ delay: a }, f);
          t.shouldReduceMotion && Br(y) && (b = A(A({}, b), { type: !1, delay: 0 }));
          var w = Nl(y, E, x, b);
          h.push(w);
        }
      }
    ...
    function cx(t) {
      ...
      function l(c, f) {
          ...
          var p,
            ...
            b = function (M) {
              ...
              if (
                ...
                (z.protectedKeys = A({}, E)),
                (!z.isActive && rt === null) || (!X && !z.prevProp) || pl(X) || typeof X == "boolean")
              )
                return "continue";
              var Tt = px(z.prevProp, X),
                Ct = Tt || (N === f && z.isActive && !ht && et) || (M > x && et),
        ...
        var S = !!m.length;
        return o && d.initial === !1 && !t.manuallyAnimateOnMount && (S = !1), (o = !1), S ? e(m) : Promise.resolve();
      }
      function u(c, f, p) {
        var d;
        ...
        (d = t.variantChildren) === null ||
          ...
          d.forEach(function (y) {
            var E;
            return (E = y.animationState) === null || E === void 0 ? void 0 : E.setActive(c, f);
          }),
          (n[c].isActive = f);
        var h = l(p, c);
    ...
    function qe(t) {
      return t === void 0 && (t = !1), { isActive: t, protectedKeys: {}, needsAnimating: {}, prevResolvedValues: {} };
    }
    function fx() {
      var t;
      return (
    ...
    var Po,
      ...
      Bv = v(() => {
        G(),
          ...
          rn(),
          zn(),
          (Po = [st.Animate, st.InView, st.Focus, st.Hover, st.Tap, st.Drag, st.Exit]),
                ...
                function () {
                  ...
                  var u =
                    (s = n.animationState) === null || s === void 0
                      ? void 0
                      : s.setActive(st.Exit, !o, { custom: (l = a?.custom) !== null && l !== void 0 ? l : e });
                  !o && u?.then(i);
                },
                [o]
              );
    ...
    function ma(t, e) {
      var n = t.point;
      return { point: n, delta: Dp(n, Hv(e)), offset: Dp(n, hx(e)), velocity: mx(e, 0.1) };
    }
    function hx(t) {
      return t[0];
    }
    ...
    function mx(t, e) {
      ...
      for (var n = t.length - 1, r = null, o = Hv(t); n >= 0 && ((r = t[n]), !(o.timestamp - r.timestamp > Nr(e))); )
        n--;
      if (!r) return { x: 0, y: 0 };
          ...
          (zl = (function () {
                  ...
                  if (o.lastMoveEvent && o.lastMoveEventInfo) {
                    ...
                    if (!(!d && !h)) {
                      ...
                      var E = o.handlers,
                        x = E.onStart,
                        b = E.onMove;
                      d || (x && x(o.lastMoveEvent, p), (o.startEvent = o.lastMoveEvent)), b && b(o.lastMoveEvent, p);
                    }
                  }
                }),
            ...
            return (
              ...
              (t.prototype.end = function () {
                this.removeListeners && this.removeListeners(), tn.update(this.updatePoint);
              }),
              t
            );
          })());
    ...
    function Vp(t, e) {
      var n,
        r = e.min - t.min,
        o = e.max - t.max;
      return e.max - e.min < t.max - t.min && ((n = bt([o, r], 2)), (r = n[0]), (o = n[1])), { min: r, max: o };
    }
    function bx(t, e) {
    ...
    function wx(t, e) {
      var n = 0.5,
        r = we(t),
        o = we(e);
      return o > r ? (n = Ln(e.min, e.max - r, t.min)) : r > o && (n = Ln(t.min, t.max - o, e.min)), Rr(0, 1, n);
    }
    function Ex(t, e) {
      var n = {};
    ...
    function ke(t) {
      return _v(t) || Up(t.x) || Up(t.y) || t.z || t.rotate || t.rotateX || t.rotateY;
    }
    function Up(t) {
      return t && t !== "0%";
    }
    ...
    function Qv(t, e) {
      var n = e.x,
        r = e.y;
      vs(t.x, n.translate, n.scale, n.originPoint), vs(t.y, r.translate, r.scale, r.originPoint);
    }
    function Tx(t, e, n, r) {
      var o, i;
      r === void 0 && (r = !1);
      ...
      if (a) {
        ...
        for (var s, l, u = 0; u < a; u++)
          (s = n[u]),
            (l = s.projectionDelta),
            ((i = (o = s.instance) === null || o === void 0 ? void 0 : o.style) === null || i === void 0
              ? void 0
              : i.display) !== "contents" &&
              (r && s.options.layoutScroll && s.scroll && s !== s.root && En(t, { x: -s.scroll.x, y: -s.scroll.y }),
    ...
    var Jv,
      Zv,
      Ul = v(() => {
        G(), Ht(), Kv(), (Jv = ["x", "scaleX", "originX"]), (Zv = ["y", "scaleY", "originY"]);
      });
    function $v(t, e) {
            ...
            return (
                ...
                if (this.visualElement.isPresent !== !1) {
                  var s = function (f) {
                    ...
                    l = function (f, p) {
                      ...
                      (m &&
                        !y &&
                        (r.openGlobalLock && r.openGlobalLock(), (r.openGlobalLock = Nm(m)), !r.openGlobalLock)) ||
                        ((r.isDragging = !0),
                        ...
                        se(function (x) {
                          ...
                          if (Zt.test(O)) {
                            var S =
                              (w = (b = r.visualElement.projection) === null || b === void 0 ? void 0 : b.layout) ===
                                null || w === void 0
                                ? void 0
                                : w.actual[x];
                            if (S) {
                        ...
                        E?.(f, p),
                        (d = r.visualElement.animationState) === null || d === void 0 || d.setActive(st.Drag, !0));
                    },
                    u = function (f, p) {
                      var d = r.getProps(),
                        h = d.dragPropagation,
                      ...
                      if (!(!h && !r.openGlobalLock)) {
                        ...
                        if (m && r.currentDirection === null) {
                          (r.currentDirection = Ax(x)), r.currentDirection !== null && y?.(r.currentDirection);
                          return;
                        }
              ...
              (t.prototype.cancel = function () {
                ...
                !r && this.openGlobalLock && (this.openGlobalLock(), (this.openGlobalLock = null)),
                  (n = this.visualElement.animationState) === null || n === void 0 || n.setActive(st.Drag, !1);
              }),
              (t.prototype.updateAxis = function (e, n, r) {
                ...
                if (!(!r || !io(e, o, this.currentDirection))) {
                  ...
                  this.constraints && this.constraints[e] && (a = gx(a, this.constraints[e], this.elastic[e])),
                    i.set(a);
                }
              }),
              (t.prototype.resolveConstraints = function () {
                ...
                r && wn(r)
                  ...
                  a !== this.constraints &&
                    ...
                    se(function (s) {
                      e.getAxisMotionValue(s) && (e.constraints[s] = Ex(i.actual[s], e.constraints[s]));
                    });
              }),
              ...
              (t.prototype.getAxisMotionValue = function (e) {
                ...
                return (
                  ...
                  this.visualElement.getValue(
                    e,
                    (r = (n = this.visualElement.getProps().initial) === null || n === void 0 ? void 0 : n[e]) !==
                      null && r !== void 0
                      ? r
                      : 0
                  )
                  ...
                  a.addEventListener("didUpdate", function (u) {
                    ...
                    e.isDragging &&
                      ...
                      (se(function (p) {
                        ...
                        d && ((e.originPoint[p] += c[p].translate), d.set(d.get() + c[p].translate));
                      }),
          ...
          updatePropListeners: function (r) {
            gr.forEach(function (o) {
              var i,
                a = "on" + o,
                s = r[a];
              (i = e[o]) === null || i === void 0 || i.call(e), s && (e[o] = n[a](s));
            });
          },
        };
      return (
    ...
    function Fx(t, e, n) {
      ...
      for (var o in e) {
        ...
        if (ce(i)) t.addValue(o, i);
          ...
          } else t.addValue(o, jn((r = t.getStaticValue(o)) !== null && r !== void 0 ? r : i));
      }
              ...
              var Mt = ai(m),
                ...
                Z = A(
                  A(
                    {
                      ...
                      addVariantChild: function (I) {
                        ...
                        if (P)
                          return (
                            (B = P.variantChildren) === null || B === void 0 || B.add(I),
                            function () {
                      ...
                      sortNodePosition: function (I) {
                        return !c || n !== I.treeType ? 0 : c(Z.getInstance(), I.getInstance());
                      },
                      ...
                      addValue: function (I, B) {
                        Z.hasValue(I) && Z.removeValue(I), z.set(I, B), (O[I] = B.get()), St(I, B);
                      },
                      removeValue: function (I) {
                        var B;
                        z.delete(I), (B = X.get(I)) === null || B === void 0 || B(), X.delete(I), delete O[I], u(I, S);
                      },
                      hasValue: function (I) {
                        return z.has(I);
                      },
                      getValue: function (I, B) {
                        var P = z.get(I);
                        return P === void 0 && B !== void 0 && ((P = jn(B)), Z.addValue(I, P)), P;
                      },
                      ...
                      readValue: function (I) {
                        var B;
                        return (B = O[I]) !== null && B !== void 0 ? B : l(M, I, d);
                      },
                  ...
                  ),
                  {
                    ...
                    syncRender: Tt,
                    setProps: function (I) {
                      (I.transformTemplate || m.transformTemplate) && Z.scheduleRender(),
                        (m = I),
                    ...
                    getVariant: function (I) {
                      var B;
                      return (B = m.variants) === null || B === void 0 ? void 0 : B[I];
                    },
                    ...
                    getVariantContext: function (I) {
                      ...
                      if (!Mt) {
                        ...
                        return m.initial !== void 0 && (B.initial = m.initial), B;
                      }
    ...
    var Wl,
      og,
      ig = v(() => {
        G(), fe(), (Wl = /var\((--[a-zA-Z0-9-_]+),? ?([a-zA-Z0-9 ()%#.,-]+)?\)/), (og = 4);
      });
    function Ux(t) {
      var e = [];
      return (
    ...
    var Gp,
      ...
      Wx = v(() => {
        G(),
          ...
          je(),
          Iv(),
          (Gp = new Set(["width", "height", "top", "left", "right", "bottom", "x", "y"])),
          (wa = function (t) {
            return Gp.has(t);
          }),
          (ag = function (t) {
          ...
          (lg = function (t, e, n, r) {
            n === void 0 && (n = {}), r === void 0 && (r = {}), (e = A({}, e)), (r = A({}, r));
              ...
              (o.forEach(function (c) {
                ...
                if (t.hasValue(c)) {
                  ...
                  if (In(h)) {
                    ...
                    for (var x = E; x < y; x++)
                      m
                        ? qt(gn(h[x]) === m, "All keyframes must be of the same type")
                        : ((m = gn(h[x])),
                          qt(
                            m === d || (lr(d) && lr(m)),
                  ...
                  if (d !== m)
                    if (lr(d) && lr(m)) {
                      ...
                      typeof b == "string" && f.set(parseFloat(b)),
                        typeof h == "string"
                          ? (e[c] = parseFloat(h))
                          : Array.isArray(h) && m === U && (e[c] = h.map(parseFloat));
                    } else
                      d?.transform && m?.transform && (p === 0 || h === 0)
                        ? p === 0
                          ? f.set(m.transform(p))
                          : (e[c] = d.transform(h))
                        : (a || ((i = Ux(t)), (a = !0)), s.push(c), (r[c] = r[c] !== void 0 ? r[c] : e[c]), Ea(f, h));
                }
              }),
              s.length)
            ) {
    ...
    var bs,
      ...
      Xx = v(() => {
        pg(),
          ...
          qs(),
          (dg = function (t, e) {
            return Ys(t) ? fg(e, { enableHardwareAcceleration: !1 }) : cg(e, { enableHardwareAcceleration: !0 });
          });
      });
    function Qp(t, e) {
    ...
    function Qx(t) {
      ...
      return g.createElement(
        mg,
        A({}, t, { layoutGroup: o, switchLayoutGroup: mt(Ws), isPresent: n, safeToRemove: r })
      );
    }
    var mg,
      Jp,
            ...
            return (
              ...
              (e.prototype.getSnapshotBeforeUpdate = function (n) {
                ...
                return (
                  u &&
                    ((u.isPresent = l),
                    s || n.layoutDependency !== i || i === void 0 ? u.willUpdate() : this.safeToRemove(),
                    n.isPresent !== l &&
                      (l
                        ? u.promote()
                        : u.relegate() ||
              ...
              (e.prototype.componentWillUnmount = function () {
                var n = this.props,
                  ...
                  a = r.projection;
                a && (a.scheduleCheckAfterUnmount(), o?.group && o.group.remove(a), i?.deregister && i.deregister(a));
              }),
    ...
    function eO(t, e, n, r, o, i) {
      var a, s, l, u;
      o
        ? ((t.opacity = dt(0, (a = n.opacity) !== null && a !== void 0 ? a : 1, yg(r))),
          (t.opacityExit = dt((s = e.opacity) !== null && s !== void 0 ? s : 1, 0, bg(r))))
        : i &&
          (t.opacity = dt(
      ...
      for (var c = 0; c < gg; c++) {
        ...
        if (!(p === void 0 && d === void 0)) {
          ...
          h ? ((t[f] = Math.max(dt(Es(p), Es(d), r), 0)), (Zt.test(d) || Zt.test(p)) && (t[f] += "%")) : (t[f] = d);
        }
      }
    ...
    function ef(t, e, n, r, o) {
      return (t -= e), (t = Qo(t, 1 / n, r)), o !== void 0 && (t = Qo(t, 1 / o, r)), t;
    }
    function oO(t, e, n, r, o, i, a) {
      ...
      if (typeof e == "number") {
        ...
        t === i && (l -= e), (t.min = ef(t.min, e, n, l, o)), (t.max = ef(t.max, e, n, l, o));
      }
    }
    function nf(t, e, n, r, o) {
      var i = bt(n, 3),
    ...
    var wg,
      Eg,
      iO = v(() => {
        G(), Ht(), wt(), Ul(), (wg = ["x", "scaleX", "originX"]), (Eg = ["y", "scaleY", "originY"]);
      });
    function of(t) {
            ...
            return (
              ...
              (t.prototype.promote = function (e, n) {
                ...
                if (e !== o && ((this.prevLead = o), (this.lead = e), e.show(), o)) {
                  o.instance && o.scheduleRender(),
                    ...
                    !((r = e.root) === null || r === void 0) && r.isUpdating && (e.isLayoutDirty = !0);
              ...
              (t.prototype.exitAnimationComplete = function () {
                this.members.forEach(function (e) {
                  var n, r, o, i, a;
                  (r = (n = e.options).onExitComplete) === null || r === void 0 || r.call(n),
                    (a = (o = e.resumingFrom) === null || o === void 0 ? void 0 : (i = o.options).onExitComplete) ===
                      null ||
                      a === void 0 ||
                      a.call(i);
                });
    ...
    function af(t, e, n) {
      ...
      var u = t.x.scale * e.x,
        c = t.y.scale * e.y;
      return (i += "scale(".concat(u, ", ").concat(c, ")")), i === Pg ? "none" : i;
    }
    var Pg,
      lO = v(() => {
          ...
          (Cg = (function () {
            ...
            return (
              ...
              (t.prototype.forEach = function (e) {
                this.isDirty && this.children.sort(Tg), (this.isDirty = !1), this.children.forEach(e);
              }),
              t
            );
          })());
    ...
    function Ag(t) {
      ...
      return (function () {
        function a(s, l, u) {
          ...
          for (var f = 0; f < this.path.length; f++) this.path[f].shouldResetTransform = !0;
          this.root === this && (this.nodes = new Cg());
        }
        return (
          (a.prototype.addEventListener = function (s, l) {
            return this.eventHandlers.has(s) || this.eventHandlers.set(s, new An()), this.eventHandlers.get(s).add(l);
          }),
              ...
              if (
                ...
                e(s, function () {
                  (u.root.updateBlockedByResize = !0),
                    ...
                    On.hasAnimatedSinceResize && ((On.hasAnimatedSinceResize = !1), u.nodes.forEach(mO));
                });
              }
              p && this.root.registerSharedNode(p, this),
                this.options.animate !== !1 &&
                  ...
                  this.addEventListener("didUpdate", function (E) {
                    ...
                    var et =
                        (b = (x = u.options.transition) !== null && x !== void 0 ? x : h.getDefaultTransition()) !==
                          null && b !== void 0
                          ? b
                          : kg,
                      rt = h.getProps(),
                      ...
                      Ft = !N && z;
                    if (
                      (!((w = u.resumeFrom) === null || w === void 0) && w.instance) ||
                      Ft ||
                      (N && (Ct || !u.currentAnimation))
                    ) {
                      u.resumeFrom && ((u.resumingFrom = u.resumeFrom), (u.resumingFrom.resumingFrom = void 0)),
                        u.setAnimationOrigin(M, Ft);
                      var St = A(A({}, Dl(et, "layout")), { onPlay: ht, onComplete: Tt });
                      h.shouldReduceMotion && ((St.delay = 0), (St.type = !1)), u.startAnimation(St);
          ...
          (a.prototype.isTreeAnimationBlocked = function () {
            ...
            return (
              ...
              ((s = this.parent) === null || s === void 0 ? void 0 : s.isTreeAnimationBlocked()) ||
              !1
            );
          }),
          (a.prototype.startUpdate = function () {
            ...
            this.isUpdateBlocked() ||
              ((this.isUpdating = !0), (s = this.nodes) === null || s === void 0 || s.forEach(yO));
          }),
          (a.prototype.willUpdate = function (s) {
            ...
            if ((!this.root.isUpdating && this.root.startUpdate(), !this.isLayoutDirty)) {
              ...
              if (!(h === void 0 && !m)) {
                var y =
                  (c = this.options.visualElement) === null || c === void 0 ? void 0 : c.getProps().transformTemplate;
          ...
          (a.prototype.didUpdate = function () {
            ...
            this.isUpdating &&
              ((this.isUpdating = !1),
              this.potentialNodes.size && (this.potentialNodes.forEach(xO), this.potentialNodes.clear()),
          ...
          (a.prototype.updateSnapshot = function () {
            if (!(this.snapshot || !this.instance)) {
              ...
              pf(l), (this.snapshot = { measured: s, layout: l, latestValues: {} });
            }
          }),
          ...
          (a.prototype.updateScroll = function () {
            this.options.layoutScroll &&
              this.instance &&
              ((this.isScrollRoot = o(this.instance)), (this.scroll = r(this.instance)));
          }),
          (a.prototype.resetTransform = function () {
            ...
            if (i) {
              var l = this.isLayoutDirty || this.shouldResetTransform,
                ...
                c = (s = this.options.visualElement) === null || s === void 0 ? void 0 : s.getProps().transformTemplate,
          ...
          (a.prototype.applyTransform = function (s, l) {
            ...
            for (var c = 0; c < this.path.length; c++) {
              var f = this.path[c];
              !l && f.options.layoutScroll && f.scroll && f !== f.root && En(u, { x: -f.scroll.x, y: -f.scroll.y }),
          ...
          (a.prototype.removeTransform = function (s) {
            ...
            for (var c = 0; c < this.path.length; c++) {
              ...
              if (f.instance && ke(f.latestValues)) {
                ...
                var p = Pt(),
                  d = f.measure();
                Qt(p, d), rf(u, f.latestValues, (l = f.snapshot) === null || l === void 0 ? void 0 : l.layout, p);
              }
            }
            ...
            !this.layout ||
              ...
              (!this.targetDelta &&
                ...
                this.relativeParent &&
                  ...
                  Tr(this.relativeTargetOrigin, this.layout.actual, this.relativeParent.layout.actual),
              ...
              !(!this.relativeTarget && !this.targetDelta) &&
                ...
                s.target
                  ? vx(this.target, this.relativeTarget, this.relativeParent.target)
                  : this.targetDelta
                  ? (this.resumingFrom
                ...
                this.attemptToResolveRelativeTarget &&
                  ...
                  this.relativeParent &&
                    ...
                    ((this.relativeTarget = Pt()),
                    (this.relativeTargetOrigin = Pt()),
                    Tr(this.relativeTargetOrigin, this.target, this.relativeParent.target),
                    Qt(this.relativeTarget, this.relativeTargetOrigin)))));
          }),
          ...
          (a.prototype.calcProjection = function () {
            ...
            if (
              ((this.isTreeAnimating = !!(
                (!((s = this.parent) === null || s === void 0) && s.isTreeAnimating) ||
              ...
              Qt(this.layoutCorrected, this.layout.actual),
                Tx(this.layoutCorrected, this.treeScale, this.path, !!this.resumingFrom || this !== f);
              var p = f.target;
              if (p) {
                this.projectionDelta || ((this.projectionDelta = kn()), (this.projectionDeltaWithTransform = kn()));
                var d = this.treeScale.x,
                  h = this.treeScale.y,
                  m = this.projectionTransform;
                Pr(this.projectionDelta, this.layoutCorrected, p, this.latestValues),
                  (this.projectionTransform = af(this.projectionDelta, this.treeScale)),
                  (this.projectionTransform !== m || this.treeScale.x !== d || this.treeScale.y !== h) &&
          ...
          (a.prototype.scheduleRender = function (s) {
            var l, u, c;
            s === void 0 && (s = !0),
              (u = (l = this.options).scheduleRender) === null || u === void 0 || u.call(l),
              s && ((c = this.getStack()) === null || c === void 0 || c.scheduleRender()),
          ...
          (a.prototype.setAnimationOrigin = function (s, l) {
            ...
            var m = Pt(),
              y = f?.isShared,
              E = (((c = this.getStack()) === null || c === void 0 ? void 0 : c.members.length) || 0) <= 1,
              x = !!(y && !E && this.options.crossfade === !0 && !this.path.some(EO));
            (this.animationProgress = 0),
              (this.mixTargetDelta = function (b) {
                ...
                lf(h.x, s.x, O),
                  ...
                  y && ((u.animationValues = d), eO(d, p, u.latestValues, O, x, E)),
          ...
          (a.prototype.startAnimation = function (s) {
            ...
            this.notifyListeners("animationStart"),
              ...
              this.resumingFrom && ((c = this.resumingFrom.currentAnimation) === null || c === void 0 || c.stop()),
              this.pendingAnimation && (tn.update(this.pendingAnimation), (this.pendingAnimation = void 0)),
                ...
                (On.hasAnimatedSinceResize = !0),
                  (l.currentAnimation = $x(
                    ...
                    A(A({}, s), {
                      onUpdate: function (f) {
                        var p;
                        l.mixTargetDelta(f), (p = s.onUpdate) === null || p === void 0 || p.call(s, f);
                      },
                      onComplete: function () {
                        var f;
                        (f = s.onComplete) === null || f === void 0 || f.call(s), l.completeAnimation();
                      },
                    })
                  )),
                  l.resumingFrom && (l.resumingFrom.currentAnimation = l.currentAnimation),
          ...
          (a.prototype.finishAnimation = function () {
            var s;
            this.currentAnimation &&
              ((s = this.mixTargetDelta) === null || s === void 0 || s.call(this, Os), this.currentAnimation.stop()),
          ...
          (a.prototype.applyTransformsToTarget = function () {
            var s = this.getLead(),
              ...
              c = s.layout,
              f = s.latestValues;
            !l || !u || !c || (Qt(l, u), En(l, f), Pr(this.projectionDeltaWithTransform, this.layoutCorrected, l, f));
          }),
          ...
          (a.prototype.resetRotation = function () {
            ...
            if (s) {
              for (var l = !1, u = {}, c = 0; c < zo.length; c++) {
                var f = zo[c],
                  p = "rotate" + f;
                s.getStaticValue(p) && ((l = !0), (u[p] = s.getStaticValue(p)), s.setStaticValue(p, 0));
              }
              if (l) {
                s?.syncRender();
            ...
            if (!this.projectionDelta || !this.layout || !y.target) {
              ...
              return (
                this.options.layoutId &&
                  ((E.opacity = (u = this.latestValues.opacity) !== null && u !== void 0 ? u : 1),
                  (E.pointerEvents = go(s.pointerEvents) || "")),
                this.hasProjected &&
                  !ke(this.latestValues) &&
                  ((E.transform = m ? m({}, "") : "none"), (this.hasProjected = !1)),
                E
              );
            }
            var x = y.animationValues || y.latestValues;
            this.applyTransformsToTarget(),
              (h.transform = af(this.projectionDeltaWithTransform, this.treeScale, x)),
              m && (h.transform = m(x, h.transform));
            var b = this.projectionDelta,
              w = b.x,
              O = b.y;
            (h.transformOrigin = "".concat(w.origin * 100, "% ").concat(O.origin * 100, "% 0")),
              y.animationValues
                ? (h.opacity =
                    y === this
                      ? (f = (c = x.opacity) !== null && c !== void 0 ? c : this.latestValues.opacity) !== null &&
                        f !== void 0
                        ? f
                        : 1
            ...
            for (var S in Ar)
              if (x[S] !== void 0) {
                var M = Ar[S],
                  ...
                  z = M.applyTo,
                  X = N(x[S], y);
                if (z) for (var et = z.length, rt = 0; rt < et; rt++) h[z[rt]] = X;
                else h[S] = X;
              }
            return this.options.layoutId && (h.pointerEvents = y === this ? go(s.pointerEvents) || "" : "none"), h;
          }),
    ...
    function fO(t) {
      var e,
        ...
        o,
        i =
          (n = (e = t.resumeFrom) === null || e === void 0 ? void 0 : e.snapshot) !== null && n !== void 0
            ? n
            : t.snapshot;
      if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
        ...
        Pr(u, s, i.layout);
        var c = kn();
        i.isShared ? Pr(c, t.applyTransform(l, !0), i.measured) : Pr(c, s, i.layout);
        var f = !xg(u),
          p = !1;
        if (
          !t.resumeFrom &&
          ((t.relativeParent = t.getClosestProjectingParent()), t.relativeParent && !t.relativeParent.resumeFrom)
        ) {
        ...
        Rg(),
          ...
          (Dg = Ag({
            ...
            defaultParent: function () {
              if (!ao.current) {
                var t = new Mg(0, {});
                t.mount(window), t.setOptions({ layoutScroll: !0 }), (ao.current = t);
              }
              return ao.current;
            },
...
`);
      ...
      AO = v(() => {
        Yl(),
          CO(),
          (df = { default: { filter: "grayscale(1)", opacity: 0.5 }, active: { filter: "grayscale(0)", opacity: 1 } }),
            ...
            return g.createElement(
              ...
              e.map(({ toggle: i, snippet: a }, s) =>
                g.createElement(
                  Se,
                  { key: s },
                  i === void 0 && g.createElement(_n, { language: "typescript", customStyle: o }, a),
                  i && !n && g.createElement(_n, { language: "typescript", customStyle: o }, "  // ..."),
                  i &&
                    n &&
                    g.createElement(
                      Qe.div,
                      ...
                      g.createElement(
                        _n,
                        { language: "typescript", customStyle: o, codeTagProps: { style: { paddingLeft: "15px" } } },
                        a
                      )
                    )
                )
        ...
        TO(),
          ...
          (zg = ({ activeStep: t, data: e, width: n, filename: r }) => {
            let [o, i] = at([]),
              ...
              s = (c) => {
                let f = 0;
                for (let p = 0; p < c; p++) f -= a[p].current.getBoundingClientRect().height;
                return f;
              },
              l = xt(() => {
                let c = e.flatMap((f, p) => {
                  ...
                  return f.length > 1 && h.push({ yPos: s(p), backdropHeight: d, index: p, open: !0 }), h;
                });
                i(c);
              }, [e]);
            Wn(() => {
            ...
            return g.createElement(
              ...
              g.createElement(
                ...
                g.createElement(
                  Ng,
                  { animate: { y: o[t]?.yPos ?? 0 }, transition: { ease: "easeInOut", duration: 0.4 } },
                  g.createElement(Ig, null, g.createElement(_n, { language: "typescript", customStyle: u }, "// " + r)),
                  e.map((c, f) =>
                    g.createElement(Vg, {
                      key: f,
                      ref: a[f],
      ...
      Bg,
      RO = v(() => {
        Bg = Y.ul(() => ({ display: "flex", flexDirection: "column", rowGap: 16, padding: 0, margin: 0 }));
      }),
      Ug,
      MO = v(() => {
      ...
      Yg,
      DO = v(() => {
        (Hg = Y.li(() => ({ display: "flex", alignItems: "flex-start", columnGap: 12 }))),
          (Wg = Y.div`
  font-family: ${({ theme: t }) => t.typography.fonts.base};
  color: ${({ theme: t }) => t.color.darker};
  font-size: 13px;
          ...
          (To = ({ children: t, index: e, isCompleted: n }) =>
            g.createElement(
              ...
              g.createElement(
                ...
                n ? g.createElement(Xn, { width: 10, height: 10, icon: "check", color: "white" }) : e
              ),
    ...
    function IO() {
      ...
      return (
        W(() => {
          (async () => {
            try {
              let n = (await (await fetch("/index.json")).json()).entries["example-button--primary"].importPath;
              e({ data: n, error: null });
            } catch (n) {
              e({ data: null, error: n });
            }
    ...
    var LO = v(() => {}),
          ...
          return (
            W(() => {
              if (t) {
                ...
                return (
                  e.getData("example-button--warning") ? o({ data: !0, error: null }) : n.getServerChannel().on(Di, i),
                  () => {
            ...
            W(() => {
              if (e) {
                let i = new ResizeObserver(() => {
                  o && r({ top: o.offsetTop, left: o.offsetLeft, height: o.offsetHeight, width: o.offsetWidth });
                });
                return (
                  i.observe(o),
                  () => {
      ...
      UO = v(() => {
        Ds(),
          ...
          BO(),
          Qg(),
          (Jg = ({ onFinish: t, api: e, addonsStore: n, skipOnboarding: r, codeSnippets: o }) => {
            let [i, a] = at("imports"),
              s = Mi(),
              ...
              E = () => {
                ...
                navigator.clipboard.writeText(b.replace("// Copy the code below", "")), c(!0);
              },
              x = xt(() => {
                e.emit(xn, { step: "X:SkippedOnboarding", where: `HowToWriteAStoryModal:${i}`, type: "telemetry" });
              }, [e, i]);
            return g.createElement(
              ah,
              ...
              ({ Title: b, Description: w, Close: O }) =>
                g.createElement(
                  ...
                  null,
                  o
                    ? g.createElement(zg, { activeStep: l[i] || 0, data: o.code, width: 480, filename: o.filename })
                    : null,
                  i === "customStory" &&
                    m &&
                    !h?.data &&
                    ...
                    g.createElement(
                      ...
                      g.createElement(
                        ...
                        g.createElement(
                          sd,
                          null,
                          g.createElement(Xn, { icon: "bookmarkhollow", width: 13 }),
                        ...
                        i === "imports" &&
                          g.createElement(
                            ...
                            g.createElement(
                              ...
                              y
                                ? g.createElement("p", null, "Import a component. In this case, the Button component.")
                                : g.createElement(
                                    g.Fragment,
                                    null,
                                    g.createElement(
                        ...
                        i === "meta" &&
                          g.createElement(
                            ...
                            g.createElement(
                              cr,
                              null,
                              g.createElement(Bt, { variant: "secondary", onClick: () => a("imports") }, "Previous"),
                              g.createElement(Bt, { onClick: () => a("story") }, "Next")
                            )
                          ),
                        i === "story" &&
                          g.createElement(
                            ...
                            g.createElement(
                              cr,
                              null,
                              g.createElement(Bt, { variant: "secondary", onClick: () => a("meta") }, "Previous"),
                              g.createElement(Bt, { onClick: () => a("args") }, "Next")
                            )
                          ),
                        i === "args" &&
                          g.createElement(
                            ...
                            g.createElement(
                              cr,
                              null,
                              g.createElement(Bt, { variant: "secondary", onClick: () => a("story") }, "Previous"),
                              g.createElement(Bt, { onClick: () => a("customStory") }, "Next")
                            )
                          ),
                        i === "customStory" &&
                          (h?.error
                            ...
                            : g.createElement(
                                ...
                                g.createElement(
                                  "div",
                                  null,
                                  g.createElement("h3", null, "Create your first story"),
                                  g.createElement(
                                    "p",
                                    null,
                                ...
                                g.createElement(
                                  cr,
                                  null,
                                  g.createElement(Bt, { variant: "secondary", onClick: () => a("args") }, "Previous"),
                                  h?.data ? g.createElement(Bt, { onClick: () => t() }, "Go to story") : null
                                )
                              ))
                      )
                    ),
...
export const Warning = {
  ...
  export const Warning: Story = {
    ...
    function YO() {
      ...
      return (
        W(() => {
          (async () => {
            try {
              let n = (await (await fetch("/project.json")).json())?.language === "javascript" ? Zg : $g;
              e({ data: n, error: null });
            } catch (n) {
              e({ data: null, error: n });
            }
      ...
      return (
        ...
        W(() => {
          ...
          t.setQueryParams({ onboarding: "true" }),
            u !== "example-button--primary" && t.selectStory("example-button--primary", void 0, { ref: void 0 });
        }, []),
        e
          ? g.createElement(
              Ri,
              ...
              e &&
                ...
                g.createElement(yh, {
                  ...
                  skipOnboarding: () => {
                    l(), t.emit(xn, { step: "X:SkippedOnboarding", where: "WelcomeModal", type: "telemetry" });
                  },
                }),
              e &&
                ...
                g.createElement(sb, {
                  ...
                  onLastTourDone: () => {
                    t.selectStory("configure-your-project--docs"),
                      t.emit(xn, { step: "6:FinishedOnboarding", type: "telemetry" }),
                      l();
                  },
                }),
              e &&
                ...
                g.createElement(Jg, {
                  ...
                  addonsStore: Ni,
                  onFinish: () => {
                    t.selectStory("example-button--warning"), a("4:VisitNewStory");
                  },
                  skipOnboarding: l,
                })
            )
    ...
    Ni.register("@storybook/addon-onboarding", async (t) => {
      ...
      t.once(ru, () => {
        if (!(t.getData("example-button--primary") || document.getElementById("example-button--primary"))) {
          console.warn(
        ...
        t.togglePanel(!0), t.togglePanelPosition("bottom"), t.setSelectedPanel("addon-controls");

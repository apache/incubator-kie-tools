try {
  (() => {
    ...
    function L(e, t) {
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Set) {
          ...
          for (n of e) if (((a = n), (a && typeof a == "object" && ((a = ze(t, a)), !a)) || !t.has(a))) return !1;
          return !0;
        }
        if (r === Map) {
          if (e.size !== t.size) return !1;
          for (n of e)
            if (((a = n[0]), (a && typeof a == "object" && ((a = ze(t, a)), !a)) || !L(n[1], t.get(a)))) return !1;
          return !0;
        }
    ...
    var kt = Object.create,
      ...
      Yt = (e, t, r, n) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let a of Ze(t))
            !Vt.call(e, a) && a !== r && ge(e, a, { get: () => t[a], enumerable: !(n = Gt(t, a)) || n.enumerable });
        return e;
      },
      Jt = (e, t, r) => (
        (r = e != null ? kt(Wt(e)) : {}),
    ...
    var rr = (e) => Array.from({ length: e }, (t, r) => [Z].concat(Array.from({ length: r }, () => "*")).join(".")),
          ...
          i.forEach((l) => {
            let u = l.split("."),
              c = (p, d, f) => {
                ...
                else if (E === Ye) for (let { name: m, data: y } of t(p)) q(y, t) && c(y, `${d}.${m}`, f + 1);
                else {
                  let m = p[E];
                  q(m, t) && c(m, `${d}.${E}`, f + 1);
                }
      ...
      tt = G(({ name: e, data: t, dataIterator: r, nodeRenderer: n, expandPaths: a, expandLevel: i }) => {
        let s = A("TreeView"),
          l = W({}),
          [, u] = l;
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(et, { name: e, data: t, dataIterator: r, depth: 0, path: Z, nodeRenderer: n })
            )
          )
        );
      }),
    ...
    function pr(e) {
      if (typeof e == "object") {
        ...
        let r = t.reduce((n, a) => {
          let i = e[a];
          return (
            typeof i == "object" && i !== null && Object.keys(i).reduce((s, l) => (s.includes(l) || s.push(l), s), n), n
          );
        }, []);
    ...
    var fr = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      qe = ({ sortAscending: e = !1, sorted: t = !1, onClick: r = void 0, borderStyle: n = {}, children: a, ...i }) => {
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                "tr",
                null,
                o.createElement(qe, { borderStyle: c.none, sorted: r && n, sortAscending: i, onClick: l }, e),
                t.map((p) =>
                  o.createElement(
                    qe,
                    { borderStyle: c.solid, key: p, sorted: r && a === p, sortAscending: i, onClick: s.bind(null, p) },
                    p
                  )
                )
              )
        ...
        if (
          ...
          let m = (T, x) => (ot, it) => {
              ...
              if (Te === ve) P = _e(ye, Oe);
                ...
                let B = { string: 0, number: 1, object: 2, symbol: 3, boolean: 4, undefined: 5, function: 6 };
                P = _e(B[Te], B[ve]);
              }
              return x || (P = -P), P;
            },
        ...
        switch (t.nodeType) {
          case Node.ELEMENT_NODE:
            return o.createElement(
              "span",
              null,
              o.createElement(yr, { tagName: t.tagName, attributes: t.attributes, styles: n.htmlOpenTag }),
      ...
      Nr = ({ children: e, className: t }) => o.createElement(Pe, { horizontal: !0, vertical: !0, className: t }, e),

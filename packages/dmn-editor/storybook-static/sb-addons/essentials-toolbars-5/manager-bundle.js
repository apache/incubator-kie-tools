try {
  (() => {
    ...
    var G = ({ active: o, title: t, icon: e, description: r, onClick: a }) =>
      ...
      D = ({ currentValue: o, items: t }) => o != null && t.find((e) => e.value === o && e.type !== "reset"),
      ...
      j = ({ left: o, right: t, title: e, value: r, icon: a, hideIcon: d, onClick: S, currentValue: i }) => {
      ...
      J = (o, t) => ({
        ...
        toolbar: {
          ...
          items: t.toolbar.items.map((e) => {
            ...
            return (
              r.type === "reset" && t.toolbar.icon && ((r.icon = t.toolbar.icon), (r.hideIcon = !0)), { ...Z, ...r }
            );
          }),
        },
      }),
    ...
    g.register(b, () => g.add(b, { title: b, type: B.TOOL, match: () => !0, render: () => l.createElement(Q, null) }));
  })();
} catch (e) {

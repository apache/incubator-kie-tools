            ...
            function (_dereq_, module3, exports3) {
                ...
                return function (fn) {
                  var memoizerific = function () {
                    ...
                    for (i = 0; i < argsLengthMinusOne; i++) {
                      if (
                        ((lruPath[i] = { cacheItem: currentCache, arg: arguments[i] }), currentCache.has(arguments[i]))
                      ) {
              ...
              function removeCachedResult(removedLru) {
                ...
                for (
                  ...
                  i >= 0 &&
                  ((currentLru = removedLru[i]), (tmp = currentLru.cacheItem.get(currentLru.arg)), !tmp || !tmp.size);
                  i--
                )
      ...
      for (var i = 1, isOwn = !0; i < parts.length; i += 1) {
        ...
        if (
          ...
          if ($gOPD && i + 1 >= parts.length) {
            ...
            (isOwn = !!desc),
              isOwn && "get" in desc && !("originalValue" in desc.get) ? (value2 = desc.get) : (value2 = value2[part]);
    ...
    module.exports = function inspect_(obj, options2, depth, seen) {
      ...
      if (!isDate(obj) && !isRegExp(obj)) {
        var ys = arrObjKeys(obj, inspect),
          isPlainObject3 = gPO ? gPO(obj) === Object.prototype : obj instanceof Object || obj.constructor === Object,
        ...
        return (
          ...
          isArray2(target) && isArray2(source2)
            ...
            : Object.keys(source2).reduce(function (acc, key2) {
                ...
                return (
                  has2.call(acc, key2) ? (acc[key2] = merge2(acc[key2], value2, options2)) : (acc[key2] = value2), acc
                );
              }, mergeTarget)
        );
      },
    ...
    var utils = require_utils(),
      ...
      parseObject = function (chain, val, options2, valuesParsed) {
        for (var leaf = valuesParsed ? val : parseArrayValue(val, options2), i = chain.length - 1; i >= 0; --i) {
          ...
          if (root3 === "[]" && options2.parseArrays) obj = [].concat(leaf);
            ...
            var cleanRoot =
                root3.charAt(0) === "[" && root3.charAt(root3.length - 1) === "]" ? root3.slice(1, -1) : root3,
      ...
      parseKeys = function (givenKey, val, options2, valuesParsed) {
        if (givenKey) {
          ...
          return (
            segment && keys.push("[" + key2.slice(segment.index) + "]"), parseObject(keys, val, options2, valuesParsed)
          );
        }
      },
...
var require_SetCache = __commonJS({
  "../../node_modules/lodash/_SetCache.js"(exports, module) {
    ...
    function SetCache(values2) {
      ...
      for (this.__data__ = new MapCache2(); ++index < length; ) this.add(values2[index]);
    }
  ...
  "../../node_modules/lodash/_equalByTag.js"(exports, module) {
    ...
    function equalByTag(object, other, tag, bitmask, customizer, equalFunc, stack) {
      switch (tag) {
        ...
        case arrayBufferTag:
          return !(
            object.byteLength != other.byteLength || !equalFunc(new Uint8Array2(object), new Uint8Array2(other))
          );
        case boolTag:
        case dateTag:
        case numberTag:
    ...
    function overRest(func, start2, transform) {
      return (
        ...
        function () {
          ...
          index = -1;
          for (var otherArgs = Array(start2 + 1); ++index < start2; ) otherArgs[index] = args2[index];
  ...
  "../../node_modules/synchronous-promise/index.js"(exports, module) {
    ...
    SynchronousPromise4.prototype = {
      ...
      resume: function () {
        ...
        return (
          firstPaused && ((firstPaused._paused = !1), firstPaused._runResolutions(), firstPaused._runRejections()), this
        );
      },
      ...
      _findFirstAncestor: function (matching) {
        for (var test = this, result2; test; ) matching(test) && (result2 = test), (test = test._parent);
        return result2;
      },
    ...
    function createAggregateErrorFrom(errors) {
      return typeof window < "u" && "AggregateError" in window ? new window.AggregateError(errors) : { errors };
    }
    ...
    return function mutateUndefined(value2) {
      isObject3(value2) &&
        Object.entries(value2).forEach(([k, v2]) => {
          v2 === "_undefined_" ? (value2[k] = void 0) : mutated.get(v2) || (mutated.set(v2, !0), mutateUndefined(v2));
        }),
        Array.isArray(value2) &&
...
var __create3 = Object.create,
  ...
  __toESM3 = (mod, isNodeMode, target) => (
    ...
    __copyProps3(
      isNodeMode || !mod || !mod.__esModule ? __defProp3(target, "default", { value: mod, enumerable: !0 }) : target,
      mod
    )
  );
...
function dedent(templ) {
  for (var values2 = [], _i = 1; _i < arguments.length; _i++) values2[_i - 1] = arguments[_i];
    ...
    return matches2
      ? arr.concat(
          matches2.map(function (match) {
            var _a, _b;
            return (_b = (_a = match.match(/[\t ]/g)) === null || _a === void 0 ? void 0 : _a.length) !== null &&
              _b !== void 0
              ? _b
              : 0;
          })
...
var B = Object.create,
  ...
  P = (r, e, t) => (
    (t = r != null ? B(h(r)) : {}), E(e || !r || !r.__esModule ? R(t, "default", { value: r, enumerable: !0 }) : t, r)
  ),
  x = I((T) => {
...
var c = P(x()),
  ...
  v = (r, e, t) => {
    ...
    if (S([n, a]) !== 1) throw new Error(`Invalid conditional value ${JSON.stringify({ arg: n, global: a })}`);
    let i = n ? e[n] : t[a];
    return O(r.if, i);
  },
  L = (r) =>
...
var ArgsStore = class {
  ...
  GlobalsStore = class {
    ...
    set({ globals: globals2 = {}, globalTypes = {} }) {
      ...
      this.allowedGlobalNames = new Set([...Object.keys(globals2), ...Object.keys(globalTypes)]);
...
function normalizeStory(key2, storyAnnotations, meta) {
  ...
  let exportName = M(key2),
    name2 =
      (typeof storyObject != "function" && storyObject.name) || storyObject.storyName || story?.name || exportName,
    decorators = [...(storyObject.decorators || []), ...(story?.decorators || [])],
...
var checkGlobals = (parameters) => {
    ...
    (globals2 || globalTypes) &&
      logger.error("Global args/argTypes can only be set globally", JSON.stringify({ globals: globals2, globalTypes }));
  },
...
function prepareContext(context) {
  ...
  let mappedArgs = Object.entries(targetedContext.args).reduce((acc, [key2, val]) => {
    ...
    includedArgs = Object.entries(mappedArgs).reduce((acc, [key2, val]) => {
      ...
      return v(argType, mappedArgs, targetedContext.globals) && (acc[key2] = val), acc;
    }, {});
      ...
      `),
        ...
        : (visited.add(value2),
          Array.isArray(value2)
            ...
            : {
                name: "object",
                value: (0, import_mapValues.default)(value2, (field) => inferType(field, name2, new Set(visited))),
              })
      : { name: "object", value: {} };
  },
...
function composeStory(
  ...
  let normalizedComponentAnnotations = normalizeComponentAnnotations(componentAnnotations),
    storyName =
      exportsName || storyAnnotations.storyName || storyAnnotations.story?.name || storyAnnotations.name || "unknown",
    normalizedStory = normalizeStory(storyName, storyAnnotations, normalizedComponentAnnotations),
    normalizedProjectAnnotations = normalizeProjectAnnotations({ ...projectAnnotations, ...defaultConfig }),
  ...
  return Object.assign(
    ...
    { storyName, args: story.initialArgs, play: story.playFunction, parameters: story.parameters, id: story.id }
  );
}
    ...
    loadAllCSFFiles({ batchSize = EXTRACT_BATCH_SIZE } = {}) {
      ...
      let importPaths = Object.entries(this.storyIndex.entries).map(([storyId, { importPath }]) => [
        ...
        loadInBatches = (remainingImportPaths) => {
          if (remainingImportPaths.length === 0) return import_synchronous_promise.SynchronousPromise.resolve([]);
          ...
          return import_synchronous_promise.SynchronousPromise.all(csfFilePromiseList).then((firstResults) =>
            loadInBatches(remainingImportPaths.slice(batchSize)).then((restResults) => firstResults.concat(restResults))
          );
        };
        ...
        entries: Object.fromEntries(
          Object.entries(this.storyIndex.entries).map(([id, entry]) => [
            ...
            stories[id]
              ...
              : {
                  ...entry,
                  parameters: this.preparedMetaFromCSFFile({ csfFile: cachedCSFFiles[entry.importPath] }).parameters,
                },
          ])
        ),
      };
...
function useSharedState(sharedId, defaultState) {
  ...
  return (
    useEffect(() => {
      defaultState !== void 0 && !lastValue && emit(`${SHARED_STATE_SET}-client-${sharedId}`, defaultState);
    }, [sharedId]),
    [
      state,
      (s) => {
...
var stripExtension = (path) => {
  ...
  removeRedundantFilename = (paths) => {
    ...
    return paths.filter((val, index) =>
      index === paths.length - 1 && (val === prevVal || indexRe.test(val)) ? !1 : ((prevVal = val), !0)
    );
  };
...
var import_synchronous_promise2 = __toESM(require_synchronous_promise(), 1),
  ...
  StoryStoreFacade = class {
    ...
    getStoryIndex(store) {
      let fileNameOrder = Object.keys(this.csfExports),
        ...
        sortableV6 = Object.entries(this.entries).map(([storyId, { type, importPath, ...entry }]) => {
          ...
          return (
            ...
            [storyId, storyLike, csfFile.meta.parameters, this.projectAnnotations.parameters || {}]
          );
        }),
        sortedV7;
      try {
    ...
    addStoriesFromExports(fileName, fileExports) {
      ...
      if (storyExports.length && (componentTags.includes(STORIES_MDX_TAG) || autodocsOptedIn)) {
        ...
        this.entries[docsId] = {
          ...
          tags: [...componentTags, "docs", ...(autodocsOptedIn && !componentAutodocs ? [AUTODOCS_TAG] : [])],
          storiesImports: [],
        };
      }
  ...
  addArgTypesEnhancer = (enhancer) => {
    checkMethod("addArgTypesEnhancer"), scope.__STORYBOOK_CLIENT_API__?.addArgTypesEnhancer(enhancer);
  },
  ...
  setGlobalRender = (render) => {
    checkMethod("setGlobalRender"),
      scope.__STORYBOOK_CLIENT_API__ && (scope.__STORYBOOK_CLIENT_API__.facade.projectAnnotations.render = render);
  },
      ...
      (this.lastFileName = 0),
        ...
        (this.addParameters = ({ globals: globals2, globalTypes, ...parameters }) => {
          (this.facade.projectAnnotations.parameters = combineParameters(
            ...
            globals2 &&
              (this.facade.projectAnnotations.globals = { ...this.facade.projectAnnotations.globals, ...globals2 }),
            globalTypes &&
        ...
        (this.storiesOf = (kind, m2) => {
          ...
          if (
            (m2 || logger.warn(`Missing 'module' parameter for story with a kind of '${kind}'. It will break your HMR`),
            m2)
          ) {
          ...
          m2 &&
            ...
            m2.hot.dispose(() => {
              this.facade.clearFilenameExports(fileName),
                ...
                setTimeout(() => {
                  this._loadAddedExports(), this.onImportFnChanged?.({ importFn: this.importFn.bind(this) });
                }, 0);
            }));
          let hasAdded = !1,
            api = {
          ...
          return (
            (api.add = (storyName, storyFn, parameters = {}) => {
              ...
              let { decorators, loaders, component, args: args2, argTypes, ...storyParameters } = parameters,
              ...
              value: function (input) {
                ...
                return (
                  ...
                  tokenize(input.join(""), options2, function (token, data) {
                    ...
                    output && buf.push(output),
                      options2.stream && (_this.stickyStack = updateStickyStack(_this.stickyStack, token, data));
                  }),
...
var StoryRender = class {
  ...
  Preview = class {
    constructor(channel = addons.getChannel()) {
      (this.channel = channel),
        (this.storyRenders = []),
        scope.FEATURES?.storyStoreV7 && addons.hasServerChannel() && (this.serverChannel = addons.getServerChannel()),
    ...
    initializeWithStoryIndex(storyIndex) {
      ...
      return this.storyStore.initialize({ storyIndex, importFn: this.importFn, cache: !scope.FEATURES?.storyStoreV7 });
    }
    ...
    async onResetArgs({ storyId, argNames }) {
      let story =
          this.storyRenders.find((r) => r.id === storyId)?.story || (await this.storyStore.loadStory({ storyId })),
        updatedArgs = (
          argNames || [
            ...new Set([...Object.keys(story.initialArgs), ...Object.keys(this.storyStore.args.get(storyId))]),
          ]
    ...
    async extract(options2) {
      ...
      return (
        scope.FEATURES?.storyStoreV7 && (await this.storyStore.cacheAllCSFFiles()), this.storyStore.extract(options2)
      );
    }
...
var PreviewWithSelection = class extends Preview {
    ...
    async setInitialGlobals() {
      ...
      globals2 && this.storyStore.globals.updateFromPersisted(globals2), this.emitGlobals();
    }
    initializeWithStoryIndex(storyIndex) {
      return super
        .initializeWithStoryIndex(storyIndex)
        .then(
          () => (
            scope.FEATURES?.storyStoreV7 || this.channel.emit(SET_INDEX, this.storyStore.getSetIndexPayload()),
    ...
    async onStoriesChanged({ importFn, storyIndex }) {
      await super.onStoriesChanged({ importFn, storyIndex }),
        scope.FEATURES?.storyStoreV7 || this.channel.emit(SET_INDEX, await this.storyStore.getSetIndexPayload()),
    ...
    async renderSelection({ persistedArgs } = {}) {
      ...
      entry.type === "story"
        ...
        : isMdxEntry(entry)
        ? (render = new MdxDocsRender(this.channel, this.storyStore, entry, this.mainStoryCallbacks(storyId)))
        : (render = new CsfDocsRender(this.channel, this.storyStore, entry, this.mainStoryCallbacks(storyId)));
      ...
      try {
        ...
        err !== PREPARE_ABORTED &&
          (lastRender && (await this.teardownRender(lastRender)), this.renderStoryLoadingException(storyId, err));
        return;
      }
...
var getQueryString = ({ selection, extraParams }) => {
    let { search = "" } = document3.location,
      { path, selectedKind, selectedStory, ...rest } = import_qs3.default.parse(search, { ignoreQueryPrefix: !0 });
  ...
  getSelectionSpecifierFromPath = () => {
    let query = import_qs3.default.parse(document3.location.search, { ignoreQueryPrefix: !0 }),
      ...
      globals2 = typeof query.globals == "string" ? parseArgsParam(query.globals) : void 0,
    ...
    return storyId ? { storySpecifier: storyId, args: args2, globals: globals2, viewMode } : null;
  },
  UrlStore = class {
    constructor() {
...
function insertScriptsSequentially(scriptsToExecute, callback, index = 0) {
  scriptsToExecute[index](() => {
    index++,
      index === scriptsToExecute.length ? callback() : insertScriptsSequentially(scriptsToExecute, callback, index);
  });
}
      ...
      (scope.__STORYBOOK_STORY_STORE__ = preview.storyStore)),
    {
      ...
      configure(renderer, loadable, m2, disableBackwardCompatibility = !0) {
        ...
        initialized
          ...
          : (preview.initialize({ getStoryIndex: () => clientApi.getStoryIndex(), importFn, getProjectAnnotations }),
            (initialized = !0));
      },
    }
  );
...
__export(core_client_exports, { ClientApi: () => ClientApi, StoryStore: () => StoryStore, start: () => start });

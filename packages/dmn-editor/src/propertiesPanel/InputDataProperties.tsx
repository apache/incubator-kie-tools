...
import { DMN16__tInputData } from "@kie-tools/dmn-marshaller/dist/schemas/dmn-1_6/ts-gen/types";
...
export function InputDataProperties({
  ...
  inputData: Normalized<DMN16__tInputData>;
    ...
    <>
      ...
      <FormGroup label="Description">
        <TextArea
          ...
          onChange={(_event, newDescription) => {
            setState((state) => {
              (state.dmn.model.definitions.drgElement![index] as Normalized<DMN16__tInputData>).description = {
      ...
      <DocumentationLinksFormGroup
        ...
        onChange={(newExtensionElements) => {
          setState((state) => {
            (state.dmn.model.definitions.drgElement![index] as Normalized<DMN16__tInputData>).extensionElements = {

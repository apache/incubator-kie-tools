...
import { DMN16__tInputClause } from "@kie-tools/dmn-marshaller/dist/schemas/dmn-1_6/ts-gen/types";
...
export function DecisionTableInputHeaderCell(props: {
  ...
  const updater = useBoxedExpressionUpdater<Normalized<DMN16__tInputClause>>(selectedObjectInfos?.expressionPath ?? []);

  const cell = useMemo(() => selectedObjectInfos?.cell as Normalized<DMN16__tInputClause>, [selectedObjectInfos?.cell]);

...
import { DMN16__tDecision } from "@kie-tools/dmn-marshaller/dist/schemas/dmn-1_6/ts-gen/types";
    ...
    <>
      ...
      <TextField
        ...
        onChange={(newDescription) => {
          setState((state) => {
            (state.dmn.model.definitions.drgElement![index] as Normalized<DMN16__tDecision>).description = {
      ...
      <TextField
        ...
        onChange={(newQuestion) => {
          setState((state) => {
            (state.dmn.model.definitions.drgElement![index] as Normalized<DMN16__tDecision>).question = {
              __$$text: newQuestion,
            };
          });
        }}
      ...
      <TextField
        ...
        onChange={(newAllowedAnswers) => {
          setState((state) => {
            (state.dmn.model.definitions.drgElement![index] as Normalized<DMN16__tDecision>).allowedAnswers = {
      ...
      <DocumentationLinksFormGroup
        ...
        onChange={(newExtensionElements) => {
          setState((state) => {
            (state.dmn.model.definitions.drgElement![index] as Normalized<DMN16__tDecision>).extensionElements = {

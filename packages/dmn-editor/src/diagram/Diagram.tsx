...
export const Diagram = React.forwardRef<DiagramRef, { container: React.RefObject<HTMLElement> }>(
  ({ container }, ref) => {
    ...
    console.log("DIAGRAM EDGES", edges);

    return (
      <>
        {canAutoGenerateDrd && <DmnDiagramWithoutDrd />}
    ...
    >
      <div className={"kie-dmn-editor--diagram-empty-state"}>
        ...
        <EmptyState>
          ...
          <EmptyStateBody>{`The current DMN doens't have a DRD associated with the DRG.`}</EmptyStateBody>
          <EmptyStateBody>{`Do you want to auto generated it?`}</EmptyStateBody>
          <EmptyStatePrimary>
            <div style={{ display: "flex", flexDirection: "row", justifyContent: "center" }}>
              <Button
                ...
                onClick={async () => {
                  ...
                  const isAlternativeInputDataShape = dereferencedState
                    .computed(dereferencedState)
                    .isAlternativeInputDataShape();
                  const indexedDrd = dereferencedState.computed(dereferencedState).indexedDrd();
                  ...
                  dmnEditorStoreApi.setState((s) => {
                    ...
                    applyAutoLayout({
                      s: dereferencedState,
                      __old_dmnShapesByHref: indexedDrd.dmnShapesByHref,
                      __old_edges: edges,
              ...
              <Button
                ...
                onClick={() => {
                  dmnEditorStoreApi.setState((state) => {
                    state.diagram.autoLayout.canAutoGenerateDrd = false;
                  });
                }}
              >
                No

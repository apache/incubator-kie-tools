    ...
    >
      <div className={"kie-dmn-editor--diagram-empty-state"}>
        ...
        <EmptyState variant={EmptyStateVariant.small}>
          ...
          <EmptyStateBody>{`The current DMN does not have any Diagram associated with it.`}</EmptyStateBody>
          ...
          <Tooltip
            content={
              <span style={{ fontSize: "12px", wordBreak: "break-word" }}>
                <span>
                  Auto generating the diagram will automatically place the nodes with the default size and shape. You
                  can also manually build your diagram using the &quot;DRG Nodes&quot; options from the palette.
                </span>
              </span>
            }
          >

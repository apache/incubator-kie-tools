...
export const Diagram = React.forwardRef<DiagramRef, { container: React.RefObject<HTMLElement> }>(
  ({ container }, ref) => {
    ...
    return (
      <>
        {autoGenerateDrd && <DmnDiagramWithoutDrd />}
...
//             {`Empty DRD`}
//           </Title>
//           <EmptyStateBody>Auto generated it?</EmptyStateBody>
//           <EmptyStatePrimary>
//             <Button
...
//               onClick={() => {
//                 dmnEditorStoreApi.setState((state) => {
//                   state.diagram.autoLayout.autoGenerateDrd = false;
//                 });
//               }}
//             >
//               Yes
...
function DmnDiagramWithoutDrd() {
  ...
  return (
    ...
    >
      <Alert
        variant="info"
        title="DRD auto generated based on the DRG!"
        actionClose={
          <AlertActionCloseButton
            onClose={() => {
              dmnEditorStoreApi.setState((s) => {
                s.diagram.autoLayout.autoGenerateDrd = false;
              });
            }}
          />
        }
        actionLinks={
          <AlertActionLink
            onClick={() => {
              dmnEditorStoreApi.setState((s) => {
                s.dmn.model.definitions = dmnModelBeforeEditingRef.current.definitions;
                s.diagram.autoLayout.autoGenerateDrd = false;
              });
            }}
          >

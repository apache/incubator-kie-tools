...
import { AutolayoutParentNode, autoLayout } from "../autolayout/autoLayout";
...
export const Diagram = React.forwardRef<DiagramRef, { container: React.RefObject<HTMLElement> }>(
  ({ container }, ref) => {
    ...
    const onDrop = useCallback(
        ...
        if (e.dataTransfer.getData(MIME_TYPE_FOR_DMN_EDITOR_NEW_NODE_FROM_PALETTE)) {
          ...
          if (externalDrgElement.__$$element === "decisionService") {
            ...
            await addExistingDecisionServiceToDrd({
              ...
              drdIndex: dereferencedState.computed(dereferencedState).getDrdIndex(),
              dropPoint,
              externalDmnsIndex,
              thisDmnsDefinitions: dereferencedState.dmn.model.definitions,
              thisDmnsIndexedDrd: dereferencedState.computed(dereferencedState).indexedDrd(),
              thisDmnsNamespace: dereferencedState.dmn.model.definitions["@_namespace"],
              applyAutoLayout: async (toApplyChanges) => {
                ...
                toApplyChanges({
                  ...
                  indexedDrd: dereferencedState.computed(dereferencedState).indexedDrd(),
                  drdIndex,
                });
          ...
          if (drgElement.__$$element === "decisionService") {
            ...
            await addExistingDecisionServiceToDrd({
              ...
              decisionServiceNamespace: dereferencedState.dmn.model.definitions["@_namespace"],
              drdIndex: dereferencedState.computed(dereferencedState).getDrdIndex(),
              dropPoint,
              externalDmnsIndex: dereferencedState
                .computed(dereferencedState)
                .getExternalModelTypesByNamespace(externalModelsByNamespace).dmns,
              thisDmnsDefinitions: dereferencedState.dmn.model.definitions,
              thisDmnsIndexedDrd: dereferencedState.computed(dereferencedState).indexedDrd(),
      ...
      [container, reactFlowInstance, dmnEditorStoreApi, snapGrid, externalModelsByNamespace, applyAutoLayout]
    );

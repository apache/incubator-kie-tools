...
export function snapShapePosition(snapGrid: SnapGrid, shape: Normalized<DMN_LATEST__DMNShape>) {
...
export function snapShapeDimensions(grid: SnapGrid, shape: Normalized<DMN_LATEST__DMNShape>, minSizes: DC__Dimension) {

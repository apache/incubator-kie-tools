...
import { DMN_LATEST__tDefinitions, DMN_LATEST__DMNShape } from "@kie-tools/dmn-marshaller/src/index";
...
export function setDecisionServiceVisiblity({
  ...
  const shape = diagramElements?.[__readonly_shapeIndex] as Normalized<DMN_LATEST__DMNShape> | undefined;

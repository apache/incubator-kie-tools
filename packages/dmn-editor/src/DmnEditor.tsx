...
export const DmnEditorInternal = ({
  ...
  //   if (
  //     dmn.model.definitions["dmndi:DMNDI"]?.["dmndi:DMNDiagram"] === undefined &&
  //     dmn.model.definitions.drgElement !== undefined
  //   ) {
  //     dmnEditorStoreApi.setState((s) => {
  //       autoGenerateDrd(s.dmn.model, externalModelsByNamespace, s.diagram);
  //     });
  //   }
  //   // should run when the model was changed;

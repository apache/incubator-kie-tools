...
import { autolayout, FAKE_MARKER, visitNodeAndNested } from "../autolayout/autolayout";
...
export async function autoGenerateDrd(
    ...
    "dmndi:DMNDiagram": [
      {
        ...
        "dmndi:DMNDiagramElement": [...DMNDiagramElement],
  ...
  const { nodesById, edgesById, nodes, edges, drgEdges } = computeDiagramData(
    diagram,
    model.definitions,

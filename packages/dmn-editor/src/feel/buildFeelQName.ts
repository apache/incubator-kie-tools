...
import { DMN16__tImport, DMN16__tNamedElement } from "@kie-tools/dmn-marshaller/dist/schemas/dmn-1_6/ts-gen/types";
...
export function buildFeelQNameFromNamespace({
  ...
  // namespace is determined by the `@_name` attribute of a DMN16__tImport, not by its namespace declaration

...
export interface State {
  ...
  diagram: {
    autoLayout: {
      autoGenerateDrd: boolean;
      rollbackAutoGeneratedDrd: boolean;
      previousModel: State["dmn"]["model"] | undefined;
    };
...
export const defaultStaticState = (): Omit<State, "dmn" | "dispatch" | "computed"> => ({
  ...
  diagram: {
    autoLayout: {
      autoGenerateDrd: false,
      rollbackAutoGeneratedDrd: false,
...
export function createDmnEditorStore(
  ...
  return create(
    immer<State>(() => ({
      dmn: {
        model: normalize(model, diagram, externalModelsByNamespace),
      },
      ...defaultState,
      diagram: {
        ...diagram,
        // A model without DRD and whith DRG element should be auto generated
        autoLayout: {
          autoGenerateDrd:

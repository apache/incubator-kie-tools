...
| management-console.image                | object | `{"account":"apache","name":"incubator-kie-kogito-management-console","pullPolicy":"IfNotPresent","registry":"docker.io","tag":"10.1.x"}`                                                                                                               | Image source configuration for the Management Console image                                                                                      |

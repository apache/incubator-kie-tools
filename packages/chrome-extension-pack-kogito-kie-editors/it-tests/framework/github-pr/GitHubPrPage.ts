...
export default class GitHubPrPage extends EditorPage {
  private static readonly SEE_AS_DIAGRAM_BUTTON_LOCATOR = By.xpath(
    "//button[text()='See as diagram']"
  );
  private static readonly CLOSE_DIAGRAM_BUTTON_LOCATOR = By.xpath(
    "//button[text()='Close diagram']"
  );
  private static readonly ORIGINAL_BUTTON_LOCATOR = By.xpath(
    "//button[text()='Original']"
  );
  private static readonly CHANGES_BUTTON_LOCATOR = By.xpath(
    "//button[text()='Changes']"
  );
  ...
  public async waitUntilLoaded(): Promise<void> {
    return await this.tools
      .by(GitHubPrPage.SEE_AS_DIAGRAM_BUTTON_LOCATOR)
      .wait(1000)
      .untilPresent();
  }
  ...
  public async scrollToPrHeader(): Promise<void> {
    ...
    const panel: Element = await this.tools
      .by(GitHubPrPage.PR_HEADER_LOCATOR)
      .getElement();
  ...
  public async isSourceOpened(): Promise<boolean> {
    return await this.tools
      .by(GitHubPrPage.RAW_CONTENT_LOCATOR)
      .wait(5000)
      .isVisible();
  }
  ...
  public async seeAsDiagram(): Promise<void> {
    const seeAsDiagramButton: Element = await this.tools
      .by(GitHubPrPage.SEE_AS_DIAGRAM_BUTTON_LOCATOR)
      .getElement();
  ...
  public async closeDiagram(): Promise<void> {
    const closeDiagramButton: Element = await this.tools
      .by(GitHubPrPage.CLOSE_DIAGRAM_BUTTON_LOCATOR)
      .getElement();
    return await closeDiagramButton.click();
  }

  public async original(): Promise<void> {
    const originalButton: Element = await this.tools
      .by(GitHubPrPage.ORIGINAL_BUTTON_LOCATOR)
      .getElement();
    await originalButton.click();
    return await this.tools
      .by(GitHubPrPage.CHANGES_BUTTON_LOCATOR)
      .wait(1000)
      .untilEnabled();
  }

  public async changes(): Promise<void> {
    const changesButton: Element = await this.tools
      .by(GitHubPrPage.CHANGES_BUTTON_LOCATOR)
      .getElement();

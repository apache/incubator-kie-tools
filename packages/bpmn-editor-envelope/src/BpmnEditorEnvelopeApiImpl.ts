...
import { BpmnMultiplyingArchitectureEditorFactory } from "./BpmnMultiplyingArchitectureEditorFactory";
  ...
  implements KogitoEditorEnvelopeApi
{
  constructor(readonly bpmnArgs: BpmnEnvelopeApiFactoryArgs) {
    super(bpmnArgs, new BpmnMultiplyingArchitectureEditorFactory());
  }
}

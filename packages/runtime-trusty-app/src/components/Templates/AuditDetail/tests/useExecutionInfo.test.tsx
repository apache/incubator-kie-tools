...
describe("useExecutionInfo", () => {
  test("retrieves general information about an execution", async () => {
    ...
    apiMock.mockImplementation(() => Promise.resolve(execution) as AxiosPromise);
    ...
    expect(result.current).toStrictEqual(Object.assign({ status: RemoteDataStatus.SUCCESS }, execution));

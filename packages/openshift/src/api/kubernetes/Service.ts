...
import { SERVICE_TEMPLATE } from "../../template/ResourceTemplates";
...
export class CreateService extends ResourceFetch {
  ...
  public body(): string {
    return JSON.stringify(this.args.descriptor ?? SERVICE_TEMPLATE({ ...this.args }));
  }

  public endpoint(): string {
    return `/${baseEndpoint(KubernetesApiVersions.SERVICE)}/namespaces/${this.args.namespace}/services`;
  }
}

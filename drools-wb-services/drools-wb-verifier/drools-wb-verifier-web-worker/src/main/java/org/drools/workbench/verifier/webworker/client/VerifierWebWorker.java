...
public class VerifierWebWorker
    ...
    private native void setUpListener()/*-{
        ...
        $wnd.receiveFromMainApp = $entry(function (gg) {
            that.@org.drools.workbench.verifier.webworker.client.VerifierWebWorker::received(Ljava/lang/String;)(gg)
        });
        ...
        myConsole.error = function (message) {
            that.@org.drools.workbench.verifier.webworker.client.VerifierWebWorker::log(Ljava/lang/String;)(message)
        }

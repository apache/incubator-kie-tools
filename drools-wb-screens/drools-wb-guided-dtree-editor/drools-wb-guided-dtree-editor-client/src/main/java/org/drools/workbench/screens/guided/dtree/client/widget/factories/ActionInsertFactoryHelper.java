...
public class ActionInsertFactoryHelper implements FactoryHelper<ActionInsertNode> {
    ...
    public ActionInsertFactoryHelper( final ActionInsertNode context,
    ...
    @Override
    public ActionInsertNode getContext() {
        return this.context;
    }

    @Override
    public void setContext( final ActionInsertNode context ) {
        this.context = context;
    }

...
public class FactModelEditor
    ...
    private void setIconImage() {
        if ( expanded ) {
            icon.setResource( CollapseExpand.INSTANCE.collapse() );
            icon.setAltText( CollapseExpandConstants.INSTANCE.Collapse() );
        } else {
            icon.setResource( CollapseExpand.INSTANCE.expand() );
            icon.setAltText( CollapseExpandConstants.INSTANCE.Expand() );
        }
    }

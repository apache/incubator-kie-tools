...
public class SelectPriorCellOnRowTest extends BaseKeyboardOperationTest<SelectPriorCellOnRow> {

    @Override
    protected SelectPriorCellOnRow getHandler(final GridLayer layer) {
        return new SelectPriorCellOnRow(layer);
    }

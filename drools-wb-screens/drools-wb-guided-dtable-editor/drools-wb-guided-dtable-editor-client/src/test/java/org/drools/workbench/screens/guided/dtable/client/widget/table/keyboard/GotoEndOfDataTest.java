...
public class GotoEndOfDataTest extends BaseKeyboardOperationTest<GotoEndOfData> {

    @Override
    protected GotoEndOfData getHandler(final GridLayer layer) {
        return new GotoEndOfData(layer);
    }

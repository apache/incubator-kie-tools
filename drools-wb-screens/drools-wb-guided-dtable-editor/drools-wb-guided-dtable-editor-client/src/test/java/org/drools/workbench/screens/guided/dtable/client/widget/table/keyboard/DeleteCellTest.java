...
public class DeleteCellTest extends BaseKeyboardOperationTest<DeleteCell> {

    @Override
    protected DeleteCell getHandler(final GridLayer layer) {
        return new DeleteCell(layer);
    }
    ...
    public void checkPerformanceWithSelectedCell() {
        ...
        verify(dtPresenter,
               times(1)).onDeleteSelectedCells();
    }

    @Test
    public void checkIsNotExecutableWithoutSelectedCell() {

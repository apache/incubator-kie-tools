...
public class CellUtilitiesConvertToDoubleTest {
    ...
    public static Collection testParameters() {
        return Arrays.asList( new Object[][]{
                { new Double( "1" ), new BigDecimal( "1" ), false },
                { new Double( "2" ), new BigInteger( "2" ), false },
                { new Double( "3" ), new Byte( "3" ), false },
                { new Double( "4.0" ), new Double( "4.0" ), false },
                { new Double( "5.0" ), new Float( "5.0" ), false },
                { new Double( "6" ), new Integer( "6" ), false },
                { new Double( "7" ), new Long( "7" ), false },
                { new Double( "8" ), new Short( "8" ), false },
                { new Double( "9" ), "9", false },
                { null, true, false },
                { null, new Date(), false },
                { null, "banana", false },
                { null, null, true }

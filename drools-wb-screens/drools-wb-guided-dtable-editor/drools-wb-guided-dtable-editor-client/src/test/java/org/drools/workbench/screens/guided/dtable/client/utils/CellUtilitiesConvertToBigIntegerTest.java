...
public class CellUtilitiesConvertToBigIntegerTest {
    ...
    public static Collection testParameters() {
        return Arrays.asList( new Object[][]{
                ...
                { new BigInteger( "3" ), new Byte( "3" ) },
                { null, new Double( "4.0" ) },
                { null, new Float( "5.0" ) },
                { new BigInteger( "6" ), new Integer( "6" ) },
                { new BigInteger( "7" ), new Long( "7" ) },
                { new BigInteger( "8" ), new Short( "8" ) },
                { new BigInteger( "9" ), "9" },
                { null, true },
                { null, new Date() },
                { null, "banana" }
    ...
    public void conversion() {
        assertEquals( expected,
                      cellUtilities.convertToBigInteger( new DTCellValue52( value ) ) );
    }

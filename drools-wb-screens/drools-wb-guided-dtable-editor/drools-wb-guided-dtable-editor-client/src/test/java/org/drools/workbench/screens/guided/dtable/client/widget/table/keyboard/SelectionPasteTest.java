...
public class SelectionPasteTest extends BaseKeyboardOperationTest<SelectionPaste> {

    @Override
    protected SelectionPaste getHandler(final GridLayer layer) {
        return new SelectionPaste(layer);
    }

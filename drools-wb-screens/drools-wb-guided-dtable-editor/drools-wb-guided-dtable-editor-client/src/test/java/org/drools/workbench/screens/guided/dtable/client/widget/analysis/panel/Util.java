...
public class Util {
    ...
    public static RuleInspector getMockRuleInspector( final int rowNumber ) {
        final RuleInspector ruleInspector = mock( RuleInspector.class );
        when( ruleInspector.getRowIndex() ).thenReturn( rowNumber );

...
@Dependent
public class LimitedEntryActionSetFieldCol52DefinitionBuilder extends BaseActionColumnDefinitionBuilder {

    @Inject
    public LimitedEntryActionSetFieldCol52DefinitionBuilder( final Caller<GuidedDecisionTableEditorService> service ) {
        super( service );
    }

    @Override
    public Class getSupportedColumnType() {
        return LimitedEntryActionSetFieldCol52.class;
    }

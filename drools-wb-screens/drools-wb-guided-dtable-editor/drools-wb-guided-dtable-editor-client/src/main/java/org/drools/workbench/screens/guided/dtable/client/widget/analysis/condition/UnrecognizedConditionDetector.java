...
public class UnrecognizedConditionDetector extends ConditionDetector<UnrecognizedConditionDetector> {
    ...
    public UnrecognizedConditionDetector( Pattern52 pattern,
                                          String factField,
                                          String operator ) {
    ...
    public UnrecognizedConditionDetector( UnrecognizedConditionDetector a,
                                          UnrecognizedConditionDetector b ) {
        super( a, b );
    }

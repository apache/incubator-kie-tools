...
@Dependent
public class LimitedEntryActionInsertFactCol52DefinitionBuilder extends BaseActionColumnDefinitionBuilder {

    @Inject
    public LimitedEntryActionInsertFactCol52DefinitionBuilder( final Caller<GuidedDecisionTableEditorService> service ) {
        super( service );
    }

    @Override
    public Class getSupportedColumnType() {
        return LimitedEntryActionInsertFactCol52.class;
    }

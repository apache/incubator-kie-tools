...
@Dependent
public class LimitedEntryConditionCol52DefinitionBuilder extends BaseConditionColumnDefinitionBuilder {

    @Inject
    public LimitedEntryConditionCol52DefinitionBuilder( final Caller<GuidedDecisionTableEditorService> service ) {
        super( service );
    }

    @Override
    public Class getSupportedColumnType() {
        return LimitedEntryConditionCol52.class;
    }
    ...
    public void generateDefinition( final GuidedDecisionTableView.Presenter dtPresenter,
        ...
        generateConditionColumn( dtPresenter,
                                 column,

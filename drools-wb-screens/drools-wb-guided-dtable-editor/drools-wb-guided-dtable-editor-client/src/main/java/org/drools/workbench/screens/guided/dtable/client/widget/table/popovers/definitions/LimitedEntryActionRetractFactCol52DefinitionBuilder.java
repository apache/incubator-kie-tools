...
@Dependent
public class LimitedEntryActionRetractFactCol52DefinitionBuilder extends BaseActionColumnDefinitionBuilder {

    @Inject
    public LimitedEntryActionRetractFactCol52DefinitionBuilder( final Caller<GuidedDecisionTableEditorService> service ) {
        super( service );
    }

    @Override
    public Class getSupportedColumnType() {
        return LimitedEntryActionRetractFactCol52.class;
    }
    ...
    public void generateDefinition( final GuidedDecisionTableView.Presenter dtPresenter,
        ...
        if ( !( column instanceof LimitedEntryActionRetractFactCol52 ) ) {
            return;
        }

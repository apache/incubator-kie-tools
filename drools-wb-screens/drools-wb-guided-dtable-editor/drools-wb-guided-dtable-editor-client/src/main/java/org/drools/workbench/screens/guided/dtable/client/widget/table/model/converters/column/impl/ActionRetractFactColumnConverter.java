...
public class ActionRetractFactColumnConverter extends BaseColumnConverterImpl {
    ...
    private GridColumn<?> convertColumn( final ActionRetractFactCol52 column,
                                         final GuidedDecisionTablePresenter.Access access,
                                         final GuidedDecisionTableView gridWidget ) {
    ...
    protected GridColumn<String> newActionRetractFactColumn( final List<GridColumn.HeaderMetaData> headerMetaData,
                                                             final double width,

...
public class RightPanelMenuItemProducerTest {
    ...
    @Before
    public void setup() {
        rightPanelMenuItemProducer = spy(new RightPanelMenuItemProducer() {
            {
                this.rightPanelMenuItem = rightPanelMenuItemMock;
            }
        });
    }
    ...
    public void getRightPanelMenuItem() {
        final RightPanelMenuItem retrieved = rightPanelMenuItemProducer.getRightPanelMenuItem();
        assertEquals(rightPanelMenuItemMock, retrieved);
    }
}
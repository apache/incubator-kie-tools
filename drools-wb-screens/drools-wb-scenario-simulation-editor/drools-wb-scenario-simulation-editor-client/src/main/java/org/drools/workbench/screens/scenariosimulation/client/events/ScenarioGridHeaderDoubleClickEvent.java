...
public class ScenarioGridHeaderDoubleClickEvent extends GwtEvent<ScenarioGridHeaderDoubleClickHandler> {
    ...
    public static Type<ScenarioGridHeaderDoubleClickHandler> TYPE = new Type<>();
    ...
    @Override
    public Type<ScenarioGridHeaderDoubleClickHandler> getAssociatedType() {
        return TYPE;
    }

    @Override
    protected void dispatch(ScenarioGridHeaderDoubleClickHandler handler) {

...
import static org.drools.workbench.screens.scenariosimulation.model.FactMappingValueOperator.EQUALS;
...
public class OperatorEvaluatorTest {
    ...
    public void equalsTest() {
        OperatorEvaluator operatorService = new OperatorEvaluator();
        ...
        assertTrue(operatorService.evaluate(EQUALS, test1, test1));
        assertFalse(operatorService.evaluate(EQUALS, test1, test2));
        // Tested via Comparable.compareTo
        assertTrue(operatorService.evaluate(EQUALS, comparableTest1, comparableTest1));
    }

...
public class PackageDataModelOracleCompletionsTest {
    ...
    public void testFactFieldOperatorCompletions() {
        ...
        String[] personThisOperators = oracle.getOperatorCompletions( "Person",
                                                                      "this" );
        assertEquals( 4,
        ...
        String[] personAgeOperators = oracle.getOperatorCompletions( "Person",
                                                                     "age" );
        assertEquals( 10,
        ...
        String[] personRankOperators = oracle.getOperatorCompletions( "Person",
                                                                      "rank" );
        assertEquals( 8,
        ...
        String[] personNameOperators = oracle.getOperatorCompletions( "Person",
                                                                      "name" );
        assertEquals( 12,
    ...
    public void testFactFieldConnectiveOperatorCompletions() {
        ...
        String[] personThisConnectiveOperators = oracle.getConnectiveOperatorCompletions( "Person",
                                                                                          "this" );
        assertEquals( 3,
        ...
        String[] personAgeConnectiveOperators = oracle.getConnectiveOperatorCompletions( "Person",
                                                                                         "age" );
        assertEquals( 11,
        ...
        String[] personRankConnectiveOperators = oracle.getConnectiveOperatorCompletions( "Person",
                                                                                          "rank" );
        assertEquals( 11,
        ...
        String[] personNameConnectiveOperators = oracle.getConnectiveOperatorCompletions( "Person",
                                                                                          "name" );
        assertEquals( 13,

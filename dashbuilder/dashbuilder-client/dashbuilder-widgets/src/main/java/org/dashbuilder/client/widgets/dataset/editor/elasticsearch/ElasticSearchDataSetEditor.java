 ...
 */
@Dependent
public class ElasticSearchDataSetEditor extends DataSetEditor<ElasticSearchDataSetDef> implements IsWidget, org.dashbuilder.dataset.client.editor.ElasticSearchDataSetDefEditor {
    ...
    public ValueBoxEditor<String> clusterName() {
        return attributesEditor.clusterName();
    }

    @Override
    public ValueBoxEditor<String> index() {
        return attributesEditor.index();
    }

    @Override
    public ValueBoxEditor<String> type() {
        return attributesEditor.type();
    }

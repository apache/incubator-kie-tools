...
public abstract class CategorisableItem extends VersionableItem {
    ...
    public CategorisableItem(Path assetPath) {
        super(assetPath);
        //JLIU
        //The information of what category this asset belongs to can be stored in asset dot file. But where to story what categories we have?

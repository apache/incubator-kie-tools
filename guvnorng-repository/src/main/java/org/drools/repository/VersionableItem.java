...
public abstract class VersionableItem extends Item {
     ...
     */
    public VersionableItem(Path assetPath) {
        super(assetPath);
...
*/
    ...
    //JLIU: All Dublin Core properties can use asset metadata file (dot file)

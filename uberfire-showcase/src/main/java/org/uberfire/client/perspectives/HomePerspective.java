...
public class HomePerspective {
    ...
    public PerspectiveDefinition getPerspective() {
        ...
        west.addPart( new PartDefinitionImpl( new PlaceRequestImpl( "perspectives" ) ) );
        definition.getRoot().setChild( Position.WEST,
                                       west );

        final PanelDefinition east1 = new PanelDefinitionImpl();
        east1.addPart( new PartDefinitionImpl( new PlaceRequestImpl( "notifications" ) ) );
        definition.getRoot().setChild( Position.EAST,
                                       east1 );

        final PanelDefinition east2 = new PanelDefinitionImpl();
        east2.addPart( new PartDefinitionImpl( new PlaceRequestImpl( "rssFeed" ) ) );
        east1.setChild( Position.EAST,
                        east2 );

        definition.getRoot().addPart( new PartDefinitionImpl( new PlaceRequestImpl( "welcome" ) ) );

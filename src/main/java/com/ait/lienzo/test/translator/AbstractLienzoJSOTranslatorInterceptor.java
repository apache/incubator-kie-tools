...
public abstract class AbstractLienzoJSOTranslatorInterceptor implements LienzoMockitoClassTranslator.TranslatorInterceptor {
    ...
    protected abstract void setMakeMethodBody( String fqcn, 
                                               CtClass ctClass, 
    ...
    protected void doTheJob( ClassPool classPool, 
                             String name ) throws NotFoundException, CannotCompileException {
    ...
    protected boolean isMakeMethod( CtMethod method, 
                                    String className ) throws NotFoundException {
        
        return isMethod( method, className, METHOD_MAKE );
        
    }

    protected boolean isCreateMethod( CtMethod method, 
                                      String className ) throws NotFoundException {
    ...
    protected boolean isMethod( CtMethod method, 
                                String className, 

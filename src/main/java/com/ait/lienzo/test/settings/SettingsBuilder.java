...
public final class SettingsBuilder {
    ...
    public static com.ait.lienzo.test.settings.Settings build( Settings settingsAnnotation,
                                                               Stubs stubsAnnotation,
                                                               JSOStubs jsoStubsAnnotation,
                                                               JSOMocks jsoMocksAnnotation,
                                                               Mocks mocksAnnotation,
                                                               Translators translatorAnnotation ) throws Exception {
        ...
        Class<? extends LienzoMockitoClassTranslator.TranslatorInterceptor>[] interceptorClasses = 
                settingsAnnotation.translators();
        
        List<LienzoMockitoClassTranslator.TranslatorInterceptor> interceptors = 
                new LinkedList<LienzoMockitoClassTranslator.TranslatorInterceptor>();
        ...
        if ( null != translatorAnnotation ) {
            ...
            for ( Class<? extends LienzoMockitoClassTranslator.TranslatorInterceptor> interceptorClass : 
                    translatorAnnotation.value() ) {
        ...
        com.ait.lienzo.test.settings.Settings result =
                new com.ait.lienzo.test.settings.Settings( interceptors );
    ...
    private static void addMocks( String[] mocks,
                                  com.ait.lienzo.test.settings.Settings settings ) {
    ...
    private static void addJSOStubs( String[] jsoStubs, 
                                     com.ait.lienzo.test.settings.Settings settings ) {
    ...
    private static void addJSOMocks( String[] jsoMocks, 
                                     com.ait.lienzo.test.settings.Settings settings ) {
    ...
    private static void addStubs( Class<?>[] stubs, 
                                  com.ait.lienzo.test.settings.Settings settings ) {
        ...
        if ( null != stubs && stubs.length > 0 ) {
            ...
            for ( Class<?> stubTargetClass : stubs ) {
                ...
                if ( !stubTargetClass.isAnnotationPresent( StubClass.class ) ) {
                    ...
                    throw new RuntimeException( "The stub class [" + stubTargetClass.getName() 
                            + "] does not have the StubClass annotation." );

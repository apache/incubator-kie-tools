        ...
        else
        {
            switch (tailDirection)
            {
                ...
                case NONE:
                    ...
                    getOrthogonalLinePointsAndDirection(buffer, lastDirection, null, x, y, p1x, p1y, x + 1, y + 1, write);// last arguments are arbitrary, as not used, but must not be the same.
                default:
                    break;
            }
        }

...
public class ShapesExample extends BaseExample implements Example {
    ...
    public void run() {
    	...
    	rectangleButton.onclick = (e) -> {return addSubExample(rectangleExample);};
    	roundedCornersRectangleButton.onclick = (e) -> {return addSubExample(roundedCornersExample);};
    	linesButton.onclick = (e) -> {return addSubExample(linesExample);};
    	dashedLinesButton.onclick = (e) -> {return addSubExample(dashedLinesExample);};
    	lineCapsButton.onclick = (e) -> {return addSubExample(linesCapExample);};
    	lineJoinsButton.onclick = (e) -> {return addSubExample(lineJoinsExample);};
    	arcsButton.onclick = (e) -> {return addSubExample(arcsExample);};
    	arrowsButton.onclick = (e) -> {return addSubExample(arrowsExample);};
    	arrowAttributesButton.onclick = (e) -> {return addSubExample(arrowAttributesExample);};
    	circleButton.onclick = (e) -> {return addSubExample(circleExample);};
    	ellipseButton.onclick = (e) -> {return addSubExample(ellipseExample);};
    	quadraticCurveButton.onclick = (e) -> {return addSubExample(quadraticCurveExample);};
    	cubicCurveButton.onclick = (e) -> {return addSubExample(cubicCurveExample);};
    	polygonsButton.onclick = (e) -> {return addSubExample(polygonsExample);};

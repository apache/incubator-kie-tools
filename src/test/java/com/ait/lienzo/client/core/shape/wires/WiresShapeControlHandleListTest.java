...
public class WiresShapeControlHandleListTest {
    ...
    @Mock WiresShape shape;
    @Mock HandlerRegistrationManager handlerRegistrationManager;
    @Mock ControlHandleList controlHandleList;
    @Mock IControlHandle handle0;
    IPrimitive<?> primitive0;
    @Mock IControlHandle handle1;
    IPrimitive<?> primitive1;
    @Mock IControlHandle handle2;
    IPrimitive<?> primitive2;
    @Mock IControlHandle handle3;
    ...
    public void setup() {
        ...
        tested = new WiresShapeControlHandleList( shape, IControlHandle.ControlHandleStandardType.RESIZE,
                controlHandleList, handlerRegistrationManager );
    ...
    public void testCP_DragHandlers() {
        ...
        tested = new WiresShapeControlHandleList( realShape, IControlHandle.ControlHandleStandardType.RESIZE,
                controlHandleList, handlerRegistrationManager );
        ...
        realShape
                .setResizable( true )
                .addWiresResizeStartHandler( new WiresResizeStartHandler() {
                    @Override
    ...
    private void setCPLocations( double x0, double y0,
                                 double x1, double y1,
                                 double x2, double y2,
                                 double x3, double y3 ){

...
public class Modal extends DivWidget implements HasVisibility,
    ...
    private void reconfigure( boolean keyboard,
    ...
    private void configure( boolean keyboard,
                            BackdropType backdropType,
                            boolean show ) {
    ...
    private native void reconfigure( Element e,
                                     boolean k,
                                     boolean b,
                                     boolean s ) /*-{
        var modal = null;
    ...
    private native void changeVisibility( Element e,
                                          String visibility ) /*-{
    ...
    private native void setHandlerFunctions( Element e ) /*-{
        ...
        $wnd.jQuery(e).on('hide', function (e) {
            that.@org.uberfire.client.views.bs2.modal.Modal::onHide(Lcom/google/gwt/user/client/Event;)(e);
        });
        $wnd.jQuery(e).on('hidden', function (e) {
            that.@org.uberfire.client.views.bs2.modal.Modal::onHidden(Lcom/google/gwt/user/client/Event;)(e);
        });
        $wnd.jQuery(e).on('show', function (e) {
            that.@org.uberfire.client.views.bs2.modal.Modal::onShow(Lcom/google/gwt/user/client/Event;)(e);
        });
        $wnd.jQuery(e).on('shown', function (e) {
            that.@org.uberfire.client.views.bs2.modal.Modal::onShown(Lcom/google/gwt/user/client/Event;)(e);
        });
    }-*/;
     ...
     * @param height the Modal's body height, in px
     */
    public void setBodyHeigth( int height ) {
        DOM.setStyleAttribute( body.getElement(), "height", height + "px" );
    }

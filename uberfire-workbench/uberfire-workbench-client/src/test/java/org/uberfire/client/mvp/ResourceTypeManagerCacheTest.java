...
public class ResourceTypeManagerCacheTest {
    ...
    public void testGetResourceTypeDefinitions() {
        ...
        {
            List<ResourceTypeDefinition> definitions = resourceTypeManagerCache.getResourceTypeDefinitionsByCategory(process);
            assertTrue(definitions.isEmpty());
        }

        {
            List<ResourceTypeDefinition> definitions = resourceTypeManagerCache.getResourceTypeDefinitionsByCategory(model);
            assertEquals(clientResourceType,
                         definitions.get(0));
        }
    }
}
...
public class DecoratedWorkbenchPanelPresenter implements WorkbenchPanelPresenter {
    ...
    @Inject
    public DecoratedWorkbenchPanelPresenter( @DecoratedWorkbenchPanel final WorkbenchPanelView view,

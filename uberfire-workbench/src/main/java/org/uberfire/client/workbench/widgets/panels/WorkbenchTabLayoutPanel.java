...
public class WorkbenchTabLayoutPanel extends ResizeComposite
    ...
    private class Tab extends SimplePanel {
        ...
        public boolean remove(Widget w) {
            ...
            if ( replacingWidget || index < 0 ) {
                ...
                return WorkbenchTabLayoutPanel.this.remove( index );
            }
        }
    ...
    public WorkbenchTabLayoutPanel(double barHeight,
        ...
        //Add focus bar
        panel.add( focusBar );
        panel.setWidgetLeftRight( focusBar,
                                  0,
                                  Unit.PX,
                                  0,
                                  Unit.PX );
        ...
        panel.add( deckPanel );
        panel.setWidgetLeftRight( deckPanel,
                                  0,
                                  Unit.PX,
                                  0,
                                  Unit.PX );
    ...
    /**
     * Sets a tab's HTML contents. Use care when setting an object's HTML; it is
    ...
    private void insert(final Widget child,
        ...
        deckPanel.insertProtected( child,
                                   beforeIndex );
        tabs.add( beforeIndex,
                  tab );

...
public class WorkbenchContextProcessor extends AbstractProcessor {

    private static final Logger logger = LoggerFactory.getLogger( WorkbenchContextProcessor.class );

    private final ContextActivityGenerator activityGenerator = new ContextActivityGenerator();
    ...
    public boolean process( Set<? extends TypeElement> annotations,
        ...
        for ( Element e : roundEnv.getElementsAnnotatedWith( WorkbenchContext.class ) ) {

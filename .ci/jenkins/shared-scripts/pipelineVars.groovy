...
class PipelineVars implements Serializable {
    ...
    String dockerHubApacheKiePushCredentialsId = 'quay-io-kie-tools-token'
    String dockerHubApacheKiePushCredentialsId = 'quay_kiegroup_registry_token'
    String dockerHubApacheKiePushCredentialsId = 'dockerhub_apache_kie_registry_token'

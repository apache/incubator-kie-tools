...
public abstract class AbstractRuntimeDMOModelReaderServiceTest extends AbstractDMOModelReaderServiceTest<ClassLoader, RuntimeDMOModelReaderService> {
    ...
    @Override
    protected ClassLoader getSource() {
    ...
    public void testExtractAllModels() {
        Assertions.assertThatThrownBy(() -> resolveModelReader().readAllFormModels())
                .isInstanceOf(RuntimeException.class)
                .hasMessage("Unsupported operation: RuntimeDMOModelReader doesn't support listing all models");
    }

    @Test
    public void testExtractModuleModels() {
        Assertions.assertThatThrownBy(() -> resolveModelReader().readModuleFormModels())
                .isInstanceOf(RuntimeException.class)
                .hasMessage("Unsupported operation: RuntimeDMOModelReader doesn't support listing models");
    }

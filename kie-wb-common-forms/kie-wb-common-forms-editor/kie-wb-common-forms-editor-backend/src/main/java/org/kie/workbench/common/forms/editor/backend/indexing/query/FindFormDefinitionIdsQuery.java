...
package org.kie.workbench.common.forms.editor.backend.indexing.query;
...
@ApplicationScoped
public class FindFormDefinitionIdsQuery extends FindResourcesQuery implements NamedQuery {

    public static final String NAME = FindFormDefinitionIdsQuery.class.getSimpleName();

    @Inject
    private FindFormDefinitionIdsResponseBuilder responseBuilder;
        ...
        this.checkInvalidAndRequiredTerms(queryTerms,
                                          ...
                                          new Predicate[]{t -> {
                                              if (!(t instanceof ValueResourceIndexTerm)) {
                                                  ...
                                                  return ((ValueResourceIndexTerm) t).getTerm().equals(ResourceType.FORM.toString());
                                              }
                                          }});
    ...
    public static class FindFormDefinitionIdsResponseBuilder implements ResponseBuilder {

        private IOService ioService;

        public FindFormDefinitionIdsResponseBuilder() {
        }

        public FindFormDefinitionIdsResponseBuilder(IOService ioService) {
        ...
        public String findFormId(Iterable<KProperty<?>> properties) {
            for (KProperty property : properties) {
                if (property.getName().equals(ResourceType.FORM.toString())) {

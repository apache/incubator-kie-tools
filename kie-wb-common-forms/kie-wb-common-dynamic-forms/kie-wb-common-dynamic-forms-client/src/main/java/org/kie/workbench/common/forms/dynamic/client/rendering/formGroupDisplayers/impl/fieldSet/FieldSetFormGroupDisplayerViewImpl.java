...
package org.kie.workbench.common.forms.dynamic.client.rendering.formGroupDisplayers.impl.fieldSet;
...
@Templated
public class FieldSetFormGroupDisplayerViewImpl extends Composite implements FieldSetFormGroupDisplayerView {

    @DataField
    protected LegendElement legend = Document.get().createLegendElement();

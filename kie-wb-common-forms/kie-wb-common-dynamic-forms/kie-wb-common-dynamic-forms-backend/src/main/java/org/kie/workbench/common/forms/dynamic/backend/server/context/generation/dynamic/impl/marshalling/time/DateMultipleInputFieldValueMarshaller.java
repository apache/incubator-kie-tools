...
@Dependent
public class DateMultipleInputFieldValueMarshaller extends AbstractDateMultipleFieldValueMarshaller<DateMultipleInputFieldDefinition> {

    @Override
    public Class<DateMultipleInputFieldDefinition> getSupportedField() {
        return DateMultipleInputFieldDefinition.class;
    }

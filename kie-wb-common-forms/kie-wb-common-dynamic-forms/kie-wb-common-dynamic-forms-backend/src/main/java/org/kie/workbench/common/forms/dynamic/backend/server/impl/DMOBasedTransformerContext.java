...
public class DMOBasedTransformerContext implements TransformerContext<DynamicRenderingContext> {
    ...
    private DynamicRenderingContext renderingContext;

    private ProjectDataModelOracle oracle;

    private Map<String, FactBuilder> factBuilders;

    private DMOBasedTransformerContext( Object model, ProjectDataModelOracle oracle, Map<String, FactBuilder> factBuilders, DynamicRenderingContext context ) {
        this.model = model;
    ...
    private DMOBasedTransformerContext( Object model, String type, ProjectDataModelOracle oracle, Map<String, FactBuilder> factBuilders, DynamicRenderingContext context ) {
        this.model = model;
        this.type = type;
        this.oracle = oracle;
        this.factBuilders = factBuilders;
    ...
    @Override
    public DynamicRenderingContext getRenderingContext() {
    ...
    public static DMOBasedTransformerContext getTransformerContextFor( Object model ) throws IOException {
        ...
        return new DMOBasedTransformerContext( model, oracle, builders, new DynamicRenderingContext() );
    }
}

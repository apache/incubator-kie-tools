...
import static org.kie.workbench.common.forms.processing.engine.handling.FormValidator.*;
...
public class DefaultModelValidator<MODEL> implements ModelValidator<MODEL> {
    ...
    protected boolean checkBinding( FormField formField, String fieldName ) {

...
public class FormHandlerMock extends FormHandlerImpl {

    protected DataBinder dataBinder;

    public FormHandlerMock( FormValidator validator,
                            FieldStyleHandler fieldStyleHandler,
                            FieldChangeHandlerManager fieldChangeManager, DataBinder binder ) {
        super( validator, fieldStyleHandler, fieldChangeManager );

...
package org.kie.workbench.common.forms.common.client.widgets.picture;
...
import org.kie.workbench.common.forms.common.client.widgets.picture.widget.PictureWidget;
...
public class PictureInput extends SimplePanel implements HasValue<String> {
    ...
    public void init( int width, int height ) {
        widget.init( width, height, new PictureWidget.TakePictureCallback() {
            @Override

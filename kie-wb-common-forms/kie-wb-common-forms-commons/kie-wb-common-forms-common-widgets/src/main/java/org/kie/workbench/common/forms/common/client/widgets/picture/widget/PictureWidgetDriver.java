...
package org.kie.workbench.common.forms.common.client.widgets.picture.widget;
...
public class PictureWidgetDriver extends JavaScriptObject {
    ...
    public final native void startStreaming( double width, double height ) /*-{
        ...
        if ( this.streaming ) {
            @org.kie.workbench.common.forms.common.client.widgets.picture.widget.PictureWidgetDriver::stopStreaming(*)(this);
        }

...
public class PreferenceScopeResolutionStrategyMockTest {
    ...
    @Before
    public void setup() {
        preferenceScopeResolutionStrategyMock = new PreferenceScopeResolutionStrategyMock();
    }

    @Test
    public void getInfo() {
        assertNull(preferenceScopeResolutionStrategyMock.getInfo());
    }

    @Test
    public void getScopeResolver() {
        assertNull(preferenceScopeResolutionStrategyMock.getScopeResolver());
    }
}
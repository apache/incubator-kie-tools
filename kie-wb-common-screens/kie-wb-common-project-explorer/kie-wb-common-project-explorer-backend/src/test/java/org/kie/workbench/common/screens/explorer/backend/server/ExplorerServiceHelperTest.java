...
public class ExplorerServiceHelperTest {
    ...
    public void testDeleteOperationHasRestrictions() {
        ...
        thenOperationIsRestricted(FolderItemOperation.DELETE,
                                  restrictedOperations);
        thenThereAreNOperationsRestricted(1,
                                          restrictedOperations);
    }
    ...
    public void testRenameOperationHasRestrictions() {
        ...
        thenOperationIsRestricted(FolderItemOperation.RENAME,
                                  restrictedOperations);
        thenThereAreNOperationsRestricted(1,
                                          restrictedOperations);
    }
    ...
    public void testCopyOperationHasRestrictions() {
        ...
        thenOperationIsRestricted(FolderItemOperation.COPY,
                                  restrictedOperations);
        thenThereAreNOperationsRestricted(1,
                                          restrictedOperations);
    }
    ...
    public void testDeleteRenameCopyOperationHasRestrictions() {
        ...
        thenOperationIsRestricted(FolderItemOperation.COPY,
                                  restrictedOperations);
        thenThereAreNOperationsRestricted(3,
                                          restrictedOperations);
    }
    ...
    private void givenThatOperationHasRestrictions(FolderItemOperation operation) {
        mockOperationRestrictions(operation,
                                  true);
    }
    ...
    private void mockOperationRestrictions(FolderItemOperation operation,
    ...
    private void thenOperationIsRestricted(FolderItemOperation operation,
                                           List<FolderItemOperation> restrictedOperations) {
        assertTrue(restrictedOperations.contains(operation));
    }

    private void thenThereAreNOperationsRestricted(int n,
                                                   List<FolderItemOperation> restrictedOperations) {
        assertEquals(n,
                     restrictedOperations.size());
    }

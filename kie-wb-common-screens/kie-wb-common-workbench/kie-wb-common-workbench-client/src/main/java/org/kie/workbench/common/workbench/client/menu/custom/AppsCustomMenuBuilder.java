...
public class AppsCustomMenuBuilder implements MenuFactory.CustomMenuBuilder {
    ...
    @Inject
    public AppsCustomMenuBuilder(final IconMenuItemPresenter menuItem,
                                 final PlaceManager placeManager) {
        this.menuItem = menuItem;

        menuItem.setup("fa fa-th",
                       DefaultWorkbenchConstants.INSTANCE.Apps(),
                       () -> placeManager.goTo(PerspectiveIds.APPS));
    }

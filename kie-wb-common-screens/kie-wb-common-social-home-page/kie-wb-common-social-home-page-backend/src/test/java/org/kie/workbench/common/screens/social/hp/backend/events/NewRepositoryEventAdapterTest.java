...
public class NewRepositoryEventAdapterTest {
    ...
    @InjectMocks
    private NewRepositoryEventAdapter newRepositoryEventAdapter;
    ...
    public void getDefinedCreatedMessage() {
        ...
        final String message = newRepositoryEventAdapter.getCreatedMessage();

        assertEquals( "message-created", message );
    }
}

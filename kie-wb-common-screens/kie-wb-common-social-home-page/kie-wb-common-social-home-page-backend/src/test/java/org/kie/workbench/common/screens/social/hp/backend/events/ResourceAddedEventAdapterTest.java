...
public class ResourceAddedEventAdapterTest {
    ...
    @InjectMocks
    private ResourceAddedEventAdapter resourceAddedEventAdapter;
    ...
    public void getDefinedCreatedMessage() {
        ...
        final String message = resourceAddedEventAdapter.getAddedMessage();

        assertEquals( "message-added", message );
    }
}

...
public class ServerTemplateOCPStorage implements KieServerTemplateStorage {
    ...
    public ServerTemplate load(String identifier) {
        return instance.load(identifier);
    }

    @Override
    public boolean exists(String identifier) {
        return instance.exists(identifier);
    }

    @Override
    public ServerTemplate update(ServerTemplate serverTemplate) {
        return instance.update(serverTemplate);
    }

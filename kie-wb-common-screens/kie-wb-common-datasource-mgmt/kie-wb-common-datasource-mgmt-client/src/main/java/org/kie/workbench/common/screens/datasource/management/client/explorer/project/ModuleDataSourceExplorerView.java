...
public interface ModuleDataSourceExplorerView
        extends UberView<ModuleDataSourceExplorerView.Presenter> {
    ...
    void addModuleSelectorHandler(final ModuleSelectorHandler handler);

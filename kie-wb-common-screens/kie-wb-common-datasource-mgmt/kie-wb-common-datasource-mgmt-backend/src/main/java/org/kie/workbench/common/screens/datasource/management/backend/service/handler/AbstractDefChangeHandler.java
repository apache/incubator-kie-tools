...
public abstract class AbstractDefChangeHandler implements DefChangeHandler {
    ...
    protected void updateDeployment( Path path, Def registeredDef,
                                     Def def,
    ...
    protected void fireEvent( Def def, Def originalDef,
                              Path path,
                              SessionInfo sessionInfo,
                              ResourceChangeType changeType ) {
    ...
    private Def readDef( Path path ) {
        ...
        try {
            ...
            logger.error( "It was not possible to deserialize content from file: " + path, e );
        }
        return def;
    }

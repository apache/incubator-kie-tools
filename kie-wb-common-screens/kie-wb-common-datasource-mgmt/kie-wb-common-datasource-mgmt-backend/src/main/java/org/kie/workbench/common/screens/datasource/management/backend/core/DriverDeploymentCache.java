...
public interface DriverDeploymentCache {
    ...
    DriverDeploymentCacheEntry put( DriverDeploymentInfo deploymentInfo, DriverDef driverDef );

    void remove( DriverDeploymentInfo deploymentInfo );

    DriverDeploymentCacheEntry get( DriverDeploymentInfo deploymentInfo );

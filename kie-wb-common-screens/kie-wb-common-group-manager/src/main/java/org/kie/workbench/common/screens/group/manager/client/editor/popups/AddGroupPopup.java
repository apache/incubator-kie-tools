...
public class AddGroupPopup extends Modal {
    ...
    interface AddGroupPopupBinder
            extends
            UiBinder<Widget, AddGroupPopup> {

    }

    private static AddGroupPopupBinder uiBinder = GWT.create( AddGroupPopupBinder.class );
    ...
    private void onOKButtonClick() {
        ...
        if ( nameTextBox.getText() == null || nameTextBox.getText().trim().isEmpty() ) {
            ...
            nameHelpInline.setText( GroupManagerConstants.INSTANCE.GroupNameIsMandatory() );
            hasError = true;
        } else {
            nameGroup.setType( ControlGroupType.NONE );
        }

...
/**
 * i18n constants for Group Manager
 */
public interface GroupManagerConstants
        extends
        Messages {

    GroupManagerConstants INSTANCE = GWT.create( GroupManagerConstants.class );
    ...
    String ConfirmGroupDeletion0( String groupName );

...
public class DataObjectFieldEditor extends Composite {
    ...
    private ObjectProperty objectField;
    ...
    public void setObjectField( ObjectProperty objectField ) {
    ...
    private void notifyFieldChange( String memberName,
                                    Object oldValue,
                                    Object newValue ) {
        DataObjectFieldChangeEvent changeEvent = new DataObjectFieldChangeEvent( getContext().getContextId(), DataModelerEvent.DATA_OBJECT_FIELD_EDITOR, getDataModel(), getDataObject(), getObjectField(), memberName, oldValue, newValue );
    ...
    private void loadDataObjectField( DataObject dataObject,

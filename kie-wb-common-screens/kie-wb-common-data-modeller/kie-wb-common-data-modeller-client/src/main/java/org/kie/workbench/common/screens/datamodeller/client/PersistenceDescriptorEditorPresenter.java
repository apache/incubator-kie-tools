...
public class PersistenceDescriptorEditorPresenter
    ...
    public boolean onMayClose() {
        if (isDirty(getUpdatedContent().hashCode())) {
    ...
    @Override
    protected Caller<? extends SupportsSaveAndRename<PersistenceDescriptorEditorContent, Metadata>> getSaveAndRenameServiceCaller() {
    ...
    public PersistenceDescriptorEditorContent getUpdatedContent() {
        updateContent();
        return getContent();
    }
        ...
        savePopUpPresenter.show(versionRecordManager.getCurrentPath(),
                                new ParameterizedCommand<String>() {
                                    ...
                                    public void execute(final String commitMessage) {
                                        editorService.call(getSaveSuccessCallback(getUpdatedContent().hashCode())).save(versionRecordManager.getCurrentPath(),
                                                                                                                        getUpdatedContent(),
                                                                                                                        metadata,
                                                                                                                        commitMessage);
                                    }
    ...
    public void onSourceTabSelected() {
        PersistenceDescriptorModel persistenceDescriptor = getUpdatedContent().getDescriptorModel();
    ...
    public void onPersistenceUnitNameChange() {
        ...
        getUpdatedContent().getDescriptorModel().getPersistenceUnit().setName(view.getPersistenceUnitName());
    }

    @Override
    public void onPersistenceProviderChange() {
        ensurePersistenceUnit();
        getUpdatedContent().getDescriptorModel().getPersistenceUnit().setProvider(view.getPersistenceProvider());
    }

    @Override
    public void onJTADataSourceChange() {
        ensurePersistenceUnit();
        getUpdatedContent().getDescriptorModel().getPersistenceUnit().setJtaDataSource(view.getJTADataSource());
    }
        ...
        dataSourceSelector.show(new ParameterizedCommand<DataSourceInfo>() {
            ...
            public void execute(DataSourceInfo dataSourceInfo) {
                ...
                if (dataSourceInfo.isDeployed()) {
                    getUpdatedContent().getDescriptorModel().getPersistenceUnit().setJtaDataSource(
    ...
    public void onJTATransactionsChange() {
        ensurePersistenceUnit();
        getUpdatedContent().getDescriptorModel().getPersistenceUnit().setTransactionType(

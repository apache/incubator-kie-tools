...
public class DataObjectBreadcrums extends Breadcrumbs {
    ...
    public void add(final DataObject dataObject) {
    ...
    private void adjustNavigation(DataObject dataObject) {
        ...
        for (BufferElement bufferElement : buffer) {
            ...
            if (dataObject.getClassName().equals(bufferElement.getDataObject().getClassName())) break;
        }
        buffer.clear();
    ...
    class BufferElement {
        ...
        BufferElement(DataObject dataObject) {
    ...
    // Event notifications
    private void notifyObjectSelected(DataObject dataObject) {
        dataModelerEvent.fire(new DataObjectSelectedEvent( getContext().getContextId(), DataModelerEvent.DATA_MODEL_BREAD_CRUMB, getDataModel(), dataObject));
    }

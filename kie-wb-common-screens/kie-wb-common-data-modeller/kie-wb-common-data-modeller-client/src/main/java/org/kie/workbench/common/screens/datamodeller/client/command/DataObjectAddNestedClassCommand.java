...
public class DataObjectAddNestedClassCommand extends AbstractDataModelCommand {
    ...
    public DataObjectAddNestedClassCommand( DataModelerContext context, String source, DataObject dataObject,
    ...
    public void execute() {
        ...
        DataModelerEvent event = new DataObjectChangeEvent()
                .withChangeType( ChangeType.NESTED_CLASS_ADD_CHANGE )
                .withOldValue( null )
                .withNewValue( nestedClass )

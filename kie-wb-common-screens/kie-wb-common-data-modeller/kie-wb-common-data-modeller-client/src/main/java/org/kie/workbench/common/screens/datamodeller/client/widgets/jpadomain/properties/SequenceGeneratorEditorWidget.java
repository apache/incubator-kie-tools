...
@Dependent
public class SequenceGeneratorEditorWidget extends BasePopupPropertyEditorWidget {

    private SequenceGeneratorEditionDialog popup;

    @Inject
    public SequenceGeneratorEditorWidget(SequenceGeneratorEditionDialog popup) {
        this.popup = popup;
    }

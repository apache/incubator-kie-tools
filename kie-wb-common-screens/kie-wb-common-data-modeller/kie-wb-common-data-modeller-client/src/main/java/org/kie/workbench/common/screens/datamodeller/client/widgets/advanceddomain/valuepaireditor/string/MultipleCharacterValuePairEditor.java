...
public class MultipleCharacterValuePairEditor extends MultipleValuePairEditor {
    ...
    public ValuePairEditor<?> createValuePairEditor( AnnotationValuePairDefinition valuePairDefinition ) {
        ValuePairEditor<?> valuePairEditor = GWT.create( CharacterValuePairEditor.class );
    ...
    public void setEditorValue( ValuePairEditor<?> valuePairEditor, Object value ) {
        ((CharacterValuePairEditor )valuePairEditor).setValue( value != null ? value.toString() : null );
    }
}

...
public interface DroolsDataObjectFieldEditorView
        extends BaseEditorView<DroolsDataObjectFieldEditorView.Presenter>,
        HasErrorPopup {
    ...
    void setPositionOnError( boolean onError );

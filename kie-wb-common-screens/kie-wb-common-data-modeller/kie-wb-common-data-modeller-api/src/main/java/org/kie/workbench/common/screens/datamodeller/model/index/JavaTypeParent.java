...
public class JavaTypeParent implements IndexElementsGenerator {

    private ValueJavaTypeParentIndexTerm javaTypeParentTerm;

    public JavaTypeParent( final ValueJavaTypeParentIndexTerm javaTypeParentTerm ) {
        this.javaTypeParentTerm = PortablePreconditions.checkNotNull( "javaTypeParentTerm",
                javaTypeParentTerm );
    }
    ...
    public List<Pair<String, String>> toIndexElements() {
        ...
        indexElements.add( new Pair<String, String>( javaTypeParentTerm.getTerm(),
                javaTypeParentTerm.getValue() ) );

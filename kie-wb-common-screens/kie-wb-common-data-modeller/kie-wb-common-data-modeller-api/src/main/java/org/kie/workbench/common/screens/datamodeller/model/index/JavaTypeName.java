...
public class JavaTypeName implements IndexElementsGenerator {

    private ValueJavaTypeNameIndexTerm javaTypeNameTerm;

    public JavaTypeName( final ValueJavaTypeNameIndexTerm javaTypeNameTerm) {
        this.javaTypeNameTerm = PortablePreconditions.checkNotNull( "javaTypeNameTerm",
                javaTypeNameTerm );
    }
    ...
    public List<Pair<String, String>> toIndexElements() {
        ...
        indexElements.add( new Pair<String, String>( javaTypeNameTerm.getTerm(),
                javaTypeNameTerm.getValue() ) );

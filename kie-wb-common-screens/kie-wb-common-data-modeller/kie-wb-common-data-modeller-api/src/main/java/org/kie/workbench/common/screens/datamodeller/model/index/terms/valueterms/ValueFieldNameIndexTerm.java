...
@Portable
public class ValueFieldNameIndexTerm extends FieldNameIndexTerm implements ValueIndexTerm {

    private String fieldName;

    public ValueFieldNameIndexTerm() {
        //Errai marshalling
    }

    public ValueFieldNameIndexTerm( String fieldName ) {

...
public class JavaType implements IndexElementsGenerator {

    private ValueJavaTypeIndexTerm javaTypeTerm;

    public JavaType( final ValueJavaTypeIndexTerm javaTypeTerm ) {
        this.javaTypeTerm = PortablePreconditions.checkNotNull( "javaTypeTerm",
                javaTypeTerm );
    }
    ...
    public List<Pair<String, String>> toIndexElements() {
        ...
        indexElements.add( new Pair<String, String>( javaTypeTerm.getTerm(),
                javaTypeTerm.getValue() ) );

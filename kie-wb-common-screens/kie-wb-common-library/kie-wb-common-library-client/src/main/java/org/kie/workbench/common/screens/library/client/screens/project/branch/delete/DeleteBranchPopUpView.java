...
@Templated
public class DeleteBranchPopUpView implements DeleteBranchPopUpScreen.View,
                                              IsElement {
    ...
    @Override
    public void init(final DeleteBranchPopUpScreen presenter) {
    ...
    public void show(final String name) {
        this.description.textContent = ts.format(LibraryConstants.DeleteBranchDescription,
                                                 name);
        this.confirmedNameLabel.textContent = ts.format(LibraryConstants.ConfirmBranchName);
        errorSetup();
        modal.show();
    }
    ...
    public String getWrongConfirmedNameValidationMessage() {
        return ts.format(LibraryConstants.WrongBranchConfirmedName);
    }

    @Override
    public String getDeletingMessage() {
        return ts.format(LibraryConstants.DeletingBranch,
    ...
    private Button deleteButton() {
        return PopUpUtils.button(ts.format(LibraryConstants.DeleteBranch),
                                 () -> presenter.delete(),
                                 ButtonType.PRIMARY);
    }

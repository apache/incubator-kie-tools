...
public class ValidationItemPresenter extends ListItemPresenter<ModuleRepositories.ModuleRepository, ValidationPresenter, ValidationItemPresenter.View> {
    ...
    public interface View extends ListItemView<ValidationItemPresenter>,
                                  IsElement {
    ...
    @Override
    public ValidationItemPresenter setup(final ModuleRepositories.ModuleRepository projectRepository,
    ...
    @Override
    public ModuleRepositories.ModuleRepository getObject() {

...
@Templated
public class ArchetypeManagementScreenView implements ArchetypeManagementScreenPresenter.View,
                                                      IsElement {
    ...
    @Override
    public void init(final ArchetypeManagementScreenPresenter presenter) {

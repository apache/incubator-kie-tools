...
public class ProjectImportScreenPresenterTest {
    ...
    @InjectMocks
    protected ProjectImportsScreenPresenter presenter = new ProjectImportsScreenPresenter( view, serviceCaller );
    ...
    public void initTest() {
        ...
        when( menuBuilder.addCopy( any( Path.class ), any( Validator.class ) ) ).thenReturn( menuBuilder );
        when( menuBuilder.addRename( any( Path.class ), any( Validator.class ) ) ).thenReturn( menuBuilder );
    ...
    private void verifyShowHide( boolean positive ) {
        when( serviceCaller.call( any( RemoteCallback.class ), any( ErrorCallback.class ) ) )
                .thenAnswer( new LoadContentAnswer( importsService, importsContent, positive ? null : errorCallback ) );
